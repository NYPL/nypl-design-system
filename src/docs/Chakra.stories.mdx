...
appropriately. Unfortunately, this only effect within the `Story` component.
...
patterns allows the Design System to have control over props and standard styles.
This means that not all styled props are available for these types of components.
