...
export const versionsData = [
  [
    ...
    <Text size="body2">
      Reservoir is constantly undergoing improvements with a new version
      published ever two weeks.
    </Text>,
    <Text size="body2" whiteSpace="nowrap">
      <Link
  ...
  [
    ...
    <Text size="body2">
      Reservoir v3.6.0 updated the default font weight for the base styles. All
      components were impacted by the update.
    </Text>,
    <Text size="body2" whiteSpace="nowrap">
      --
    </Text>,
