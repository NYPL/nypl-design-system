      ...
      <Card isCentered>
        ...
        <CardContent>
          <Text size="body2">
            ...
            and ReadMe to setup your project. You can also learn about our component
      ...
      <Card isCentered>
        ...
        <CardContent>
          <Text size="body2">
            ...
            published on npm . If you're looking to contribute to this project,
            checkout the nypl-design-system repo on Github for more information.
          </Text>
        </CardContent>
      </Card>
    </Box>
