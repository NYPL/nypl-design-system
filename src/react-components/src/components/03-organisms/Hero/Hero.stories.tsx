...
export const heroStaffPicks = () => (
  <Hero
    heroType={HeroTypes.Primary}
    heading={
      <Heading level={1} id={"1"} text={"Staff Picks"} blockName={"hero"} />
    }
    subHeaderText={
      <BodyText blockName="hero">
        Nobody loves books more than our experts. Browse and filter hundreds of
        their favorites. Want more suggestions? Check out{" "}
        <a href="#etc">Best Books</a> and <a href="#etc2">125 Books We Love</a>.
      </BodyText>
    }
...
export const DigitalResearchBooksHeader = () => (
  <SectionName>
    <Hero
      heroType={HeroTypes.Secondary}
      heading={
        <Heading level={1} id={"1"} text={"ResearchNow"} blockName={"hero"} />
      }
      subHeaderText={
        <BodyText blockName="hero">
          The internet’s search engine for research collections and e-books you
          can use right now. Powered by the New York Public Library.
        </BodyText>
      }
      image={
        <Image
