...
<ComponentDocsHeader
  ...
  componentName="Bidirectionality"
  summary="Details about bidirectionality support in Reservoir components"
/>
...
- [Reservoir Bidirectionality Goal](#reservoir-bidirectionality-goal)
...
When building user interfaces (UIs), we tend to think in terms of left-to-right
for layout direction because the default language we build UIs for is English.
At NYPL, we serve patrons who speak a variety of languages including Arabic
and Hebrew which are right-to-left languages. To correctly render any language,
UIs should be mirrored to accomodate navigation and the passage of time, for example.
