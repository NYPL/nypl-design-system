...
<ComponentDocsHeader
  ...
  componentName="Iconography"
  summary="Details about icons in Reservoir"
/>
...
colors are currently available through the DS `Icon` component.

If your project requires an icon or color that is not currently available
in the `Icon` component, please inform your project manager or reach out
directly to the NYPL Design System team.
