...
| CSS Attribute | Value     | CSS Variable                       | JS Theme Object   |
| ------------- | --------- | ---------------------------------- | ----------------- |
| `font-size`   | `2.25rem` | `--nypl-fontSizes-heading-primary` | `heading.primary` |
| `font-weight` | `300`     | `--nypl-fontWeights-light`         | `light`           |
...
| CSS Attribute | Value     | CSS Variable                         | JS Theme Object     |
| ------------- | --------- | ------------------------------------ | ------------------- |
| `font-size`   | `1.75rem` | `--nypl-fontSizes-heading-secondary` | `heading.secondary` |
| `font-weight` | `500`     | `--nypl-fontWeights-medium`          | `medium`            |
...
| CSS Attribute | Value      | CSS Variable                        | JS Theme Object    |
| ------------- | ---------- | ----------------------------------- | ------------------ |
| `font-size`   | `1.375rem` | `--nypl-fontSizes-heading-tertiary` | `heading.tertiary` |
| `font-weight` | `500`      | `--nypl-fontWeights-medium`         | `medium`           |
| `line-height` | `1.25`     | n/a                                 | n/a                |
...
| CSS Attribute | Value     | CSS Variable                       | JS Theme Object   |
| ------------- | --------- | ---------------------------------- | ----------------- |
| `font-size`   | `1.25rem` | `--nypl-fontSizes-heading-callout` | `heading.callout` |
| `font-weight` | `400`     | `--nypl-fontWeights-regular`       | `regular`         |
| `line-height` | `1.25`    | n/a                                | n/a               |
...
| CSS Attribute | Value  | CSS Variable                    | JS Theme Object |
| ------------- | ------ | ------------------------------- | --------------- |
| `font-size`   | `1rem` | `--nypl-fontSizes-text-default` | `text.default`  |
| `font-weight` | `300`  | `--nypl-fontWeights-light`      | `light`         |
| `line-height` | `1.5`  | n/a                             | n/a             |

<Text displaySize={TextDisplaySizes.Caption}>Caption</Text>

| CSS Attribute | Value      | CSS Variable                    | JS Theme Object |
| ------------- | ---------- | ------------------------------- | --------------- |
| `font-size`   | `0.875rem` | `--nypl-fontSizes-text-caption` | `text.captions` |
| `font-weight` | `300`      | `--nypl-fontWeights-light`      | `light`         |
| `line-height` | `1.25`     | n/a                             | n/a             |
...
| CSS Attribute | Value     | CSS Variable                 | JS Theme Object |
| ------------- | --------- | ---------------------------- | --------------- |
| `font-size`   | `0.75rem` | `--nypl-fontSizes-text-tag`  | `text.tag`      |
| `font-weight` | `400`     | `--nypl-fontWeights-regular` | `regular`       |
| `line-height` | `1.5`     | n/a                          | n/a             |
...
| CSS Attribute | Value      | CSS Variable                 | JS Theme Object |
| ------------- | ---------- | ---------------------------- | --------------- |
| `font-size`   | `0.625rem` | `--nypl-fontSizes-text-mini` | `text.mini`     |
| `font-weight` | `400`      | `--nypl-fontWeights-regular` | `regular`       |
| `line-height` | `1.5`      | n/a                          | n/a             |
...
| rem     | px     | CSS Variable          | JS Theme Object |
| ------- | ------ | --------------------- | --------------- |
| `0.625` | `10px` | `--nypl-fontSizes--3` | `-3`            |
