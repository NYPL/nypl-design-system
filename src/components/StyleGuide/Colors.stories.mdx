...
export const cssVars = {
  ...
  ui: [
    ...
    },
    {
      ...
      dataBgDefaultColor: checkContrast(1.20),
      textColor: "ui.black",
    },
    {
    ...
    },
    {
      ...
      dataBgDefaultColor: checkContrast(2.70),
      textColor: "ui.black",
    },
    {
      colorSource: "ui.black",
    ...
    },
    {
      ...
      dataBgDefaultColor: checkContrast(2.60),
      textColor: "ui.black",
    },
  ],
  grayscale: [
  ...
  dark: [
    ...
    },
    {
      ...
      dataDarkBgPageColor: ["4.60", "AA", "AAA"],
      dataDarkBgDefaultColor: ["4.32", "Fail", "AA"],
    ...
    },
    {
      ...
      dataDarkBgPageColor: ["7.25", "AAA", "AAA"],
      dataDarkBgDefaultColor: ["6.80", "AA", "AAA"],
    ...
    {
      name: "dark.ui.focus",
      dataDarkBgPageColor: ["4.85", "AA", "AAA"],
      dataDarkBgDefaultColor: ["4.56", "AA", "AAA"],
    ...
    },
    {
      ...
      dataDarkBgPageColor: ["4.82", "AA", "AAA"],
      dataDarkBgDefaultColor: ["4.53", "AA", "AAA"],
    ...
    },
    {
      ...
      dataDarkBgPageColor: ["6.65", "AA", "AAA"],
      dataDarkBgDefaultColor: ["6.24", "AA", "AAA"],
    ...
    },
    {
      ...
      dataDarkBgPageColor: ["3.23", "Fail", "AA"],
      dataDarkBgDefaultColor: ["3.03", "Fail", "AA"],
    ...
    },
    {
      ...
      dataDarkBgPageColor: ["3.39", "Fail", "AA"],
      dataDarkBgDefaultColor: ["3.18", "Fail", "AA"],
    ...
    },
    {
      ...
      dataDarkBgPageColor: ["1.48", "Fail", "Fail"],
      dataDarkBgDefaultColor: ["1.39", "Fail", "Fail"],
    ...
    },
    {
      ...
      dataDarkBgPageColor: ["1.20", "Fail", "Fail"],
      dataDarkBgDefaultColor: ["1.13", "Fail", "Fail"],
      dataBlackColor: ["1.35", "Fail", "Fail"],
    ...
    },
    {
      ...
      dataBlackColor: checkContrast(1.30),
      dataWhiteColor: checkContrast(16.10),
    ...
    },
    {
      ...
      dataDarkBgPageColor: ["1.59", "Fail", "Fail"],
      dataDarkBgDefaultColor: ["1.49", "Fail", "Fail"],
    ...
    },
    {
      ...
      dataDarkBgPageColor: ["1.47", "Fail", "Fail"],
      dataDarkBgDefaultColor: ["1.38", "Fail", "Fail"],
