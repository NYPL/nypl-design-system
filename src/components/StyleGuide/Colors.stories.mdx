...
<Canvas>
  ...
  >
    ...
    <List type={ListTypes.Unordered} className="card-grid__cards" noStyling>
    ...
    <List type={ListTypes.Unordered} className="card-grid__cards" noStyling>
      <li style={{ textAlign: "center" }}>
        <UIDocCard backgroundColor={getCSSVariable("--section-blogs-primary")}>
          --section-blogs-primary: {getCSSVariable("--section-blogs-primary")}
        </UIDocCard>
      </li>
      <li style={{ textAlign: "center" }}>
        <UIDocCard
