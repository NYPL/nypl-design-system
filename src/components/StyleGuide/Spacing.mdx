...
<ComponentDocsHeader
  ...
  summary="How to use Reservoir spacing values and design tokens"
/>
...
- {<Link href="#tabular-data-spacing" target="_self">Text Spacing</Link>}
...
Use these tokens to add spacing before or after text elements.

|               | JS Token            | CSS Token                          | Value  |
| :------------ | :------------------ | :--------------------------------- | :----- |
| **Heading**   | `heading.default`   | `--nypl-spacing-heading-default`   | `1rem` |
| **Paragraph** | `paragraph.default` | `--nypl-spacing-paragraph-default` | `1rem` |
