...
display an optional "Clear all filters" button. The "Show results" button will always be rendered at the bottom of the modal
popup regardless of the filtering method being used.

It is recommended that the label for the "Show results" button also include the current number of items in
the results list: for example, "Show 72 results."

The number value should update
