...
- {<Link href="#terminology" target="_self">Terminology</Link>}
  ...
  - {<Link href="#breakpoint-ranges" target="_self">Breakpoint Ranges</Link>}
  - {<Link href="#columns" target="_self">Columns</Link>}
  - {<Link href="#gutters" target="_self">Gutters</Link>}
  - {<Link href="#margines" target="_self">Margins</Link>}
...
<Image src="/img/grid-perceived-columns-1.png" alt="One perceived column" />
</div>
