...
<Banner
  content={<>The Reservoir team will support v3 until the end of Q2 FY26.</>}
  mt="s"
  mb="s"
  variant="warning"
/>
...
- [General Updates & Requirements](#general-updates-requirements)
- [Upgrade Path](#upgrade-path)
- [Breaking Changes](#breaking-changes)
- [Additional Testing Needs](#additional-testing-needs)
