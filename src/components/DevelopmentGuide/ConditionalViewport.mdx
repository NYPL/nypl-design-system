...
- [Background on the viewport and input auto-zoom issue](#background-on-the-viewport-and-input-auto-zoom-issue)
- [How to resolve](#how-to-resolve)
- [Approach for Next.js App Router apps](#approach-for-nextjs-app-router-apps)
- [Approach for Next.js Pages Router apps](#approach-for-nextjs-pages-router-apps)
...
device, and the user interacts with it by scrolling or zooming in and out.
...
devices. Since Reservoir components should be able to render regardless of
