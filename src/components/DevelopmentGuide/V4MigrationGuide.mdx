...
`Heading` and `Text`. If you’re using the `noSpace` prop, you'll need to
remove it. If you were relying on default spacing from Reservoir, you'll need
to add it back in manually.

| Component           | Spacing removed |
| ------------------- | :-------------- |
| **DatePicker**      | accordionType   |
| **Heading**         | `mb='s'`        |
| **HelperErrorText** | accordionType   |
| **HorizontalRule**  | accordionType   |
| **Label**           | accordionType   |
| **List**            | accordionType   |
| **StyledList**      | accordionType   |
| **Text**            | accordionType   |
