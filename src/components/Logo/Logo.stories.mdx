...
`"cleverWhite"`, `"digitalCollectionsBlack"`, `"digitalCollectionsWhite"`,
`"firstbookColor"`, `"firstbookColorNegative"`, `"googlePlayBlack"`,
`"lpaBlack"`, `"lpaColor"`, `"lpaWhite"`, `"mlnBlack"`, `"mlnColor"`, `"mlnWhite"`, `"nycdoeColor"`,
`"nyplFullBlack"`, `"nyplFullWhite"`, `"nyplLionBlack"`, `"nyplLionWhite"`, `"nyplTextBlack"`,
`"nyplTextWhite"`, `"openebooksColor"`, `"openebooksNegative"`, `"openebooksWithTextColor"`,
