...
import { logoNamesArray } from "./logoVariables";
...
`"nyplTextBlack"`, `"nyplTextWhite"`, `"openebooksColor"`,
`"openebooksNegative"`, `"openebooksWithTextColor"`,
...
`"schomburgCircleWhite"`, `"schomburgColor"`, `"schomburgWhite"`,
`"simplyeBlack"`, `"simplyeWhite"`, `"simplyeColor"`, `"snflBlack"`,
`"snflWhite"`, `"treasuresColor"`, `"treasuresColorNegative"`.
