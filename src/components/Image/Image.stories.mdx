...
second pacakge checks if the `img`'s native `loading="lazy` attribute is
supported by the browser.

The `Image`'s implementation of lazy loading is based on the recipe provided by
them. Once the image's wrapper is in view, we load the image by rendering it
through the native `loading="lazy` attribute or through the
...
<Canvas>
  <Story name="Lazy Loading">
    <SimpleGrid columns={1}>
      <Image alt="Alt text" src="https://placeimg.com/540/420/animals" />
      <Image alt="Alt text" src="https://placeimg.com/500/400/animals" />
      <Image alt="Alt text" src="https://placeimg.com/460/460/animals" />
      <Image alt="Alt text" src="https://placeimg.com/420/490/animals" />
      <Image alt="Alt text" src="https://placeimg.com/200/120/animals" />
      <Image alt="Alt text" src="https://placeimg.com/640/340/animals" />
      <Image alt="Alt text" src="https://placeimg.com/460/480/animals" />
      <Image alt="Alt text" src="https://placeimg.com/100/200/animals" />
      <Image alt="Alt text" src="https://placeimg.com/400/400/animals" />
      <Image alt="Alt text" src="https://placeimg.com/250/360/animals" />
    </SimpleGrid>
  </Story>
</Canvas>
