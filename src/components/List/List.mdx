...
To render a description list, pass in `"dl"` to the `listContainer` prop. The optional
...
<List listContainer="dl" title={listHeading}>
  <dt>Balrogs</dt>
...
<List listContainer={ul} listItems={fishArray} />
`}
  language="jsx"
/>
...
<Source
  code={`
// With \`dt\`/\`dd\` elements
<List listContainer="dl" title="Animal Crossing Fish">
  <dt>Mahi-mahi</dt>
...
// ...
<List listItems={fishDescriptions} title="Animal Crossing Fish" listContainer="dl" />
`}
  language="jsx"
/>
