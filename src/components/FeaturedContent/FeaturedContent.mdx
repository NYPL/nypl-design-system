...
The above example with an overline, a heading, two lines of body text, and a button is the recommended usage, though other uses are possible. Keep in mind that the minimum height of `FeaturedContent` is 320px.
