...
NYPL web applications often uses dynamic content and live regions to provide
real-time feedback for the number of results returned in search and filter
scenarios.

NYPL web applications may also use live regions to provide general form
validation after a form is submitted.
