...
Audio and video content needs to be made accessible for NYPL audiences.
...
punctuation and grammar. Unedited automatic captions can be a useful
starting point, but are generally not sufficient and should be edited
for accuracy.
