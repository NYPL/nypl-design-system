...
- There was a problem. First name is required.
- Opps, something went wrong! First name is required.
- An error has occurred. First name is required.
...
- There was a problem. Your password must be at least 8 characters long.
- Opps, something went wrong! Your phone number does not have the correct format.
...
<span id=”fnameerror”>There was a problem. Please enter your first name.</span>
`}
  language="html"
/>
...
placed on the error message. See more about [how to manage focus](https://nypl.github.io/nypl-design-system/reservoir/v4/?path=/docs/accessibility-guide-managing-focus--docs#how-to-manage-focus).

## NYPL Patterns

NYPL will use a formal, yet familiar, tone when writing error messages.

### Form Inputs

Error messages applied to form input fields should be prepended with "There was
a problem." The remainder of the error message should give details about the
problem itself.
