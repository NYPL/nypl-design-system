...
- [Making Errors Explicit and Providing Instructions](#making-errors-explicit-and-providing-instructions)
- [Avoiding Reliance on Color](#avoiding-reliance-on-color)
- [Programmatic Indicator of Error](#programmatic-indicator-of-error)
- [Associating Inline Errors with their Fields](#associating-inline-errors-with-their-field)
- [Shifting Focus to Errors](#shifting-focus-to-errors)
- [NYPL Patterns](#NYPL-patterns)
- [Resources](#resources)

## General Information

Accessible error handling ensures errors are easily perceived, understood, and corrected by
everyone, whether they are using assistive technology or not. Some core features of accessible
errors include:

- Explicit statements of error and instructions for correction
- Avoiding reliance on color to indicate the error state
...
also be a secondary visual indication, such as an icon or the word “error” (as
