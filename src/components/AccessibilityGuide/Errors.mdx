...
Accessible error handling ensures errors are easily perceived, understood, and corrected
by those using assistive technology and those who are not. Some core features of accessible
errors include:
