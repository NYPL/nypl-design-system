...
component. The NYPL Design System does have custom styling that targets the
...
every input element. The suggestion dropdown hovers over the page's content and
a min-height is added to each block to better display the dropdown.
