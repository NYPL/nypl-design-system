...
for global messaging at the top of the site, above the NYPL header, while the
`Banner` component should be used for all messaging that sits within the flow of
the page.
