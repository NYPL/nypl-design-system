...
The `variant` prop can be used to render different variants of `Banner`. Each
...
It is recommended to rely on the color styles set with the `variant` prop.
...
set in order to override the predefined variants.
