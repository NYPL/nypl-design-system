...
//     // Previous Page
//     expect(links.get(0).props.href).toEqual("page=5");
//     expect(links.get(1).props.href).toEqual("page=1");
//     expect(links.get(2).props.href).toEqual("page=4");
//     expect(links.get(3).props.href).toEqual("page=5");
//     expect(links.get(4).props.href).toEqual("page=6");
//     expect(links.get(5).props.href).toEqual("page=7");
//     expect(links.get(6).props.href).toEqual("page=8");
//     expect(links.get(7).props.href).toEqual("page=20");
//     // Next Page
//     expect(links.get(8).props.href).toEqual("page=7");
//   });
...
//     );
//     expect(wrapper.find("a").first().hasClass("disabled")).toEqual(true);
//     expect(
...
//     );
//     expect(wrapper.find("a").last().hasClass("disabled")).toEqual(true);
//     expect(
...
//     );
//     expect(wrapper.find("a").at(5).hasClass("selected")).toEqual(true);
//   });

//   it("When pagination has 1 element, pagination is not shown", () => {
//     const shallow = render(
