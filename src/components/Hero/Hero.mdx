...
<Source
  code={`
<Hero
  backgroundImageSrc="https://loremflickr.com/g/2400/800/new+york+public+library"
  heroType="campaign"
  heading={<Heading level="h1" id="campaign-hero" text="Hero Campaign" />}
  imageProps={{
    alt: "Image example",
    src: "https://loremflickr.com/800/400/new+york+public+library",
  }}
...
<Source
  code={`
backgroundImageSrc="https://loremflickr.com/1600/800/new+york+public+library"
