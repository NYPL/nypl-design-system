...
<Canvas>
  <DSProvider>
    <VStack spacing={10} align="stretch">
      <Heading text="Primary" id="primary-heading" />
      <Hero
        backgroundImageSrc="https://placeimg.com/1600/800/arch"
        heading={<Heading level="one" id="primary-hero" text="Hero Primary" />}
        heroType="primary"
      />
      <Heading id="secondary-heading" text="Secondary" />
      ...
      <Heading id="tertiary-heading" text="Tertiary" />
      <Hero
        heading={
          <Heading
            level="one"
      ...
      <Hero
        ...
        heroType="tertiary"
      />
      <Heading id="campaign-heading" text="Campaign" />
      <Hero
      ...
      />
      <Box marginTop="30px" />
      <Heading id="fiftyfifty-heading" text="FiftyFifty" />
      <Hero
        heroType="fiftyFifty"
        imageAlt={imageAlt}
        imageSrc={imageSrc}
...
on the `heroType` variants for the `"secondary"` main variant.
