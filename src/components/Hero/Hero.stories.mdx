...
The `"primary"` hero type should be used with the `backgroundImageSrc` and
`heading` props.
...
The `"secondary"` hero type should be used with the `heading`, `imageProps`, and
`subHeaderText` props.
...
The `"tertiary"` hero type should be used with the `heading`, and `subHeaderText`
props.
...
The `"campaign"` hero type should be used with the `backgroundImageSrc`, `heading`,
`imageProps`, and `subHeaderText` props.
...
The `"fiftyFifty"` hero type should be used with the `imageProps` and
`subHeaderText` props.
