...
<Meta
  ...
  argTypes={{
    ...
    foregroundColor: { control: { type: null } },
    heading: { control: { type: null } },
    image: { control: { type: null } },
    locationDetails: { control: { type: null } },
    subHeaderText: { control: { type: null } },
  }}
/>
  ...
  <Story
    ...
    argTypes={{
      heroType: {
        ...
        table: {
          defaultValue: { summary: "HeroTypes.Primary" },
        },
