...
<Canvas of={TableStories.WithATitle} />

## With Row Dividers

Use the `showRowDividers` prop to render a divider between each row.

<Canvas of={TableStories.WithRowDividers} />
...
<Canvas of={TableStories.WithRowHeaders} />
...
<Canvas of={TableStories.WithCustomHeaderColors} />
...
<Canvas of={TableStories.WithJSXElement} />
