...
<Heading level="h1" overline="Page layout" size="display1" subtitle="A structural skelton for composing a standard page layout.">Template</Heading>
...
The Reservoir Design System provides a set of "template" components
that work together to render a consistent mobile and desktop layout.
