...
If you need to render the `SkipNav` component, set `renderSkipNav` to true.
...
If you are using a custom header component or you need to use the Reservoir's
`SkipNav` component, then set the `renderSkipNav` prop to true. This will render
the `SkipNav` component at the top of the page before any other elements. The
main link will point to the `#mainContent` `main` element.
...
Note: If you need to render the `SkipNav` component, you need to explicitly
