...
a tooltiip correctly, start by following the recommendations below.
...
While the Reservoir Tooltip component does allow icons and images to be included
in tooltip content, this practice should be avoided.
