...
The following body content is passed as a string to the `textContent` prop. It
...
The following content is passed as HTML DOM elements to the `textContent` prop.
