...
If the number of items in the checkbox list exceeds 20 items, it is recommended to enable the component's search functionality.
It is also recommended to use scroll for overflow with over 20 items.
