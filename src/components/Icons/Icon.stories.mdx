...
`"fileTypeSpreadsheet"`, `"fileTypeVideo"`, `"headset"`, `"locator"`, `"minus"`,
`"plus"`, `"search"`, `"socialFacebook"`, `"socialInstagram"`, `"socialTumblr"`,
`"socialTwitter"`, `"socialYoutube"`, `"speakerNotes"`, `"utilityAccountFilled"`,
