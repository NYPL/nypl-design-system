...
- {<Link href="#rotations" target="_self">Rotations</Link>}
- {<Link href="#colors" target="_self">Colors</Link>}
- {<Link href="#sizes" target="_self">Sizes</Link>}
- {<Link href="#all-icons" target="_self">All Icons</Link>}
- {<Link href="#custom-icons" target="_self">Custom Icons</Link>}
...
<ArgTypes of={IconStories.WithControls} />
...
<Canvas of={IconStories.Rotations} />
