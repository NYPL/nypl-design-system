...
`"locator"`, `"mapsPlace"`, `"minus"`, `"moonCrescent"`, `"plus"`, `"search"`,
`"socialFacebook"`, `"socialInstagram"`, `"socialPinterest"`,
`"socialSoundCloud"`, `"socialSpotify"`, `"socialTikTok"`, `"socialTumblr"`,
`"socialTwitter"`, `"socialVimeo"`, `"socialYoutube"`, `"speakerNotes"`,
`"sunFull"`, `"utilityAccountFilled"`, `"utilityAccountUnfilled"`,
`"utilityHamburger"`, `"utilitySearch"`.
