...
be found in the `IconNames` type. They are: `"accessibilityPartial"`,
`"actionCheckCircle"`, `"actionCheckCircleFilled"`, `"actionExit"`,
`"actionHelpDefault"`, `"actionHelpOutline"`, `"actionIdentity"`,
`"actionIdentityFilled"`, `"actionLaunch"`, `"actionPower"`,
