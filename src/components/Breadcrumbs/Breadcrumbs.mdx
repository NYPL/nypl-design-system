...
The `customLink` prop allows apps with internal routers (Next.js, for example) to pass their custom link component
...
<Breadcrumbs customLink={Link} breadcrumbsData={breadcrumbsDataWithLinkProps} />
`} language="tsx" />
