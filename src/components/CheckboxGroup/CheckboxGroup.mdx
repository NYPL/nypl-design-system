...
- [Required](#required)
- [Disabled](#disabled)
- [Lsbels Using JSX Elements](#labels-using-jsx-elements)
...
Lsbels Using JSX Elements Elementslabels-using
React elementss be passed to the `labelText` prop of the `Checkbox` component.
