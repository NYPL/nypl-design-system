...
<Banner
  content={
    <>
      <strong>NOTE:</strong> The border you see around the{" "}
      <code>Notification</code> in these docs is not part of the component. It
      has been added to help illustrate how the <code>Notification</code> sits
