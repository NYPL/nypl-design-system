...
<ComponentDocsHeader
  ...
  componentName="Card"
  summary="A flexible container used to group single-subject content in a 
...
Note: all of the examples have images with the `isLazy` prop set to true.
...
The `imageProps` prop is used to render the internal `CardImage`
component.
...
Note: `Card` always displays as a column at smaller container widths.
