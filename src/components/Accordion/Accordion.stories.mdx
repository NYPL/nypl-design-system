...
export const accordionTextData = [
  {
    accordionType: "default",
    label: "Tom Nook",
    panel: (
...
<Canvas withToolbar>
  <Story name="panelMaxHeight Example">
    <Accordion accordionData={accordionData} panelMaxHeight="75px" />
  </Story>
</Canvas>
...
<Canvas withToolbar>
  <Story name="panelMaxHeight Example With Long Text">
    <Accordion accordionData={accordionTextData} panelMaxHeight="75px" />
  </Story>
</Canvas>
