...
objects with `label` and `panel` properties, and optional `accordionVariant`, `ariaLabel`,
...
The `accordionVariant` prop can be used to change the accordion button's background
