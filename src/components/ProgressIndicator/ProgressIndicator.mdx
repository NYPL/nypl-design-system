...
The `labelPlacement` prop can be used to set the placement of a label relative to
the indicator. By default, the label will be displayed below the indicator. This
prop only applies to circular indicator variants.
