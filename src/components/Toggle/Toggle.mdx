...
If the `Toggle` is part of a form, you should pass the component an HTML `name`
attribute. A `name` is required to be able to add the value to form data. If you
do not, a `name` of `"default"` will automatically be applied.
