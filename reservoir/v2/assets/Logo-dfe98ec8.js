import{j as o,a as n,F as a}from"./jsx-runtime-fdf4db99.js";import{M as p,D as g,C as i,A as m,b as r}from"./index-445595fc.js";import{C as f}from"./ComponentChangelogTable-310bbbfd.js";import{L as d,W as t,S as u,a as y,A as v,C}from"./Logo.stories-5a8f03b0.js";import{L as l}from"./Link-24c1437a.js";import{u as s}from"./index-09eae0a8.js";import"./index-0cbcd92a.js";import"./_commonjsHelpers-de833af9.js";import"./iframe-da8f5748.js";import"../sb-preview/runtime.js";import"./index-42773b54.js";import"./extends-98964cd2.js";import"./isNativeReflectConstruct-2a967270.js";import"./inheritsLoose-d541526f.js";import"./setPrototypeOf-0bb37fbe.js";import"./doctrine-33c8ee8e.js";import"./index-314a82e0.js";import"./index-11d98b33.js";import"./index-356e4a49.js";import"./index-8f383b84.js";import"./emotion-react-jsx-runtime.browser.esm-49aea89b.js";import"./chakra-ui-layout.esm-e0dbb94e.js";import"./List-582282a6.js";import"./useDSHeading-94e72700.js";import"./Heading-7eebc756.js";import"./Text-d88b2f7a.js";import"./Table-64c6aa77.js";import"./index-6148c31a.js";import"./Logo-484e2077.js";import"./Icon-4eeffe51.js";import"./SimpleGrid-bd04b221.js";import"./types-ee6958f5.js";const b=[{date:"2023-12-07",version:"2.1.3",type:"Update",affects:["Styles"],notes:['Udpates the "digitalCollectionsBlack" variant to use NYPL color design tokens.']},{date:"2023-11-09",version:"2.1.2",type:"Update",affects:["Documentation","Functionality","Styles"],notes:["Adds `sizeBasedOn` prop to the `Logo` component."]}];function h(c){const e=Object.assign({h1:"h1",table:"table",thead:"thead",tr:"tr",th:"th",tbody:"tbody",td:"td",code:"code",h2:"h2",ul:"ul",li:"li",p:"p",a:"a"},s(),c.components);return n(a,{children:[o(p,{of:d}),`
`,o(e.h1,{id:"logo",children:"Logo"}),`
`,n(e.table,{children:[o(e.thead,{children:n(e.tr,{children:[o(e.th,{children:"Component Version"}),o(e.th,{children:"DS Version"})]})}),n(e.tbody,{children:[n(e.tr,{children:[o(e.td,{children:"Added"}),o(e.td,{children:o(e.code,{children:"0.25.9"})})]}),n(e.tr,{children:[o(e.td,{children:"Latest"}),o(e.td,{children:o(e.code,{children:"2.1.3"})})]})]})]}),`
`,o(e.h2,{id:"table-of-contents",children:"Table of Contents"}),`
`,n(e.ul,{children:[`
`,n(e.li,{children:[`
`,o(l,{href:"#overview",target:"_self",children:"Overview"}),`
`]}),`
`,n(e.li,{children:[`
`,o(l,{href:"#component-props",target:"_self",children:"Component Props"}),`
`]}),`
`,n(e.li,{children:[`
`,o(l,{href:"#accessibility",target:"_self",children:"Accessibility"}),`
`]}),`
`,n(e.li,{children:[`
`,o(l,{href:"#sizes",target:"_self",children:"Sizes"}),`
`]}),`
`,n(e.li,{children:[`
`,o(l,{href:"#all-logos",target:"_self",children:"All Logos"}),`
`]}),`
`,n(e.li,{children:[`
`,o(l,{href:"#custom-logos",target:"_self",children:"Custom Logos"}),`
`]}),`
`,n(e.li,{children:[`
`,o(l,{href:"#changelog",target:"_self",children:"Changelog"}),`
`]}),`
`]}),`
...
`,n(e.p,{children:["For accessibility purposes, every Reservoir Design System (DS) ",o(e.code,{children:"Logo"}),` will
...
`,n(e.p,{children:[o(e.code,{children:"Logos"}),`s are decorative by default. This means that they are presentational and
...
`,n(e.p,{children:["Update the size of the ",o(e.code,{children:"Logo"})," component by passing the ",o(e.code,{children:"size"}),` prop with a value
...
`,n(e.p,{children:["Note: ",o(e.code,{children:'"default"'})," sets the width to ",o(e.code,{children:"100%"}),` and the rendered logo will expand to
fill the full width of the parent element.`]}),`
`,n(e.p,{children:["In addition, the ",o(e.code,{children:"sizeBasedOn"}),` prop can be passed to determine whether the size
of the `,o(e.code,{children:"Logo"})," is updated based on either the ",o(e.code,{children:'"height"'})," or ",o(e.code,{children:'"width"'}),`. By default,
the `,o(e.code,{children:"sizeBasedOn"})," prop is set to ",o(e.code,{children:'"width"'}),"."]}),`
`,o(r,{code:`
// Example
...
`,n(e.p,{children:["Update the icon of the ",o(e.code,{children:"Logo"})," component by passing the ",o(e.code,{children:"name"}),` prop with a value
...
`,o(e.code,{children:'"nycpsBlack"'}),", ",o(e.code,{children:'"nycpsColor"'}),", ",o(e.code,{children:'"nycpsWhite"'}),", ",o(e.code,{children:'"nyplFullBlack"'}),`,
`,o(e.code,{children:'"nyplFullWhite"'}),", ",o(e.code,{children:'"nyplLionBlack"'}),", ",o(e.code,{children:'"nyplLionWhite"'}),", ",o(e.code,{children:'"nyplTextBlack"'}),`,
`,o(e.code,{children:'"nyplTextWhite"'}),", ",o(e.code,{children:'"openebooksColor"'}),", ",o(e.code,{children:'"openebooksNegative"'}),`,
`,o(e.code,{children:'"openebooksWithTextColor"'}),", ",o(e.code,{children:'"openebooksWithTextNegative"'}),", ",o(e.code,{children:'"qplAltBlack"'}),`,
`,o(e.code,{children:'"qplAltWhite"'}),", ",o(e.code,{children:'"qplBlack"'}),", ",o(e.code,{children:'"qplColor"'}),", ",o(e.code,{children:'"qplWhite"'}),`,
`,o(e.code,{children:'"reservoirIconColor"'}),", ",o(e.code,{children:'"reservoirVerticalColor"'}),", ",o(e.code,{children:'"schomburgBlack"'}),`,
`,o(e.code,{children:'"schomburgCircleBlack"'}),", ",o(e.code,{children:'"schomburgCircleColor"'}),", ",o(e.code,{children:'"schomburgCircleWhite"'}),`,
`,o(e.code,{children:'"schomburgColor"'}),", ",o(e.code,{children:'"schomburgWhite"'}),", ",o(e.code,{children:'"simplyeBlack"'}),", ",o(e.code,{children:'"simplyeWhite"'}),`,
`,o(e.code,{children:'"simplyeColor"'}),", ",o(e.code,{children:'"snflBlack"'}),", ",o(e.code,{children:'"snflWhite"'}),", ",o(e.code,{children:'"treasuresColor"'}),`,
`,o(e.code,{children:'"treasuresColorNegative"'}),"."]}),`
`,n(e.p,{children:["If you feel a necessary logo should be added to the ",o(e.code,{children:"Logo"}),` component, please
reach out to the DS team.`]}),`
`,o(i,{of:v}),`
`,o(e.h2,{id:"custom-logos",children:"Custom Logos"}),`
`,n(e.p,{children:["If you'd like to pass a custom ",o(e.code,{children:"svg"}),` to your application, you can pass it a
...
`,language:"tsx"}),`
`,o(i,{of:C}),`
`,o(e.h2,{id:"changelog",children:"Changelog"}),`
`,o(f,{changelogData:b})]})}function $(c={}){const{wrapper:e}=Object.assign({},s(),c.components);return e?o(e,Object.assign({},c,{children:o(h,c)})):h(c)}export{$ as default};
//# sourceMappingURL=Logo-dfe98ec8.js.map
