...
import {
  ...
  A as m,
  L as b,
} from "./Checkbox.stories-CLYWgyuD.js";
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          " component renders a checkbox input element. The ",
          e.jsx(n.code, { children: "Checkbox" }),
          " component should be used to allow users to select one or more options from a list of choices.",
        ],
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          "Please note that the examples on this page show the ",
          e.jsx(n.code, { children: "Checkbox" }),
          " component in isolation. It is recommended to use the ",
          e.jsx(n.code, { children: "Checkbox" }),
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          " and ",
          e.jsx(n.code, { children: '<input type="checkbox" />' }),
          `
...
with the value of the `,
          ...
          ` element. If there is helper or invalid text,
the `,
          e.jsx(n.code, { children: "<input>" }),
          " element will have a ",
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://www.w3.org/TR/wai-aria-practices-1.1/examples/checkbox/checkbox-1/checkbox-1.html",
              rel: "nofollow",
              children: "W3C WAI ARIA Checkbox Example",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "a11ymatters Accessible Checkbox",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "MDN ARIA: checkbox role",
            }),
          }),
          `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          ` and clicking
on it won't remove the checkmark; the `,
          e.jsx(n.code, { children: "isChecked" }),
...
`,
      e.jsxs(n.p, {
        children: [
          "Note: This state only changes the icon through the ",
          e.jsx(n.code, { children: "isIndeterminate" }),
          ` prop. This
does not affect whether the checkbox is checked. The `,
          e.jsx(n.code, { children: "isIndeterminate" }),
          ` prop must
...
function w(s = {}) {
  ...
  return n ? e.jsx(n, { ...s, children: e.jsx(h, { ...s }) }) : h(s);
}
export { w as default };
