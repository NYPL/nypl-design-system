...
function t({ children: n, variant: L }) {
  return e.jsx("div", {
    className: `placeholder placeholder--${L}`,
    children: n,
  });
}
try {
  (t.displayName = "Placeholder"),
    (t.__docgenInfo = {
      description: `Creates a gray box with an editable string for dropping in spaces
...
that hasn't been created yet`,
      ...
      props: {
        variant: {
          defaultValue: null,
          description: "Modifier string for the classname.",
          name: "variant",
          required: !1,
          type: { name: "string" },
        },
...
const X = { title: "Components/Page Layout/Template", component: S },
  Q =
  ...
  Z = [
    {
      ...
      panel: e.jsxs(l, {
        ...
        layout: "row",
        children: [
          e.jsx(d, { level: "h4", id: "heading1", children: "Tom Nook" }),
          e.jsxs(c, {
            children: [
              "Tom Nook, ",
  ...
  te = ["Name", "Nick Name", "Species", "Description", "Bio", "Salary (USD)"],
  ne = [
    [
      "Tom Nook",
      "Tanukichi",
  ...
  r = {
    args: {
      aboveHeader: e.jsx(t, { variant: "short", children: "Above Header" }),
      breakout: e.jsxs(e.Fragment, {
        children: [
          e.jsx(t, { variant: "short", children: "Breadcrumbs" }),
          e.jsx(t, { children: "Hero" }),
        ],
      }),
      contentBottom: e.jsx(t, { variant: "short", children: "Content Bottom" }),
      contentId: "mainContent",
      contentPrimary: e.jsxs(e.Fragment, {
        children: [
          e.jsx(t, { children: "Main Content" }),
          e.jsx(t, { variant: "short", children: "More Content" }),
        ],
      }),
      contentTop: e.jsx(t, { variant: "short", children: "Content Top" }),
      footer: e.jsx(t, { children: "Footer" }),
      header: e.jsx(t, { variant: "short", children: "Header" }),
      renderFooterElement: !0,
      renderHeaderElement: !0,
      renderSkipNavigation: !1,
      sidebar: "left",
    },
    argTypes: {
      aboveHeader: { control: !1 },
      breakout: { control: !1 },
      contentBottom: { control: !1 },
      contentPrimary: { control: !1 },
      contentSidebar: { control: !1 },
      contentTop: { control: !1 },
      footer: { control: !1 },
      header: { control: !1 },
      renderSkipNavigation: G("true"),
      sidebar: { table: { defaultValue: { summary: "none" } } },
    },
    render: (n) =>
      e.jsx(S, {
        ...n,
        contentSidebar: e.jsxs(t, { children: ["Sidebar (", n.sidebar, ")"] }),
      }),
    parameters: {
      design: {
        type: "figma",
  ...
  i = {
    args: { sidebar: "left" },
    argTypes: {
      aboveHeader: { table: { disable: !0 } },
      breakout: { table: { disable: !0 } },
      contentBottom: { table: { disable: !0 } },
      contentId: { table: { disable: !0 } },
      contentPrimary: { table: { disable: !0 } },
      contentSidebar: { table: { disable: !0 } },
      contentTop: { table: { disable: !0 } },
      footer: { table: { disable: !0 } },
      header: { table: { disable: !0 } },
            ...
            children: [
              e.jsxs(A, {
                children: [
                  e.jsx(B, {
                    children: e.jsx(t, {
                      variant: "short",
                      children: "Above Header",
                    }),
                  }),
                  e.jsxs(N, {
                    children: [
                      e.jsx(t, { variant: "short", children: "Header" }),
                      e.jsx(t, { variant: "short", children: "Breadcrumbs" }),
                      e.jsx(t, { children: "Hero" }),
                    ],
                  }),
              ...
              e.jsxs(I, {
                ...
                children: [
                  ...
                  n.sidebar === "left" &&
                    e.jsx(h, {
                      children: e.jsx(t, { children: "Left Sidebar" }),
                    }),
                  e.jsxs(R, {
                    children: [
                      e.jsx(t, { children: "Main Content" }),
                  ...
                  n.sidebar === "right" &&
                    e.jsx(h, {
                      children: e.jsx(t, { children: "Right Sidebar" }),
                    }),
                  e.jsx(M, {
                    children: e.jsx(t, {
                      variant: "short",
              ...
              e.jsx(q, { children: e.jsx(t, { children: "Footer" }) }),
            ],
          }),
        ],
      }),
            ...
            children: [
                ...
                children: [
                  e.jsx(B, {
                    children: e.jsx(_, {
                      ...
                      notificationContent: e.jsx(e.Fragment, {
                        children:
                          'This is an "announcement" Notification with a heading. Cras mattis consectetur purus sit amet fermentum. Maecenas faucibus mollis interdum. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.',
                      }),
                      showIcon: !1,
                    }),
                  }),
                  e.jsxs(N, {
                    children: [
                      ...
                      e.jsx(E, {
                        ...
                        imageProps: { alt: "Image example", src: m("smaller") },
              ...
              e.jsxs(I, {
                ...
                children: [
                  ...
                  e.jsxs(R, {
                    children: [
                      e.jsx("p", { children: "This is the main content!" }),
                      e.jsx(W, { accordionData: ee }),
                      e.jsx(K, {}),
                      e.jsx("p", { children: "Fill out the form!" }),
                      e.jsxs(V, {
                        action: "/end/point",
                        id: "form1",
                        children: [
                      ...
                      e.jsx(J, {
                        ...
                        isFullWidth: !0,
                        my: "l",
                        textContent: e.jsxs(e.Fragment, {
                          children: [
                            e.jsx(p, {
                              size: "heading5",
                              children: "Sit Dapibus Elit",
                            }),
                            "Donec id elit non mi porta gravida at eget metus. Nulla vitae elit libero, a pharetra augue. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Cras mattis consectetur purus sit amet fermentum.",
                          ],
                        }),
                      }),
                      e.jsx(U, {
                        ...
                        tableData: ne,
                        titleText:
                          "Table with horizontal scrolling and no row headers",
                        useRowHeaders: !0,
                      }),
                    ],
                  }),
                  e.jsxs(h, {
                    children: [
                      e.jsx("p", {
                        children: "Sidebar information in a `Card` component.",
                      }),
                      e.jsxs(l, {
                        imageProps: {
                          alt: "Alt text",
              ...
              e.jsx(q, {
                children: e.jsxs(l, {
                  ...
                  foregroundColor: "#FFF",
                  children: [
                    e.jsx(d, { id: "heading1-footer", children: "Footer" }),
                    e.jsxs(c, {
                      children: [
                        e.jsx("p", {
                          children:
                        ...
                        e.jsx("p", {
                          children:
                            "© The New York Public Library, 2021 The New York Public Library is a 501(c)(3) | EIN 13-1887440",
                        }),
                      ],
                    }),
                    e.jsxs($, {
...
r.parameters = {
  ...
  parameters: {
    design: {
      ...
      ...((T = (x = r.parameters) == null ? void 0 : x.docs) == null
        ? void 0
        : T.source),
    },
    description: {
      ...
      ...((C = (f = r.parameters) == null ? void 0 : f.docs) == null
        ? void 0
        : C.description),
    },
  },
...
i.parameters = {
  ...
  render: args => <>
      ...
      ...((y = (v = i.parameters) == null ? void 0 : v.docs) == null
        ? void 0
        : y.source),
    },
  },
...
const re = [
    ...
    "FullExampleWithTemplateChildrenComponents",
  ],
  se = Object.freeze(
    Object.defineProperty(
      {
        __proto__: null,
        ChildrenComponentProps: i,
        FullExampleWithTemplateChildrenComponents: s,
        WithControls: r,
...
export { i as C, s as F, se as T, r as W };
