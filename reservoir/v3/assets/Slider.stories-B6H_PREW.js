...
const { expect: l, userEvent: s, within: he } = __STORYBOOK_MODULE_TEST__,
  me = {
    title: "Components/Form Elements/Slider",
    component: a,
    argTypes: {
      className: { control: !1 },
      defaultValue: { control: !1, table: { defaultValue: { summary: "0" } } },
      ...
      name: { control: !1 },
      onChange: { control: !1 },
      onChangeEnd: { control: !1 },
      showBoxes: d("true"),
      showHelperInvalidText: d("true"),
      showLabel: d("true"),
      showRequiredLabel: d("true"),
      showValues: d("true"),
  ...
  u = {
    ...
    play: async ({ canvasElement: r }) => {
      const n = he(r),
        t = n.getByRole("spinbutton");
      l(n.getByRole("slider")).toHaveAttribute("aria-valuenow", "50"),
        l(t).toHaveValue(50),
        await s.clear(t),
        await s.type(t, "75"),
        l(n.getByRole("slider")).toHaveAttribute("aria-valuenow", "75"),
        l(t).toHaveValue(75),
        await s.clear(t),
        await s.type(t, "145"),
        l(n.getByRole("slider")).toHaveAttribute("aria-valuenow", "100"),
        l(t).toHaveValue(100);
    },
  },
  x = {
    ...
    play: async ({ canvasElement: r }) => {
      const n = he(r),
        t = n.getAllByRole("spinbutton"),
        i = n.getAllByRole("slider");
      l(i).toHaveLength(2),
        l(t[0]).toHaveValue(25),
        l(t[1]).toHaveValue(75),
        l(i[0]).toHaveAttribute("aria-valuenow", "25"),
        l(i[1]).toHaveAttribute("aria-valuenow", "75"),
        await s.clear(t[0]),
        await s.clear(t[1]),
        await s.type(t[0], "80"),
        await s.type(t[1], "20"),
        l(n.getAllByRole("spinbutton")[0]).toHaveAttribute(
          "aria-invalid",
          "true"
        ),
        l(n.getAllByRole("spinbutton")[1]).toHaveAttribute(
          "aria-invalid",
          "true"
        ),
        l(n.getByText(/Oh no this is an error/)).toBeInTheDocument(),
        await s.clear(t[0]),
        await s.clear(t[1]),
        await s.type(t[0], "34"),
        await s.type(t[1], "65"),
        l(t[0]).toHaveValue(34),
        l(t[1]).toHaveValue(65),
        l(i[0]).toHaveAttribute("aria-valuenow", "34"),
        l(i[1]).toHaveAttribute("aria-valuenow", "65"),
        await s.click(t[0]),
        await s.tab(),
        l(i[0]).toHaveFocus(),
        await s.keyboard("{ArrowRight}"),
        await s.keyboard("{ArrowRight}"),
        l(i[0]).toHaveAttribute("aria-valuenow", "36"),
        await s.tab(),
        l(i[1]).toHaveFocus(),
        await s.keyboard("{ArrowRight}"),
        await s.keyboard("{ArrowRight}"),
        l(i[1]).toHaveAttribute("aria-valuenow", "67");
    },
  },
  p = {
    render: () =>
        ...
        children: [
          ...
          e.jsxs(S, {
            children: [
              ...
              e.jsx("p", {
                children:
                  "Note: If the `min` prop value is greater than the `max` prop value, then this will be an errored state.",
              }),
              e.jsx(a, {
                defaultValue: 50,
                helperText: "Component helper text.",
...
function be() {
  const r = (n) => {
    console.log(`The single Slider updated value is: ${n}`);
  };
  return e.jsx(a, {
    defaultValue: 50,
    helperText: "Component helper text.",
...
const b = { render: () => e.jsx(be, {}) };
function ve() {
  const r = (n) => {
    const [t, i] = n;
    console.log(`The Range Slider updated start value is: ${t}`),
      console.log(`The Range Slider updated end value is: ${i}`);
  };
  return e.jsx(a, {
    defaultValue: [15, 75],
    helperText: "Component helper text.",
...
const w = { render: () => e.jsx(we, {}) };
function Te() {
  const [r, n] = ge.useState([15, 75]),
    t = (R) => {
      n([R.target.value, r[1]]);
    },
    i = (R) => {
      n([r[0], R.target.value]);
    };
  return e.jsxs(ce, {
    id: "slider-example",
    children: [
...
u.parameters = {
  ...
  play: async ({
    ...
    expect(textInput).toHaveValue(100);
      ...
      ...((I = (y = u.parameters) == null ? void 0 : y.docs) == null
        ? void 0
        : I.source),
    },
    description: {
      ...
      ...((E = (B = u.parameters) == null ? void 0 : B.docs) == null
        ? void 0
        : E.description),
    },
  },
...
x.parameters = {
  ...
  play: async ({
    ...
    expect(sliders[1]).toHaveAttribute("aria-valuenow", "67");
      ...
      ...((F = (q = x.parameters) == null ? void 0 : q.docs) == null
        ? void 0
        : F.source),
    },
  },
...
p.parameters = {
  ...
  render: () => <VStack align="stretch" spacing="l">
      ...
      ...((k = (D = p.parameters) == null ? void 0 : D.docs) == null
        ? void 0
        : k.source),
    },
  },
...
h.parameters = {
  ...
  render: () => <VStack align="stretch" spacing="l">
      ...
      ...((O = (G = h.parameters) == null ? void 0 : G.docs) == null
        ? void 0
        : O.source),
    },
  },
...
g.parameters = {
  ...
  render: () => <>
      ...
      ...((P = (N = g.parameters) == null ? void 0 : N.docs) == null
        ? void 0
        : P.source),
    },
  },
...
c.parameters = {
  ...
  render: () => <>
      ...
      ...(($ = (U = c.parameters) == null ? void 0 : U.docs) == null
        ? void 0
        : $.source),
    },
  },
...
m.parameters = {
  ...
  render: () => <>
      ...
      ...((Q = (K = m.parameters) == null ? void 0 : K.docs) == null
        ? void 0
        : Q.source),
    },
  },
...
b.parameters = {
  ...
  render: () => <SliderExampleComponent />
      ...
      ...((X = (Z = b.parameters) == null ? void 0 : Z.docs) == null
        ? void 0
        : X.source),
    },
  },
...
v.parameters = {
  ...v.parameters,
  docs: {
    ...((ee = v.parameters) == null ? void 0 : ee.docs),
    source: {
      originalSource: `{
  render: () => <RangeSliderExample />
}`,
      ...((te = (ae = v.parameters) == null ? void 0 : ae.docs) == null
        ? void 0
        : te.source),
    },
  },
...
f.parameters = {
  ...f.parameters,
  docs: {
    ...((le = f.parameters) == null ? void 0 : le.docs),
    source: {
      originalSource: `{
  render: () => <SliderEndExample />
}`,
      ...((re = (ne = f.parameters) == null ? void 0 : ne.docs) == null
        ? void 0
        : re.source),
    },
  },
...
w.parameters = {
  ...
  render: () => <RangeSliderEndExample />
      ...
      ...((oe = (ie = w.parameters) == null ? void 0 : ie.docs) == null
        ? void 0
        : oe.source),
    },
  },
...
T.parameters = {
  ...
  render: () => <RangeSliderValuesUpdateExample />
      ...
      ...((xe = (ue = T.parameters) == null ? void 0 : ue.docs) == null
        ? void 0
        : xe.source),
    },
  },
...
const Se = [
    ...
    "SingleSliderStates",
    "RangeSliderStates",
    "SingleSliderVariants",
    "SingleSliderVariantsHiddenLabels",
    "RangeSliderWithAdjustedHandles",
    "GetInputValuesSingleSlider",
    "GetInputValuesRangeSlider",
    "FinalSingleSliderValue",
    "FinalRangeSliderValue",
  ...
  Ce = Object.freeze(
    Object.defineProperty(
      {
        __proto__: null,
        FinalRangeSliderValue: w,
        FinalSingleSliderValue: f,
        GetInputValuesRangeSlider: v,
        GetInputValuesSingleSlider: b,
        ProgrammaticallyUpdate: T,
        RangeSliderStates: h,
        RangeSliderWithAdjustedHandles: m,
        RangeSliderWithControls: x,
        SingleSliderStates: p,
        SingleSliderVariants: g,
        SingleSliderVariantsHiddenLabels: c,
        WithControls: u,
        __namedExportsOrder: Se,
        default: me,
      },
      Symbol.toStringTag,
      { value: "Module" }
