...
import {
  ...
  D as b,
  c as g,
} from "./Button.stories-RP-dfQKS.js";
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          ` in the Controls section to see the types of buttons
...
`,
          e.jsxs(n.li, {
            children: [
              ...
              " is used for actions that move the user forward. This is the default.",
            ],
          }),
          `
`,
          e.jsxs(n.li, {
            children: [
              ...
              " is used for actions that move the user back, such as cancellations.",
            ],
          }),
          `
`,
          e.jsxs(n.li, {
            children: [
              ...
              " is used for equally weighted actions in a text based list.",
            ],
          }),
          `
`,
          e.jsxs(n.li, {
            children: [
              ...
              ' is used for call to action text such as "Donate".',
            ],
          }),
          `
`,
          e.jsxs(n.li, {
            children: [
              ...
              ` is a variant used when there is no brand and will display the
...
`,
          e.jsxs(n.li, {
            children: [
              e.jsx(n.code, { children: '"pill"' }),
              " is used for equally weighted actions within cards and always in a set.",
            ],
          }),
          `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          " component is passed inside a ",
          e.jsx(n.code, { children: "Button" }),
          ` component with
no text, it will automatically be configured to use the `,
          e.jsx(n.code, { children: '"iconOnly"' }),
          " type.",
        ],
      }),
      `
...
accessible. `,
          e.jsx(n.code, { children: "Button" }),
          `s should be used to perform user actions or submit forms,
never to link and go to another page. For `,
          e.jsx(n.code, { children: "Button" }),
          `s without text and only an
icon, make sure to pass an `,
...
`,
      e.jsxs(n.p, {
        children: [
          e.jsx(n.code, { children: "Button" }),
          "s can be rendered in three sizes through the ",
...
`,
          ...
          e.jsx(n.code, { children: '"small"' }),
          `
size is available, we recommend to use the `,
          e.jsx(n.code, { children: '"medium"' }),
          " and ",
          e.jsx(n.code, { children: '"large"' }),
          " sizes.",
...
can be used to provide additional context to the `,
          e.jsx(n.code, { children: "Button" }),
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://www.w3.org/TR/wai-aria-practices-1.1/examples/button/button.html",
              rel: "nofollow",
              children: "W3C WAI ARIA Button Examples",
            }),
          }),
          `
`,
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "W3C WAI WCAG Target Size",
            }),
          }),
          `
`,
...
The `,
          ...
          " component should be used to wrap the ",
          e.jsx(n.code, { children: "Button" }),
          " component.",
        ],
      }),
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "Icon" }),
          " component collaborates great with the ",
          e.jsx(n.code, { children: "Button" }),
          ` component. Check out
`,
          e.jsx(n.a, {
            href: "https://github.com/NYPL/nypl-design-system/blob/development/src/components/Icons/Icon.tsx",
            rel: "nofollow",
            children: e.jsx(n.code, {
              children: "src/components/Icons/Icon.tsx",
            }),
          }),
          `
...
is an `,
          ...
          e.jsx(n.code, { children: "Button" }),
          " component ",
          e.jsx(n.code, { children: 'aria-label="Previous"' }),
          ".",
        ],
      }),
      `
...
a call out. The "Back to Top" button must be of `,
          e.jsx(n.code, { children: 'buttonType="secondary"' }),
          ` and
...
`,
      e.jsxs(n.p, {
        children: [
          "The variations modified by the ",
          e.jsx(n.code, { children: "buttonType" }),
          " prop:",
        ],
      }),
...
function C(o = {}) {
  const { wrapper: n } = { ...l(), ...o.components };
  return n ? e.jsx(n, { ...o, children: e.jsx(d, { ...o }) }) : d(o);
}
export { C as default };
