import { u as i, j as e, M as r, S as o } from "./iframe-D93LbwGv.js";
function t(s) {
  const n = {
    a: "a",
    code: "code",
  ...
  return e.jsxs(e.Fragment, {
    children: [
      e.jsx(r, { title: "Hooks/useNYPLBreakpoints" }),
      `
`,
            ...
            children: [
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, {
                    children: e.jsx(n.code, { children: "1.0.4" }),
                  }),
                ],
              }),
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, {
                    children: e.jsx(n.code, { children: "1.0.5" }),
                  }),
                ],
              }),
            ],
...
`,
      e.jsxs(n.p, {
        children: [
          "This custom hook is inspired by Chakra's ",
          e.jsx(n.code, { children: "useMediaQuery" }),
          ` hook. Internally, the
hook uses the `,
          e.jsx(n.code, { children: "useMediaQuery" }),
          " hook and the ",
          e.jsx(n.code, { children: "MediaMatch" }),
...
`,
      e.jsx(n.p, {
        children: "The hook returns an object with five boolean values:",
      }),
      `
`,
      e.jsx(o, {
...
This breakpoint value is based on the "medium" breakpoint value of `,
          e.jsx(n.code, { children: '"38em"' }),
          `
(or `,
          e.jsx(n.code, { children: '"600px"' }),
          `). If different components need to be conditionally rendered based
on the current size of the viewport, we can use the `,
          e.jsx(n.code, { children: "isLargerThanMobile" }),
          `
boolean value.`,
        ],
      }),
