...
import {
  ...
  b as y,
  L as v,
} from "./Image.stories-D4J0RP4e.js";
            ...
            children: [
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, {
                    children: e.jsx(n.code, { children: "0.0.6" }),
                  }),
                ],
              }),
              e.jsxs(n.tr, {
...
`,
              e.jsx(s, {
                href: "#credit-and-caption",
                target: "_self",
                children: "Credit and Caption",
              }),
              `
`,
            ],
...
`,
      e.jsxs(n.p, {
        children: [
          "If you want a simple HTML ",
          e.jsx(n.code, { children: "img" }),
          ` element then don't pass in values for the
`,
          e.jsx(n.code, { children: "aspectRatio" }),
          " or ",
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "alt" }),
          ` prop should be used to concisely describe the image. If the image is purely decorative,
the `,
          e.jsx(n.code, { children: "alt" }),
          ` attribute should still be present, but can be set to an empty string. In this scenario,
an `,
          e.jsx(n.code, { children: "alt" }),
          ` prop does not need to be passed. The component will set the attribute to an empty string
`,
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "W3C WAI Images Tutorial",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "WebAIM Accessible Images",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://usability.yale.edu/web-accessibility/articles/images",
              rel: "nofollow",
              children: "Yale Usability & Web Accessibility",
            }),
          }),
          `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          "By passing in ",
          e.jsx(n.code, { children: "credit" }),
          " or ",
          e.jsx(n.code, { children: "caption" }),
          ", the ",
          e.jsx(n.code, { children: "Image" }),
          ` component will
render an HTML `,
          e.jsx(n.code, { children: "figure" }),
          " element and render an ",
          e.jsx(n.code, { children: "img" }),
          ` element inside with the
proper props. If no `,
          e.jsx(n.code, { children: "credit" }),
          " or ",
          e.jsx(n.code, { children: "caption" }),
          ` prop values are passed,
then an `,
          e.jsx(n.code, { children: "img" }),
          " element will be rendered with or without wrapper style divs.",
        ],
      }),
      `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          "Use the ",
          e.jsx(n.code, { children: "size" }),
          " prop to set the desired size with the ",
          e.jsx(n.code, { children: "ImageSizes" }),
          " enum.",
        ],
      }),
      `
...
`,
      e.jsx(n.h3, {
        id: "size-based-on-width",
        children: "Size Based On Width",
      }),
      `
`,
      e.jsx(t, { of: m }),
...
`,
      e.jsx(n.h3, {
        id: "size-based-on-height",
        children: "Size Based On Height",
      }),
      `
`,
      e.jsx(t, { of: f }),
...
`,
      e.jsxs(n.p, {
        children: [
          "Use the ",
          e.jsx(n.code, { children: "aspectRatio" }),
          ` prop to set the desired aspect ratio. Note: the
following example has `,
          e.jsx(n.code, { children: "size" }),
          " set to ",
          e.jsx(n.code, { children: "ImageSizes.Small" }),
          ".",
        ],
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          "For a better viewing experience, the ",
          e.jsx(n.code, { children: "Image" }),
          ` components below have been wrapped
...
`,
      e.jsxs(n.p, {
        children: [
          "Use the ",
          e.jsx(n.code, { children: "imageType" }),
          ` prop to get an image variant. Note that to get a perfect
circle, the `,
          e.jsx(n.code, { children: "aspectRatio" }),
          " prop ",
          e.jsx(n.em, { children: "must" }),
          " be set to ",
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "Image" }),
          ` component accepts HTML image attributes. If needed, you can pass
functions such as `,
          e.jsx(n.code, { children: "onLoad" }),
          " and ",
          e.jsx(n.code, { children: "onError" }),
          " or attributes such as ",
          e.jsx(n.code, { children: "srcset" }),
          ".",
        ],
      }),
      `
...
the first example below, when the image is finished loading, the `,
          e.jsx(n.code, { children: "onLoad" }),
          `
...
Set a fallback image source through the `,
...
`,
          ...
          e.jsx(n.code, { children: "onerror" }),
          ` attribute with a
callback function to load the `,
          e.jsx(n.code, { children: "fallbackSrc" }),
          ` image. Additionally, a warning will
      ...
      e.jsx(a, {
        content: e.jsxs(e.Fragment, {
          children: [
            ...
            " if no `fallbackSrc` prop is passed, the `Image` component will not call the `onerror` image attribute.",
          ],
        }),
        type: "warning",
      }),
...
`,
      e.jsx(a, {
        content: e.jsxs(e.Fragment, {
          children: [
            e.jsx(n.strong, { children: "IMPORTANT:" }),
            " If a custom image component, such as the Next.js `Image` component, is passed to the `component` prop, then the `fallbackSrc` and `onError` props won't work. It is expected that the custom image component that is passed in implements the `onError` attribute.",
          ],
        }),
        type: "warning",
      }),
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img#image_loading_errors",
              rel: "nofollow",
              children: "MDN Image loading errors",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "MDN HTMLElement: error event",
            }),
          }),
          `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "Image" }),
          ` component handles lazy loading images through two npm packages:
`,
          e.jsx(n.a, {
            href: "https://github.com/thebuilder/react-intersection-observer",
            rel: "nofollow",
            children: e.jsx(n.code, {
              children: "react-intersection-observer",
            }),
          }),
          `
and `,
          e.jsx(n.a, {
            href: "https://www.npmjs.com/package/@charlietango/use-native-lazy-loading",
            rel: "nofollow",
            children: e.jsx(n.code, {
              children: "@charlietango/use-native-lazy-loading",
            }),
          }),
          `.
The first package handles using the `,
          e.jsx(n.code, { children: "IntersectionObserver" }),
          ` API in React and the
second package checks if the `,
          e.jsx(n.code, { children: "img" }),
          "'s native ",
          e.jsx(n.code, { children: 'loading="lazy"' }),
          ` attribute is
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "Image" }),
          `'s implementation of lazy loading is based on the recipe provided by
`,
          e.jsx(n.code, { children: "react-intersection-observer" }),
          `. Once the image's wrapper is in view, we load the
image by rendering it through the native `,
          e.jsx(n.code, { children: 'loading="lazy"' }),
...
`,
      e.jsx(n.p, {
        children: `In the following example, open the "Network" tab in your browser's console and
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "Browser-level image lazy-loading for the web",
            }),
          }),
          `
`,
...
`,
      ...
      `
`,
      e.jsx(x, { changelogData: I }),
    ],
  });
}
function L(i = {}) {
  const { wrapper: n } = { ...c(), ...i.components };
  return n ? e.jsx(n, { ...i, children: e.jsx(l, { ...i }) }) : l(i);
}
export { L as default };
