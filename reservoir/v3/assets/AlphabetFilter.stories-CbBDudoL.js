import { g as i, j as t, H as T, r as y } from "./iframe-D93LbwGv.js";
import { a as w } from "./storybookUtils-BmTl87w5.js";
const M = {
    title: "Components/Navigation/AlphabetFilter",
    component: i,
    argTypes: {
      activeLetters: { control: !1 },
      className: { control: !1 },
      currentLetter: { control: !1 },
      id: { control: !1 },
      isDisabled: w(),
      onClick: { control: !1 },
    },
  ...
  s = {
    render: () =>
      t.jsx(i, {
        onClick: void 0,
        headingText: t.jsx(T, { level: "h4", children: "Custom H4 Heading" }),
      }),
  },
  n = { render: () => t.jsx(i, { currentLetter: "c", onClick: void 0 }) };
function N() {
  const [j, F] = y.useState(),
    H = (o) => {
      console.log(o), F(o);
    };
  return t.jsx(i, { currentLetter: j, onClick: H });
}
const a = { name: "Using onClick", render: () => t.jsx(N, {}) };
var c, l, d, p, m;
e.parameters = {
  ...e.parameters,
  docs: {
  ...
  parameters: {
    ...
    jest: ["AlphabetFilter.test.tsx"]
      ...
      ...((d = (l = e.parameters) == null ? void 0 : l.docs) == null
        ? void 0
        : d.source),
    },
    description: {
      ...
      ...((m = (p = e.parameters) == null ? void 0 : p.docs) == null
        ? void 0
        : m.description),
    },
  },
...
n.parameters = {
  ...
  render: () => <AlphabetFilter currentLetter="c" onClick={undefined} />
      ...
      ...((A = (v = n.parameters) == null ? void 0 : v.docs) == null
        ? void 0
        : A.source),
    },
  },
...
a.parameters = {
  ...
  render: () => <CurrentLetterExample />
      ...
      ...((k = (S = a.parameters) == null ? void 0 : S.docs) == null
        ? void 0
        : k.source),
    },
  },
...
export { U as A, r as S, a as U, e as W, s as a, n as b };
