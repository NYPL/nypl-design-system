...
const { expect: b, userEvent: o, within: W } = __STORYBOOK_MODULE_TEST__,
  X = {
  ...
  n = {
    ...
    render: (i) =>
      e.jsxs(r, {
        ...i,
        children: [
          e.jsx(a, { id: "main-2", labelText: "Radio 2", value: "2" }),
          e.jsx(a, { id: "main-3", labelText: "Radio 3", value: "3" }),
          e.jsx(a, { id: "main-4", labelText: "Radio 4", value: "4" }),
          e.jsx(a, { id: "main-5", labelText: "Radio 5", value: "5" }),
        ],
      }),
    parameters: {
      design: {
    ...
    play: async ({ canvasElement: i }) => {
      const l = W(i);
      b(l.getByRole("radiogroup")).toBeInTheDocument(),
        b(l.getByLabelText("Radio 4")).toBeChecked(),
        await o.click(l.getByLabelText("Radio 3")),
        await o.click(l.getByLabelText("Radio 2")),
        await o.click(l.getByLabelText("Radio 5")),
        b(l.getByLabelText("Radio 5")).toBeChecked(),
        await o.keyboard("{arrowdown}"),
        await o.keyboard("{arrowleft}"),
        await o.keyboard("{arrowup}"),
        await o.keyboard("{arrowright}"),
        await o.keyboard("{arrowdown}"),
        b(l.getByLabelText("Radio 2")).toBeChecked();
    },
  },
  s = {
    render: () =>
      e.jsxs(e.Fragment, {
        children: [
          e.jsxs(r, {
            ...
            name: "column-example",
            children: [
              e.jsx(a, { id: "column-2", labelText: "Radio 2", value: "2" }),
              e.jsx(a, { id: "column-3", labelText: "Radio 3", value: "3" }),
              e.jsx(a, { id: "column-4", labelText: "Radio 4", value: "4" }),
              e.jsx(a, { id: "column-5", labelText: "Radio 5", value: "5" }),
            ],
          }),
          e.jsx("br", {}),
          e.jsxs(r, {
            ...
            layout: "row",
            children: [
              e.jsx(a, { id: "row-2", labelText: "Radio 2", value: "2" }),
              e.jsx(a, { id: "row-3", labelText: "Radio 3", value: "3" }),
              e.jsx(a, { id: "row-4", labelText: "Radio 4", value: "4" }),
              e.jsx(a, { id: "row-5", labelText: "Radio 5", value: "5" }),
            ],
          }),
        ],
      }),
    ...
    render: () =>
      e.jsxs(U, {
        ...
        children: [
          e.jsxs(m, {
            children: [
              e.jsx(T, { level: "h3", size: "heading6", children: "Errored" }),
              e.jsxs(r, {
                defaultValue: "4",
                id: "errored",
                ...
                children: [
                  e.jsx(a, { id: "radio-2", labelText: "Radio 2", value: "2" }),
                  e.jsx(a, { id: "radio-3", labelText: "Radio 3", value: "3" }),
                  e.jsx(a, { id: "radio-4", labelText: "Radio 4", value: "4" }),
                  e.jsx(a, { id: "radio-5", labelText: "Radio 5", value: "5" }),
                ],
              }),
            ],
          }),
          e.jsxs(m, {
            children: [
              e.jsx(T, { level: "h3", size: "heading6", children: "Required" }),
              e.jsxs(r, {
          ...
          e.jsxs(m, {
            children: [
              e.jsx(T, { level: "h3", size: "heading6", children: "Disabled" }),
              e.jsxs(r, {
      ...
      e.jsxs(r, {
        ...
        children: [
          ...
          e.jsx(a, {
            ...
            labelText: e.jsxs(p, {
              children: [
                e.jsx("span", { children: "English" }),
                e.jsx(R, {}),
                e.jsx("span", { children: "23" }),
              ],
            }),
            value: "English",
          }),
          e.jsx(a, {
            ...
            labelText: e.jsxs(p, {
              children: [
                e.jsx("span", { children: "Science" }),
                e.jsx(R, {}),
                e.jsx("span", { children: "10" }),
              ],
            }),
            value: "Science",
          }),
...
function P() {
  const i = (l) => {
    console.log(`Controlled example. Selected: ${l}`);
  };
  return e.jsxs(r, {
    defaultValue: "3",
    ...
    onChange: i,
    children: [
      e.jsx(a, { id: "2", labelText: "Radio 2", value: "2" }),
      e.jsx(a, { id: "3", labelText: "Radio 3", value: "3" }),
      e.jsx(a, { id: "4", labelText: "Radio 4", value: "4" }),
    ],
  });
}
const x = { render: () => e.jsx(P, {}) };
function $() {
  const i = A.createRef(),
    l = (_) => {
      _.preventDefault();
      const M = i.current.value;
      console.log(`Uncontrolled example. Selected: ${M}`);
    };
  return e.jsx(z, {
    id: "form",
    onSubmit: l,
...
n.parameters = {
  ...
  play: async ({
    ...
    expect(screen.getByLabelText("Radio 2")).toBeChecked();
      ...
      ...((g = (v = n.parameters) == null ? void 0 : v.docs) == null
        ? void 0
        : g.source),
    },
    description: {
      ...
      ...((w = (j = n.parameters) == null ? void 0 : j.docs) == null
        ? void 0
        : w.description),
    },
  },
...
s.parameters = {
  ...
  render: () => <>
      ...
      ...((G = (y = s.parameters) == null ? void 0 : y.docs) == null
        ? void 0
        : G.source),
    },
  },
...
t.parameters = {
  ...
  render: () => <VStack align="left" spacing="l">
      ...
      ...((q = (S = t.parameters) == null ? void 0 : S.docs) == null
        ? void 0
        : q.source),
    },
  },
...
u.parameters = {
  ...
  name: "Label Using JSX Elements"
      ...
      ...((C = (k = u.parameters) == null ? void 0 : k.docs) == null
        ? void 0
        : C.source),
    },
  },
...
x.parameters = {
  ...
  render: () => <RadioGroupControlledExample />
      ...
      ...((V = (F = x.parameters) == null ? void 0 : F.docs) == null
        ? void 0
        : V.source),
    },
  },
...
export { t as B, n as C, u as J, s as L, Q as R, c as U, x as a };
