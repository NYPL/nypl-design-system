...
const a = "" + new URL("exampleColumn-Upqc3-9-.png", import.meta.url).href,
  p = "" + new URL("examplePopup-BDluWQIO.png", import.meta.url).href,
  u = "" + new URL("exampleRow-B_YZmSr0.png", import.meta.url).href,
  x = "" + new URL("filterBar-Dv5bhq8l.png", import.meta.url).href;
function r(t) {
  const n = {
    a: "a",
    code: "code",
  ...
  return e.jsxs(e.Fragment, {
    children: [
      e.jsx(c, { title: "Style Guide/Filtering/Page elements/Filter bar" }),
      `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "filter bar" }),
          ` is a wrapper for individual form input elements, including the
following DS components: `,
...
`,
              e.jsx(o, {
                href: "#filter-option-labeling",
                target: "_self",
                children: "Filter option labeling",
              }),
              `
`,
            ],
...
`,
              e.jsx(o, {
                href: "#filter-option-status",
                target: "_self",
                children: "Filter option status",
              }),
              `
`,
            ],
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "filter bar" }),
          ` element should be rendered using the DS
`,
          e.jsx(n.a, {
...
`,
          e.jsx(n.a, {
            href: "./?path=/docs/components-form-elements-filterbarpopup--docs",
            children: "FilterBarPopup",
          }),
          `
components.`,
        ],
      ...
      e.jsx(h, {
        content: e.jsxs(e.Fragment, {
          children: [
            ...
            " The filter bar should be configured based on the viewport.",
          ],
        }),
        mb: "s",
        type: "warning",
...
`,
      e.jsxs(n.p, {
        children: [
          "For tablet and desktop viewports, the ",
          e.jsx(n.code, { children: "FilterBarInline" }),
          ` component should be used
to render the `,
          e.jsx(n.code, { children: "filter bar" }),
          ` element using one of two layouts: column (vertical)
or row (horizontal).`,
        ],
      }),
      `
...
`,
                e.jsxs(n.li, {
                  children: [
                    "The ",
                    e.jsx(n.code, { children: "filter bar" }),
                    ` element should be placed in a sidebar on either the left or
...
`,
                e.jsx(n.li, {
                  children: `This configuration allows users to easily make selections across multiple
facets.`,
                }),
                `
`,
...
`,
                        e.jsx(n.li, {
                          children: `for filters that are non-contextual and apply to the entirety of the main
content area`,
                        }),
                        `
`,
...
`,
                        e.jsxs(n.li, {
                          children: [
                            "The ",
                            e.jsx(n.code, { children: "MultiSelect" }),
                            ` component is the most common input element used for
...
`,
                        e.jsxs(n.li, {
                          children: [
                            e.jsx(n.code, { children: "MultiSelect" }),
                            ` components should be configured to allow multiple
`,
                            e.jsx(n.code, { children: "MultiSelect" }),
...
`,
                        e.jsxs(n.li, {
                          children: [
                            e.jsx(n.code, { children: "MultiSelect" }),
                            " components should be configured to use the ",
                            e.jsx(n.code, { children: '"expand"' }),
                            ` overflow
functionality`,
                          ],
                        }),
...
`,
                        e.jsxs(n.li, {
                          children: [
                            "When ",
                            e.jsx(n.code, { children: "MultiSelect" }),
                            " components are used, at least one ",
                            e.jsx(n.code, { children: "MultiSelect" }),
                            ` component
...
`,
                e.jsxs(n.li, {
                  children: [
                    "The ",
                    e.jsx(n.code, { children: "filter bar" }),
                    ` should be placed above the area of the page that is pertinent
to the filters.`,
                  ],
                }),
                `
`,
                e.jsxs(n.li, {
                  children: [
                    "The filters that compose the ",
                    e.jsx(n.code, { children: "filter bar" }),
                    ` should render in one row for desktop
...
`,
                        e.jsx(n.li, {
                          children: `For specific use cases that need more than five filter facets, the filters
...
`,
                e.jsx(n.li, {
                  children: `Filters should be contextual and only apply to certain sections of the main
...
`,
                        e.jsxs(n.li, {
                          children: [
                            e.jsx(n.code, { children: "MultiSelect" }),
                            " components should be configured so that only one ",
                            e.jsx(n.code, { children: "MultiSelect" }),
                            `
component can be opened at any given time. (i.e. When a `,
                            e.jsx(n.code, { children: "MultiSelect" }),
                            `
component is opened, all other `,
                            e.jsx(n.code, { children: "MultiSelect" }),
                            " components will close.)",
                            `
`,
                            e.jsxs(n.ul, {
                              children: [
...
`,
                                e.jsx(n.li, {
                                  children: `NOTE: This configuration requires users to make selections in only one
            ...
            children: [
              e.jsxs(n.p, {
                children: [
                  ...
                  ` component should be used to render
the filter bar element. The `,
                  e.jsx(n.code, { children: "filter bar" }),
                  ` element will not be visible when the
...
with each filter option. For example, `,
          e.jsx(n.code, { children: "English (5)" }),
          " or ",
          e.jsx(n.code, { children: "Offsite (11)" }),
          `. The
...
`,
          ...
          ", and ",
          e.jsx(n.code, { children: "Toggle" }),
          ` components, and the labels of the checkbox
options within a `,
          e.jsx(n.code, { children: "MultiSelect" }),
          ` component, as well as the options within a
`,
          e.jsx(n.code, { children: "Select" }),
          " component.",
        ],
...
`,
      e.jsx(n.p, {
        children: `Disabling a filter retains consistency and avoids the the need for a user to
...
`,
      e.jsx(n.h3, {
        id: "desktop-and-tablet-1",
        children: "Desktop and tablet",
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          "For desktop and tablet viewports, the ",
          e.jsx(n.code, { children: "filter bar" }),
          ` can display optional "Apply
...
`,
      e.jsxs(n.p, {
        children: [
          'The "Apply filters" button must be rendered when the ',
          e.jsx(n.a, {
            href: "./?path=/docs/style-guide-filtering-applying-clearing-filters--docs#batch-filtering",
            children: `batch
filtering`,
          }),
          `
...
the `,
          e.jsx(n.a, {
            href: "./?path=/docs/style-guide-filtering-applying-clearing-filters--docs#live-filtering",
            children: `live
filtering`,
          }),
          `
...
`,
          e.jsxs(n.li, {
            children: [
              ...
              ` list based on the filter options that have been
selected`,
            ],
          }),
          `
`,
          e.jsxs(n.li, {
            children: [
              "update the ",
              e.jsx(n.code, { children: "results" }),
              " list based on the filter options that have been selected",
            ],
          }),
          `
`,
          e.jsxs(n.li, {
            children: [
              ...
              ` heading to reflect the number of items in the
updated `,
              e.jsx(n.code, { children: "results" }),
              " list",
            ],
...
`,
          e.jsx(n.code, { children: "TagSet" }),
          ` component is not used as part of the overall searching and filtering
UX.`,
        ],
      }),
      `
`,
      e.jsx(n.p, {
        children: 'Clicking the "Clear all filters" button should:',
      }),
      `
`,
      e.jsxs(n.ul, {
...
`,
          e.jsxs(n.li, {
            children: [
              "reset all form input elements within the ",
              e.jsx(n.code, { children: "filter bar" }),
            ],
          }),
          `
`,
          e.jsxs(n.li, {
            children: [
              "update the ",
              e.jsx(n.code, { children: "active filters" }),
              " list to remove all filter options",
            ],
          }),
          `
`,
...
`,
      e.jsx(n.p, {
        children: `For mobile viewports, the filter bar will display a "Show results" button and can
display an optional "Clear all filters" button.`,
      }),
      `
`,
      e.jsx(n.p, {
        children: `The "Show results" button will always be rendered at the bottom of the modal
...
`,
      e.jsx(n.p, {
        children: `The "Clear all filters" button is optional, but it is recommended to render the
...
function m(t = {}) {
  const { wrapper: n } = { ...d(), ...t.components };
