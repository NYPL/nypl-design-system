...
import {
  ...
  a as u,
  b as x,
} from "./Pagination.stories-BbkmPNJ1.js";
const j = [
  {
    date: "2025-01-30",
    version: "3.5.3",
...
`,
              e.jsx(a, {
                href: "#pagination-with-url-updates",
                target: "_self",
                children: "Pagination with URL Updates",
              }),
              `
`,
            ],
...
`,
              e.jsx(a, {
                href: "#pagination-with-unchanging-url",
                target: "_self",
                children: "Pagination with Unchanging URL",
              }),
              `
`,
            ],
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "Pagination" }),
          ` component helps navigate between pages of a multi-page
application. It is commonly used on a search results page. Update the `,
          e.jsx(n.code, { children: "pageCount" }),
          `
...
`,
      e.jsxs(n.p, {
        children: [
          "Internally, the ",
          e.jsx(n.code, { children: "Pagination" }),
          " component is implemented with a ",
...
an `,
          ...
          ` element. This
component uses anchor `,
          e.jsx(n.code, { children: "<a>" }),
          ` tags because it is navigating between URLs. In the
"unchanging URL" variation, each anchor tag has an `,
          e.jsx(n.code, { children: "href" }),
          ` attribute with a value
of `,
          e.jsx(n.code, { children: '"#"' }),
          ", because the URL is not changing.",
        ],
      }),
      `
`,
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "W3C Design System Pagination",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "a11ymatters Accessible Pagination",
            }),
          }),
          `
`,
...
`,
      e.jsx(n.h2, {
        id: "pagination-with-url-updates",
        children: "Pagination with URL Updates",
      }),
      `
`,
...
declare and pass a `,
          e.jsx(n.code, { children: "getPageHref" }),
          " function to the ",
          e.jsx(n.code, { children: "Pagination" }),
          ` component. This
function takes a `,
          e.jsx(n.code, { children: "selectedPage" }),
          ` number argument for the selected page and it
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          e.jsx(n.code, { children: "getPageHref" }),
          ` function will compute a new URL that
has `,
          e.jsx(n.code, { children: "&page=" }),
          ` as a URL query. In your own application this query parameter can be
...
`,
      e.jsx(n.h2, {
        id: "pagination-with-unchanging-url",
        children: "Pagination with Unchanging URL",
      }),
      `
`,
...
changed. However, the optional `,
          e.jsx(n.code, { children: "onPageChange" }),
          ` prop is available in case URL
...
`,
      e.jsxs(n.p, {
        children: [
          "In the following example, the ",
          e.jsx(n.code, { children: "onPageChange" }),
          ` function gets the selected page as
its only function argument. This is computed internally in the `,
          e.jsx(n.code, { children: "Pagination" }),
          `
...
`,
      e.jsx(n.h3, {
        id: "forcing-a-page-change-programmatically",
        children: "Forcing a Page Change Programmatically",
      }),
      `
`,
      e.jsxs(n.p, {
...
You can use the `,
          e.jsx(n.code, { children: "currentPage" }),
          " prop to do this. Note, the ",
          e.jsx(n.code, { children: "currentPage" }),
          ` prop can
only be used with the client-side, unchanging URL version of the `,
          e.jsx(n.code, { children: "Pagination" }),
          `
component, and in combination with the `,
          e.jsx(n.code, { children: "onPageChange" }),
          " function.",
        ],
      }),
