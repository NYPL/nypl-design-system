...
const G = [
  ...
  W = {
    ...
    argTypes: {
      borders: {
        ...
        control: { type: "radio" },
        options: _,
        table: { disable: !1, defaultValue: { summary: "none" } },
      },
      className: { table: { disable: !1 } },
      color: {
        control: { type: "radio" },
        options: Y,
        table: { disable: !1, defaultValue: { summary: "textDefault" } },
      },
      id: { table: { disable: !1 } },
      layout: {
        control: { type: "radio" },
        options: X,
        table: { disable: !1, defaultValue: { summary: "row" } },
      },
      linksData: { table: { disable: !1 } },
      showLabels: {
        description:
        ...
        table: { disable: !1, defaultValue: { summary: "false" } },
      },
      size: {
        control: { type: "radio" },
        options: P,
        table: { disable: !1, defaultValue: { summary: "small" } },
      },
    },
    parameters: {
      controls: { hideNoControlsWarning: !0 },
      design: {
        type: "figma",
  ...
  t = {
    ...
    render: ({ borders: m, showLabels: E, color: p, ...R }) => {
      const F = m === "circular" ? !1 : E;
      return e.jsxs("div", {
        children: [
          e.jsx("div", {
            style:
            ...
            children: e.jsx(a, { showLabels: F, borders: m, color: p, ...R }),
          }),
          p === "textInverse" &&
            e.jsx(g, {
              size: "caption",
  ...
  o = { render: () => e.jsx(a, { layout: "row", linksData: G }) },
  r = {
    render: () =>
      e.jsxs(h, {
        align: "stretch",
        ...
        children: [
          e.jsxs(i, {
            children: [
              ...
              e.jsx(a, { layout: "row", linksData: l }),
            ],
          }),
          e.jsxs(i, {
            children: [
              ...
              e.jsx(a, { layout: "column", linksData: l }),
            ],
          }),
        ],
      }),
        ...
        children: [
          e.jsxs(i, {
            children: [
              ...
              e.jsx(a, { size: "small", linksData: s }),
            ],
          }),
          e.jsxs(i, {
            children: [
              ...
              e.jsx(a, { size: "medium", linksData: s }),
            ],
          }),
          e.jsxs(i, {
            children: [
              ...
              e.jsx(a, { size: "large", linksData: s }),
            ],
          }),
        ],
      }),
        ...
        children: [
          e.jsxs(i, {
            children: [
              ...
              e.jsx(a, { color: "textDefault", linksData: l }),
            ],
          }),
          e.jsxs(i, {
            children: [
              ...
              e.jsx(a, { color: "link", linksData: l }),
            ],
          }),
          e.jsxs(i, {
            children: [
              ...
              e.jsx(i, {
                ...
                p: "s",
                children: e.jsx(a, { color: "textInverse", linksData: l }),
              }),
              e.jsx(g, {
                size: "caption",
                mt: "s",
        ...
        children: [
          e.jsxs(i, {
            children: [
              ...
              e.jsx(a, { borders: "none", linksData: s }),
            ],
          }),
          e.jsxs(i, {
            children: [
              ...
              e.jsx(a, { borders: "straight", linksData: s }),
            ],
          }),
          e.jsxs(i, {
            children: [
              ...
              e.jsx(a, { borders: "circular", linksData: s }),
              e.jsx(g, {
                size: "caption",
                mt: "s",
                children: "NOTE: labels are disallowed with circular borders.",
              }),
            ],
          }),
        ],
        ...
        children: [
          e.jsxs(i, {
            children: [
              ...
              e.jsx(a, { showLabels: !1, linksData: l }),
            ],
          }),
          e.jsxs(i, {
            children: [
              ...
              e.jsx(a, { showLabels: !0, linksData: l }),
            ],
          }),
        ],
      }),
...
t.parameters = {
  ...
  render: ({
    ...
    return <div>
      ...
      ...((y = (k = t.parameters) == null ? void 0 : k.docs) == null
        ? void 0
        : y.source),
    },
  },
...
o.parameters = {
  ...
  render: () => <SocialMediaLinks layout="row" linksData={exampleAllLinkData} />
      ...
      ...((T = (D = o.parameters) == null ? void 0 : D.docs) == null
        ? void 0
        : T.source),
    },
  },
...
r.parameters = {
  ...
  render: () => <VStack align="stretch" spacing="l">
      ...
      ...((S = (v = r.parameters) == null ? void 0 : v.docs) == null
        ? void 0
        : S.source),
    },
  },
...
d.parameters = {
  ...
  render: () => <VStack align="stretch" spacing="l">
      ...
      ...((w = (z = d.parameters) == null ? void 0 : z.docs) == null
        ? void 0
        : w.source),
    },
  },
...
c.parameters = {
  ...
  render: () => <VStack align="stretch" spacing="l">
      ...
      ...((M = (V = c.parameters) == null ? void 0 : V.docs) == null
        ? void 0
        : M.source),
    },
  },
...
x.parameters = {
  ...
  render: () => <VStack align="stretch" spacing="l">
      ...
      ...((H = (C = x.parameters) == null ? void 0 : C.docs) == null
        ? void 0
        : H.source),
    },
  },
...
u.parameters = {
  ...
  render: () => <VStack align="stretch" spacing="l">
      ...
      ...((A = (O = u.parameters) == null ? void 0 : O.docs) == null
        ? void 0
        : A.source),
    },
  },
...
export { o as A, x as B, c as C, r as L, U as S, t as W, d as a, u as b };
