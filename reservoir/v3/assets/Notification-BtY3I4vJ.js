...
import {
  ...
  H as u,
  D as g,
} from "./Notification.stories-7BdAY_fP.js";
import { C as b } from "./ComponentChangelogTable-Ck_3mwrR.js";
const w = [
  {
    date: "2025-04-24",
    version: "3.6.1",
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          ` component is a configurable callout that should be used to
...
`,
      e.jsxs(n.p, {
        children: [
          "In the preview below, the border around the ",
          e.jsx(n.code, { children: "Notification" }),
          ` is not part of the
component. It has been added to help illustrate how the `,
          e.jsx(n.code, { children: "Notification" }),
          ` sits
...
`,
          e.jsx(n.code, { children: "aside" }),
          ` HTML landmark element, helps screen readers better navigate a page with
multiple `,
          e.jsx(n.code, { children: "Notification" }),
          "s.",
        ],
...
heading or body copy within the notification should use the words `,
...
default, when a title is passed to the `,
          e.jsx(n.code, { children: "notificationHeading" }),
          ` prop, the
`,
          e.jsx(n.code, { children: "Notification" }),
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "Notification" }),
          ` icon can be displayed with or without an icon. The icon can
be hidden with the `,
          e.jsx(n.code, { children: "showIcon" }),
          " prop set to ",
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "notificationContent" }),
...
`,
          e.jsx(n.code, { children: "dismissible" }),
          " prop to ",
...
`,
      ...
      `
`,
      e.jsx(b, { changelogData: w }),
    ],
  });
}
function H(o = {}) {
  const { wrapper: n } = { ...r(), ...o.components };
