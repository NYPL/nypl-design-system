...
import {
  ...
  b as j,
  U as g,
} from "./AlphabetFilter.stories-CbBDudoL.js";
            ...
            children: [
              ...
              e.jsxs(t.tr, {
                children: [
                  ...
                  e.jsx(t.td, {
                    children: e.jsx(t.code, { children: "3.5.4" }),
                  }),
                ],
              }),
            ],
...
`,
      e.jsxs(t.p, {
        children: [
          "The ",
          e.jsx(t.code, { children: "AlphabetFilter" }),
          ` component renders a list of letter buttons, a pound sign
...
`,
      e.jsx(t.h3, {
        id: "consuming-app-responsibilities",
        children: "Consuming App Responsibilities",
      }),
      `
`,
      e.jsxs(t.p, {
        children: [
          ...
          ` handler is executed, it will be up to the consuming app to
...
`,
      e.jsxs(t.p, {
        children: [
          "If the ",
          e.jsx(t.code, { children: "filterValue" }),
          " passed to ",
          e.jsx(t.code, { children: "onClick" }),
          " is ",
          e.jsx(t.code, { children: "showAll" }),
          ` (meaning the Show All
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          e.jsx(t.code, { children: "<nav>" }),
          ` element with a
WAI-ARIA role of `,
          e.jsx(t.code, { children: 'role="navigation"' }),
          `. Each letter button has an attribute of
`,
          e.jsx(t.code, { children: 'aria-label="Page {#}"' }),
          ", where ",
          e.jsx(t.code, { children: "{#}" }),
          ` is equal to a button's letter value. The
`,
          e.jsx(t.code, { children: "Show All" }),
          " button has ",
          e.jsx(t.code, { children: 'aria-label="Show All"' }),
          ` applied. When a letter button is
set to a current state (when a button is clicked or `,
          e.jsx(t.code, { children: "currentLetter" }),
          ` is
programmatically set), `,
          e.jsx(t.code, { children: 'aria-current="page"' }),
          ` is applied to the button and
...
`,
      e.jsxs(t.p, {
        children: [
          "The ",
          e.jsx(t.code, { children: "AlphabetFilter" }),
          ` component is accessible via keyboard. The color contrast
...
`,
      e.jsxs(t.p, {
        children: [
          "Only one ",
          e.jsx(t.code, { children: "AlphabetFilter" }),
          ` component should be rendered on a page. This is
because only one HTML `,
          e.jsx(t.code, { children: "<nav>" }),
          " element with an ",
          e.jsx(t.code, { children: "aria-label" }),
          ` attribute value of
`,
          e.jsx(t.code, { children: '"Filter by letter"' }),
...
`,
          e.jsx(t.li, {
            children: e.jsx(t.a, {
              href: "https://developer.mozilla.org/en-US/docs/Web/HTML/Element/nav#exampless",
              rel: "nofollow",
              children: "MDN nav",
            }),
          }),
...
`,
      e.jsx(t.h3, {
        id: "consuming-app-accessibility",
        children: "Consuming App Accessibility",
      }),
      `
`,
      e.jsxs(t.p, {
...
`,
          e.jsx(t.code, { children: "role=”alert”" }),
          ` attribute applied or as a child of a Live Region container with
the `,
          e.jsx(t.code, { children: 'aria-live="polite"' }),
          " attribute applied.",
        ],
      }),
      `
...
`,
      e.jsx(t.h3, {
        id: "alphabetfilter-with-activeletters-set",
        children: "AlphabetFilter with activeLetters set",
      }),
      `
`,
      e.jsxs(t.p, {
        children: [
          "Pass an array of letters to the ",
          e.jsx(t.code, { children: "activeLetters" }),
          ` prop to narrow filter options.
...
passed to `,
          e.jsx(t.code, { children: "activeLetters" }),
          " to limit filter options available to the user.",
        ],
      }),
      `
`,
...
`,
      e.jsx(t.h3, {
        id: "set-letter-selection-programmatically",
        children: "Set letter selection programmatically",
      }),
      `
`,
      e.jsxs(t.p, {
        children: [
          "Use the ",
          e.jsx(t.code, { children: "currentLetter" }),
          ` prop to pass a single letter value to set the selected
...
`,
      e.jsx(t.h3, {
        id: "dynamically-update-currentletter-using-onclick",
        children: "Dynamically update currentLetter using onClick",
      }),
      `
`,
      e.jsxs(t.p, {
        children: [
          "You can pass and extract the value through the ",
          e.jsx(t.code, { children: "currentLetter" }),
          " and ",
          e.jsx(t.code, { children: "onClick" }),
          `
...
`,
      e.jsx(t.p, {
        children: `Try it out: open up the browser's console to see new values being logged on each
change.`,
      }),
      `
`,
...
`,
      ...
      `
`,
      e.jsx(m, { changelogData: b }),
    ],
  });
}
function C(n = {}) {
  const { wrapper: t } = { ...c(), ...n.components };
  return t ? e.jsx(t, { ...n, children: e.jsx(a, { ...n }) }) : a(n);
}
export { C as default };
