...
import {
  ...
  d as v,
  e as S,
} from "./SearchBar.stories-rKIbJtyV.js";
            ...
            children: [
              e.jsxs(t.tr, {
                children: [
                  ...
                  e.jsx(t.td, {
                    children: e.jsx(t.code, { children: "0.0.4" }),
                  }),
                ],
              }),
              e.jsxs(t.tr, {
...
`,
              e.jsx(n, {
                href: "#with-custom-heading",
                target: "_self",
                children: "With Custom Heading",
              }),
              `
`,
            ],
...
`,
              e.jsx(n, {
                href: "#heading-and-description-text",
                target: "_self",
                children: "Heading and Description Text",
              }),
              `
`,
            ],
...
`,
              e.jsx(n, {
                href: "#textinput-and-onsubmit-values",
                target: "_self",
                children: "TextInput and onSubmit Values",
              }),
              `
`,
            ],
...
`,
      e.jsxs(t.p, {
        children: [
          "The main wrapper element that is rendered is a ",
          e.jsx(t.code, { children: "<form>" }),
          ` DOM element. All the
props passed to `,
          e.jsx(t.code, { children: "SearchBar" }),
          " will apply to the ",
          e.jsx(t.code, { children: "<form>" }),
          ` element and its children.
The `,
          e.jsx(t.code, { children: "SearchBar" }),
          " component will render a ",
          e.jsx(t.code, { children: "Select" }),
          ` component (optional),
`,
          e.jsx(t.code, { children: "TextInput" }),
          " component, ",
          e.jsx(t.code, { children: "Button" }),
          " component, and ",
          e.jsx(t.code, { children: "HelperErrorText" }),
          ` component
...
`,
      e.jsxs(t.p, {
        children: [
          "The ",
          e.jsx(t.code, { children: "Select" }),
          ` dropdown narrows the search within a specific category, typically
title or author. Toggle the `,
          e.jsx(t.code, { children: "Select" }),
...
`,
      e.jsxs(t.p, {
        children: [
          "Note: The labels for the ",
          e.jsx(t.code, { children: "Select" }),
          " and ",
          e.jsx(t.code, { children: "TextInput" }),
          ` components are not visible but
...
`,
      e.jsxs(t.p, {
        children: [
          "The ",
          e.jsx(t.code, { children: "SearchBar" }),
          " component is implemented with Reservoir ",
          e.jsx(t.code, { children: "Select" }),
          ", ",
          e.jsx(t.code, { children: "TextInput" }),
          `,
and `,
          e.jsx(t.code, { children: "Button" }),
          ` accessible components. This a "complete" component that renders an
HTML `,
          e.jsx(t.code, { children: "<form>" }),
          " element that is submitted with a ",
          e.jsx(t.code, { children: "<button>" }),
          " element of ",
          e.jsx(t.code, { children: 'type="submit"' }),
          `.
The `,
          e.jsx(t.code, { children: "<form>" }),
          " element also has a ",
          e.jsx(t.code, { children: 'role="search"' }),
...
`,
          e.jsx(t.li, {
            children: e.jsx(t.a, {
              href: "../?path=/docs/components-form-elements-select--docs",
              children: "Reservoir Select",
            }),
          }),
          `
`,
...
`,
          e.jsx(t.li, {
            children: e.jsx(t.a, {
              ...
              rel: "nofollow",
              children: "a11ymatters Accessible Search Form",
            }),
          }),
          `
`,
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          ` element when a string is
passed to the `,
          e.jsx(t.code, { children: "headingText" }),
          ` component. If this is an accessibility issue, it's
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          " is rendered through the DS ",
          e.jsx(t.code, { children: "Heading" }),
          " component.",
        ],
      }),
      `
...
`,
      e.jsxs(t.p, {
        children: [
          "To render an optional ",
          e.jsx(t.code, { children: "Select" }),
          ` component, an object must be passed to the
`,
          e.jsx(t.code, { children: "selectProps" }),
          " prop. It ",
          ...
          ", and ",
          e.jsx(t.code, { children: "optionsData" }),
          `
properties. The `,
          ...
          ", and ",
          e.jsx(t.code, { children: "value" }),
          ` properties are optional. The
`,
          e.jsx(t.code, { children: "labelText" }),
          " value won't be rendered but will be used for its ",
...
and `,
          ...
          " props to the ",
          e.jsx(t.code, { children: "selectProps" }),
          ` prop object. You must then control the
...
`,
      e.jsxs(t.p, {
        children: [
          "The ",
          e.jsx(t.code, { children: "optionsData" }),
          " prop is an array of objects that contain the ",
...
`,
      e.jsxs(t.p, {
        children: [
          e.jsx(t.strong, { children: "Note:" }),
          " when ",
          e.jsx(t.code, { children: "Select" }),
          ` options have a length greater than approximately 30
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          ` component, an object must be passed to the
`,
          e.jsx(t.code, { children: "textInputProps" }),
          " prop. It ",
          e.jsx(t.em, { children: "must" }),
          " include ",
          e.jsx(t.code, { children: "labelText" }),
...
`,
          ...
          e.jsx(t.code, { children: "aria-label" }),
          `
attribute. Optional properties to pass include `,
          e.jsx(t.code, { children: "defaultValue" }),
          ", ",
          e.jsx(t.code, { children: "id" }),
          ", ",
          e.jsx(t.code, { children: "isClearable" }),
          `,
`,
          e.jsx(t.code, { children: "isClearableCallback" }),
          ", ",
          e.jsx(t.code, { children: "max" }),
          ", ",
          e.jsx(t.code, { children: "maxLength" }),
          ", ",
          e.jsx(t.code, { children: "min" }),
          ", ",
          e.jsx(t.code, { children: "onChange" }),
          ", ",
          e.jsx(t.code, { children: "pattern" }),
          `,
`,
          e.jsx(t.code, { children: "placeholder" }),
          ", and ",
          e.jsx(t.code, { children: "value" }),
          ".",
        ],
...
`,
      e.jsx(t.h4, {
        id: "isclearable-and-isclearablecallback",
        children: "isClearable and isClearableCallback",
      }),
      `
`,
      e.jsxs(t.p, {
...
`,
          e.jsx(t.a, {
            href: "../?path=/docs/components-form-elements-textinput--docs#isclearable-button",
            children: "isClearable Button",
          }),
          `
section.`,
        ],
...
`,
      e.jsxs(t.p, {
        children: [
          "To render a custom input component, pass the component to the ",
          e.jsx(t.code, { children: "textInputElement" }),
          `
prop. This will render your custom input component such as an `,
          e.jsx(t.code, { children: "Autocomplete" }),
          `
...
`,
      e.jsxs(t.p, {
        children: [
          "A ",
          e.jsx(t.code, { children: "Button" }),
          " component will automatically be rendered for the ",
          e.jsx(t.code, { children: "SearchBar" }),
          `
component. If you want to pass a callback function to the `,
          e.jsx(t.code, { children: "Button" }),
          `, use the
`,
          e.jsx(t.code, { children: "buttonOnClick" }),
          " prop.",
        ],
      }),
      `
`,
      e.jsxs(t.p, {
        children: [
          "It's also possible to render the ",
          e.jsx(t.code, { children: "ButtonType.NoBrand" }),
          ` variant style when the
`,
          e.jsx(t.code, { children: "noBrandButtonType" }),
          " prop is set to ",
          e.jsx(t.code, { children: "true" }),
          ". The ",
          e.jsx(t.code, { children: "ButtonType.Primary" }),
          ` variant
...
`,
      e.jsx(t.h3, {
        id: "helpererrortext-component",
        children: "HelperErrorText Component",
      }),
      `
`,
      e.jsxs(t.p, {
        children: [
          "To render the ",
          e.jsx(t.code, { children: "HelperErrorText" }),
          ` component, pass a string or HTML to the
`,
          e.jsx(t.code, { children: "helperText" }),
          " prop. For the invalid state when ",
          e.jsx(t.code, { children: "isInvalid" }),
          ` is true, pass the
error string or HTML in the `,
          e.jsx(t.code, { children: "invalidText" }),
          " prop.",
        ],
      }),
      `
...
`,
      e.jsxs(t.p, {
        children: [
          "While the Design System does not implement an ",
          e.jsx(t.code, { children: "Autosuggest" }),
          " or ",
          e.jsx(t.code, { children: "Autocomplete" }),
          `
component, it does show a pattern for using the `,
          e.jsx(t.code, { children: "react-autosuggest" }),
          ` package.
In this example, we're using the `,
          e.jsx(t.code, { children: "react-autosuggest" }),
          ` example found in the
Basic Autosuggest story as the main component inside the `,
          e.jsx(t.code, { children: "SearchBar" }),
          " component.",
        ],
      }),
...
`,
      e.jsxs(t.p, {
        children: [
          "In order to render this custom input element in the ",
          e.jsx(t.code, { children: "SearchBar" }),
          ` component, pass
it in the `,
          e.jsx(t.code, { children: "textInputElement" }),
          " prop. Do not pass an object to the ",
          e.jsx(t.code, { children: "textInputProps" }),
          `
prop since the custom input component passed in `,
          e.jsx(t.code, { children: "textInputElement" }),
          ` will take
precedence.`,
        ],
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          e.jsx(t.code, { children: "Basic" }),
          ` example to see different states in real time.
Here are the same possible states of the `,
          e.jsx(t.code, { children: "SearchBar" }),
          " component in static examples.",
        ],
      }),
      `
`,
...
`,
      e.jsxs(t.p, {
        children: [
          "For the disabled state, set the ",
...
`,
      e.jsx(t.h2, {
        id: "heading-and-description-text",
        children: "Heading and Description Text",
      }),
      `
`,
      e.jsxs(t.p, {
        children: [
          "Use the ",
          e.jsx(t.code, { children: "descriptionText" }),
          " and ",
          e.jsx(t.code, { children: "headingText" }),
          ` props to render a heading and
description above the main `,
          e.jsx(t.code, { children: "SearchBar" }),
          " form component.",
        ],
      }),
...
`,
      e.jsx(t.h2, {
        id: "textinput-and-onsubmit-values",
        children: "TextInput and onSubmit Values",
      }),
      `
`,
...
`,
      e.jsxs(t.p, {
        children: [
          "It is possible to get certain values from the ",
          e.jsx(t.code, { children: "SearchBar" }),
...
`,
      e.jsxs(t.p, {
        children: [
          "The keyword value in the ",
          e.jsx(t.code, { children: "TextInput" }),
          ` component can be accessed by passing a
function to the `,
          e.jsx(t.code, { children: "onChange" }),
          " property in the ",
          e.jsx(t.code, { children: "textInputProp" }),
          ` prop. This is useful
...
`,
      e.jsx(t.p, {
        children: "To get values when the form is submitted, you must:",
      }),
      `
`,
      e.jsxs(t.ul, {
...
`,
          e.jsxs(t.li, {
            children: [
              "get the values returned in the ",
              e.jsx(t.code, { children: "onSubmit" }),
              " callback function.",
            ],
          }),
          `
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          " for the ",
          e.jsx(t.code, { children: "Select" }),
          ` is "selectName" and the
`,
          e.jsx(t.code, { children: "name" }),
          " for the ",
          e.jsx(t.code, { children: "TextInput" }),
          ' is "textInputName". The ',
          e.jsx(t.code, { children: "onSubmit" }),
          ` function can get
the submitted values through the `,
          e.jsx(t.code, { children: "event" }),
          ` object. In the example below, the
values can be retrieved as `,
          e.jsx(t.code, { children: "event.target.selectName.value" }),
          ` and
`,
...
function B(r = {}) {
  const { wrapper: t } = { ...i(), ...r.components };
  return t ? e.jsx(t, { ...r, children: e.jsx(c, { ...r }) }) : c(r);
}
export { B as default };
