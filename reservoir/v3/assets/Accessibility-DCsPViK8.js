import{u as o,j as e,M as d,L as l,a as n,y as r,bu as t}from"./iframe-D93LbwGv.js";const h=""+new URL("focusLiveFiltering-C-KmvDTb.gif",import.meta.url).href,c=""+new URL("focusKeywordSearch-BaaZzS66.gif",import.meta.url).href,f=""+new URL("focusClearingFilters-CV9KI8L_.gif",import.meta.url).href,g=""+new URL("focusPagination-zRzs_z3X.gif",import.meta.url).href,p=""+new URL("focusSorting-A-gVtlLL.gif",import.meta.url).href;function a(s){const i={code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",ul:"ul",...o(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{title:"Style Guide/Filtering/Accessibility"}),`
