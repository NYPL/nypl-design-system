...
import { u as A } from "./useMultiSelect-amaASZqv.js";
const F = [
    {
      id: "boroughs",
      name: "Boroughs",
...
const we = {
  ...
  G = { render: () => e.jsx(je, {}) },
  R = { render: () => e.jsx(ye, {}) },
  L = { render: () => e.jsx(fe, {}), name: "UI Containers for Row Layout" },
  H = { render: () => e.jsx(Fe, {}), name: "UI Containers for Column Layout" },
  E = { render: () => e.jsx(Me, {}) },
  P = { render: () => e.jsx(Ie, {}) },
  Se = (a) => {
    const {
        onChange: S,
        onMixedStateChange: b,
        selectedItems: c,
        onClear: i,
        onClearAll: p,
      } = A(),
      s = [c],
      m = (n, { isBlockElement: t, multiSelectWidth: l }) =>
        F &&
        F.map((r) =>
          e.jsx(
            T,
            {
              ...
              items: r.items,
              selectedItems: c,
              onChange: (C) => S(C.target.id, r.id),
              onMixedStateChange: (C) => b(C.target.id, r.id, r.items),
              onClear: () => i(r.id),
              width: l,
              closeOnBlur: n,
            },
      ...
      x = ({ closeOnBlur: n, layout: t, width: l }) =>
        e.jsx(w, {
          id: "multiselect-group",
          labelText: "MultiSelect Group",
          layout: t,
          multiSelectWidth: l,
          renderMultiSelect: m.bind(void 0, n),
        });
    return e.jsx(u, {
      id: a.id,
      heading: a.heading,
  ...
  je = () => {
    const {
      ...
      i = (s, { isBlockElement: m, multiSelectWidth: x }) =>
        F &&
        F.map((n) =>
          e.jsx(
            T,
            {
              ...
              items: n.items,
              selectedItems: b,
              onChange: (t) => a(t.target.id, n.id),
              onMixedStateChange: (t) => S(t.target.id, n.id, n.items),
              onClear: () => c(n.id),
              width: x,
            },
            n.id
      ...
      p = ({ closeOnBlur: s, layout: m, width: x }) =>
        e.jsx(w, {
          id: "multiselect-group",
          labelText: "MultiSelect Group",
          layout: m,
          multiSelectWidth: x,
          renderMultiSelect: i.bind(void 0, s),
        });
    return e.jsxs(_, {
      align: "left",
      children: [
        e.jsx(u, {
          heading: e.jsx(q, { level: "h3", children: "Custom H3 Heading" }),
          renderChildren: p,
        }),
        e.jsx(u, {
          heading: e.jsx(q, { level: "h5", children: "Custom H5 Heading" }),
          renderChildren: p,
        }),
        e.jsx(u, { renderChildren: p }),
      ],
    });
  },
  ye = () => {
    const {
      ...
      [m, x] = f.useState([]),
      n = [b],
      t = (d, { isBlockElement: o, multiSelectWidth: g }) =>
        F &&
        F.map((I) =>
          e.jsx(
            T,
            {
              ...
              selectedItems: b,
              isBlockElement: o,
              onChange: (D) => a(D.target.id, I.id),
              onMixedStateChange: (D) => S(D.target.id, I.id, I.items),
              onClear: () => c(I.id),
              width: g,
            },
            I.id
      ...
      l = ({ closeOnBlur: d, layout: o, width: g }) =>
        e.jsx(w, {
          showLabel: !1,
          id: "row",
          ...
          layout: o,
          multiSelectWidth: g,
          renderMultiSelect: t.bind(void 0, d),
        }),
      r = ({ closeOnBlur: d, layout: o, width: g }) =>
        e.jsx(w, {
          showLabel: !1,
          id: "column",
          labelText: "Column",
      ...
      C = ({ closeOnBlur: d, layout: o, width: g }) =>
        e.jsx(w, {
          showLabel: !1,
          id: "row-clear-all",
      ...
      h = ({ closeOnBlur: d, layout: o, width: g }) =>
        e.jsx(w, {
          showLabel: !1,
          id: "column-clear-all",
      ...
      y = ({ closeOnBlur: d, layout: o, width: g }) =>
        e.jsx(w, {
          showLabel: !1,
      ...
      k = ({ closeOnBlur: d, layout: o, width: g }) =>
        e.jsx(w, {
          showLabel: !1,
      ...
      W = ({ closeOnBlur: d, layout: o, width: g }) =>
        e.jsx(w, {
          showLabel: !1,
          id: "row-all-buttons",
      ...
      j = ({ closeOnBlur: d, layout: o, width: g }) =>
        e.jsx(w, {
          showLabel: !1,
      ...
      v = ({ closeOnBlur: d, layout: o, width: g }) =>
        e.jsxs(e.Fragment, {
          children: [
            e.jsx(w, {
              id: "group-one",
  ...
  fe = () => {
    const {
      ...
      p = ge("ui.bg.default", "dark.ui.bg.default"),
      s = [b],
      m = (l, { isBlockElement: r, multiSelectWidth: C }) =>
        F &&
        F.map((h) =>
          e.jsx(
            T,
            {
              ...
              selectedItems: b,
              isBlockElement: r,
              onChange: (y) => a(y.target.id, h.id),
              onMixedStateChange: (y) => S(y.target.id, h.id, h.items),
              onClear: () => c(h.id),
              width: C,
            },
            h.id
      ...
      x = (l, { isBlockElement: r, multiSelectWidth: C }) =>
        U &&
        U.map((h) =>
          e.jsx(
            T,
      ...
      n = ({ closeOnBlur: l, layout: r, width: C }) =>
        e.jsx(w, {
          showLabel: !1,
          id: "row-all-buttons",
          labelText: "Row with Clear All and Submit Buttons",
          layout: r,
          multiSelectWidth: C,
          renderMultiSelect: x.bind(void 0, l),
        }),
      t = ({ closeOnBlur: l, layout: r, width: C }) =>
        e.jsxs(e.Fragment, {
          children: [
            e.jsx(w, {
              id: "group-one",
              ...
              layout: r,
              multiSelectWidth: C,
              renderMultiSelect: m.bind(void 0, l),
            }),
            e.jsx(w, {
              id: "group-two",
              labelText: "Group Two",
  ...
  Fe = () => {
    const {
      ...
      p = [b],
      s = (n, { isBlockElement: t, multiSelectWidth: l }) =>
        F &&
        F.map((r) =>
          e.jsx(
            T,
            {
              ...
              selectedItems: b,
              isBlockElement: t,
              onChange: (C) => a(C.target.id, r.id),
              onMixedStateChange: (C) => S(C.target.id, r.id, r.items),
              onClear: () => c(r.id),
              width: l,
            },
            r.id
      ...
      m = ({ closeOnBlur: n, layout: t, width: l }) =>
        e.jsx(w, {
          showLabel: !1,
          id: "column-all-buttons",
          ...
          layout: t,
          multiSelectWidth: l,
          renderMultiSelect: s.bind(void 0, n),
        }),
      x = ({ closeOnBlur: n, layout: t, width: l }) =>
        e.jsxs(e.Fragment, {
          children: [
  ...
  Me = (a) => {
    ...
    const r = () => {
      ...
      C = (y, { isBlockElement: k, multiSelectWidth: W }) =>
        U &&
        U.map((j) =>
          e.jsx(
            T,
            {
              ...
              items: j.items,
              selectedItems: c,
              onChange: (v) => S(v.target.id, j.id),
              onClear: () => i(j.id),
              onMixedStateChange: (v) => b(v.target.id, j.id, j.items),
              width: W,
            },
            j.id
          )
        ),
      h = ({ closeOnBlur: y, layout: k, width: W }) =>
        e.jsxs(e.Fragment, {
          children: [
            e.jsx(w, {
              id: "multiselect-group",
              ...
              layout: k,
              multiSelectWidth: W,
              renderMultiSelect: C.bind(void 0, y),
            }),
            e.jsxs(N, {
              id: "checkbox-example",
  ...
  Ie = () => {
    ...
    f.useEffect(() => {
      const t = [];
      for (let l of i[0]) t.push({ id: `tag-${l}`, label: l });
      i[1] !== "" && t.push({ id: "tag-color", label: i[1] }), m(t);
    }, [i]);
    const x = (t) => {
        ...
        S((l) => l.filter((r) => `tag-${r}` !== t.id)),
          t.id === "tag-color" && c(""),
          m((l) => l.filter((r) => r.id !== r.id));
      },
      n = ({ layout: t }) =>
        e.jsxs(e.Fragment, {
          children: [
...
B.parameters = {
  ...
  parameters: {
    ...
    jest: ["FilterBarInline.test.tsx"]
      ...
      ...((z = ($ = B.parameters) == null ? void 0 : $.docs) == null
        ? void 0
        : z.source),
    },
    description: {
...
G.parameters = {
  ...
  render: () => <FilterBarInlineHeadingStory />
      ...
      ...((Z = (Y = G.parameters) == null ? void 0 : Y.docs) == null
        ? void 0
        : Z.source),
    },
  },
...
R.parameters = {
  ...
  render: () => <FilterBarLayoutStory />
      ...
      ...((ne = (te = R.parameters) == null ? void 0 : te.docs) == null
        ? void 0
        : ne.source),
    },
  },
...
L.parameters = {
  ...L.parameters,
  docs: {
    ...((re = L.parameters) == null ? void 0 : re.docs),
    source: {
      originalSource: `{
  render: () => <FilterBarRowContainerStory />,
  name: "UI Containers for Row Layout"
}`,
      ...((ie = (le = L.parameters) == null ? void 0 : le.docs) == null
        ? void 0
        : ie.source),
    },
  },
...
H.parameters = {
  ...
  name: "UI Containers for Column Layout"
      ...
      ...((se = (ae = H.parameters) == null ? void 0 : ae.docs) == null
        ? void 0
        : se.source),
    },
  },
...
E.parameters = {
  ...E.parameters,
  docs: {
    ...((de = E.parameters) == null ? void 0 : de.docs),
    source: {
      originalSource: `{
  render: () => <FilterBarChildrenStory />
}`,
      ...((ce = (ue = E.parameters) == null ? void 0 : ue.docs) == null
        ? void 0
        : ce.source),
    },
  },
...
P.parameters = {
  ...P.parameters,
  docs: {
    ...((me = P.parameters) == null ? void 0 : me.docs),
    source: {
      originalSource: `{
  render: () => <FilterBarTagSetStory />
}`,
      ...((be = (he = P.parameters) == null ? void 0 : he.docs) == null
        ? void 0
        : be.source),
    },
  },
    ...
    Object.defineProperty(
      {
        __proto__: null,
        ColumnLayout: H,
        FilterBarInlineHeading: G,
        LayoutPatterns: R,
        MultipleChildren: E,
        TagSetExample: P,
        UIContainers: L,
        WithControls: B,
        __namedExportsOrder: Te,
        default: we,
      },
      Symbol.toStringTag,
      { value: "Module" }
...
export { H as C, Be as F, R as L, E as M, P as T, L as U, B as W, G as a };
