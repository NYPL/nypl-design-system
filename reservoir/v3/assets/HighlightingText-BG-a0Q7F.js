import { u as l, j as e, M as t, L as r, a as s } from "./iframe-D93LbwGv.js";
function o(n) {
  const i = {
    a: "a",
    code: "code",
  ...
  return e.jsxs(e.Fragment, {
    children: [
      e.jsx(t, { title: "Accessibility Guide/Highlighting Text" }),
      `
`,
...
`,
              e.jsx(r, {
                href: "#nypl-recommendations",
                target: "_self",
                children: "NYPL Recommendations",
              }),
              `
`,
            ],
...
`,
      e.jsxs(i.p, {
        children: [
          "The ",
          e.jsx(i.code, { children: "<mark>" }),
          ` HTML element is intended to represent text which is marked or
...
`,
      e.jsx(i.p, {
        children: `From a visual perspective, highlighting text in the UI requires more than a just
...
`,
      e.jsxs(i.p, {
        children: [
          "By combining the semantic meaning of the ",
          e.jsx(i.code, { children: "<mark>" }),
          ` element and layering on an
...
use `,
          e.jsx(i.code, { children: "yellow" }),
          ` to highlight text, but other colors may be used based on the use
case.`,
        ],
      }),
      `
`,
      e.jsxs(i.p, {
        children: [
          "To meet WCAG 2.1 AA requirements, the full implementation of the ",
          e.jsx(i.code, { children: "highlight" }),
          `
...
`,
      e.jsx(i.h3, {
        id: "heavier-font-weight",
        children: "Heavier Font Weight",
      }),
      `
`,
      e.jsxs(i.p, {
...
`,
      e.jsx(i.p, {
        children: "Add a 1px border using a contrast compliant color.",
      }),
      `
`,
...
`,
          e.jsx(i.li, {
            children: e.jsx(i.a, {
              href: "http://localhost:6006/?path=/docs/style-guide-colors--docs#highlighter-colors",
              rel: "nofollow",
              children:
                "NYPL Reservoir Design System Color Palette: Highlighter Colors",
            }),
          }),
          `
`,
          e.jsx(i.li, {
            children: e.jsx(i.a, {
              ...
              rel: "nofollow",
              children: "The Mark Text element",
            }),
          }),
          `
`,
...
function d(n = {}) {
  ...
  return i ? e.jsx(i, { ...n, children: e.jsx(o, { ...n }) }) : o(n);
}
export { d as default };
