...
import { u as V } from "./useMultiSelect-amaASZqv.js";
const { action: C } = __STORYBOOK_MODULE_ACTIONS__,
  { userEvent: m, within: g, expect: f } = __STORYBOOK_MODULE_TEST__,
  o = [
    { id: "art", name: "Art" },
    ...
    { id: "government_and_law", name: "Government and Law" },
  ...
  je = [
    { id: "art", name: "Art" },
    { id: "architecture", name: "Architecture", isDisabled: !0 },
    { id: "art_history", name: "Art History" },
    {
      id: "design",
      name: "Design",
      children: [
        { id: "fashion", name: "Fashion", isDisabled: !0 },
        { id: "ux", name: "User Experience", isDisabled: !0 },
        { id: "architecture_design", name: "Architecture", isDisabled: !1 },
        { id: "home", name: "Home", isDisabled: !1 },
      ],
    },
    { id: "business", name: "Business" },
  ],
  Ie = [
    ...
    { id: "art_history", name: "Art History" },
    {
      ...
      children: [
        { id: "fashion", name: "Fashion", isDisabled: !0 },
        { id: "ux", name: "User Experience", isDisabled: !0 },
        { id: "architecture_design", name: "Architecture", isDisabled: !0 },
        { id: "home", name: "Home", isDisabled: !0 },
      ],
    },
    { id: "business", name: "Business" },
  ],
  Ae = [
    { id: "art", name: "Art", itemCount: 7 },
    { id: "architecture", name: "Architecture", itemCount: 20 },
    { id: "creativity", name: "Creativity", isDisabled: !0, itemCount: 0 },
    {
      id: "design",
      name: "Design",
      children: [
        { id: "bauhaus", name: "Bauhaus", isDisabled: !0, itemCount: 0 },
        { id: "fashion", name: "Fashion", itemCount: 2 },
        { id: "ux", name: "User Experience", itemCount: 5 },
        { id: "home", name: "Home", itemCount: 1 },
        { id: "standards", name: "Standards", isDisabled: !0, itemCount: 0 },
      ],
      itemCount: 11,
    },
    { id: "business", name: "Business", itemCount: 2 },
    { id: "education", name: "Education", itemCount: 15 },
    { id: "games", name: "Games", itemCount: 6 },
  ],
  Oe = {
    title: "Components/Form Elements/MultiSelect",
    component: b,
    argTypes: {
      defaultItemsVisible: { table: { defaultValue: { summary: "5" } } },
      id: { control: !1 },
      closeOnBlur: { table: { defaultValue: { summary: "false" } } },
      isBlockElement: { table: { defaultValue: { summary: "false" } } },
      isDefaultOpen: { table: { defaultValue: { summary: "false" } } },
      isSearchable: { table: { defaultValue: { summary: "false" } } },
      listOverflow: {
        control: "radio",
        options: ye,
      ...
      onChange: { control: !1 },
      onMixedStateChange: { control: !1 },
      selectedItems: { control: !1 },
      width: {
        description:
  ...
  v = {
    ...
    play: async ({ canvasElement: t }) => {
      let c = g(t).getByRole("button");
      await m.click(c), await f(c).toHaveAttribute("aria-expanded", "true");
      const u = g(t).getByText(/Architecture/);
      await m.click(u);
      const d = g(t).getByText(/Cartography/);
      await m.click(d);
      let l = g(t).getByTestId("multi-select-close-button-testid");
      await f(l).toHaveAttribute(
        "aria-label",
        "remove 2 items selected from MultiSelect"
      ),
        await m.click(l);
      const s = g(t).getAllByRole("textbox")[0];
      await m.type(s, "Design"), await f(d).not.toBeVisible();
      let r = g(t).getAllByRole("checkbox");
      f(r.length).toBe(1);
      const n = g(t).getByText(/Design/);
      await f(n).toBeVisible(), await m.click(n);
      const i = g(s.parentElement).getAllByRole("button")[0];
      await m.click(i),
        await m.click(l),
        f(r).not.toBeChecked,
        await m.click(document.body),
        await f(c).toHaveAttribute("aria-expanded", "false");
    },
  },
  k = {
    render: () =>
      e.jsx(e.Fragment, {
        children: e.jsxs(x, {
          ...
          children: [
            e.jsxs("div", {
              children: [
                e.jsx(h, { level: "h3", size: "heading6", text: "Default" }),
                e.jsx(a, {
            ...
            e.jsxs("div", {
              children: [
                e.jsx(h, { level: "h3", size: "heading6", text: "Custom" }),
                e.jsx(a, {
      ...
      e.jsx(e.Fragment, {
        children: e.jsxs(x, {
          ...
          children: [
            e.jsxs("div", {
              children: [
                e.jsx(h, { level: "h3", size: "heading6", text: "true" }),
                e.jsxs(x, {
                  align: "left",
                  spacing: "s",
                  children: [
                    ...
                    e.jsx(_, {
                      children:
                        "Maecenas sed diam eget risus varius blandit sit amet non magna. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Aenean lacinia bibendum nulla sed consectetur. Donec sed odio dui.",
                    }),
                  ],
                }),
              ],
                ...
                e.jsxs(x, {
                  ...
                  children: [
                    e.jsxs(x, {
                      ...
                      children: [
                        e.jsx(a, { id: "multi-select-id-11", items: o }),
                        e.jsx(a, { id: "multi-select-id-12", items: o }),
                        e.jsx(a, { id: "multi-select-id-13", items: o }),
                      ],
                    }),
                    e.jsx(_, {
                      children:
      ...
      e.jsx(e.Fragment, {
        children: e.jsxs(x, {
          ...
          children: [
            ...
            e.jsxs("div", {
              children: [
                e.jsx(h, { level: "h3", size: "heading6", text: "fitContent" }),
                e.jsx(a, {
  ...
  T = { render: () => e.jsx(Te, { items: o }) },
  De = (t) => {
    const {
        onChange: c,
        onMixedStateChange: u,
        onClear: d,
        selectedItems: l,
      } = V(),
      [s, r] = S.useState("");
    S.useEffect(() => {
      Object.keys(l).length !== 0 && C(s)(l), s === "onClear" && C(s)(l);
    }, [s, l]);
    const n = t.id;
    return e.jsx(b, {
      ...t,
      selectedItems: l,
      onChange: (i) => {
        c(i.target.id, n), r("onChange");
      },
      onMixedStateChange: (i) => {
        u(i.target.id, n, t.items), r("onMixedStateChange");
      },
      onClear: () => {
        d(n), r("onClear");
      },
  ...
  a = ({
    ...
    isDefaultOpen: l,
    items: s,
    listOverflow: r = "scroll",
    width: n = "full",
    defaultItemsVisible: i = 5,
  }) => {
    const {
        onChange: we,
        onMixedStateChange: ve,
        onClear: ke,
        selectedItems: w,
      } = V(),
      [H, L] = S.useState("");
    return (
      S.useEffect(() => {
        Object.keys(w).length !== 0 && C(H)(w), H === "onClear" && C(H)(w);
      }, [H, w]),
      e.jsx(b, {
        buttonText: "MultiSelect",
        closeOnBlur: c,
        defaultItemsVisible: i,
        id: t,
        isBlockElement: u,
        isDefaultOpen: l,
        isSearchable: d,
        ...
        width: n,
        onChange: (z) => {
          we(z.target.id, t), L("onChange");
        },
        onMixedStateChange: (z) => {
          ve(z.target.id, t, s), L("onMixedStateChange");
        },
        onClear: () => {
          ke(t), L("onClear");
        },
  ...
  Te = ({ items: t }) => {
    ...
    return (
      S.useEffect(() => {
        Object.keys(s).length !== 0 && C(r)(s), r === "onClear" && C(r)(s);
      }, [r, s]),
      e.jsxs(Me, {
        minHeight: "300px",
        alignItems: "baseline",
        children: [
          e.jsx(b, {
            ...
            width: "fitContent",
            onChange: (i) => {
              c(i.target.id, "ms-group-1"), n("onChange");
            },
            onMixedStateChange: (i) => {
              u(i.target.id, "ms-group-1", t), n("onMixedStateChange");
            },
            onClear: () => {
              d("ms-group-1"), n("onClear");
            },
          }),
          e.jsx(b, {
            buttonText: "MultiSelect",
            ...
            width: "fitContent",
            onChange: (i) => {
              c(i.target.id, "ms-group-2"), n("onChange");
            },
            onMixedStateChange: (i) => {
              u(i.target.id, "ms-group-2", t), n("onMixedStateChange");
            },
            onClear: () => {
              d("ms-group-2"), n("onClear");
            },
          }),
          e.jsx(b, {
            buttonText: "MultiSelect",
            ...
            width: "fitContent",
            onChange: (i) => {
              c(i.target.id, "ms-group-3"), n("onChange");
            },
            onMixedStateChange: (i) => {
              u(i.target.id, "ms-group-3", t), n("onMixedStateChange");
            },
            onClear: () => {
              d("ms-group-3"), n("onClear");
            },
          }),
          e.jsx(Ee, {
            id: "clear-all",
...
v.parameters = {
  ...v.parameters,
  docs: {
    ...((F = v.parameters) == null ? void 0 : F.docs),
    source: {
      originalSource: `{
  args: {
    buttonText: "MultiSelect",
  ...
  play: async ({
    ...
    await expect(multiselect).toHaveAttribute("aria-expanded", "false");
      ...
      ...((N = (R = v.parameters) == null ? void 0 : R.docs) == null
        ? void 0
        : N.source),
    },
  },
...
k.parameters = {
  ...k.parameters,
  docs: {
    ...((q = k.parameters) == null ? void 0 : q.docs),
    source: {
      originalSource: `{
  render: () => <>
      ...
      ...((U = (G = k.parameters) == null ? void 0 : G.docs) == null
        ? void 0
        : U.source),
    },
  },
...
B.parameters = {
  ...
  render: () => <MultiSelectStory id="multi-select-id-4" isBlockElement isDefaultOpen={false} isSearchable={false} items={withChildrenItems} />
      ...
      ...((K = (J = B.parameters) == null ? void 0 : J.docs) == null
        ? void 0
        : K.source),
    },
  },
...
y.parameters = {
  ...y.parameters,
  docs: {
    ...((Y = y.parameters) == null ? void 0 : Y.docs),
    source: {
      originalSource: `{
  render: () => <MultiSelectStory id="multi-select-id-5" isBlockElement isDefaultOpen={false} isSearchable={false} items={withDisabledItems} />
      ...
      ...((Q = (P = y.parameters) == null ? void 0 : P.docs) == null
        ? void 0
        : Q.source),
    },
  },
...
M.parameters = {
  ...
  render: () => <MultiSelectStory id="multi-select-id-6" isBlockElement isDefaultOpen={false} isSearchable={false} items={withDisabledAllChildrenItems} />
      ...
      ...(($ = (Z = M.parameters) == null ? void 0 : Z.docs) == null
        ? void 0
        : $.source),
    },
  },
...
E.parameters = {
  ...E.parameters,
  docs: {
    ...((ee = E.parameters) == null ? void 0 : ee.docs),
    source: {
      originalSource: `{
  render: () => <Stack direction="row" align="left" spacing="xl">
      ...
      ...((ie = (te = E.parameters) == null ? void 0 : te.docs) == null
        ? void 0
        : ie.source),
    },
  },
...
j.parameters = {
  ...j.parameters,
  docs: {
    ...((se = j.parameters) == null ? void 0 : se.docs),
    source: {
      originalSource: `{
  render: () => <MultiSelectStory id="multi-select-id-8" isBlockElement isDefaultOpen={false} isSearchable={false} items={withItemCountItems} />
      ...
      ...((ae = (ne = j.parameters) == null ? void 0 : ne.docs) == null
        ? void 0
        : ae.source),
    },
  },
...
I.parameters = {
  ...I.parameters,
  docs: {
    ...((le = I.parameters) == null ? void 0 : le.docs),
    source: {
      originalSource: `{
  name: "isBlockElement",
  render: () => <>
      ...
      ...((ce = (re = I.parameters) == null ? void 0 : re.docs) == null
        ? void 0
        : ce.source),
    },
  },
...
A.parameters = {
  ...A.parameters,
  docs: {
    ...((oe = A.parameters) == null ? void 0 : oe.docs),
    source: {
      originalSource: `{
  render: () => <>
      <Stack align="left" spacing="l">
      ...
      ...((ue = (de = A.parameters) == null ? void 0 : de.docs) == null
        ? void 0
        : ue.source),
    },
  },
...
D.parameters = {
  ...
  render: () => <MultiSelectStory id="multi-select-id-17" closeOnBlur={true} isBlockElement items={withChildrenItems} />
      ...
      ...((fe = (pe = D.parameters) == null ? void 0 : pe.docs) == null
        ? void 0
        : fe.source),
    },
  },
...
T.parameters = {
  ...T.parameters,
  docs: {
    ...((be = T.parameters) == null ? void 0 : be.docs),
    source: {
      originalSource: `{
  render: () => <MultiSelectGroupStory items={withItems} />
}`,
      ...((Ce = (Se = T.parameters) == null ? void 0 : Se.docs) == null
        ? void 0
        : Ce.source),
    },
  },
    ...
    Object.defineProperty(
      {
        __proto__: null,
        InAGroup: T,
        __namedExportsOrder: He,
        closeOnBlurState: D,
        default: Oe,
        defaultOpenState: O,
        disabledListItems: y,
        disabledListItemsAllChildren: M,
        isBlockElement: I,
        itemCountListItems: j,
        nestedListItems: B,
        searchInputField: E,
        visibleListItems: k,
        width: A,
