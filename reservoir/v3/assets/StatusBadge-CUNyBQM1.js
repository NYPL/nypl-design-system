...
import {
  ...
  a as f,
  I as g,
} from "./StatusBadge.stories-CcTXJSaG.js";
            ...
            children: [
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, {
                    children: e.jsx(n.code, { children: "0.18.7" }),
                  }),
                ],
              }),
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, {
                    children: e.jsx(n.code, { children: "3.5.4" }),
                  }),
                ],
              }),
            ],
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          ` component is able to displays multiple
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          e.jsx(n.code, { children: "StatusBadge" }),
          ` component, the implementation should not
...
`,
          e.jsx(n.code, { children: "StatusBadge" }),
          " and not rely just on the color.",
        ],
      }),
      `
`,
...
`,
          e.jsxs(n.li, {
            children: [e.jsx(n.code, { children: "level" }), " (deprecated)"],
          }),
          `
`,
        ],
...
`,
          e.jsxs(n.li, {
            children: [
              ...
              " variants align with specific uses.",
            ],
          }),
          `
`,
...
`,
          e.jsxs(n.li, {
            children: [
              ...
              " variants have been deprecated in favor of the semantic ",
              e.jsx(n.code, { children: "type" }),
              `
variants.`,
            ],
...
`,
      e.jsxs(n.p, {
        children: [
          "Use the ",
          e.jsx(n.code, { children: "fontSize" }),
          " prop to set the font size with the following design tokens:",
        ],
      }),
      `
`,
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.code, { children: "desktop.body.body1" }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.code, { children: "desktop.body.body2" }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.code, { children: "desktop.caption" }),
          }),
          `
`,
        ],
...
`,
      e.jsxs(n.p, {
        children: [
          "The default label font size is ",
          e.jsx(n.code, { children: "desktop.body.body2" }),
          ".",
        ],
      }),
      `
...
`,
          e.jsx(n.li, {
            children: `Text capitalization is dependent on each use case and final decisions should
...
`,
          e.jsxs(n.li, {
            children: [
              "An icon can be rendered within the component by passing a DS ",
...
tokens for spacing values (ex. `,
              e.jsx(n.code, { children: 'marginRight="xs"' }),
              ").",
            ],
          }),
          `
