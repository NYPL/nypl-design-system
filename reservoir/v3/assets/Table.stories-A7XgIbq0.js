...
const le = {
    ...
    component: a,
    argTypes: {
      columnHeaders: { control: { disable: !0 } },
      columnHeadersBackgroundColor: { control: { type: "color" } },
      columnHeadersTextColor: { control: { type: "color" } },
      id: { control: !1 },
      isScrollable: { ...T(), defaultValue: { summary: "false" } },
      showRowDividers: { ...T(), defaultValue: { summary: "false" } },
      showTitleText: { ...T(), defaultValue: { summary: "false" } },
      tableData: { control: !1 },
      tableTextSize: { options: se, defaultValue: { summary: "body1" } },
      useColumnStyles: {
        control: { type: "boolean" },
        description:
          "**Only used for Storybook** – Apply custom column styles and use alternate table data",
      },
      useRowHeaders: { ...T(), defaultValue: { summary: "false" } },
    },
  },
  t = [
    "First Name",
  ...
  y = ["Name", "Nick Name", "Species", "Description", "Bio", "Salary (USD)"],
  S = [
    [
      "Tom Nook",
      "Tanukichi",
  ...
  l = {
    args: {
      className: void 0,
      columnHeaders: t,
      columnHeadersBackgroundColor: void 0,
      columnHeadersTextColor: void 0,
      columnStyles: void 0,
      id: void 0,
      isScrollable: !1,
      showRowDividers: !1,
    ...
    render: (p) =>
      e.jsx(a, {
        ...p,
        columnHeaders: p.useColumnStyles ? y : t,
        columnStyles: p.useColumnStyles ? v : void 0,
        tableData: p.useColumnStyles ? S : s,
      }),
    parameters: {
      design: {
        type: "figma",
          ...
          e.jsxs("div", {
            children: [
              e.jsx(b, {
                level: "h4",
                size: "heading6",
                children: "With Empty Style Object",
              }),
              e.jsx(a, {
                columnHeaders: w,
                columnStyles: oe,
  ...
  re = ["First Name", "Last Name", "Avatar"],
  ie = [
    [
      "Tom",
      "Nook",
...
l.parameters = {
  ...
  parameters: {
    ...
    jest: "Table.test.tsx"
      ...
      ...((C = (D = l.parameters) == null ? void 0 : D.docs) == null
        ? void 0
        : C.source),
    },
    description: {
      ...
      ...((j = (R = l.parameters) == null ? void 0 : R.docs) == null
        ? void 0
        : j.description),
    },
  },
...
o.parameters = {
  ...
  render: () => <Table columnHeaders={columnHeaders} id="table-title-text" tableData={tableData} titleText="Table with visible title" />
      ...
      ...((k = (N = o.parameters) == null ? void 0 : N.docs) == null
        ? void 0
        : k.source),
    },
  },
...
r.parameters = {
  ...
  render: () => <Table columnHeaders={columnHeaders} id="table-aria-label" showTitleText={false} tableData={tableData} titleText="Table with aria-label" />
      ...
      ...((B = (W = r.parameters) == null ? void 0 : W.docs) == null
        ? void 0
        : B.source),
    },
  },
...
i.parameters = {
  ...
  render: () => <Table columnHeaders={columnHeaders} id="table-row-dividers" showTitleText={false} showRowDividers tableData={tableData} titleText="Table with row dividers" />
      ...
      ...((E = (I = i.parameters) == null ? void 0 : I.docs) == null
        ? void 0
        : E.source),
    },
  },
...
n.parameters = {
  ...
  render: () => <Table columnHeaders={columnHeaders} id="table-row-headers" showTitleText={false} tableData={tableData} titleText="Table with row headers" useRowHeaders />
      ...
      ...((_ = (K = n.parameters) == null ? void 0 : K.docs) == null
        ? void 0
        : _.source),
    },
  },
...
u.parameters = {
  ...
  render: () => <Table columnHeaders={columnHeaders} columnHeadersBackgroundColor="var(--nypl-colors-ui-link-secondary)" columnHeadersTextColor="var(--nypl-colors-ui-white)" id="table-custom-header-colors" showRowDividers showTitleText={false} tableData={tableData} titleText="Table with custom header colors" useRowHeaders />
      ...
      ...((Y = (P = u.parameters) == null ? void 0 : P.docs) == null
        ? void 0
        : Y.source),
    },
  },
...
c.parameters = {
  ...
  render: () => <Table columnHeaders={columnHeadersAltBasic} id="table-native-column-styles" showTitleText={false} tableData={tableDataAltBasic} titleText="Table using native column styles" />
      ...
      ...((O = ($ = c.parameters) == null ? void 0 : $.docs) == null
        ? void 0
        : O.source),
    },
  },
...
d.parameters = {
  ...
  render: () => <Stack spacing="xl">
      ...
      ...((L = (X = d.parameters) == null ? void 0 : X.docs) == null
        ? void 0
        : L.source),
    },
  },
...
m.parameters = {
  ...m.parameters,
  docs: {
    ...((U = m.parameters) == null ? void 0 : U.docs),
    source: {
      originalSource: `{
  render: () => <Stack spacing="xl">
      <div>
      ...
      ...((Z = (G = m.parameters) == null ? void 0 : G.docs) == null
        ? void 0
        : Z.source),
    },
  },
...
const ne = [
  ...
  de = Object.freeze(
    Object.defineProperty(
      {
        __proto__: null,
        CustomColumnStyles: d,
        CustomHeaderColors: u,
        HideTitleText: r,
        HorizontalScrolling: m,
        JSXElements: h,
        NativeColumnStyles: c,
        RowDividers: i,
        RowHeaders: n,
        ShowTitleText: o,
        WithControls: l,
        __namedExportsOrder: ne,
        default: le,
      },
      Symbol.toStringTag,
      { value: "Module" }
