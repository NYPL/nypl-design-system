...
import {
  ...
  B as m,
  L as u,
} from "./Toggle.stories-sYEcktF3.js";
const f = [
  {
    date: "2024-03-14",
    version: "3.0.0",
            ...
            children: [
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, {
                    children: e.jsx(n.code, { children: "0.25.8" }),
                  }),
                ],
              }),
              e.jsxs(n.tr, {
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          ` component is used as an alternative for the Checkbox component and
returns a boolean response. Like the Checkbox component, the `,
          e.jsx(n.code, { children: "Toggle" }),
          ` component
...
`,
      e.jsxs(n.p, {
        children: [
          e.jsx(n.code, { children: "Toggle" }),
          ` components are commonly used for “on/off” switches to perform binary
...
`,
      e.jsx(n.p, {
        children: `The Toggle component label should clarify the action being performed. Labels
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "Toggle" }),
          " component is implemented using Chakra's ",
          e.jsx(n.code, { children: "Switch" }),
          ` component. While
some accessibility resources state that using a `,
          e.jsx(n.code, { children: "<button>" }),
          ` element is better for
a toggle or switch component, Chakra UI internally uses a `,
          e.jsx(n.code, { children: "checkbox" }),
          ` element.
Because Chakra's `,
          e.jsx(n.code, { children: "Switch" }),
          ` component handles the internal state so well and its
styles, we chose this over implementing this component with a `,
          e.jsx(n.code, { children: "<button>" }),
          " element.",
        ],
      }),
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://chakra-ui.com/docs/components/form/switch",
              rel: "nofollow",
              children: "Chakra UI Switch",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://w3c.github.io/aria-practices/examples/switch/switch-button.html",
              rel: "nofollow",
              children: "W3C Switch Example Using HTML Button",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "Inclusive Components Toggle Buttons",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://www.erikkroes.nl/blog/accessible-html-toggle-button-switch/",
              rel: "nofollow",
              children: "Accessible HTML Toggle Button (Switch)",
            }),
          }),
          `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          "Note that the ",
          e.jsx(n.code, { children: "isChecked" }),
          " property in this example is set to ",
          e.jsx(n.code, { children: "true" }),
          `. Clicking
on it won't change the toggle; The `,
          e.jsx(n.code, { children: "isChecked" }),
          ` prop must now be controlled
