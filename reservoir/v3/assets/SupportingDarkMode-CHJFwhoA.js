import { u as i, j as e, M as d, L as n, S as s } from "./iframe-D93LbwGv.js";
function t(r) {
  const o = {
    a: "a",
    code: "code",
  ...
  return e.jsxs(e.Fragment, {
    children: [
      e.jsx(d, { title: "Development Guide/Supporting Dark Mode" }),
      `
`,
      e.jsx(o.h1, {
        id: "supporting-dark-mode",
        children: "Supporting Dark Mode",
      }),
      `
`,
...
`,
              e.jsx(n, {
                href: "#reservoir-default-configuration",
                target: "_self",
                children: "Reservoir Default Configuration",
              }),
              `
`,
            ],
...
`,
              e.jsx(n, {
                href: "#consuming-app-configuration",
                target: "_self",
                children: "Consuming App Configuration",
              }),
              `
`,
            ],
...
`,
              e.jsx(n, {
                href: "#using-custom-dark-mode-styles",
                target: "_self",
                children: "Using Custom Dark Mode Styles",
              }),
              `
`,
            ],
...
`,
      e.jsx(o.p, {
        children: `Offering dark mode color styles on a website might be considered a hip feature
...
`,
      e.jsx(o.p, {
        children: `With these accessibility benefits in mind, NYPL is aiming to implement dark
...
`,
      e.jsx(o.p, {
        children: `All DS components support light and dark color mode and have gone through color
...
`,
          e.jsx(o.li, {
            children: e.jsx(o.a, {
              ...
              rel: "nofollow",
              children: "WebAIM Contrast Checker",
            }),
          }),
          `
`,
          e.jsx(o.li, {
            children: e.jsx(o.a, {
              ...
              rel: "nofollow",
              children: "W3 WAI Colors with Good Contrast",
            }),
          }),
          `
`,
          e.jsx(o.li, {
            children: e.jsx(o.a, {
              ...
              rel: "nofollow",
              children:
                "The A11y Project - Operating System and Browser Accessibility Display Modes",
            }),
          }),
          `
`,
...
`,
      e.jsx(o.h2, {
        id: "reservoir-default-configuration",
        children: "Reservoir Default Configuration",
      }),
      `
`,
      e.jsx(o.p, {
        children: `By default, the Reservoir Design System (DS) is configured to ignore a user's
...
`,
      e.jsxs(o.p, {
        children: [
          "This configuration is controlled with the ",
          e.jsx(o.code, { children: "useSystemColorMode" }),
          ` and
`,
          e.jsx(o.code, { children: "initialColorMode" }),
          ` global attributes found in
`,
          e.jsx(o.a, {
            href: "https://github.com/NYPL/nypl-design-system/blob/b52c9a5fea6b5eed929119e9dd5ed155044e44c7/src/theme/index.ts#L161",
            rel: "nofollow",
            children: "src/theme/index.ts",
          }),
          `
(lines 161 - 166) in the Reservoir repo. They are set to `,
          e.jsx(o.code, { children: "false" }),
          " and ",
          e.jsx(o.code, { children: '"light"' }),
          `
respectively.`,
        ],
      }),
...
`,
      e.jsxs(o.p, {
        children: [
          "If desired, the ",
          e.jsx(o.code, { children: "initialColorMode" }),
          ` can be overridden by the consuming
application. To do this, please refer to the `,
          e.jsx(n, {
            href: "#consuming-app-configuration",
            target: "_self",
            children: `Consuming App
Configuration`,
          }),
          " section.",
        ],
...
`,
      e.jsx(o.h2, {
        id: "consuming-app-configuration",
        children: "Consuming App Configuration",
      }),
      `
`,
...
applications must add the `,
          e.jsx(o.code, { children: "ColorModeScript" }),
          ` component, which helps keep track of
...
`,
      e.jsxs(o.p, {
        children: [
          "For proper configuration, the ",
          e.jsx(o.code, { children: "initialColorMode" }),
          ` prop must be passed to the
`,
          e.jsx(o.code, { children: "ColorModeScript" }),
          ` component. With this prop, consuming apps can set the value for
...
`,
      e.jsx(o.p, {
        children: e.jsx(o.strong, { children: "Color Mode Options" }),
      }),
      `
`,
      e.jsxs(o.p, {
...
`,
      e.jsxs(o.p, {
        children: [
          e.jsx(o.strong, { children: "NOTE:" }),
          " Although the ",
          e.jsx(o.code, { children: "initialColorMode" }),
          " prop can be set to the ",
          e.jsx(o.code, { children: '"light"' }),
          ` value,
...
apps will use the `,
          ...
          " or ",
          e.jsx(o.code, { children: '"system"' }),
          ` values in order to enable the dark mode
color styles.`,
        ],
      }),
      `
...
`,
      e.jsxs(o.p, {
        children: [
          ...
          " component with the ",
          e.jsx(o.code, { children: "initialColorMode" }),
          ` prop should be added
to the top level of the consuming application, before all content. More often
than not, the `,
          e.jsx(o.code, { children: "ColorModeScript" }),
          ` component will be added alongside the
`,
          e.jsx(o.code, { children: "DSProvider" }),
          " component (",
          e.jsx(o.a, {
            href: "https://github.com/NYPL/nypl-design-system#using-the-design-system-in-your-product",
            rel: "nofollow",
            children: `see the
docs`,
          }),
...
`,
      e.jsx(o.h3, {
        ...
        children: "Optional Configuration",
      }),
      `
`,
      e.jsx(o.p, {
        children: e.jsx(o.strong, {
          children: "For SSR Frameworks (ex. Next.js)",
        }),
      }),
      `
`,
...
the color mode, it is recommended to also add the `,
          e.jsx(o.code, { children: "colorModeManager" }),
          ` prop in the
`,
          e.jsx(o.code, { children: "DSProvider" }),
          " component to aid with proper color rendering. When ",
          e.jsx(o.code, { children: "colorModeManager" }),
          `
is implemented, the app will load the `,
          e.jsx(o.code, { children: "initialColorMode" }),
...
functionality. The `,
          e.jsx(o.code, { children: "cookieStorageManager" }),
          " and ",
          e.jsx(o.code, { children: "localStorageManager" }),
          ` functions can
be used to help to store the `,
          e.jsx(o.code, { children: "chakra-ui-color-mode" }),
          ` value in the browser, but, by
default, the necessary variables will be stored in `,
          e.jsx(o.code, { children: "localStorage" }),
          ` unless otherwise
specified. The `,
          e.jsx(o.code, { children: "getServerSideProps" }),
          ` function runs before the page loads, ensuring
...
exposes Chakra's `,
          e.jsx(o.code, { children: "useColorMode" }),
          " and ",
          e.jsx(o.code, { children: "useColorModeValue" }),
          " hooks.",
        ],
      }),
      `
...
`,
      e.jsxs(o.p, {
        children: [
          e.jsx(o.code, { children: "useColorMode" }),
          ` gives you access to the current color mode, and a function to
...
`,
      e.jsxs(o.p, {
        children: [
          e.jsx(o.code, { children: "useColorModeValue" }),
          ` is a React hook used to change any value or style based on the
...
`,
      e.jsx(o.h3, {
        id: "react-syntax-reminder",
        children: "React Syntax Reminder",
      }),
      `
`,
      e.jsxs(o.p, {
        children: [
          ...
          " and ",
          e.jsx(o.code, { children: "useColorModeValue" }),
          ` hooks only work if called inside the
`,
          e.jsx(o.code, { children: "DSProvider" }),
          ` wrapper. Additionally, like all hooks, they must be called from
...
`,
      e.jsx(o.h2, {
        id: "using-custom-dark-mode-styles",
        children: "Using Custom Dark Mode Styles",
      }),
      `
`,
      e.jsx(o.p, {
        children: `If all NYPL consuming apps were composed using only Reservoir Design System (DS)
...
`,
      e.jsx(o.h3, {
        id: "setting-styles-with-javascript-recommended",
        children: "Setting Styles with Javascript (recommended)",
      }),
      `
`,
      e.jsxs(o.p, {
...
being used to leverage the style patterns and `,
          e.jsx(n, {
            href: "#design-tokens",
            target: "_self",
...
elements, such as `,
          e.jsx(n, {
            href: "#chakra-style-props",
            target: "_self",
            children: "Chakra style props",
          }),
          ", ",
          e.jsx(n, {
            href: "#design-tokens",
...
style props, along with a wide array of `,
          e.jsx(o.a, {
            href: "https://chakra-ui.com/docs/styled-system/style-props#pseudo",
            rel: "nofollow",
            children: `pseudo
selectors`,
          }),
          `, provide
helpful and time-saving shorthand to style components. Examples include the `,
          e.jsx(o.code, { children: "bg" }),
          `
prop in place of the `,
          e.jsx(o.code, { children: "background" }),
          " CSS attribute and the ",
          e.jsx(o.code, { children: "px" }),
          ` prop to add both
the `,
          e.jsx(o.code, { children: "padding-left" }),
          " and ",
          e.jsx(o.code, { children: "padding-right" }),
          " CSS attributes to an element.",
        ],
      }),
      `
`,
...
color values `,
          e.jsx(o.code, { children: "ui.bg.default" }),
          " and ",
          e.jsx(o.code, { children: "dark.ui.bg.default" }),
          ` are color design tokens
and `,
          e.jsx(o.code, { children: "inset.default" }),
          ` is a spacing design token. For a full reference chart
showing all available design tokens, refer to the `,
          e.jsx(o.a, {
            href: "../?path=/docs/development-guide-design-tokens--docs",
            children: `Design
Tokens`,
          }),
          ` page in Reservoir
...
`,
      e.jsxs(o.p, {
        children: [
          ...
          e.jsx(o.code, { children: "@media" }),
          ` queries and nested styles, CSS-in-JS allows
...
`,
      e.jsx(o.h4, {
        id: "preparing-your-components",
        children: "Preparing Your Components",
      }),
      `
`,
      e.jsxs(o.p, {
...
composed using `,
          e.jsx(n, {
            href: "#using-ds-components",
            target: "_self",
            children: "DS components",
          }),
          " or Chakra ",
          e.jsx(n, {
            href: "#using-structural-ui-components",
            target: "_self",
            children: "Structural UI components",
          }),
          ".",
        ],
      }),
...
`,
      e.jsx(o.h5, {
        id: "using-ds-components",
        children: "Using DS Components",
      }),
      `
`,
      e.jsx(o.p, {
        children: `If a DS component can be used to take the place of a custom components or custom
...
`,
      e.jsx(o.h5, {
        id: "using-structural-ui-components",
        children: "Using Structural UI Components",
      }),
      `
`,
      e.jsxs(o.p, {
...
components to note are `,
          e.jsx(o.code, { children: "Box" }),
          " (",
          e.jsx(o.a, {
            href: "../?path=/docs/components-chakra-exports-layout-box--docs",
...
built, and
`,
          e.jsx(o.code, { children: "Stack" }),
          " (",
          e.jsx(o.a, {
            href: "../?path=/docs/components-chakra-exports-layout-stack-hstack-vstack--docs",
            children: `see the
docs`,
          }),
          `),
...
`,
      e.jsx(o.p, {
        children: `For app-specific components, dark mode styles should be applied using CSS-in-JS.
There are two methods to do this.`,
      }),
      `
`,
      e.jsx(o.h5, {
        id: "method-1-recommended",
        children: "Method 1 (recommended)",
      }),
      `
`,
      e.jsxs(o.p, {
        children: [
          "To add styles to DS and Chakra UI components, pass a style object to the ",
          e.jsx(o.code, { children: "sx" }),
          `
prop. Within the style object, use the `,
          e.jsx(o.code, { children: "_dark" }),
          ` pseudo selector to add the styles
...
HTML elements, you must use the React `,
          e.jsx(o.code, { children: "style" }),
          " prop rather than the Chakra ",
          e.jsx(o.code, { children: "sx" }),
          `
prop or the `,
          e.jsx(n, {
...
`,
      e.jsx(o.h3, {
        id: "css-and-css-precompilers",
        children: "CSS and CSS Precompilers",
      }),
      `
`,
      e.jsxs(o.p, {
...
CSS vars (`,
          e.jsx(o.a, {
            ...
            children: "Colors Storybook page",
          }),
          ").",
        ],
      }),
...
`,
          e.jsx(o.code, { children: "prefers-color-scheme" }),
          " media query must be written after the default styles.",
        ],
      }),
      `
`,
...
`,
      e.jsxs(o.p, {
        children: [
          "If the consuming application uses a toggle, you can use the ",
          e.jsx(o.code, { children: "useColorMode" }),
          ` hook to
retrieve the current `,
          e.jsx(o.code, { children: "colorMode" }),
          " and add ",
          e.jsx(o.code, { children: '"light"' }),
          " or ",
          e.jsx(o.code, { children: '"dark"' }),
          ` classes to applicable
components.`,
        ],
      }),
      `
...
`,
      e.jsx(o.p, {
        children: `If mockups have not been specifically created to show the dark mode version of a
...
and in the `,
          e.jsx(o.a, {
            href: "https://www.figma.com/file/qShodlfNCJHb8n03IFyApM/Main?node-id=61991%3A45315",
            rel: "nofollow",
...
For more details, please refer to the `,
          e.jsx(n, {
            href: "#legacy-color-conversions",
            target: "_self",
            children: "Legacy Color Conversions",
          }),
          " section.",
        ],
      }),
...
`,
      e.jsx(o.h3, {
        id: "legacy-color-conversions",
        children: "Legacy Color Conversions",
      }),
      `
`,
      e.jsx(o.p, {
        children: `In older designs and consuming apps, grayscale colors may have been used in the
...
`,
      e.jsx(o.p, {
        children: "Use the following tables to update legacy color values.",
      }),
      `
`,
        ...
        children: [
          e.jsx(o.thead, {
            children: e.jsxs(o.tr, {
              children: [
                e.jsx(o.th, { children: "Legacy Grayscale Color" }),
                e.jsx(o.th, { children: "Current Semantic Color" }),
              ],
            }),
          }),
          e.jsxs(o.tbody, {
            children: [
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.gray.x-light-cool" }),
                  e.jsx(o.td, { children: "ui.bg.default" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.gray.light-cool" }),
                  e.jsx(o.td, { children: "ui.bg.hover" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.gray.medium" }),
                  e.jsx(o.td, { children: "ui.bg.active" }),
                ],
              }),
            ],
          }),
          ...
          e.jsxs(o.tbody, {
            children: [
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.gray.medium" }),
                  e.jsx(o.td, { children: "ui.border.default" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.gray.dark" }),
                  e.jsx(o.td, { children: "ui.border.hover" }),
                ],
              }),
            ],
          }),
        ...
        children: [
          ...
          e.jsxs(o.tbody, {
            children: [
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.white" }),
                  e.jsx(o.td, { children: "ui.typography.heading.inverse" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.black" }),
                  e.jsx(o.td, { children: "ui.typography.heading" }),
                ],
              }),
            ],
          }),
          ...
          e.jsxs(o.tbody, {
            children: [
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.white" }),
                  e.jsx(o.td, { children: "ui.typography.body.inverse" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.black" }),
                  e.jsx(o.td, { children: "ui.typography.body" }),
                ],
              }),
            ],
          }),
...
`,
      e.jsx(o.h4, {
        ...
        children: "Disabled State Colors",
      }),
      `
`,
      e.jsxs(o.table, {
        children: [
          ...
          e.jsxs(o.tbody, {
            children: [
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.gray.xx-light-cool" }),
                  e.jsx(o.td, { children: "ui.disabled.secondary" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.gray.light-cool" }),
                  e.jsx(o.td, { children: "ui.disabled.primary" }),
                ],
              }),
            ],
          }),
...
`,
      e.jsx(o.h3, {
        id: "lightdark-color-map",
        children: "Light/Dark Color Map",
      }),
      `
`,
      e.jsx(o.p, {
        children: `Each brand color, section color and semantic color design token in the light
      ...
      e.jsxs(o.table, {
        children: [
          e.jsx(o.thead, {
            children: e.jsxs(o.tr, {
              children: [
                e.jsx(o.th, { children: "Light Color Palette" }),
          ...
          e.jsxs(o.tbody, {
            children: [
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.disabled.primary" }),
                  e.jsx(o.td, { children: "dark.ui.disabled.primary" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.disabled.secondary" }),
                  e.jsx(o.td, { children: "dark.ui.disabled.secondary" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.error.primary" }),
                  e.jsx(o.td, { children: "dark.ui.error.primary" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.error.secondary" }),
                  e.jsx(o.td, { children: "dark.ui.error.secondary" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.focus" }),
                  e.jsx(o.td, { children: "dark.ui.focus" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.link.primary" }),
                  e.jsx(o.td, { children: "dark.ui.link.primary" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.link.secondary" }),
                  e.jsx(o.td, { children: "dark.ui.link.secondary" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.status.primary" }),
                  e.jsx(o.td, { children: "dark.ui.status.primary" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.status.secondary" }),
                  e.jsx(o.td, { children: "dark.ui.status.secondary" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.success.primary" }),
                  e.jsx(o.td, { children: "dark.ui.success.primary" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.success.secondary" }),
                  e.jsx(o.td, { children: "dark.ui.success.secondary" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.test" }),
                  e.jsx(o.td, { children: "dark.ui.test" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.warning.primary" }),
                  e.jsx(o.td, { children: "dark.ui.warning.primary" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.warning.secondary" }),
                  e.jsx(o.td, { children: "dark.ui.warning.secondary" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.bg.default" }),
                  e.jsx(o.td, { children: "dark.ui.bg.default" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.bg.hover" }),
                  e.jsx(o.td, { children: "dark.ui.bg.hover" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.bg.active" }),
                  e.jsx(o.td, { children: "dark.ui.bg.active" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.border.default" }),
                  e.jsx(o.td, { children: "dark.ui.border.default" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.border.hover" }),
                  e.jsx(o.td, { children: "dark.ui.border.hover" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.typography.body" }),
                  e.jsx(o.td, { children: "dark.ui.typography.body" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.typography.body.inverse" }),
                  e.jsx(o.td, { children: "dark.ui.typography.body.inverse" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.typography.heading" }),
                  e.jsx(o.td, { children: "dark.ui.typography.heading" }),
                ],
              }),
              e.jsxs(o.tr, {
                children: [
                  e.jsx(o.td, { children: "ui.typography.heading.inverse" }),
                  e.jsx(o.td, {
                    children: "dark.ui.typography.heading.inverse",
                  }),
                ],
              }),
            ],
...
function a(r = {}) {
  const { wrapper: o } = { ...i(), ...r.components };
  return o ? e.jsx(o, { ...r, children: e.jsx(t, { ...r }) }) : t(r);
}
export { a as default };
