import { u as s, j as n, M as a, L as t } from "./iframe-D93LbwGv.js";
function o(i) {
  const e = {
    a: "a",
    code: "code",
  ...
  return n.jsxs(n.Fragment, {
    children: [
      n.jsx(a, { title: "Accessibility Guide/Skip Navigation" }),
      `
`,
...
`,
          n.jsx(e.a, {
            href: "https://nypl.org/accessibility",
            rel: "nofollow",
            children: "NYPL.org/accessibility",
          }),
          `. For most digitial
applications on the NYPL.org platform, the `,
          n.jsx(e.a, {
...
`,
      n.jsxs(e.p, {
        children: [
          ...
          n.jsx(e.code, { children: "SkipNavigation" }),
...
`,
      n.jsxs(e.p, {
        children: [
          ...
          n.jsx(e.code, { children: '"#mainContent"' }),
          ` anchor which an NYPL page is
expected to have. The `,
          n.jsx(e.code, { children: "TemplateAppContainer" }),
          " component renders as a ",
          n.jsx(e.code, { children: "main" }),
          ` HTML
element with a default `,
          n.jsx(e.code, { children: "id" }),
          " of ",
          n.jsx(e.code, { children: '"mainContent"' }),
          `. While it's possible to update
the target of the skip link and the id of the `,
          n.jsx(e.code, { children: "<main>" }),
          ` element, this is not
recommended. When using the DS' `,
          n.jsx(e.code, { children: "SkipNavigation" }),
          " and ",
          n.jsx(e.code, { children: "TemplateAppContainer" }),
          `
...
using the `,
          n.jsx(e.code, { children: "TemplateAppContainer" }),
          " component, make sure to render a ",
          n.jsx(e.code, { children: "main" }),
          ` HTML
element with an `,
          n.jsx(e.code, { children: "id" }),
...
`,
      n.jsxs(e.p, {
        children: [
          `The second link points to additional accessibility information on
`,
          n.jsx(e.a, {
            href: "https://nypl.org/accessibility",
            rel: "nofollow",
...
function r(i = {}) {
  ...
  return e ? n.jsx(e, { ...i, children: n.jsx(o, { ...i }) }) : o(i);
}
export { r as default };
