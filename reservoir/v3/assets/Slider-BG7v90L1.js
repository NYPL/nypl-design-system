...
import {
  ...
  g as y,
  P as C,
} from "./Slider.stories-B6H_PREW.js";
            ...
            children: [
              ...
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, {
                    children: e.jsx(n.code, { children: "3.3.2" }),
                  }),
                ],
              }),
            ],
...
`,
              e.jsx(t, {
                href: "#programmatically-update",
                target: "_self",
                children: "Programmatically Update",
              }),
              `
`,
            ],
...
with text so there is no overlap. Internally, a `,
...
The value is also used to generate appropriate `,
          e.jsx(n.code, { children: "aria-label" }),
          ` values for the
component's text input and slider thumb. When `,
...
the `,
          ...
          ", ",
          e.jsx(n.code, { children: "aria-orientation" }),
          ", and ",
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "W3C WAI-Aria Practices - Slider",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "W3C WAI-Aria Practices - Slider (Multi-Thumb)",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://chakra-ui.com/docs/components/form/slider",
              rel: "nofollow",
              children: "Chakra Slider",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://chakra-ui.com/docs/components/form/range-slider",
              rel: "nofollow",
              children: "Chakra RangeSlider",
            }),
          }),
          `
`,
...
`,
      e.jsx(n.h3, {
        id: "slider-accessibility-implementation",
        children: "Slider Accessibility Implementation",
      }),
      `
`,
      e.jsxs(n.p, {
...
System (DS) `,
          ...
          e.jsx(n.code, { children: "<input>" }),
          ` element
which shows the current value. This `,
          e.jsx(n.code, { children: "input" }),
          ` element also has its own
`,
          e.jsx(n.code, { children: "aria-label" }),
          ". When the input box is hidden, the ",
          e.jsx(n.code, { children: "for" }),
          " attribute in the ",
          e.jsx(n.code, { children: "label" }),
          `
element is removed.`,
...
attributes on the single slider thumb: `,
          e.jsx(n.code, { children: "aria-valuemin" }),
          ", ",
          e.jsx(n.code, { children: "aria-valuemax" }),
          `,
...
`,
      e.jsxs(n.p, {
        children: [
          "Set ",
          e.jsx(n.code, { children: "isRangeSlider" }),
          " to ",
...
value. For this type of component, the `,
          e.jsx(n.code, { children: "value" }),
...
slider configuration will contain the `,
          e.jsx(n.code, { children: "aria-label" }),
          ", ",
          e.jsx(n.code, { children: "aria-valuemin" }),
          `,
...
`,
      e.jsx(n.h3, {
        id: "rangeslider-accessibility-implementation",
        children: "RangeSlider Accessibility Implementation",
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          "Chakra's ",
          e.jsx(n.code, { children: "RangeSlider" }),
...
different than the expected standard string; the `,
          e.jsx(n.code, { children: "RangeSlider" }),
          ` expects
`,
          e.jsx(n.code, { children: "aria-label" }),
          " to be an array of two strings. On top of this, the DS ",
          e.jsx(n.code, { children: "Slider" }),
          `'s
`,
          e.jsx(n.code, { children: "<label>" }),
          ...
          e.jsx(n.code, { children: "isRangeSlider" }),
          " state, points to the ",
          e.jsx(n.em, { children: "first" }),
          `
`,
          e.jsx(n.code, { children: "<input>" }),
          " element which shows the current ",
          e.jsx(n.em, { children: "start" }),
          " value. These two ",
          e.jsx(n.code, { children: "input" }),
          `
elements also have their own `,
          e.jsx(n.code, { children: "aria-label" }),
...
`,
      e.jsxs(n.p, {
        children: [
          `Note that Chakra will automatically generate the values for the following aria
attributes on the two slider thumbs: `,
          e.jsx(n.code, { children: "aria-valuemin" }),
          ", ",
          e.jsx(n.code, { children: "aria-valuemax" }),
          `,
...
the `,
          e.jsx(n.code, { children: "aria-label" }),
          " attributes are dependent on the ",
          e.jsx(n.code, { children: "labelText" }),
          " value.",
        ],
      }),
...
`,
      e.jsx(n.h3, {
        id: "single-slider-states",
        children: "Single Slider States",
      }),
      `
`,
      e.jsx(l, { of: g }),
...
`,
      e.jsx(n.h3, {
        id: "range-slider-states",
        children: "Range Slider States",
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          "To enable the Range Slider, set the ",
          e.jsx(n.code, { children: "isRangeSlider" }),
          " prop to true.",
        ],
      }),
...
`,
      e.jsx(n.h3, {
        id: "single-slider-variants",
        children: "Single Slider Variants",
      }),
      `
`,
      e.jsx(n.p, {
        children: `In the following example, the min/max values and the current value text
input are hidden.`,
      }),
      `
`,
...
`,
      e.jsx(n.p, {
        children: "For the following examples, all labels are hidden.",
      }),
      `
`,
      e.jsx(l, { of: f }),
...
`,
      e.jsx(n.h3, {
        id: "range-slider-with-adjusted-handles",
        children: "Range Slider with Adjusted Handles",
      }),
      `
`,
      e.jsx(n.p, {
        children: "In the following examples, all the labels are hidden.",
      }),
      `
`,
      e.jsx(l, { of: b }),
...
value or values. Once the value(s) is updated, the `,
          e.jsx(n.code, { children: "onChange" }),
          ` callback will be
called and the values will be passed. If no `,
          e.jsx(n.code, { children: "onChange" }),
          ` callback is provided,
you won't be able to get the updated value(s) of the `,
          e.jsx(n.code, { children: "Slider" }),
          " component.",
        ],
      }),
...
`,
      e.jsx(n.h3, {
        id: "single-slider-value",
        children: "Single Slider Value",
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          "Open up the browser's developer console to see the value of the ",
          e.jsx(n.code, { children: "Slider" }),
          `
after updating it.`,
        ],
...
`,
      e.jsx(n.h3, {
        ...
        children: "Range Slider Values",
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          "Open up the browser's developer console to see the values of the ",
          e.jsx(n.code, { children: "Slider" }),
          `
after updating it in the `,
          e.jsx(n.code, { children: "isRangeSlider" }),
          " state.",
        ],
      }),
...
`,
      e.jsx(n.h3, {
        id: "get-final-slider-value",
        children: "Get Final Slider Value",
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          "Pass a callback function to the ",
          e.jsx(n.code, { children: "onChangeEnd" }),
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "Slider" }),
          " can be updated programmatically through the ",
          e.jsx(n.code, { children: "value" }),
          ` prop. Like the
`,
          e.jsx(n.code, { children: "defaultValue" }),
          " prop, the ",
          e.jsx(n.code, { children: "value" }),
          ` prop also takes in a single number for the regular
`,
          e.jsx(n.code, { children: "Slider" }),
          ' component or an array of two numbers for the "Range" ',
          e.jsx(n.code, { children: "Slider" }),
          " component.",
        ],
      }),
...
and returns the value(s) to the consuming app through the `,
          e.jsx(n.code, { children: "onChange" }),
          " callback.",
        ],
      }),
...
`,
      ...
      `
`,
      e.jsx(u, { changelogData: T }),
    ],
  });
}
function I(a = {}) {
  const { wrapper: n } = { ...d(), ...a.components };
