...
import {
  ...
  G as b,
  a as g,
} from "./Select.stories-BUvq4aqy.js";
            ...
            children: [
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, {
                    children: e.jsx(n.code, { children: "0.7.0" }),
                  }),
                ],
              }),
              e.jsxs(n.tr, {
...
`,
              e.jsx(t, {
                href: "#getting-select-input-value",
                target: "_self",
                children: "Getting Select Input Value",
              }),
              `
`,
            ],
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          e.jsx(n.code, { children: "option" }),
          `
children. For optimal accessibility, the `,
...
It's the developer's responsibility to ensure that the appropriate `,
          e.jsx(n.code, { children: "<option>" }),
          `
elements are provided as children. Internally, a `,
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "MDN select: The HTML Select element",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://chakra-ui.com/docs/components/form/select",
              rel: "nofollow",
              children: "Chakra UI Select",
            }),
          }),
          `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "Select" }),
          ` component renders all the necessary wrapping and associated text
elements, but the select options `,
...
`,
      e.jsxs(n.p, {
        children: [
          "There are two NYPL best practices to consider when using the ",
          e.jsx(n.code, { children: "Select" }),
          ` component
and `,
          e.jsx(n.code, { children: "option" }),
...
`,
          e.jsx(n.li, {
            children: `Use no more than 10 options. If more than 10 options are needed, an
auto-complete text input is a good alternative.`,
          }),
          `
`,
          e.jsx(n.li, {
            children: `Use at least four options. If fewer than three options are needed, a radio
...
`,
          e.jsx(n.code, { children: "labelPosition" }),
          ` prop. Note that the label will only display inline when the device
width exceeds the `,
          e.jsx(n.code, { children: "--nypl-breakpoint-medium" }),
          " breakpoint, or 600px. When ",
          e.jsx(n.code, { children: "showLabel" }),
          `
is set to `,
          ...
          ", an ",
          e.jsx(n.code, { children: "aria-label" }),
          ` attribute is added to the select input to maintain
accessibility. If the component needs to be required, the `,
          e.jsx(n.code, { children: "showRequiredLabel" }),
          ` prop
can be used to show or hide the "required" text within the `,
          e.jsx(n.code, { children: "label" }),
          " element.",
        ],
      }),
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "Select" }),
          " component can accept all HTML ",
          e.jsx(n.code, { children: "autocomplete" }),
          " values.",
        ],
      }),
      `
...
`,
      e.jsx(n.h2, {
        id: "getting-select-input-value",
        children: "Getting Select Input Value",
      }),
      `
`,
      e.jsx(n.h3, {
        id: "controlled-component-using-value-and-onchange-props",
        children: "Controlled Component using value and onChange props",
      }),
      `
`,
      e.jsxs(n.p, {
...
value through the `,
          ...
          ` props. This will be called every time
a new `,
          e.jsx(n.code, { children: "option" }),
          " value is selected.",
        ],
...
`,
      e.jsx(n.p, {
        children: `Try it out: open up the browser's console to see new values being logged on
each change.`,
      }),
      `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          "If your application uses uncontrolled components, you can pass a React ",
          e.jsx(n.code, { children: "ref" }),
          `
prop to the DS Select component to get the selected value from the DOM. Note
that this example uses a `,
          e.jsx(n.code, { children: "Form" }),
          " and a ",
          e.jsx(n.code, { children: "Button" }),
          ` to submit the form, only then
will the value be available. Additionally, you may pass a `,
...
`,
      ...
      `
`,
      e.jsx(u, { changelogData: v }),
    ],
  });
}
function T(l = {}) {
  const { wrapper: n } = { ...c(), ...l.components };
  return n ? e.jsx(n, { ...l, children: e.jsx(a, { ...l }) }) : a(l);
}
export { T as default };
