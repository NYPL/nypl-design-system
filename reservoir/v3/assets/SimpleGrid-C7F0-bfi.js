...
import {
  ...
  a as p,
  C as j,
} from "./SimpleGrid.stories-DUT9gNCB.js";
...
`,
              e.jsx(i, {
                href: "#other-simplegrid-examples",
                target: "_self",
                children: "Other SimpleGrid Examples",
              }),
              `
`,
            ],
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          ` component is used to render UI elements in a uniform grid
...
`,
      e.jsxs(n.p, {
        children: [
          "The NYPL standards for the items per row in a grid is ",
          e.jsx(n.code, { children: "3" }),
          " for desktop, ",
          e.jsx(n.code, { children: "2" }),
          ` for
tablet and `,
          e.jsx(n.code, { children: "1" }),
          " for mobile. By default, the ",
          e.jsx(n.code, { children: "SimpleGrid" }),
          ` component uses these
standards and the `,
          e.jsx(n.code, { children: "columns" }),
          " prop is optional. If the ",
          e.jsx(n.code, { children: "columns" }),
          ` prop is used, the
...
`,
      e.jsxs(n.p, {
        children: [
          "The CSS grid layout properties are used for the ",
          e.jsx(n.code, { children: "SimpleGrid" }),
          ` component. We don't
...
pick up `,
          e.jsx(n.code, { children: "SimpleGrid" }),
          ` CSS rules and will read the page in the expected DOM order
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Grid_Layout/CSS_Grid_Layout_and_Accessibility",
              rel: "nofollow",
              children: "MDN CSS Grid Layout and Accessibility",
            }),
          }),
          `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          "This example is rendering ",
          e.jsx(n.code, { children: "Icon" }),
          " components with the ",
          e.jsx(n.code, { children: "columns" }),
          " prop set to ",
          e.jsx(n.code, { children: "5" }),
          ".",
        ],
      }),
      `
...
`,
      e.jsxs(n.p, {
        children: [
          "This example is rendering square ",
          e.jsx(n.code, { children: "Image" }),
          " components with the ",
          e.jsx(n.code, { children: "columns" }),
          ` prop set
to `,
          e.jsx(n.code, { children: "6" }),
          ".",
        ],
      }),
      `
...
`,
      e.jsxs(n.p, {
        children: [
          "This example is rendering horizontal ",
