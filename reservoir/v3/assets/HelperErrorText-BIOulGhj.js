...
import {
  ...
  a as j,
  I as m,
} from "./HelperErrorText.stories-DKdw1311.js";
            ...
            children: [
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, {
                    children: e.jsx(n.code, { children: "0.0.10" }),
                  }),
                ],
              }),
              e.jsxs(n.tr, {
...
`,
              e.jsx(i, {
                href: "#html-and-jsx-children",
                target: "_self",
                children: "HTML and JSX Children",
              }),
              `
`,
            ],
...
`,
      e.jsxs(n.p, {
        children: [
          "In the Reservoir Design System (DS), the ",
...
`,
      e.jsxs(n.p, {
        children: [
          "In the case of form components, the ",
          e.jsx(n.code, { children: "HelperErrorText" }),
          ` component is associated
with a related input field by using the `,
...
`,
      e.jsxs(n.p, {
        children: [
          "This component will always render at least an empty ",
          e.jsx(n.code, { children: "<div>" }),
          ` element with an
`,
          e.jsx(n.code, { children: 'aria-live="polite"' }),
          ` attribute set even if no text content is passed. This is to
ensure that the accessibility guideline for dynamic content is met. One expected
use case of the `,
          e.jsx(n.code, { children: "HelperErrorText" }),
          ` component is to dynamically render error text
...
uses the `,
          e.jsx(n.code, { children: "HelperErrorText" }),
          " component to render the red-colored ",
          e.jsx(n.code, { children: '"This is error text :("' }),
          ` text below the input field and that text element is referenced with
the `,
          e.jsx(n.code, { children: "aria-describedby" }),
          ` attribute on the HTML input element. This type of
association is handled automatically by all DS `,
          e.jsx(n.code, { children: "Form Elements" }),
          " components.",
        ],
      }),
      `
...
`,
      e.jsxs(n.p, {
        children: [
          "By default, this prop is set to ",
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "ariaLive" }),
          " prop sets the ",
          e.jsx(n.code, { children: "aria-live" }),
          ` HTML attribute. This determines the
...
`,
          e.jsx(n.code, { children: "aria-live" }),
          " attribute: ",
          e.jsx(n.code, { children: '"off"' }),
          ", ",
          e.jsx(n.code, { children: '"polite"' }),
          ", and ",
          e.jsx(n.code, { children: '"assertive"' }),
          ".",
        ],
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: '"off"' }),
          ` value indicates that updates should not be announced and when this
value is passed, the `,
          e.jsx(n.code, { children: "aria-live" }),
          ` attribute will not be added at all. The
`,
          e.jsx(n.code, { children: '"polite"' }),
          ` value indicates that updates will be announced at the next available
time slot. The `,
          e.jsx(n.code, { children: '"assertive"' }),
          ` value indicates that updates should be announced
...
attribute is set in the wrapper `,
          e.jsx(n.code, { children: "<div>" }),
          ` element that is always rendered by the
`,
          e.jsx(n.code, { children: "HelperErrorText" }),
          " component.",
        ],
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "MDN aria-describedby Attribute",
            }),
          }),
          `
`,
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://www.w3.org/TR/wai-aria-1.1/#aria-live",
              rel: "nofollow",
              children: "W3C WAI-ARIA 1.1 - aria-live (property)",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://www.w3.org/TR/WCAG20-TECHS/ARIA19.html",
              rel: "nofollow",
              children:
                "W3C ARIA19: Using ARIA role=alert or Live Regions to Identify Errors",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://www.digitala11y.com/aria-live-properties/",
              rel: "nofollow",
              children: "DigitalA11y WAI-ARIA:aria-live (Property)",
            }),
          }),
          `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "HelperErrorText" }),
          ` component can render any HTML element or React component
through the `,
          e.jsx(n.code, { children: "text" }),
          " prop. Note that the ",
          e.jsx(n.code, { children: "text" }),
          " value is always wrapped in a ",
...
`,
      e.jsxs(n.p, {
        children: [
          "Set the ",
          e.jsx(n.code, { children: "isInvalid" }),
          " prop to ",
          e.jsx(n.code, { children: "true" }),
          ` to render the passed text content with the
