import { u as r, j as e, M as d, L as o, S as i } from "./iframe-D93LbwGv.js";
function t(s) {
  const n = {
    a: "a",
    code: "code",
  ...
  return e.jsxs(e.Fragment, {
    children: [
      e.jsx(d, { title: "Development Guide/v3 Migration Guide" }),
      `
`,
      e.jsx(n.h1, {
        id: "reservoir-v3-migration-guide",
        children: "Reservoir v3 Migration Guide",
      }),
      `
`,
...
`,
              e.jsx(o, {
                href: "#general-updates-requirements",
                children: "General Updates & Requirements",
              }),
              `
`,
            ],
...
`,
              e.jsx(o, {
                href: "#additional-testing-needs",
                children: "Additional Testing Needs",
              }),
              `
`,
            ],
...
`,
      e.jsx(n.h2, {
        id: "general-updates--requirements",
        children: "General Updates & Requirements",
      }),
      `
`,
...
`,
      e.jsx(n.p, {
        children: `With these updates, the DS will offer better support for apps that are using the
...
`,
          e.jsx(n.li, {
            children: "The Chakra UI 1.8 version is not supported by React 18.",
          }),
          `
`,
          e.jsx(n.li, {
            children: `Node 16 support ended in September, 2023 so while AWS and Vercel still
...
applications. For example, even though the `,
          e.jsx(n.code, { children: "Menu" }),
          ` component is a new addition,
...
`,
          ...
          " package in the ",
          e.jsx(n.code, { children: "package.json" }),
          " file.",
        ],
      }),
      `
...
`,
      e.jsx(n.p, {
        children: e.jsx(n.code, {
          children: "npm install @nypl/design-system-react-components@3.0.0",
        }),
      }),
      `
`,
...
changes in the future that the caret (`,
...
`,
      e.jsx(n.h3, {
        id: "main-additions-and-upgrades",
        children: "Main Additions and Upgrades",
      }),
      `
`,
      e.jsxs(n.ul, {
...
`,
          e.jsxs(n.li, {
            children: [
              ...
              " (v2) components are included in this release.",
            ],
          }),
          `
`,
...
2.8. `,
              e.jsxs(n.strong, {
                children: [
                  `IMPORTANT: If you manually and separately install Chakra in your app,
make sure to also upgrade it in the `,
                  e.jsx(n.code, { children: "package.json" }),
                  " file.",
                ],
              }),
...
`,
      e.jsxs(n.p, {
        children: [
          "General updates can be found in the ",
          e.jsx(n.a, {
            href: "https://github.com/NYPL/nypl-design-system/blob/development/CHANGELOG.md",
            rel: "nofollow",
            children: "Changelog",
          }),
          `,
...
`,
          e.jsxs(n.li, {
            children: [
              "There are better responsive styles for the ",
...
`,
              e.jsx(n.code, { children: "cookieStorageManagerSSR" }),
              ", ",
              e.jsx(n.code, { children: "FocusLock" }),
              ", ",
              e.jsx(n.code, { children: "useStyleConfig" }),
              ", and ",
              e.jsx(n.code, { children: "useMultiStyleConfig" }),
              ".",
            ],
          }),
          `
...
`,
      e.jsx(n.h3, {
        id: "major-visual-changes",
        children: "Major Visual Changes",
      }),
      `
`,
      e.jsxs(n.ul, {
...
`,
          e.jsxs(n.li, {
            children: [
              ...
              ` adds horizontal scrolling for desktop viewports and improves
...
`,
          e.jsxs(n.li, {
            children: [
              ...
              " and ",
              e.jsx(n.code, { children: "SocialMediaLinks" }),
...
`,
          e.jsxs(n.li, {
            children: [
              ...
              " gap values have been updated to include ",
              e.jsx(n.code, { children: '"grid"' }),
              ` in the prop
value name. For example, `,
              e.jsx(n.code, { children: "gap=”grid.xs”" }),
              ".",
            ],
          }),
          `
`,
          e.jsxs(n.li, {
            children: [
              ...
              ` component now supports app framework's routing link components. For
example, `,
              e.jsx(n.code, { children: "Link" }),
              " component from Next.js can be used through the ",
              e.jsx(n.code, { children: "as" }),
              ` prop. The
previous pattern where the framework's `,
              e.jsx(n.code, { children: "Link" }),
              ` component was used as a parent
...
`,
          e.jsxs(n.li, {
            children: [
              ...
              " ",
              e.jsx(n.code, { children: '"filter"' }),
              ` variant has been updated to improve filtering logic in
consuming apps.`,
              `
`,
              e.jsxs(n.ul, {
...
`,
                  e.jsxs(n.li, {
                    children: [
                      ...
                      e.jsx(n.code, { children: '"filter"' }),
                      " variant, the ",
                      e.jsx(n.code, { children: "tagSetData" }),
                      ` prop now
...
`,
                      ...
                      `. Any additional property can now also be
added to the object.`,
                    ],
                  }),
                  `
`,
                  e.jsxs(n.li, {
                    children: [
                      ...
                      ` function now returns the entire data object of the clicked
...
`,
          e.jsxs(n.li, {
            children: [
              ...
              ` instead of
`,
              e.jsx(n.code, { children: "cookieStorageManager" }),
              ` for color mode server-side rendering (SSR). The returned
value should still used in the `,
              e.jsx(n.code, { children: "DSProvider" }),
              "'s ",
              e.jsx(n.code, { children: "colorModeManager" }),
              " prop.",
            ],
          }),
          `
`,
          e.jsxs(n.li, {
            children: [
              "The ",
              e.jsx(n.code, { children: "FocusLock" }),
              ` component was previously imported from the separate Chakra
`,
              e.jsx(n.code, { children: "@chakra-ui/focus-lock" }),
              " package. In Chakra v2+, ",
              e.jsx(n.code, { children: "FocusLock" }),
              ` can now be
...
following to their Jest setup file (typically `,
              e.jsx(n.code, { children: "jest.config.js" }),
              `). They are
needed for the following components and hooks: `,
              e.jsx(n.code, { children: "Tabs" }),
              ", ",
              e.jsx(n.code, { children: "Slider" }),
              `, and
`,
              e.jsx(n.code, { children: "useNYPLBreakpoints" }),
              ". ",
              e.jsx(n.em, {
                children: `We are actively working on updates so that consuming
