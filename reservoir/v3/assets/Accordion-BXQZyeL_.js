...
import {
  ...
  a as u,
  I as g,
} from "./Accordion.stories-BDTwGf_F.js";
            ...
            children: [
              ...
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, {
                    children: e.jsx(n.code, { children: "3.1.7" }),
                  }),
                ],
              }),
            ],
...
`,
              e.jsx(a, {
                href: "#example-with-panelmaxheight-prop",
                target: "_self",
                children: "Example with panelMaxHeight Prop",
              }),
              `
`,
            ],
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "Accordion" }),
          ` component displays a list of high-level options that can expand
...
when the data for multiple accordions is passed in through the `,
          e.jsx(n.code, { children: "accordionData" }),
          `
prop, the `,
          e.jsx(n.code, { children: "Accordion" }),
          ` components are grouped together and rendered under a
single element. When grouped like this, each `,
          e.jsx(n.code, { children: "Accordion" }),
          ` component still opens
...
`,
      e.jsxs(n.p, {
        children: [
          "The only way to render an ",
          e.jsx(n.code, { children: "Accordion" }),
          ` component is to pass in an array of
objects with `,
          e.jsx(n.code, { children: "label" }),
          ", ",
          e.jsx(n.code, { children: "panel" }),
          ", optional ",
          e.jsx(n.code, { children: "accordionType" }),
          ", optional ",
          e.jsx(n.code, { children: "ariaLabel" }),
          `,
and optional `,
          e.jsx(n.code, { children: "buttonInteractionRef" }),
          ` properties for each accordion item. Note
that you can pass in a string or DOM elements into the `,
          e.jsx(n.code, { children: "panel" }),
          ` property in each
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "accordionType" }),
          ` prop can be used to change the accordion button's background
color. It takes a value of `,
          ...
          ` for
`,
          e.jsx(n.code, { children: '"ui.status.primary"' }),
          ", and ",
          e.jsx(n.code, { children: '"error"' }),
          " for ",
          e.jsx(n.code, { children: '"ui.status.secondary"' }),
          `. The optional
`,
          e.jsx(n.code, { children: "panelMaxHeight" }),
          " prop determines the maximum height of the ",
          e.jsx(n.code, { children: "Accordion" }),
          `'s panel
when expanded. If the content within the panel exceeds the `,
          e.jsx(n.code, { children: "panelMaxHeight" }),
          `, a
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "buttonInteractionRef" }),
          ` prop can be used to set a programmatic reference to
...
`,
      e.jsxs(n.p, {
        children: [
          "An ",
          e.jsx(n.code, { children: "ariaLabel" }),
          ` prop is also available on the component level. When this prop is
set, the value will set the same `,
          e.jsx(n.code, { children: "aria-label" }),
          ` value on all accordions in an
accordion group. Please note, however, that the `,
          e.jsx(n.code, { children: "ariaLabel" }),
          ` key in the
`,
          e.jsx(n.code, { children: "accordionData" }),
          " entries will override the value of the ",
          e.jsx(n.code, { children: "ariaLabel" }),
          ` component
prop.`,
        ],
...
`,
                  e.jsxs(n.li, {
                    children: [
                      "Use the ",
                      e.jsx(n.code, { children: "aria-expanded" }),
...
`,
          e.jsx(n.li, {
            children: `Deviates from USWDS in that the user can open multiple panels. Opening one,
...
`,
          e.jsxs(n.li, {
            children: [
              "An ",
              e.jsx(n.code, { children: "aria-label" }),
              ` attribute can be applied to the main accordion button using
...
`,
                  e.jsxs(n.li, {
                    children: [
                      "The global ",
                      e.jsx(n.code, { children: "ariaLabel" }),
                      ` prop can set a general value that will be applied to
...
`,
                  e.jsxs(n.li, {
                    children: [
                      "The ",
                      e.jsx(n.code, { children: "ariaLabel" }),
                      " key available within the ",
                      e.jsx(n.code, { children: "accordionData" }),
                      ` array entries can set
...
`,
          e.jsx(n.li, {
            children: `If the user presses the 'esc' key and focus is on an open accordion panel,
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "W3C WAI-Aria Practices - Accordion",
            }),
          }),
          `
`,
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://chakra-ui.com/docs/components/disclosure/accordion",
              rel: "nofollow",
              children: "Chakra Accordion",
            }),
          }),
          `
`,
...
`,
      e.jsx(n.h2, {
        id: "examples-with-panelmaxheight-prop",
        children: "Examples with panelMaxHeight Prop",
      }),
      `
`,
...
`,
      e.jsx(n.h2, {
        id: "always-render-the-accordion-content",
        children: "Always Render the Accordion Content",
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          "By default, the content in an ",
          e.jsx(n.code, { children: "Accordion" }),
          ` is only rendered when it is opened. When
...
content inside an `,
          e.jsx(n.code, { children: "Accordion" }),
          ` whether it's opened or closed. Use the
`,
          e.jsx(n.code, { children: "isAlwaysRendered" }),
          " prop to always render the ",
          e.jsx(n.code, { children: "Accordion" }),
          "'s content.",
        ],
      }),
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          e.jsx(n.code, { children: "Accordion" }),
          ` has the default behavior where
the content is removed when it is closed. The second `,
          e.jsx(n.code, { children: "Accordion" }),
          ` always renders
its content. This is important in this scenario because we want to keep the state
of the content when it is closed. Click on subjects inside both `,
          e.jsx(n.code, { children: "Accordion" }),
          `s and
