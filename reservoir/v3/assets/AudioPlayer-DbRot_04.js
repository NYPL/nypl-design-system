...
import {
  ...
  b as f,
  E as x,
} from "./AudioPlayer.stories-B5Sj-0C-.js";
            ...
            children: [
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, {
                    children: e.jsx(n.code, { children: "1.2.0" }),
                  }),
                ],
              }),
              e.jsxs(n.tr, {
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "AudioPlayer" }),
          ` component is used to embed a streaming audio player from 3rd
party services such as `,
          e.jsx(n.code, { children: "Libsyn" }),
          ", ",
          e.jsx(n.code, { children: "SoundCloud" }),
          ", and ",
          e.jsx(n.code, { children: "Spotify" }),
          ` on a page. The
component requires the `,
          e.jsx(n.code, { children: "embedCode" }),
          " prop or ",
          e.jsx(n.code, { children: "filePath" }),
          ` prop. The component will
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          e.jsx(n.code, { children: "AudioPlayer" }),
          ` component does not support the playback
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "AudioPlayer" }),
          " component renders an iframe element from ",
          e.jsx(n.code, { children: "Libsyn" }),
          `,
`,
          e.jsx(n.code, { children: "SoundCloud" }),
...
improved if a `,
          ...
          ` attribute is provided and most 3rd party audio services
will include a `,
          e.jsx(n.code, { children: "title" }),
          " attribute in the embed code they provide. If the ",
          e.jsx(n.code, { children: "title" }),
          `
attribute is omitted from the embed code, a default `,
          e.jsx(n.code, { children: "title" }),
          ` will be added by the
`,
          e.jsx(n.code, { children: "AudioPlayer" }),
          " component, but it is recommended to include a custom ",
          e.jsx(n.code, { children: "title" }),
          ` that
...
that the audio player will be accessible. Besides setting the `,
          e.jsx(n.code, { children: "title" }),
          ` in the
embedded `,
          e.jsx(n.code, { children: "iframe" }),
          ", there are ",
          e.jsx(n.em, { children: "some ways" }),
          " we can reduce accessibility issues.",
        ],
      }),
      `
`,
...
`,
          e.jsx(n.li, {
            children: `The text in the heading, description and helper text element should be
relevant and related to the embedded audio player.`,
          }),
          `
`,
          e.jsx(n.li, {
            children: `The iframe title should describe in a few words the content of the embedded
audio.`,
          }),
          `
`,
          e.jsx(n.li, {
            children: `Consider using the description or helper text to add a link to a full
...
`,
      e.jsx(n.p, {
        children: `The following is an example iframe code for Libsyn that would go into the
embedCode prop.`,
      }),
      `
`,
...
`,
      e.jsx(n.p, {
        children: `The following is an example iframe code for SoundCloud that would go into the
embedCode prop.`,
      }),
      `
`,
...
`,
      e.jsx(n.p, {
        children: `The following is an example iframe code for Spotify that would go into the
embedCode prop.`,
      }),
      `
`,
...
`,
      ...
      `
`,
      e.jsx(j, { changelogData: b }),
    ],
  });
}
function v(o = {}) {
  const { wrapper: n } = { ...d(), ...o.components };
  return n ? e.jsx(n, { ...o, children: e.jsx(l, { ...o }) }) : l(o);
}
export { v as default };
