...
import { i as g } from "./iconVariables-Bcc5qynd.js";
const R = {
    title: "Components/Page Layout/SimpleGrid",
    component: m,
    argTypes: {
      className: { control: !1 },
      columns: { control: { min: 2, type: "number" } },
      gap: {
        control: { type: "select" },
  ...
  w = [];
for (const c in g) {
  const A = e.jsx(z, { name: g[c], size: "xxxlarge" }, c);
  w.push(A);
}
const i = { render: () => e.jsx(m, { columns: 5, children: w }) },
  d = {
    render: () =>
      e.jsxs(m, {
        columns: 6,
        children: [
          e.jsx(r, { src: a("smaller"), alt: "" }),
          e.jsx(r, { src: a("smaller"), alt: "" }),
          e.jsx(r, { src: a("smaller"), alt: "" }),
          e.jsx(r, { src: a("smaller"), alt: "" }),
          e.jsx(r, { src: a("smaller"), alt: "" }),
...
n.parameters = {
  ...
  render: args => <SimpleGrid {...args}>
      ...
      ...((h = (p = n.parameters) == null ? void 0 : p.docs) == null
        ? void 0
        : h.source),
    },
    description: {
      ...
      ...((x = (C = n.parameters) == null ? void 0 : C.docs) == null
        ? void 0
        : x.description),
    },
  },
...
i.parameters = {
  ...
  render: () => <SimpleGrid columns={5}>{icons}</SimpleGrid>
      ...
      ...((P = (I = i.parameters) == null ? void 0 : I.docs) == null
        ? void 0
        : P.source),
    },
  },
...
d.parameters = {
  ...
  render: () => <SimpleGrid columns={6}>
      ...
      ...((y = (f = d.parameters) == null ? void 0 : f.docs) == null
        ? void 0
        : y.source),
    },
  },
...
o.parameters = {
  ...
  render: () => <SimpleGrid columns={1}>
      ...
      ...((S = (H = o.parameters) == null ? void 0 : H.docs) == null
        ? void 0
        : S.source),
    },
  },
};
const N = ["WithControls", "IconExample", "ImageExample", "CardExample"],
  q = Object.freeze(
...
export { o as C, i as I, q as S, n as W, d as a };
