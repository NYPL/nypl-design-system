...
import {
  ...
  H as w,
  a as T,
} from "./TextInput.stories-BpW2xC1A.js";
import { C } from "./ComponentChangelogTable-Ck_3mwrR.js";
            ...
            children: [
              e.jsxs(t.tr, {
                children: [
                  ...
                  e.jsx(t.td, {
                    children: e.jsx(t.code, { children: "0.22.0" }),
                  }),
                ],
              }),
              e.jsxs(t.tr, {
...
`,
              e.jsx(n, {
                href: "#labelling-variations",
                target: "_self",
                children: "Labelling Variations",
              }),
              `
`,
            ],
...
`,
              e.jsx(n, {
                href: "#html-in-helper-text",
                target: "_self",
                children: "HTML in Helper Text",
              }),
              `
`,
            ],
...
information. For optimal accessibility, the `,
          e.jsx(t.code, { children: "labelText" }),
          ` property is a required
prop, regardless of the label visibility. Additionally, while the `,
          e.jsx(t.code, { children: "id" }),
          ` prop is
optional, a unique `,
          e.jsx(t.code, { children: "id" }),
          ` attribute is necessary for accessibility. If the prop
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          ` element which is accessible
via keyboard and screen reader. The `,
          e.jsx(t.code, { children: "aria-required" }),
          " and ",
          e.jsx(t.code, { children: "required" }),
          ` attributes are
set with the `,
          e.jsx(t.code, { children: "isRequired" }),
          " prop. The ",
          e.jsx(t.code, { children: "aria-disabled" }),
          " and ",
          e.jsx(t.code, { children: "disabled" }),
          ` attributes are
set with the `,
          e.jsx(t.code, { children: "isDisabled" }),
          " prop. The ",
          e.jsx(t.code, { children: "aria-invalid" }),
          " is set with the ",
...
required `,
          e.jsx(t.code, { children: "labelText" }),
          " value. Some components that use ",
          e.jsx(t.code, { children: "TextInput" }),
          ", like ",
          e.jsx(t.code, { children: "DatePicker" }),
          `,
give the `,
          e.jsx(t.code, { children: "<input>" }),
          " an ",
...
`,
      e.jsxs(t.p, {
        children: [
          "When the ",
          e.jsx(t.code, { children: "type" }),
          " prop is set to ",
          e.jsx(t.code, { children: '"textarea"' }),
          ", the ",
          e.jsx(t.code, { children: "<textarea>" }),
          ` element
is rendered instead of the `,
          e.jsx(t.code, { children: "<input>" }),
          ` element. This element follows all the same
...
`,
          e.jsx(t.li, {
            children: e.jsx(t.a, {
              ...
              rel: "nofollow",
              children: "MDN input: The Input (Form Input) element",
            }),
          }),
          `
`,
          e.jsx(t.li, {
            children: e.jsx(t.a, {
              ...
              rel: "nofollow",
              children: "MDN textarea: The Textarea element",
            }),
          }),
          `
`,
          e.jsx(t.li, {
            children: e.jsx(t.a, {
              href: "https://chakra-ui.com/docs/components/form/input",
              rel: "nofollow",
              children: "Chakra UI Input",
            }),
          }),
          `
`,
          e.jsx(t.li, {
            children: e.jsx(t.a, {
              href: "https://chakra-ui.com/docs/components/form/textarea",
              rel: "nofollow",
              children: "Chakra UI Textarea",
            }),
          }),
          `
`,
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          ` attribute is another tool that can be used to
improve accessibility. The `,
          e.jsx(t.code, { children: "autocomplete" }),
          ` attribute improves the browser's
...
`,
          e.jsx(t.code, { children: "TextInput" }),
          ` component provides a few methods for incorporating the
`,
          e.jsx(t.code, { children: "autocomplete" }),
          " attribute.",
        ],
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          e.jsx(t.code, { children: "type" }),
          " prop is set to ",
          e.jsx(t.code, { children: '"email"' }),
          ", ",
          e.jsx(t.code, { children: '"tel"' }),
          ", or ",
          e.jsx(t.code, { children: '"url"' }),
          `, the component will
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          e.jsx(t.code, { children: "autocomplete" }),
          `
attribute manually. When the `,
          e.jsx(t.code, { children: "autoComplete" }),
          ` prop is set, its value will be used
to set the `,
          e.jsx(t.code, { children: "autocomplete" }),
          ` attribute on the input field. Furthermore, if the
`,
          e.jsx(t.code, { children: "type" }),
          " prop is set to ",
          e.jsx(t.code, { children: '"email"' }),
...
`,
          e.jsx(t.code, { children: "autoComplete" }),
          ` prop will override the value automatically added by the
component.`,
        ],
      }),
      `
`,
      e.jsxs(t.p, {
        children: [
          "Using the ",
          e.jsx(t.code, { children: "autoComplete" }),
          ` prop can be helpful when it is necessary to set
`,
          e.jsx(t.code, { children: "autocomplete" }),
          ` attribute values that are not automatically added by the
component or when privacy is a concern. For example, setting the `,
          e.jsx(t.code, { children: "autoComplete" }),
          `
prop to `,
          e.jsx(t.code, { children: '"off"' }),
          ` will disable the native browser based autocomplete
functionality.`,
        ],
      }),
      `
...
`,
          e.jsx(t.li, {
            children: e.jsx(t.a, {
              ...
              rel: "nofollow",
              children: "MDN HTML attribute: Autocomplete",
            }),
          }),
          `
`,
...
`,
      e.jsxs(t.p, {
        children: [
          "A TextInput can be rendered with or without visible labels. When ",
          e.jsx(t.code, { children: "showLabel" }),
          ` is
set to `,
          ...
          ", an ",
          e.jsx(t.code, { children: "aria-label" }),
          ` attribute is added to the input/textarea element
to maintain accessibility. If the component needs to be required, the
`,
          e.jsx(t.code, { children: "showRequiredLabel" }),
          ` prop can be used to show or hide the "(required)" text
within the `,
          e.jsx(t.code, { children: "label" }),
          " element.",
        ],
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          " prop to ",
          e.jsx(t.code, { children: "true" }),
          ` to render a button that clears the input
      ...
      e.jsx(o, {
        ...
        content: e.jsxs(e.Fragment, {
          children: [
            ...
            " The clear button works best when the `TextInput` is used as an uncontrolled component.",
          ],
        }),
        type: "recommendation",
      }),
      ...
      e.jsx(o, {
        content: e.jsxs(e.Fragment, {
          children: [
            ...
            " The clear button will not render when...",
            e.jsxs(u, {
              noStyling: !0,
              mb: "0",
              children: [
                e.jsx(t.li, {
                  children: '- the `type` prop is set to `"textarea"`',
                }),
                e.jsx(t.li, {
                  children: "- the `isDisabled` prop is set to `true`",
                }),
              ],
            }),
          ],
...
`,
      e.jsx(t.h3, {
        id: "controlled-isclearablecallback-example",
        children: "Controlled isClearableCallback Example",
      }),
      `
`,
      e.jsxs(t.p, {
        children: [
          "A ",
          e.jsx(t.code, { children: "TextInput" }),
          " component is controlled when the ",
          e.jsx(t.code, { children: "value" }),
          " and ",
          e.jsx(t.code, { children: "onChange" }),
          ` props are
set. For a controlled component, the `,
...
`,
      e.jsx(t.h3, {
        id: "focus-ref-management",
        children: "Focus Ref Management",
      }),
      `
`,
      e.jsxs(t.p, {
...
`,
          e.jsx(t.a, {
            href: "https://nypl.org/research/research-catalog/account",
            rel: "nofollow",
            children: "My Account",
          }),
          ` page (you have
...
`,
          e.jsx(t.code, { children: "TextInput" }),
          ` component's internal focus management. This was apparent through the
...
`,
      e.jsxs(t.p, {
        children: [
          "The ",
          e.jsx(t.code, { children: "TextInput" }),
          ` component keeps track of it's own ref for clearing the input
field. If your app needs to manage focus separately, you should still pass a ref
to the `,
          e.jsx(t.code, { children: "TextInput" }),
          " component as you normally would with a React component.",
        ],
      }),
      `
`,
      e.jsx(t.p, {
        children: `In the following example, when the user clicks on the "Edit" button, focus needs
...
`,
      e.jsxs(t.p, {
        children: [
          "The ",
          e.jsx(t.code, { children: "TextInput" }),
          ` component can be configured to render a number input by setting
`,
          e.jsx(t.code, { children: 'type="number"' }),
          ". In this input type, the ",
          e.jsx(t.code, { children: "maxLength" }),
          ` prop does not restrict the
length of the number that is passed to the input. This is the expected behavior
as the native HTML input and `,
          e.jsx(t.code, { children: "maxlength" }),
          " attribute behave this way.",
        ],
      }),
      `
`,
      e.jsxs(t.p, {
        children: [
          ...
          ` props do restrict the value of the number
input that is passed. This can be seen by using the up and down arrows to
increase or decrease the number value, respectively. However, if the `,
          e.jsx(t.code, { children: "max" }),
          ` prop
...
`,
      e.jsxs(t.p, {
        children: [
          "If the ",
          e.jsx(t.code, { children: "min" }),
          " prop value is greater than the ",
          e.jsx(t.code, { children: "max" }),
          ` prop value, it will trigger
the invalid state.`,
        ],
      }),
      `
...
`,
      e.jsx(t.h3, {
        id: "alternate-number-pattern",
        children: "Alternate Number Pattern",
      }),
      `
`,
      e.jsxs(t.p, {
...
`,
          ...
          ` props. Together, these props can be set to define how
many digits and what characters are allowed. For example, if a zip code is
required, the `,
          e.jsx(t.code, { children: "maxLength" }),
          ' prop can be set to "5" and the ',
          e.jsx(t.code, { children: "pattern" }),
          ` prop can be
set to `,
          e.jsx(t.code, { children: '"[0-9]\\*"' }),
          ` to allow only numbers to be entered and limit the number of
characters to 5.`,
        ],
      }),
      `
`,
      e.jsxs(t.p, {
        children: [
          "Note that the ",
          e.jsx(t.code, { children: "type" }),
          ` prop is not set to "number" in this example and that the
...
`,
      e.jsxs(t.p, {
        children: [
          "HTML can be passed into the ",
          e.jsx(t.code, { children: "helperText" }),
          " prop as a string or HTML.",
        ],
      }),
      `
`,
...
`,
      e.jsxs(t.p, {
        children: [
          "The TextInput component includes a multiline ",
          e.jsx(t.code, { children: "textarea" }),
          ` form field. To render a
`,
          e.jsx(t.code, { children: "textarea" }),
          " element, pass ",
          e.jsx(t.code, { children: '"textarea"' }),
          " for the ",
          e.jsx(t.code, { children: "type" }),
          ` prop. All the variations
described above are available for the `,
          e.jsx(t.code, { children: "textarea" }),
          " option.",
        ],
      }),
...
`,
      ...
      `
`,
      e.jsx(C, { changelogData: I }),
    ],
  });
}
function F(i = {}) {
  const { wrapper: t } = { ...d(), ...i.components };
  return t ? e.jsx(t, { ...i, children: e.jsx(c, { ...i }) }) : c(i);
}
export { F as default };
