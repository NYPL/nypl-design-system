...
`,
              e.jsx(t, {
                href: "#visited-state-patterns",
                target: "_self",
                children: "Visited State Patterns",
              }),
              `
`,
            ],
...
`,
              e.jsx(t, {
                href: "#anchor-element-rendering",
                target: "_self",
                children: "Anchor Element Rendering",
              }),
              `
`,
            ],
...
`,
              e.jsx(t, {
                href: "#link-with-routers",
                target: "_self",
                children: "Link with Routers",
              }),
              `
`,
            ],
...
`,
          e.jsx(n.code, { children: "Link" }),
          " component should be used for navigation. If an ",
          e.jsx(n.code, { children: "onClick" }),
          ` action is
required, a `,
          e.jsx(n.code, { children: "Button" }),
          ` component should be used instead. In simple terms, a link
...
`,
          ...
          " prop to the ",
          e.jsx(n.code, { children: "Link" }),
          ` component because there are some very specific use
cases within NYPL web apps that require this. Additionally, the `,
          e.jsx(n.code, { children: "onclick" }),
          `
...
Having said that, `,
          e.jsxs(n.strong, {
            children: [
              "you are highly urged to not use the ",
              e.jsx(n.code, { children: "onClick" }),
              ` prop unless
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: '"external"' }),
          " variant of the ",
          e.jsx(n.code, { children: "Link" }),
          " component includes ",
          e.jsx(n.code, { children: '"screen reader only"' }),
          `
descriptive text to clarify that the link will open in a new tab/window.
Additionally it renders with the `,
          e.jsx(n.code, { children: "rel" }),
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          e.jsx(n.code, { children: "screenreaderOnlyText" }),
          ` prop that can be used to
...
`,
      e.jsxs(n.p, {
        children: [
          "For details about NYPL link patterns, refer to the ",
          e.jsx(n.a, {
            href: "/?path=/docs/accessibility-guide-links--docs",
            children: `Links Accessibility
Guide`,
          }),
          ".",
        ],
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://www.w3.org/TR/wai-aria-practices-1.1/examples/link/link.html",
              rel: "nofollow",
              children: "W3C WAI Link Examples",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://usability.yale.edu/web-accessibility/articles/links",
              rel: "nofollow",
              children: "Yale Usability & Web Accessibility Links",
            }),
          }),
          `
`,
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "IANA: Link Relation Types",
            }),
          }),
          `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          e.jsx(n.code, { children: "Link" }),
          " component by default will render ",
          e.jsx(n.code, { children: "visited" }),
          `
state styles when a link's `,
          e.jsx(n.code, { children: "href" }),
          ` value matches an entry in a browser's history
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "visited" }),
          ` state styles are most relevant for links within a standard block
of text, but the `,
          e.jsx(n.code, { children: "visited" }),
          ` state color change may not be applicable for all
...
`,
      e.jsxs(n.p, {
        children: [
          "In cases where the ",
          e.jsx(n.code, { children: "visited" }),
          " state styles are not appropriate, the ",
          e.jsx(n.code, { children: "Link" }),
          `
component's `,
          e.jsx(n.code, { children: "hasVisitedState" }),
          " prop should be set to ",
          e.jsx(n.code, { children: "false" }),
          `. When this is done,
the `,
          e.jsx(n.code, { children: "Link" }),
          " component will not render the default purple ",
          e.jsx(n.code, { children: "visited" }),
          ` state color
after a user has clicked on a text link. Rather, the `,
          e.jsx(n.code, { children: "Link" }),
          ` component will use
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "Link" }),
          " component offers multiple variants for differing UX situations.",
        ],
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          ...
          " and ",
          e.jsx(n.code, { children: "action" }),
          ` variants for text links that sit within a block
...
`,
      e.jsxs(n.p, {
        children: [
          "Use the ",
          e.jsx(n.code, { children: "external" }),
          ` variant for text links that sit within a block of plain
...
`,
      e.jsxs(n.p, {
        children: [
          "Use the ",
          e.jsx(n.code, { children: "standalone" }),
          ` variant for text links that sit alone within the page
content area. For example, a Read More link at the end of a short description or
a View In Catalog link on a book detail page. The `,
          e.jsx(n.code, { children: "backawards" }),
          " and ",
          e.jsx(n.code, { children: "forwards" }),
          `
...
search results set. Please note that the actual `,
          e.jsx(n.code, { children: "button" }),
          ` variant has been
deprecated.`,
        ],
...
like buttons. Refer to the `,
          e.jsx(t, {
            href: "#accessibility",
            target: "_self",
            children: "Accessibility",
          }),
          " section above for clarification.",
        ],
      }),
      `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          " as part of the link, make sure that the ",
          e.jsx(n.code, { children: "Link" }),
          ` component
wraps the `,
          e.jsx(n.code, { children: "Icon" }),
          ". Use ",
          e.jsx(n.code, { children: 'type="action"' }),
          ` to apply appropriate styling to
...
`,
      e.jsx(n.h2, {
        id: "ds-v3-breaking-change",
        children: "DS v3 Breaking Change",
      }),
      `
`,
      e.jsxs(n.p, {
...
`,
      e.jsxs(n.p, {
        children: [
          "In DS 3.0.0+, this pattern is no longer supported. The ",
          e.jsx(n.code, { children: "href" }),
          ` prop should be
passed to render an accessible and valid link. There are cases where the `,
          e.jsx(n.code, { children: "href" }),
          `
...
`,
      e.jsxs(n.p, {
        children: [
          "When it comes to routing, the patterns set in ",
          e.jsxs(n.a, {
            href: "https://chakra-ui.com/docs/components/link",
            rel: "nofollow",
            children: ["Chakra's ", e.jsx(n.code, { children: "Link" })],
          }),
          `
component can also be used in the Design System's `,
          e.jsx(n.code, { children: "Link" }),
          ` component. This means
that the routing library's component should be passed to the DS `,
          e.jsx(n.code, { children: "Link" }),
          ` component
in the `,
          e.jsx(n.code, { children: "as" }),
          " prop. By default, an anchor ",
          e.jsx(n.code, { children: "<a>" }),
          " element is rendered.",
        ],
      }),
...
`,
      e.jsxs(n.p, {
        children: [
          "The recommended pattern is to pass the React Router's ",
          e.jsx(n.code, { children: "Link" }),
          ` component in the
`,
          e.jsx(n.code, { children: "as" }),
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          `: NYPL uses Next.js for their web applications so while the
...
`,
      e.jsxs(n.p, {
        children: [
          "In Next.js 13+, their ",
          e.jsx(n.code, { children: "Link" }),
          ` component renders an anchor element and this
causes a conflict with the Design System's 2.X `,
          e.jsx(n.code, { children: "Link" }),
          ` component which also
...
the `,
          e.jsx(n.code, { children: "legacyBehavior" }),
          " prop to the Next.js ",
          e.jsx(n.code, { children: "Link" }),
          ` component along with the
`,
          e.jsx(n.code, { children: "passHref" }),
          " prop.",
        ],
      }),
      `
