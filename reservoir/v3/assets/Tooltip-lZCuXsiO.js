...
import {
  ...
  P as b,
  d as y,
} from "./Tooltip.stories-Cl2ACyki.js";
...
`,
      e.jsx(n.p, {
        children: `A brief, informative message that appears when a user hovers or focuses on an
element.`,
      }),
      `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          ` component is implemented with Chakra UI and Chakra handles the
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "Tooltip" }),
          ` component is accessible via keyboard. The color contrast between
...
`,
      e.jsx(n.p, {
        children: `If a tooltip is associated with a form control (text, radio, checkbox, etc),
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "MDN ARIA: tooltip role",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://chakra-ui.com/docs/components/overlay/tooltip",
              rel: "nofollow",
              children: "Chakra UI Tooltip",
            }),
          }),
          `
`,
...
`,
      e.jsx(n.p, {
        children: `Tooltips are often misunderstood and therefore not used correctly. To implement
...
`,
          e.jsxs(n.li, {
            children: [
              e.jsx(n.strong, {
                children: "Only interactive elements should trigger tooltips.",
              }),
              ` (ex. form fields, links,
etc.)`,
            ],
          }),
          `
`,
          e.jsx(n.li, {
            children: `Tooltips should directly describe the UI control that triggers them. (i.e. do
...
`,
          e.jsx(n.li, {
            children: `Do not put essential information in tooltips. (i.e. always assume tooltip text
may never be read)`,
          }),
          `
`,
...
`,
          e.jsx(n.li, {
            children: "Do not add interactive content. (no links or buttons)",
          }),
          `
`,
        ],
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "Tooltips in the time of WCAG 2.1",
            }),
          }),
          `
`,
...
`,
      e.jsx(n.h3, {
        id: "tooltips-on-form-options",
        children: "Tooltips on form options",
      }),
      `
`,
      e.jsxs(n.ul, {
...
`,
          e.jsxs(n.li, {
            children: [
              "For correctly positioning, use the ",
              e.jsx(n.code, { children: "shouldWrapChildren" }),
              ` prop when adding a
tooltip to the `,
...
`,
          e.jsxs(n.li, {
            children: [
              "Using ",
              e.jsx(n.code, { children: "shouldWrapChildren" }),
              ` ensures that the size of the visually hidden element is
...
`,
      e.jsx(n.h3, {
        id: "tooltip-on-image-component",
        children: "Tooltip on Image component",
      }),
      `
`,
      e.jsxs(n.ul, {
...
`,
          e.jsxs(n.li, {
            children: [
              "Do not use the ",
              e.jsx(n.code, { children: "shouldWrapChildren" }),
              " prop when adding a tooltip to an ",
...
`,
          e.jsxs(n.li, {
            children: [
              "This combination of props will cause the ",
              e.jsx(n.code, { children: "Image" }),
              " component's ",
...
`,
      e.jsx(n.h3, {
        id: "tooltip-on-linked-icon",
        children: "Tooltip on Linked Icon",
      }),
      `
`,
      e.jsx(o, { of: m }),
...
`,
      e.jsx(n.h3, {
        id: "icon-and-image-content",
        children: "Icon and Image Content",
      }),
      `
`,
      e.jsxs(n.ul, {
...
`,
          e.jsxs(n.li, {
            children: [
              "A tooltip can be disabled by passing the ",
...
`,
          e.jsxs(n.li, {
            children: [
              ...
              ` prop can be used to adjust the tooltip's location relative to
its children: `,
              e.jsx(n.code, { children: '"top"' }),
              ", ",
              e.jsx(n.code, { children: '"bottom"' }),
              ", ",
              e.jsx(n.code, { children: '"left"' }),
              ", or ",
              e.jsx(n.code, { children: '"right"' }),
              ".",
            ],
          }),
          `
...
`,
          e.jsxs(n.li, {
            children: [
              ...
              ` prop sets the XY coordinate position of the tooltip in relation
...
`,
          e.jsxs(n.li, {
            children: [
              "The values of the ",
              e.jsx(n.code, { children: "offset" }),
              ` prop are static pixel values, so make sure to check
...
`,
          e.jsxs(n.li, {
            children: [
              ...
              " recommended to set custom ",
              e.jsx(n.code, { children: "offset" }),
              ` values unless there are
