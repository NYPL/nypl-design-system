import { u as l, j as e, M as r, L as t, S as i } from "./iframe-D93LbwGv.js";
function o(s) {
  const n = {
    a: "a",
    code: "code",
  ...
  return e.jsxs(e.Fragment, {
    children: [
      e.jsx(r, { title: "Accessibility Guide/Sticky Elements" }),
      `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          "Sticky elements (",
          e.jsx(n.code, { children: "position: sticky" }),
          ") switch between relative and fixed position. They move with the viewport as the user scrolls, so they are visible until they hit a given breakpoint.",
        ],
      }),
      `
`,
      e.jsx(n.p, {
        children: `Avoid sticky elements in general. The most common use case, a sticky header, is only useful when users will be repeatedly accessing the menu and scrolling through multiple pages.
...
`,
      e.jsx(n.p, {
        children: `Additionally, sticky headers can obscure other elements on the page. For large menus that will cover parts of the page, consider an accordion or just making it fixed. This keeps the header in place
...
`,
      e.jsx(n.p, {
        children: `Sticky elements should be used only for critical information that needs to remain visible, or to allow a continuous process for the user. For the new Digital Collections site, we chose to accept the shortcomings of the sticky header
...
`,
          e.jsx(n.li, {
            children: "Does it break when users zoom in on mobile devices?",
          }),
          `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          "The solution presented below only addresses the ",
          e.jsx(n.em, { children: "last" }),
          ` of these concerns: preventing a sticky
...
To return to the top of the page, keyboard users tab backwards. If the header on a page uses `,
          e.jsx(n.code, { children: "position: sticky" }),
          `,
...
`,
      e.jsxs(n.p, {
        children: [
          "The apparent solution would be using ",
          e.jsx(n.code, { children: "scroll-margin-top" }),
          ` to snap-scroll the viewport to wherever the focused
...
`,
      e.jsx(n.p, {
        children: `Instead, this approach uses a combination of CSS, HTML, and Typescript to check whether a focused element needs a sticky margin by
...
`,
      e.jsxs(n.p, {
        children: [
          "This approach was first implemented with the Digital Collections header, using a ",
          e.jsx(n.a, {
            href: "https://github.com/NYPL/digital-collections/blob/main/src/hooks/useScrolled.ts",
            rel: "nofollow",
...
`,
          e.jsxs(n.li, {
            children: [
              "HTML data attributes on the sticky element, ex. ",
              e.jsx(n.code, {
                children: "<header data-sticky-header> ... </header>",
              }),
            ],
          }),
          `
...
`,
      e.jsxs(n.p, {
        children: [
          e.jsx(n.code, { children: "applyStickyMargin()" }),
          ` contains most of the logic, namely calculating boundary interactions
...
`,
      e.jsxs(n.p, {
        children: [
          "For the complete code and more information, check out the ",
          e.jsx(n.a, {
            href: "https://github.com/NYPL/digital-collections/blob/main/src/hooks/useScrolled.ts",
            rel: "nofollow",
            children: "hook",
          }),
          " and its behavior on the ",
          e.jsx(n.a, {
            href: "https://github.com/NYPL/digital-collections",
            rel: "nofollow",
            children: "Digital Collections site",
          }),
          ".",
        ],
      }),
...
`,
          e.jsxs(n.li, {
            children: [
              e.jsx(n.a, {
                href: "https://www.tpgi.com/prevent-focused-elements-from-being-obscured-by-sticky-headers/",
                rel: "nofollow",
                children:
                  "TPGi: Prevent focused elements from being obscured by sticky headers",
              }),
              `
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://www.smashingmagazine.com/2023/05/sticky-menus-ux-guidelines/",
              rel: "nofollow",
              children: "Designing Sticky Menus: UX Guidelines",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://technology.blog.gov.uk/2018/05/21/sticky-elements-functionality-and-accessibility-testing/",
              rel: "nofollow",
              children:
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://design.gs.com/patterns/sticky-elements",
              rel: "nofollow",
              children: "Sticky Elements",
            }),
          }),
          `
`,
