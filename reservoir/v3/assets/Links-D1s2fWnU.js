import { u as a, j as e, M as o, L as t } from "./iframe-D93LbwGv.js";
function s(i) {
  const n = {
    a: "a",
    code: "code",
  ...
  return e.jsxs(e.Fragment, {
    children: [
      e.jsx(o, { title: "Accessibility Guide/Links" }),
      `
`,
...
`,
      e.jsx(n.p, {
        children: `There is no explicit rule in the accessibility space that dictates using
...
`,
      e.jsx(n.p, {
        children: `From an accessibility standpoint, the most important thing is the ability to
...
`,
      e.jsx(n.p, {
        children: `Color can be used, though it cannot be the ONLY method of distinguishing a link
...
`,
      e.jsx(n.p, {
        children: `As an example, if you have a link within a block of non-linked text, then you
...
`,
      e.jsx(n.p, {
        children: `For links that occur outside the context of a block of non-linked text, then
...
`,
      e.jsx(n.p, {
        children: `Text links can be presented in three general scenarios: in a heading, mixed
...
`,
      e.jsx(n.p, {
        children: `In cases where an underline for a text link is necessary, the 1px width and
...
the `,
          e.jsx(n.code, { children: "link primary" }),
          ` color and the default state of the link text SHOULD NOT be
underlined. The link text hover state SHOULD be rendered using the `,
          e.jsx(n.code, { children: "link secondary" }),
          ` color and MUST be underlined. Applying a link to a full heading is
...
be rendered using the `,
          e.jsx(n.code, { children: "link primary" }),
          ` color and the default state of the link
text MUST be underlined. The link text hover state SHOULD be rendered using the
`,
          e.jsx(n.code, { children: "link secondary" }),
          " color and MUST be underlined. ",
          e.jsx(n.strong, {
            children: `While this is acceptable,
...
`,
      e.jsxs(n.p, {
        children: [
          `When a body text link sits within a block of plain (unlinked) text — a
paragraph, a single sentence, or even just a few words — the link text
SHOULD be rendered using the `,
          e.jsx(n.code, { children: "link primary" }),
          ` color and the default state of the
...
`,
      e.jsxs(n.p, {
        children: [
          `When a body text link sits by itself within the page content area — a Read
More link at the end of a short description, a View In Catalog link on a book
detail page — the link text SHOULD be rendered using the `,
          e.jsx(n.code, { children: "link primary" }),
          `
...
`,
          e.jsx(n.code, { children: "link primary" }),
          ` color. The link text hover state SHOULD be rendered using
the `,
          e.jsx(n.code, { children: "link secondary" }),
          " color and MUST be underlined.",
        ],
...
`,
      e.jsx(n.h3, {
        id: "tips-for-writing-standalone-link-text",
        children: "Tips for Writing Standalone Link Text",
      }),
      `
`,
      e.jsx(n.p, {
        children: `Avoid using a URL as a text link. URLs, especially long ones, may cause reading
difficulty for both humans and screen readers.`,
      }),
      `
`,
      e.jsx(n.p, {
        children: `Keep link text as short as possible. Instead of "you can contact us," use
"contact us."`,
      }),
      `
`,
      e.jsx(n.p, {
        children: `Link should have at least one full word (two is better). Avoid using a single
letter or a symbol for a link as it lacks context and is difficult to click on.`,
      }),
      `
`,
      e.jsx(n.h3, {
        id: "acceptable-style-deviations",
        children: "Acceptable Style Deviations",
      }),
      `
`,
      e.jsx(n.p, {
...
`,
      e.jsx(n.p, {
        children: `Links in main navigation areas or in a common list format can be presented
...
`,
      e.jsx(n.p, {
        children: `Links on colored backgrounds will almost always run into problems with color
...
`,
      e.jsx(n.p, {
        children: `In situations when the link color is not used and the link color is changed to
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "WCAG Success Criterion 1.4.1 Use of Color",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "WebAIM: Links and Hypertext",
            }),
          }),
          `
`,
