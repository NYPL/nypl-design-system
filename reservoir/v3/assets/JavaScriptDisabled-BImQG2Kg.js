import{u as r,j as e,M as a}from"./iframe-CFLVJZOZ.js";function n(i){const t={h1:"h1",p:"p",...r(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(a,{title:"Style Guide/Filtering/JavaScript disabled"}),`
`,e.jsx(t.h1,{id:"filtering-when-javascript-is-disabled",children:"Filtering when JavaScript is disabled"}),`
`,e.jsx(t.p,{children:`Our engineering implementation goal is to reach parity of outcomes instead of
...
`,e.jsx(t.p,{children:`At a base default level, the filter UIs should include “apply” or “submit”
...
architecture.`}),`
`,e.jsx(t.p,{children:`Additionally, text should be updated to reflect the number of results available
...
`,e.jsx(t.p,{children:`When JavaScript is disabled, it is generally in desktop browsers and rarely in
mobile browsers. Still, in order to support a sensible default for the mobile
filter component, the popup should work without JavaScript.`})]})}function l(i={}){const{wrapper:t}={...r(),...i.components};return t?e.jsx(t,{...i,children:e.jsx(n,{...i})}):n(i)}export{l as default};
