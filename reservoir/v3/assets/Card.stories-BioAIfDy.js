...
const Se = "" + new URL("noImage-B7pFLlou.png", import.meta.url).href,
  { action: A } = __STORYBOOK_MODULE_ACTIONS__,
  Ne = {
    ...
    argTypes: {
      ...
      "imageProps.caption": { control: !1 },
      "imageProps.component": { control: !1 },
      "imageProps.credit": { control: !1 },
      "imageProps.fallbackSrc": { control: !1 },
      "imageProps.isAtEnd": { table: { defaultValue: { summary: "false" } } },
      "imageProps.isLazy": { table: { defaultValue: { summary: "false" } } },
      "imageProps.onError": { control: !1 },
      "imageProps.size": { table: { defaultValue: { summary: "default" } } },
      "imageProps.src": { table: { defaultValue: { summary: "" } } },
      isAlignedRightActions: { table: { defaultValue: { summary: "false" } } },
      isBordered: { table: { defaultValue: { summary: "false" } } },
      isCentered: { table: { defaultValue: { summary: "false" } } },
      layout: {
        control: { type: "select" },
        options: we,
  ...
  d = {
    args: {
      ...
      "imageProps.caption": void 0,
      "imageProps.component": void 0,
      "imageProps.credit": void 0,
      "imageProps.isAtEnd": !1,
      "imageProps.isLazy": !0,
      "imageProps.size": "default",
      "imageProps.src": t("smaller"),
      isAlignedRightActions: !1,
      isBordered: !1,
      isCentered: !1,
      layout: "row",
      mainActionLink: void 0,
      styles: void 0,
    },
    render: (n) =>
      e.jsxs(a, {
        ...
        id: n.id,
        imageProps: {
          alt: n["imageProps.alt"],
          aspectRatio: n["imageProps.aspectRatio"],
          component: n["imageProps.component"],
          id: "card-image-id",
          isAtEnd: n["imageProps.isAtEnd"],
          isLazy: n["imageProps.isLazy"],
          size: n["imageProps.size"],
          src: n["imageProps.src"],
        },
        isAlignedRightActions: n.isAlignedRightActions,
        isBordered: n.isBordered,
        isCentered: n.isCentered,
        layout: n.layout,
        mainActionLink: n.mainActionLink,
        children: [
          e.jsx(i, {
            level: "h3",
            id: "main-heading1",
          ...
          e.jsx(r, {
            children:
              "Vestibulum id ligula porta felis euismod semper. Nulla vitae elit libero, a pharetra augue. Nullam quis risus eget urna mollis ornare vel eu leo. Nulla vitae elit libero, a pharetra augue.",
          }),
          e.jsxs(o, {
            topBorder: !0,
            bottomBorder: !0,
          ...
          e.jsxs(o, {
            children: [
              e.jsx(s, { href: "#", children: "#hash1" }),
              ",",
              e.jsx(s, { href: "#", children: "#hash2" }),
              ",",
              e.jsx(s, { href: "#", children: "#hash3" }),
            ],
          }),
        ],
      }),
          ...
          e.jsxs(a, {
            ...
            children: [
              e.jsx(i, {
                ...
                id: "row-heading1",
                size: "heading6",
                children: "Image on Left (default)",
              }),
              e.jsx(r, {
                children:
          ...
          e.jsxs(a, {
            ...
            children: [
              e.jsx(i, {
                ...
                children: "Extra Extra Small Image",
              }),
              e.jsx(r, {
                children:
                  "Vestibulum id ligula porta felis euismod semper. Nulla vitae elit libero, a pharetra augue.",
  ...
  h = {
    render: () =>
      e.jsxs(a, {
        imageProps: {
          alt: "Alt text",
          component: e.jsx(He, { alt: "Alt text", src: t() }),
        },
        children: [
          e.jsx(i, {
            level: "h3",
            ...
            children: "Card Component with Custom Image Component",
          }),
          e.jsx(r, {
            children:
              "Nulla vitae elit libero, a pharetra augue. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean lacinia bibendum nulla sed consectetur. Vestibulum id ligula porta felis euismod semper. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Sed posuere consectetur est at lobortis.",
          }),
        ],
      }),
  },
    ...
    render: () =>
      e.jsxs(a, {
        imageProps: {
          alt: "Alt text",
          fallbackSrc: Se,
          onError: (n) => console.log("Card fallback image loaded"),
          src: "foobar.jpg",
        },
        children: [
          e.jsx(i, {
            ...
            size: "heading5",
            subtitle: "Subtitle on the card",
            children: "Card component displaying a fallback image",
          }),
          e.jsx(r, {
            children:
              "Nulla vitae elit libero, a pharetra augue. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean lacinia bibendum nulla sed consectetur. Vestibulum id ligula porta felis euismod semper. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Sed posuere consectetur est at lobortis.",
          ...
          e.jsxs(o, {
            children: [
              e.jsx(s, { type: "button", href: "#", children: "Reserve" }),
              e.jsx(s, {
                href: "#url",
                type: "forwards",
  ...
  b = {
    render: () =>
      e.jsxs(a, {
        imageProps: { alt: "Alt text", aspectRatio: "twoByOne", src: t() },
        children: [
          e.jsx(i, {
            level: "h3",
            id: "link-heading1",
            size: "heading5",
            subtitle: e.jsxs(e.Fragment, {
              children: [
                "Go to NYPL ",
                e.jsx(s, { href: "http://nypl.org", children: "home page" }),
                ".",
              ],
            }),
            url: "http://nypl.org",
            children: "Go to NYPL home page.",
          }),
          e.jsx(r, {
            children:
              "This entire `Card` component is clickable, but the links below are still accessible by tabbing through the `Card` and pressing `enter` or clicking with a mouse.",
          }),
          e.jsxs(o, {
            children: [
              e.jsx(s, { href: "#", type: "button", children: "Button" }),
              e.jsx(s, { href: "#", type: "forwards", children: "Other link" }),
            ],
          }),
        ],
      }),
      ...
      e.jsxs(l, {
        ...
        children: [
          e.jsxs(a, {
            isBordered: !0,
            mainActionLink:
              "https://nypl-ds-test-app.vercel.app/fullPages/blog/lunar-new-year#above-header-notification",
            children: [
              e.jsx(i, {
                level: "h3",
                overline: "Example",
                size: "heading6",
                children: "Lunar New Year Blog",
              }),
              e.jsx(r, {
                children:
                  "A basic blog post, including text chracters outside a standard Western font-set.",
              }),
            ],
          }),
          e.jsxs(a, {
            isBordered: !0,
            mainActionLink:
              "https://nypl-ds-test-app.vercel.app/fullPages/blog/doc-chat-forty-two#above-header-notification",
            children: [
              e.jsx(i, {
                level: "h3",
                overline: "Example",
                size: "heading6",
                children: "Doc Chat Forty-Two Blog",
              }),
              e.jsx(r, {
                children: "A blog post with an array of components.",
              }),
            ],
          }),
          e.jsxs(a, {
            isBordered: !0,
            mainActionLink:
              "https://nypl-ds-test-app.vercel.app/fullPages/homepage#above-header-notification",
            children: [
              e.jsx(i, {
                level: "h3",
                overline: "Example",
              ...
              e.jsx(r, {
                children: "A layout to mimic a basic homepage structure.",
              }),
            ],
          }),
          e.jsxs(a, {
            isBordered: !0,
            mainActionLink:
              "https://nypl-ds-test-app.vercel.app/fullPages/library-registry#above-header-notification",
            children: [
              e.jsx(i, {
                level: "h3",
                overline: "Example",
                size: "heading6",
                children: "Library Registry Interface",
              }),
              e.jsx(r, {
                children: "A POC for the Library Registry admin tools.",
              }),
            ],
          }),
          e.jsxs(a, {
...
function Be() {
  const [n, Le] = H.useState([0, 0]),
    k = H.useRef(null),
    w = () => {
      if (k.current) {
        const S = k.current.children[0],
          Ae = S.offsetHeight * 1.01,
          ke = S.offsetWidth * 0.4;
        Le([-ke, -Ae]);
      }
    };
  return (
      ...
      children: e.jsxs(a, {
        ...
        children: [
          e.jsx(i, {
            ...
            size: "heading5",
            subtitle: "Some other subtitle.",
            children: "Tooltip displays over me",
          }),
          e.jsxs(r, {
            children: [
              "This entire `Card` component is clickable, but the links below are still accessible by tabbing through the `Card` and pressing `enter` or clicking with a mouse.",
              e.jsx("br", {}),
              e.jsx(N, {
                content: "Tooltippable",
                children: "Tooltippable text",
              }),
            ],
          }),
          e.jsxs(o, {
...
const y = { name: "Full-Click With Tooltip", render: () => e.jsx(Be, {}) },
  f = {
    render: () =>
      e.jsxs(a, {
        imageProps: {
            ...
            children: [
              e.jsxs(a, {
                ...
                children: [
                  ...
                  e.jsx(r, {
                    children:
                      "Vestibulum id ligula porta felis euismod semper. Nulla vitae elit libero, a pharetra augue. Nulla vitae elit libero, a pharetra augue. Praesent commodo cursus magna, vel scelerisque nisl.",
                  }),
                ],
              }),
              e.jsxs(a, {
...
d.parameters = {
  ...
  parameters: {
    ...
    jest: ["Card.test.tsx"]
      ...
      ...((I = (R = d.parameters) == null ? void 0 : R.docs) == null
        ? void 0
        : I.source),
    },
    description: {
      ...
      ...((O = (q = d.parameters) == null ? void 0 : q.docs) == null
        ? void 0
        : O.description),
    },
  },
...
c.parameters = {
  ...
  render: () => <SimpleGrid columns={2}>
      ...
      ...((T = (E = c.parameters) == null ? void 0 : E.docs) == null
        ? void 0
        : T.source),
    },
  },
...
m.parameters = {
  ...
  render: () => <SimpleGrid columns={1}>
      ...
      ...((G = (M = m.parameters) == null ? void 0 : M.docs) == null
        ? void 0
        : G.source),
    },
  },
...
g.parameters = {
  ...
  render: () => <SimpleGrid columns={1}>
      ...
      ...((D = (Y = g.parameters) == null ? void 0 : Y.docs) == null
        ? void 0
        : D.source),
    },
  },
...
p.parameters = {
  ...
  render: () => <SimpleGrid columns={1}>
      ...
      ...((J = (U = p.parameters) == null ? void 0 : U.docs) == null
        ? void 0
        : J.source),
    },
  },
...
h.parameters = {
  ...
  render: () => <Card imageProps={{
    ...
    component: <Image alt="Alt text" src={getPlaceholderImage()} />
      ...
      ...((Q = (Z = h.parameters) == null ? void 0 : Z.docs) == null
        ? void 0
        : Q.source),
    },
  },
...
C.parameters = {
  ...
  render: () => <Card imageProps={{
    ...
    src: "foobar.jpg"
      ...
      ...((ee = ($ = C.parameters) == null ? void 0 : $.docs) == null
        ? void 0
        : ee.source),
    },
  },
...
b.parameters = {
  ...b.parameters,
  docs: {
    ...((ae = b.parameters) == null ? void 0 : ae.docs),
    source: {
      originalSource: `{
  render: () => <Card imageProps={{
    alt: "Alt text",
    ...
    src: getPlaceholderImage()
      ...
      ...((re = (ie = b.parameters) == null ? void 0 : ie.docs) == null
        ? void 0
        : re.source),
    },
  },
...
x.parameters = {
  ...
  name: "Full-Click Functionality"
      ...
      ...((se = (ne = x.parameters) == null ? void 0 : ne.docs) == null
        ? void 0
        : se.source),
    },
  },
...
v.parameters = {
  ...v.parameters,
  docs: {
    ...((le = v.parameters) == null ? void 0 : le.docs),
    source: {
      originalSource: `{
  ...
  name: "Full-Click Turbine Example"
      ...
      ...((de = (oe = v.parameters) == null ? void 0 : oe.docs) == null
        ? void 0
        : de.source),
    },
  },
...
y.parameters = {
  ...y.parameters,
  docs: {
    ...((ue = y.parameters) == null ? void 0 : ue.docs),
    source: {
      originalSource: `{
  name: "Full-Click With Tooltip",
  render: () => <FullClickWithTooltipExample />
}`,
      ...((me = (ce = y.parameters) == null ? void 0 : ce.docs) == null
        ? void 0
        : me.source),
    },
  },
...
f.parameters = {
  ...f.parameters,
  docs: {
    ...((ge = f.parameters) == null ? void 0 : ge.docs),
    source: {
      originalSource: `{
  render: () => <Card imageProps={{
    alt: "Alt text",
  ...
  name: "Right Side CardActions"
      ...
      ...((he = (pe = f.parameters) == null ? void 0 : pe.docs) == null
        ? void 0
        : he.source),
    },
  },
...
P.parameters = {
  ...P.parameters,
  docs: {
    ...((Ce = P.parameters) == null ? void 0 : Ce.docs),
    source: {
      originalSource: `{
  render: () => <SimpleGrid columns={3}>
      <Card imageProps={{
      ...
      ...((xe = (be = P.parameters) == null ? void 0 : be.docs) == null
        ? void 0
        : xe.source),
    },
  },
...
j.parameters = {
  ...j.parameters,
  docs: {
    ...((ve = j.parameters) == null ? void 0 : ve.docs),
    source: {
      originalSource: `{
  render: () => <SimpleGrid columns={1}>
      <Card imageProps={{
      ...
      ...((fe = (ye = j.parameters) == null ? void 0 : ye.docs) == null
        ? void 0
        : fe.source),
    },
  },
...
z.parameters = {
  ...z.parameters,
  docs: {
    ...((Pe = z.parameters) == null ? void 0 : Pe.docs),
    source: {
      originalSource: `{
  render: () => <>
      ...
      ...((ze = (je = z.parameters) == null ? void 0 : je.docs) == null
        ? void 0
        : ze.source),
    },
  },
...
const Re = [
    "WithControls",
    "ImagePositionColumnCards",
    "ImagePositionRowCards",
    "ImageSizeColumnCards",
    "ImageSizeRowCards",
    "CustomImageComponent",
    "FallbackImage",
    "HeadingAsLink",
    "FullClick",
    "CardFullClickTurbineExample",
    "FullClickWithTooltip",
    "CardWithRightSideCardActions",
    "GridExample",
    "StackExample",
    "WithoutImages",
  ],
  qe = Object.freeze(
    Object.defineProperty(
      {
        __proto__: null,
        CardFullClickTurbineExample: v,
        CardWithRightSideCardActions: f,
        CustomImageComponent: h,
        FallbackImage: C,
        FullClick: x,
        FullClickWithTooltip: y,
        GridExample: P,
        HeadingAsLink: b,
        ImagePositionColumnCards: c,
        ImagePositionRowCards: m,
        ImageSizeColumnCards: g,
        ImageSizeRowCards: p,
        StackExample: j,
        WithControls: d,
        WithoutImages: z,
        __namedExportsOrder: Re,
        default: Ne,
      },
      Symbol.toStringTag,
      { value: "Module" }
