...
import { L as i, W as l, R as p, C as u } from "./Label.stories-sIfAmtvF.js";
const j = [
  {
    date: "2025-03-20",
    version: "3.5.5",
            ...
            children: [
              e.jsxs(t.tr, {
                children: [
                  ...
                  e.jsx(t.td, {
                    children: e.jsx(t.code, { children: "0.0.10" }),
                  }),
                ],
              }),
              e.jsxs(t.tr, {
                children: [
                  ...
                  e.jsx(t.td, {
                    children: e.jsx(t.code, { children: "3.5.5" }),
                  }),
                ],
              }),
            ],
...
`,
              e.jsx(s, {
                href: "#isrequired-helper-text",
                target: "_self",
                children: "isRequired helper text",
              }),
              `
`,
            ],
...
`,
              e.jsx(s, {
                href: "#requiredlabeltext-to-customize-required-label",
                target: "_self",
                children: "requiredLabelText to customize required label",
              }),
              `
`,
            ],
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          " component is an accessible HTML ",
          e.jsx(t.code, { children: "<label>" }),
          ` element. The JSX prop
`,
          e.jsx(t.code, { children: "htmlFor" }),
          " should be set to the ",
          e.jsx(t.code, { children: "id" }),
          ` of the input element that the label is
associated with. This is the proper way to label inputs so that screenreaders
can read the label, without the use of the `,
...
`,
      e.jsxs(t.p, {
        children: [
          "Note: All form-related Reservoir components already implement this ",
          e.jsx(t.code, { children: "Label" }),
          `
...
`,
          e.jsx(t.li, {
            children: e.jsx(t.a, {
              href: "https://webaim.org/techniques/forms/advanced",
              rel: "nofollow",
...
`,
      e.jsxs(t.p, {
        children: [
          "An optional helper string can be rendered at the end of the ",
          e.jsx(t.code, { children: "Label" }),
          ` text through
the `,
          e.jsx(t.code, { children: "isRequired" }),
          ` prop. This is useful for visually labeling a field as required
with the `,
          e.jsx(t.code, { children: '"(required)"' }),
          " text next to the label's text. This is set to ",
...
`,
      e.jsx(t.h2, {
        id: "requiredlabeltext-to-customize-required-label",
        children: "requiredLabelText to customize required label",
      }),
      `
`,
      e.jsxs(t.p, {
        children: [
          "The ",
          e.jsx(t.code, { children: "requiredLabelText" }),
          ` prop accepts values for type string and is available to update the "(required)" text.
