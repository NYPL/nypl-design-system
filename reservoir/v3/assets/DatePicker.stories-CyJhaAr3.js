import { Q as U, R as i, j as e, V as K, H as T } from "./iframe-D93LbwGv.js";
const { userEvent: a, within: l, expect: n } = __STORYBOOK_MODULE_TEST__,
  ...
  G = {
    ...
    argTypes: {
      className: { control: !1 },
      dateFormat: { table: { defaultValue: { summary: "yyyy-MM-dd" } } },
      dateType: {
        control: { type: "select" },
        options: U,
      ...
      id: { control: !1 },
      isDateRange: { table: { defaultValue: { summary: "false" } } },
      ...
      key: { table: { disable: !0 } },
      labelText: { table: { defaultValue: { summary: "From" } } },
      nameFrom: { control: !1 },
      nameTo: { control: !1 },
  ...
  o = {
    ...
    play: async ({ canvasElement: t }) => {
      const r = l(t).getByRole("textbox");
      n(r).toHaveValue("2025-01-01"),
        await a.clear(r),
        await a.type(r, "2024-05-20"),
        await setTimeout(() => {}, 500),
        n(r).toHaveValue("2024-05-20"),
        n(l(t).queryAllByText("May 2024")[0]).toBeInTheDocument();
      const Q = l(t).getByRole("button", { name: "Previous Month" }),
        x = l(t).getByRole("button", { name: "Next Month" });
      await a.click(Q),
        n(l(t).queryByText("May 2024")).not.toBeInTheDocument(),
        n(l(t).queryAllByText("April 2024")[0]).toBeInTheDocument(),
        await a.click(x),
        await a.click(x),
        n(l(t).queryByText("April 2024")).not.toBeInTheDocument(),
        n(l(t).queryAllByText("June 2024")[0]).toBeInTheDocument(),
        await a.click(l(t).getByText("15")),
        n(r).toHaveValue("2024-06-15"),
        await a.click(r),
        await a.click(l(t).getByText("31")),
        n(r).toHaveValue("2024-05-31"),
        await a.click(r),
        await setTimeout(() => {}, 500),
        n(l(t).queryAllByText("May 2024")[0]).toBeInTheDocument(),
        await a.keyboard("{tab}"),
        n(l(t).getByText("31")).toHaveFocus(),
        await a.keyboard("{arrowleft}"),
        await a.keyboard("{arrowleft}"),
        await a.keyboard("{arrowleft}"),
        n(l(t).getByLabelText("Choose Tuesday, May 28th, 2024")).toHaveFocus(),
        await a.keyboard("{enter}"),
        n(r).toHaveValue("2024-05-28"),
        n(r).toHaveFocus();
    },
  },
  s = {
    ...
    render: () =>
      e.jsxs(K, {
        ...
        children: [
          ...
          e.jsx("p", {
            children:
              'The "required" text in the legend in the date range, or the label in a normaldate input, can be hidden when `showRequiredLabel` is set to `false`.',
          }),
          e.jsx(i, {
            id: "required-date",
            dateType: "full",
  ...
  return e.jsxs(K, {
    ...
    children: [
      ...
      e.jsx(T, {
        level: "h3",
        size: "heading6",
        children: "Passing initialDate an empty string renders an empty input",
      }),
      e.jsx(i, {
        id: "init-dates",
        dateType: "full",
      ...
      e.jsx(T, {
        level: "h3",
        size: "heading6",
        children: "Passing no initialDate renders today's date",
      }),
      e.jsx(i, {
        id: "init-dates",
        dateType: "full",
...
o.parameters = {
  ...
  play: async ({
    ...
    expect(textInput).toHaveFocus();
      ...
      ...((w = (b = o.parameters) == null ? void 0 : b.docs) == null
        ? void 0
        : w.source),
    },
    description: {
      ...
      ...((f = (g = o.parameters) == null ? void 0 : g.docs) == null
        ? void 0
        : f.description),
    },
  },
...
c.parameters = {
  ...
  render: () => <DatePicker id="year-date" dateType="year" labelText="Select the year you want to visit NYPL" helperText="Note that the Library may be closed on Sundays." />
      ...
      ...((N = (B = c.parameters) == null ? void 0 : B.docs) == null
        ? void 0
        : N.source),
    },
  },
...
u.parameters = {
  ...
  render: () => <VStack align="stretch" spacing="s">
      ...
      ...((q = (Y = u.parameters) == null ? void 0 : Y.docs) == null
        ? void 0
        : q.source),
    },
  },
...
y.parameters = {
  ...y.parameters,
  docs: {
    ...((H = y.parameters) == null ? void 0 : H.docs),
    source: {
      originalSource: `{
  render: () => InitialDateExample()
}`,
      ...((E = (j = y.parameters) == null ? void 0 : j.docs) == null
        ? void 0
        : E.source),
    },
  },
...
h.parameters = {
  ...
  render: () => <DatePicker id="format-date" dateFormat="MM-dd-yyyy" dateType="full" labelText="Select the date you want to visit NYPL" initialDate="" initialDateTo="" placeholder="This is placeholder text" placeholderTo="This is placeholderTo text" isDateRange />
      ...
      ...((_ = (A = h.parameters) == null ? void 0 : A.docs) == null
        ? void 0
        : _.source),
    },
  },
...
m.parameters = {
  ...
  render: () => <DatePicker id="format-date" dateFormat="MM-dd-yyyy" dateType="full" labelText="Select the date you want to visit NYPL" initialDate="12/1/21" initialDateTo="12/10/21" isDateRange />
      ...
      ...((C = (z = m.parameters) == null ? void 0 : z.docs) == null
        ? void 0
        : C.source),
    },
  },
...
p.parameters = {
  ...
  render: () => <DatePicker id="max-min-dates" dateFormat="MM-dd-yyyy" dateType="full" labelText="Select the date you want to visit NYPL" minDate="1/1/2022" maxDate="3/1/2022" isDateRange />
      ...
      ...((W = ($ = p.parameters) == null ? void 0 : $.docs) == null
        ? void 0
        : W.source),
    },
  },
