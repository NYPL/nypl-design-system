...
import {
  ...
  D as b,
  b as y,
} from "./Modal.stories-bqLI3jio.js";
const w = [
  {
    date: "2025-05-22",
    version: "3.6.2",
            ...
            children: [
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, {
                    children: e.jsx(n.code, { children: "0.1.0" }),
                  }),
                ],
              }),
              e.jsxs(n.tr, {
...
`,
              e.jsx(o, {
                href: "#using-the-modal-usemodal-vs-modaltrigger",
                target: "_self",
                children: "Usage",
              }),
              `
...
`,
              e.jsx(o, {
                href: "#modaltrigger-component-props",
                target: "_self",
                children: "ModalTrigger Component Props",
              }),
              `
`,
            ],
...
`,
              e.jsx(o, {
                href: "#usemodal-component-props",
                target: "_self",
                children: "useModal Component Props",
              }),
              `
`,
            ],
...
`,
              e.jsx(o, {
                href: "#confirmation-variant",
                target: "_self",
                children: "Confirmation Modal Variant",
              }),
              `
`,
            ],
...
`,
              e.jsx(o, {
                href: "#content-window-scrolling",
                target: "_self",
                children: "Content Window Scrolling",
              }),
              `
`,
            ],
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          ` component is used to focus a user's attention on a piece of information or a specific task via a window
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "Modal" }),
          ` component should only be used when a user action that has destructive, or irreversible consequences needs
...
Because of this, the `,
          e.jsx(n.code, { children: "Modal" }),
          ` component should only be used when a user's direct action activates the modal.
...
`,
      e.jsx(n.p, {
        children: `Modals must have a title and the title should communicate the general idea of the modal intention, such as the outcome
...
`,
      e.jsx(n.p, {
        children: `Modal descriptions should include any additional information or context that a user needs to know in order to make one
of the decisions offered by the action buttons. Descriptions should be written in complete sentences.`,
      }),
      `
`,
      e.jsx(n.h3, {
        id: "action-button-labels",
        children: "Action button labels",
      }),
      `
`,
      e.jsx(n.p, {
        children: `Action button labels should be specific and actionable and should ultimately describe the next steps for a user.
...
`,
      e.jsx(n.p, {
        children: `Avoid asking a question in a modal title. Questions such as “Are you sure you want to quit?” or “Do you want to cancel?”
...
`,
      e.jsx(n.p, {
        children: `It’s OK to ask a question in a modal description to confirm if a user wants to go ahead with an action.
...
`,
      e.jsxs(n.h3, {
        id: "example-text-for-a-confirmation-modal",
        children: [
          "Example text (for a ",
...
`,
      e.jsx(n.p, {
        children: `When a modal is activated, focus should be set to a significant element that gives context to the modal intention.
...
`,
      e.jsx(n.p, {
        children: `Keyboard focus should also be constrained to remain within the dialog while it is open. Pressing TAB should advance
...
`,
      e.jsx(n.p, {
        children: e.jsx(n.a, {
          ...
          rel: "nofollow",
          children: "https://www.w3.org/WAI/ARIA/apg/patterns/dialog-modal/",
        }),
      }),
      `
`,
      e.jsx(n.h2, {
        id: "using-the-modal-usemodal-vs-modaltrigger",
        children: "Using the modal: useModal vs. ModalTrigger",
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          e.jsx(n.code, { children: "ModalTrigger" }),
          ' is a component that contains both the "trigger", or the button that opens the modal, and the modal itself. When you use ',
          e.jsx(n.code, { children: "ModalTrigger" }),
          `,
you pass only the modal props and the button text, and the `,
          e.jsx(n.code, { children: "ModalTrigger" }),
          " calls the ",
...
`,
      e.jsxs(n.p, {
        children: [
          "Or, you can call ",
          e.jsx(n.code, { children: "useModal()" }),
          ". ",
          e.jsx(n.code, { children: "useModal()" }),
          " returns the Modal component, the ",
          e.jsx(n.code, { children: "onClose" }),
          " function, and the ",
          e.jsx(n.code, { children: "onOpen" }),
          ` function, giving you the responsibility to
pass `,
          e.jsx(n.code, { children: "onOpen" }),
          " and ",
          e.jsx(n.code, { children: "onClose" }),
          " to your custom open and close functions.",
        ],
      }),
      `
`,
...
`,
      e.jsx(n.h2, {
        id: "modaltrigger-component-props",
        children: "ModalTrigger Component Props",
      }),
      `
`,
...
used to open the `,
          e.jsx(n.code, { children: "Modal" }),
          ` React component. This function can be passed to any
number of elements that use the `,
          e.jsx(n.code, { children: "onClick" }),
          " attribute. The ",
          e.jsx(n.code, { children: "onClose" }),
          ` function can
be used on any element that uses the `,
          e.jsx(n.code, { children: "onClick" }),
          " attribute.",
        ],
      }),
      ...
      e.jsx(n.p, {
        children: e.jsxs(n.strong, {
          children: [
            ...
            e.jsx(n.code, { children: "buttonText" }),
            ` prop is not necessary since you have to
...
`,
      e.jsxs(n.p, {
        children: [
          'The "confirmation" ',
          e.jsx(n.code, { children: "Modal" }),
          ` variant is used when the modal can confirm or revoke the modal's content. Accordingly, there are two buttons
in the footer instead of the one in the default modal. Each button has its own custom function (`,
          e.jsx(n.code, { children: "onCancel" }),
          ", ",
          e.jsx(n.code, { children: "onConfirm" }),
          `) that will close the modal.
Additionally, the `,
          e.jsx(n.code, { children: "onCancel" }),
          ` function will be called when using
...
`,
          e.jsxs(n.li, {
            children: [
              ...
              e.jsx(n.code, { children: "onCancel" }),
              ", and ",
              e.jsx(n.code, { children: "confirmButtonLabel" }),
              " props are required for this variant.",
            ],
          }),
          `
`,
          e.jsxs(n.li, {
            children: [
              "The ",
              e.jsx(n.code, { children: "onClose" }),
              " modal prop should NOT be passed.",
            ],
          }),
          `
`,
...
`,
          e.jsxs(n.li, {
            children: [
              ...
              " prop, pass the ",
              e.jsx(n.code, { children: "onClose" }),
              " function from the hook to ",
              e.jsx(n.code, { children: "onCancel" }),
              " and ",
              e.jsx(n.code, { children: "onConfirm" }),
              `:
for example, `,
              e.jsx(n.code, { children: "onCancel: () => { onClose(); }" }),
              ".",
            ],
          }),
          `
...
`,
      e.jsxs(n.p, {
        children: [
          "By default, the ",
          e.jsx(n.code, { children: "Modal" }),
          " component will render a DS level ",
...
`,
          ...
          " component when a string is passed to the ",
...
passed to the `,
          e.jsx(n.code, { children: "headingText" }),
          ` property. This can be useful when you want to add
...
`,
      e.jsxs(n.p, {
        children: [
          "In either ",
          e.jsx(n.code, { children: "Modal" }),
          " pattern, the main content inside the ",
          e.jsx(n.code, { children: "Modal" }),
          ` component will
scroll while the `,
          e.jsx(n.code, { children: "Modal" }),
          `'s header and footer still stay static. Check the
example below with a lot of content inside the `,
          e.jsx(n.code, { children: "Modal" }),
          ".",
        ],
      }),
...
`,
      ...
      `
`,
      e.jsx(n.pre, { children: e.jsx(n.code, {}) }),
    ],
  });
}
function T(t = {}) {
  const { wrapper: n } = { ...h(), ...t.components };
  return n ? e.jsx(n, { ...t, children: e.jsx(c, { ...t }) }) : c(t);
}
export { T as default };
