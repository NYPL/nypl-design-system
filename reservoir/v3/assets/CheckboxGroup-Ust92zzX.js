...
import {
  ...
  I as C,
  P as g,
} from "./CheckboxGroup.stories-KiU_FbBH.js";
const f = [
  {
    date: "2024-09-19",
    version: "3.3.2",
...
`,
              e.jsx(t, {
                href: "#indeterminate-example",
                target: "_self",
                children: "Indeterminate Example",
              }),
              `
`,
            ],
...
`,
              e.jsx(t, {
                href: "#getting-checkbox-input-values",
                target: "_self",
                children: "Getting Checkbox Input Values",
              }),
              `
`,
            ],
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          ` components that are wrapped in
a `,
          e.jsx(n.code, { children: "<fieldset>" }),
          " element. The ",
          e.jsx(n.code, { children: "<fieldset>" }),
          " element renders a ",
          e.jsx(n.code, { children: "<legend>" }),
          ` element that
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://chakra-ui.com/docs/components/form/checkbox",
              rel: "nofollow",
              children: "Chakra UI Checkbox",
            }),
          }),
          `
`,
...
For example, if a `,
          e.jsx(n.code, { children: "Checkbox" }),
          ` label needs to display how many items that option
has, it can be displayed with the help of the `,
...
`,
      e.jsx(n.p, {
        children: `The "indeterminate" state can be used when a group of checkboxes are not all
...
`,
          e.jsx(n.a, {
            href: "https://chakra-ui.com/docs/form/checkbox#indeterminate",
            rel: "nofollow",
            children: "Checkbox",
          }),
          ` documentation.
...
`,
      e.jsx(n.h2, {
        id: "getting-checkbox-input-values",
        children: "Getting Checkbox Input Values",
      }),
      `
`,
      e.jsx(n.h3, {
        id: "controlled-component-using-name-defaultvalue-and-onchange-props",
        children:
...
and `,
          ...
          " props. The ",
          e.jsx(n.code, { children: "onChange" }),
          ` function will be called every time a new
`,
          e.jsx(n.code, { children: "Checkbox" }),
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          e.jsx(n.code, { children: "register" }),
          " React ",
          e.jsx(n.code, { children: "ref" }),
          ` from the
`,
          e.jsx(n.code, { children: "react-hook-form" }),
          " package.",
        ],
      }),
      `
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          ", individual ",
          e.jsx(n.code, { children: "Checkbox" }),
          `es can be updated programmatically
through the `,
...
`,
      e.jsxs(n.p, {
        children: [
          "When passing selected values through the ",
          e.jsx(n.code, { children: "value" }),
          ` prop, the consuming app is now
controlling the state of the values. By default, the `,
          e.jsx(n.code, { children: "CheckboxGroup" }),
          ` component
returns the value(s) checked to the consuming app through the `,
          e.jsx(n.code, { children: "onChange" }),
          ` callback.
Note that the `,
          e.jsx(n.code, { children: "defaultValue" }),
          ` prop is not necessary unless there are values that
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          e.jsx(n.code, { children: "CheckboxGroup" }),
          ` component works as expected, but
now there are three (3) additional buttons that can update the selected checkboxes
within the `,
          e.jsx(n.code, { children: "CheckboxGroup" }),
          ` component. Open the browser's console to see the
`,
          e.jsx(n.code, { children: "onChange" }),
          " callback being called ",
          e.jsx(n.em, { children: "only" }),
          ` when checkboxes are checked or unchecked.
Clicking on a button does not trigger the `,
          e.jsx(n.code, { children: "onChange" }),
          ` callback but does update
the values.`,
        ],
      }),
      `
...
function T(c = {}) {
  const { wrapper: n } = { ...r(), ...c.components };
  return n ? e.jsx(n, { ...c, children: e.jsx(h, { ...c }) }) : h(c);
}
export { T as default };
