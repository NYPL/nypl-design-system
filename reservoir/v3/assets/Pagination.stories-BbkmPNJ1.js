...
const g = x(10),
  H = {
    ...
    argTypes: {
      className: { control: !1 },
      currentPage: { control: !1 },
      getPageHref: { control: !1 },
      id: { control: !1 },
      initialPage: { control: !1, table: { defaultValue: { summary: "1" } } },
      onPageChange: { control: !1 },
    },
  },
  a = {
    args: {
      className: void 0,
      getPageHref: g.getPageHref,
      id: "pagination-id",
      initialPage: g.computedCurrentPage || 1,
      pageCount: 10,
    },
    name: "Pagination with URL Updates",
    render: (e) => n.jsx(o, { ...e, onPageChange: void 0 }),
    parameters: {
      design: {
        type: "figma",
  ...
  t = {
    ...
    render: (e) => n.jsx(o, { ...e, getPageHref: void 0 }),
    parameters: {
      design: {
        type: "figma",
        url: "https://www.figma.com/file/qShodlfNCJHb8n03IFyApM/Master?node-id=17226%3A932",
...
function N() {
  ...
  return n.jsxs(j, {
    ...
    spacing: 6,
    children: [
      n.jsx(o, { pageCount: 10, currentPage: e, onPageChange: (s) => U(s) }),
      n.jsx(S, {
        id: "go-to-btn",
        type: "button",
        onClick: w,
...
a.parameters = {
  ...
  parameters: {
    ...
    jest: ["Pagination.test.tsx"]
      ...
      ...((l = (d = a.parameters) == null ? void 0 : d.docs) == null
        ? void 0
        : l.source),
    },
    description: {
...
t.parameters = {
  ...
  parameters: {
    ...
    jest: ["Pagination.test.tsx"]
      ...
      ...((f = (u = t.parameters) == null ? void 0 : u.docs) == null
        ? void 0
        : f.source),
    },
  },
...
r.parameters = {
  ...
  name: "Forcing a Page Change Programmatically"
      ...
      ...((y = (C = r.parameters) == null ? void 0 : C.docs) == null
        ? void 0
        : y.source),
    },
  },
};
const M = ["URLUpdates", "UnchangingURL", "UpdateProgrammatically"],
  v = Object.freeze(
...
export { v as P, a as U, t as a, r as b };
