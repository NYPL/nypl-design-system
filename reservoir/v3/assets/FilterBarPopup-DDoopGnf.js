import{u as d,j as e,M as a,L as l,bv as h,C as o,bw as p,S as t}from"./iframe-D93LbwGv.js";import{C as u}from"./ComponentChangelogTable-Ck_3mwrR.js";import{F as i,W as r,a as x,M as j,T as m}from"./FilterBarPopup.stories-BFE0pfE9.js";import"./useMultiSelect-amaASZqv.js";const g=[{date:"2024-08-29",version:"3.3.0",type:"New Feature",affects:["Accessibility","Documentation","Functionality","Styles"],notes:["Adds FilterBarPopup component."]}];function c(s){const n={a:"a",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...d(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(a,{of:i}),`
`,e.jsx(n.h1,{id:"filterbarpopup",children:"FilterBarPopup"}),`
`,e.jsxs(n.table,{children:[e.jsx(n.thead,{children:e.jsxs(n.tr,{children:[e.jsx(n.th,{children:"Component Version"}),e.jsx(n.th,{children:"DS Version"})]})}),e.jsxs(n.tbody,{children:[e.jsxs(n.tr,{children:[e.jsx(n.td,{children:"Added"}),e.jsx(n.td,{children:e.jsx(n.code,{children:"3.3.0"})})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:"Latest"}),e.jsx(n.td,{children:e.jsx(n.code,{children:"3.3.0"})})]})]})]}),`
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(l,{href:"#filterbarpopup-heading",target:"_self",children:"FilterBarPopup Heading"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(l,{href:"#totalresults-example",target:"_self",children:"totalResults example"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(l,{href:"#usefilterbarpopup-hook",target:"_self",children:"useFilterBarPopup hook"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
...
`,e.jsx(h,{of:i}),`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"FilterBarPopup"}),` is a wrapper component for filter components and individual form
...
`,e.jsx(n.p,{children:"The wrapped components/component groups will always be displayed in a column layout."}),`
`,e.jsxs(n.p,{children:["It is recommended to use real-time filtering in conjunction with the ",e.jsx(n.code,{children:"totalResults"}),`
prop to update the `,e.jsx(n.code,{children:"Show X results"}),` button with X being the total number of results
associated to the results list.`]}),`
`,e.jsxs(n.p,{children:["If the consuming app is not using the above, then ",e.jsx(n.code,{children:"FilterBarPopup"}),` will render the
`,e.jsx(n.code,{children:"Show results"})," button and can render an ",e.jsx(n.em,{children:"optional"})," ",e.jsx(n.code,{children:"Clear all filters"}),`
button which is controlled by the `,e.jsx(n.code,{children:"onClear"})," prop. The ",e.jsx(n.code,{children:"Show results"}),` button will
call the `,e.jsx(n.code,{children:"onSubmit"})," function if passed and close the modal."]}),`
`,e.jsxs(n.p,{children:["Related component: ",e.jsx(n.a,{href:"../?path=/docs/components-form-elements-FilterBarInline--docs",children:"FilterBarInline"})]}),`
`,e.jsx(n.h2,{id:"component-props",children:"Component Props"}),`
`,e.jsx(o,{of:r}),`
`,e.jsx(p,{of:r}),`
`,e.jsx(n.h2,{id:"accessibility",children:"Accessibility"}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"FilterBarPopup"}),` component is a wrapper component for components with filter
functionality. The accessibility of `,e.jsx(n.code,{children:"FilterBarPopup"}),` depends on the passed child
...
`]}),`
`,e.jsx(n.h2,{id:"filterbarpopup-heading",children:"FilterBarPopup Heading"}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"FilterBarPopup"}),` component will always render a heading using the default
"Filters" label value. The default label value can be overridden using the
`,e.jsx(n.code,{children:"heading"})," prop. By default, when a string is passed to the ",e.jsx(n.code,{children:"heading"}),` prop, the
`,e.jsx(n.code,{children:"FilterBarPopup"})," component will render an ",e.jsx(n.code,{children:"h2"})," element sized as an ",e.jsx(n.code,{children:"heading5"}),`
heading. If this causes accessibility issues in your app, you can set a
custom heading by passing in a DS `,e.jsx(n.code,{children:"Heading"})," component."]}),`
`,e.jsxs(n.p,{children:["In the following examples, the ",e.jsx(n.code,{children:"FilterBarPopup"})," component will render custom ",e.jsx(n.code,{children:"h3"}),`
and `,e.jsx(n.code,{children:"h5"}),` elements. Note that no matter what heading level is set, the size will
always be set to `,e.jsx(n.code,{children:"heading5"})," internally by the ",e.jsx(n.code,{children:"FilterBarPopup"})," component."]}),`
`,e.jsx(t,{code:`
...
the `,e.jsx(n.code,{children:"FilterBarPopup"})," component accepts ",e.jsx(n.code,{children:"CheckboxGroup"}),", ",e.jsx(n.code,{children:"MultiSelectGroup"}),`,
...
`]}),`
`,e.jsxs(n.p,{children:["Here is an example of the shape of ",e.jsx(n.code,{children:"FilterBarPopup"}),":"]}),`
`,e.jsx(t,{code:`
<FilterBarPopup
id="..."
heading="..."
...
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"FilterBarPopup"}),` component does not store its state internally. It expects
...
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"Clear all filters"})," button will only be visible when the ",e.jsx(n.code,{children:"onClear"})," prop is passed."]}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"onClear"})," handler will be called when the ",e.jsx(n.code,{children:"Clear all filters"})," button is clicked."]}),`
`,e.jsxs(n.p,{children:["It is expected that the ",e.jsx(n.code,{children:"onClear"}),` handler will clear all of the current values from the
...
updates expected when the `,e.jsx(n.code,{children:"onClear"})," handler is called."]}),`
`,e.jsx(t,{code:`
...
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"onSubmit"})," handler will be called when the ",e.jsx(n.code,{children:"Show results"})," button is clicked."]}),`
...
and subsequent UI updates expected when the `,e.jsx(n.code,{children:"onSubmit"})," handler is called."]}),`
...
`,e.jsx(n.h2,{id:"totalresults-example",children:"totalResults example"}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"totalResults"}),` prop should be used if the consuming app is utilizing real-time
filtering. If the `,e.jsx(n.code,{children:"totalResults"}),` prop is passed, its value will be used as part of
the label text for the `,e.jsx(n.code,{children:"Show results"}),` button (ex. "Show 72 results" where 72 is the
value of the totalResults prop). This value should be updated as filter options are
selected or changed.`]}),`
`,e.jsxs(n.p,{children:["The example below is not fully functioning and is meant to show how the ",e.jsx(n.code,{children:"totalResults"}),`
prop is shown to users in the `,e.jsx(n.code,{children:"Show results"})," button."]}),`
`,e.jsx(o,{of:m}),`
`,e.jsx(t,{code:`
const [selectedCheckbox, setSelectedCheckbox] = useState([]);
const [textValue, setTextValue] = useState("");
...
/>
`,language:"jsx"}),`
`,e.jsx(n.h2,{id:"usefilterbarpopup-hook",children:"useFilterBarPopup hook"}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"useFilterBarPopup"})," hook provides programmatic control for the ",e.jsx(n.code,{children:"FilterBarPopup"}),` component
and allows consuming apps to open the modal overlay using a custom button or methods other than
a standard button click. Instead of importing the `,e.jsx(n.code,{children:"FilterBarPopup"}),` component directly, use
the `,e.jsx(n.code,{children:"useFilterBarPopup"})," hook to get the ",e.jsx(n.code,{children:"FilterBarPopup"})," component and helper functions."]}),`
`,e.jsx(t,{code:`
import { useFilterBarPopup } from "@nypl/design-system-react-components";
`,language:"jsx"}),`
`,e.jsxs(n.p,{children:["This hook will return an object with the ",e.jsx(n.code,{children:"FilterBarPopup"})," component, a boolean value, and two functions."]}),`
`,e.jsx(t,{code:`
const { FilterBarPopup, isOpen, onClose, onOpen } = useFilterBarPopup();
`,language:"jsx"}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"FilterBarPopup"})," component is the same as the one imported directly, the ",e.jsx(n.code,{children:"isOpen"})," value, and ",e.jsx(n.code,{children:"onClose"}),`
and `,e.jsx(n.code,{children:"onOpen"}),` functions are exposed and available to the consuming application. The only function that will
be used directly is the `,e.jsx(n.code,{children:"onOpen"})," function. Pass ",e.jsx(n.code,{children:"isOpen"})," and ",e.jsx(n.code,{children:"onClose"})," to the ",e.jsx(n.code,{children:"FilterBarPopup"}),"."]}),`
`,e.jsx(t,{code:`
...
/>
`,language:"jsx"}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"onOpen"})," function can be used to programmatically open the ",e.jsx(n.code,{children:"FilterBarPopup"}),` component through another
element or behavior in the consuming app. See the example below that uses a custom `,e.jsx(n.code,{children:"Button"})," to open the ",e.jsx(n.code,{children:"Modal"}),`.
The existing button that is rendered by the `,e.jsx(n.code,{children:"FilterBarPopup"})," component will still work as expected."]}),`
`,e.jsx(t,{code:`
import { useFilterBarPopup } from "@nypl/design-system-react-components";
// ...
const MyComponent = () => {
...
`,e.jsx(u,{changelogData:g})]})}function y(s={}){const{wrapper:n}={...d(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(c,{...s})}):c(s)}export{y as default};
