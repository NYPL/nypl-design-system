...
var W = qe,
  ...
  F = (e, r) =>
    function () {
      return r || (0, e[Re(e)[0]])((r = { exports: {} }).exports, r), r.exports;
    },
  Je = (e, r, n, i) => {
...
`) !== -1 && (j = s.spacingOuter + E + j + s.spacingOuter + l),
                (j = `{${j}}`)),
              `${s.spacingInner + l + O.prop.open + A + O.prop.close}=${
                O.value.open
              }${j}${O.value.close}`
            );
          })
      ...
      var o = (u, m, s, l, a) => {
        let d = l.colors.tag;
        return `${d.open}<${u}${
          m && d.close + m + l.spacingOuter + a + d.open
        }${
          s
            ? `>${d.close}${s}${l.spacingOuter}${a}${d.open}</${u}`
            : `${m && !l.min ? "" : " "}/`
        }>${d.close}`;
      };
      e.printElement = o;
    ...
    "node_modules/pretty-format/build/plugins/Immutable.js"(e) {
      ...
      var r = ue(),
        ...
        g = (h, $, R, C, L, w, D) =>
          ++C > $.maxDepth
            ? l(s(D))
            : `${s(D) + a}{${(0, r.printIteratorEntries)(
                h.entries(),
                $,
                R,
                C,
      ...
      var O = (h, $, R, C, L, w) => {
        ...
        A = (h, $, R, C, L, w) => {
          ...
          return ++C > $.maxDepth
            ...
            ? `${D + a}{${
                h._iter || h._object
                  ? (0, r.printIteratorEntries)(h.entries(), $, R, C, L, w)
                  : d
              }}`
            : `${D + a}[${
                h._iter || h._array || h._collection || h._iterable
                  ? (0, r.printIteratorValues)(h.values(), $, R, C, L, w)
                  : d
              }]`;
        },
        I = (h, $, R, C, L, w, D) =>
    ...
    "node_modules/pretty-format/build/index.js"(e) {
      ...
      function C(t, b, T, M, S, f) {
        ...
        return U === "[object Arguments]"
          ? N
            ? "[Arguments]"
            : `${v ? "" : "Arguments "}[${(0, n.printListItems)(
                t,
                b,
                T,
                M,
          ...
          ? N
            ? `[${t.constructor.name}]`
            : `${
                v || (!b.printBasicPrototype && t.constructor.name === "Array")
                  ? ""
                  : `${t.constructor.name} `
              }[${(0, n.printListItems)(t, b, T, M, S, z)}]`
          : U === "[object Map]"
          ? N
            ? "[Map]"
            : `Map {${(0, n.printIteratorEntries)(
                t.entries(),
                b,
                T,
                M,
          ...
          ? `[${g(t)}]`
          : `${
              v || (!b.printBasicPrototype && g(t) === "Object")
                ? ""
                : `${g(t)} `
            }{${(0, n.printObjectProperties)(t, b, T, M, S, z)}}`;
      }
      function L(t) {
    ...
    return p
      .map((y) =>
        y.nodes
          .map(
            (u) =>
              `Expected the HTML found at $('${u.target.join(
                ", "
