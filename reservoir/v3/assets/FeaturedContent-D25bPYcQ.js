...
import {
  ...
  i as m,
  t as j,
} from "./FeaturedContent.stories-BqMFobqc.js";
const f = [
  {
    date: "2025-03-20",
    version: "3.5.5",
...
`,
              e.jsx(t, {
                href: "#component-width-variations",
                target: "_self",
                children: "Component Width Variations",
              }),
              `
`,
            ],
...
`,
              e.jsx(t, {
                href: "#image-position-variations",
                target: "_self",
                children: "Image Position Variations",
              }),
              `
`,
            ],
...
`,
              e.jsx(t, {
                href: "#image-width-variations",
                target: "_self",
                children: "Image Width Variations",
              }),
              `
`,
            ],
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          ` component provides a method to visually emphasize a text
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "FeaturedContent" }),
          ` component combines a text block and an image. The text
block (`,
          e.jsx(n.code, { children: "textContent" }),
          `) can be any JSX element, so accessibility for child input
elements should follow the accessibility requirements specified for each input
component (for example,
`,
          e.jsx(n.a, {
            href: "https://nypl.github.io/nypl-design-system/reservoir/v1/?path=/docs/components-form-elements-button--docs",
            rel: "nofollow",
            children: "Button",
          }),
          `).
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://chakra-ui.com/docs/components/typography/text",
              rel: "nofollow",
              children: "Chakra UI Text",
            }),
          }),
          `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          "The width variations of the ",
          e.jsx(n.code, { children: "FeaturedContent" }),
          ` component can be rendered through
the `,
          e.jsx(n.code, { children: "isFullWidth" }),
          " prop. The default is ",
          e.jsx(n.code, { children: "isFullWidth = false" }),
          `, and the component
will fill only its parent. If `,
          e.jsx(n.code, { children: "isFullWidth = true" }),
...
`,
      e.jsxs(n.p, {
        children: [
          "The image position variations of the ",
          e.jsx(n.code, { children: "FeaturedContent" }),
          ` component can be rendered
through the `,
          e.jsx(n.code, { children: "imageProps.position" }),
          " prop. The default is ",
          e.jsx(n.code, { children: "end" }),
          `, and the image will
appear after the text block in a row (on mobile, it will appear below). The
other option is `,
          e.jsx(n.code, { children: "start" }),
          `, where the image will appear before the text block in
...
`,
      e.jsxs(n.p, {
        children: [
          "The image width variations of the ",
          e.jsx(n.code, { children: "FeaturedContent" }),
          ` component can be rendered
through the `,
          e.jsx(n.code, { children: "imageProps.width" }),
          " prop. The options for width are ",
          e.jsx(n.code, { children: "oneQuarter" }),
          `,
`,
          e.jsx(n.code, { children: "oneThird" }),
          ", ",
          e.jsx(n.code, { children: "oneHalf" }),
          ", ",
          e.jsx(n.code, { children: "twoThirds" }),
          ", and ",
          e.jsx(n.code, { children: "threeQuarters" }),
...
`,
      e.jsxs(n.p, {
        children: [
          e.jsx(n.code, { children: "textContent" }),
          " is a string or JSX element passed into ",
          e.jsx(n.code, { children: "FeaturedContent" }),
          `, so
...
`,
      e.jsx(n.p, {
        children: `The above example with an overline, a heading, a short paragraph of body text,
...
`,
      ...
      `
`,
      e.jsx(h, { changelogData: f }),
    ],
  });
}
function y(i = {}) {
  const { wrapper: n } = { ...r(), ...i.components };
