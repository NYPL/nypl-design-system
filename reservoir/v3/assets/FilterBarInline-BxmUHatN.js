...
import {
  ...
  M as f,
  T as b,
} from "./FilterBarInline.stories-D-dolKAQ.js";
...
`,
              e.jsx(l, {
                href: "#filterbarinline-heading",
                target: "_self",
                children: "FilterBarInline Heading",
              }),
              `
`,
            ],
...
`,
              e.jsx(l, {
                href: "#passing-children",
                target: "_self",
                children: "Passing Children",
              }),
              `
`,
            ],
...
`,
      e.jsx(n.p, {
        children: `The wrapped components/component groups can be displayed in a column or in a row
layout.`,
      }),
      `
`,
...
If the consuming app is not using the above, then `,
          ...
          ` can render
additional `,
          e.jsx(n.code, { children: "Clear All" }),
          " and a ",
          e.jsx(n.code, { children: "Apply Filters" }),
          " buttons. The two ",
...
`,
      e.jsxs(n.p, {
        children: [
          "The display of the ",
          e.jsx(n.code, { children: "FilterBarInline" }),
          " child components can be set to a ",
          e.jsx(n.code, { children: '"row"' }),
          ` or a
`,
          e.jsx(n.code, { children: '"column"' }),
          " layout. On screen width under 600px width the ",
...
`,
          e.jsx(n.code, { children: "closeOnBlur" }),
          " set to ",
          e.jsx(n.code, { children: "true" }),
          " by default and when ",
          e.jsx(n.code, { children: 'layout = "column"' }),
          ` is passed,
the `,
          e.jsx(n.code, { children: "closeOnBlur" }),
          " prop will be set to ",
...
`,
          ...
          " set to ",
          e.jsx(n.code, { children: "true" }),
          " by default and the child components ",
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "FilterBarInline" }),
          ` component will often be rendered within a UI container with
`,
          e.jsx(n.code, { children: "background-color" }),
          " and ",
          e.jsx(n.code, { children: "padding" }),
          ` styles applied. This treatment can easily be
...
`,
      e.jsx(n.p, {
        children: `If a consuming app supports dark mode, styles for both light and dark mode will
...
`,
      e.jsxs(n.p, {
        children: [
          e.jsx(n.strong, { children: "Note:" }),
          ` Future DS updates may provide a standalone component to implement a
...
`,
      e.jsxs(n.p, {
        children: [
          "It is expected that the ",
          e.jsx(n.code, { children: "onClear" }),
          ` handler will clear all of the current values
...
`,
      e.jsxs(n.p, {
        children: [
          "The following code is one example of how the ",
          e.jsx(n.code, { children: "FilterBarInline" }),
          ` component can
be used with the `,
          e.jsx(n.code, { children: "TagSet" }),
          ` component. Consuming apps can modify this to fit their
use case by ensuring the `,
          e.jsx(n.code, { children: "tagSetData" }),
          ` is updated with changes to filter items and
vice versa.`,
        ],
      }),
      `
...
function B(o = {}) {
  ...
  return n ? e.jsx(n, { ...o, children: e.jsx(c, { ...o }) }) : c(o);
}
export { B as default };
