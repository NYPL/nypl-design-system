...
import {
  ...
  f as k,
  I,
} from "./MultiSelect.stories-D3JZiCt6.js";
            ...
            children: [
              ...
              e.jsxs(t.tr, {
                children: [
                  ...
                  e.jsx(t.td, {
                    children: e.jsx(t.code, { children: "3.6.4" }),
                  }),
                ],
              }),
            ],
...
`,
              e.jsx(n, {
                href: "#populating-the-list-items",
                target: "_self",
                children: "Populating the List Items",
              }),
              `
`,
            ],
...
`,
              e.jsx(n, {
                href: "#visible-list-items",
                target: "_self",
                children: "Visible List Items",
              }),
              `
`,
            ],
...
`,
              e.jsx(n, {
                href: "#disabled-list-items",
                target: "_self",
                children: "Disabled List Items",
              }),
              `
`,
            ],
...
`,
              e.jsx(n, {
                href: "#search-input-field",
                target: "_self",
                children: "Search Input Field",
              }),
              `
`,
            ],
...
`,
              e.jsx(n, {
                href: "#block-element-or-float",
                target: "_self",
                children: "Block Element or Float",
              }),
              `
`,
            ],
...
`,
              e.jsx(n, {
                href: "#default-open-state",
                target: "_self",
                children: "Default Open State",
              }),
              `
`,
            ],
...
`,
              e.jsx(n, {
                href: "#multiselect-in-a-group",
                target: "_self",
                children: "MultiSelect in a Group",
              }),
              `
`,
            ],
...
`,
              e.jsx(n, {
                href: "#controlling-state-using-selecteditems-and-onchange-prop",
                target: "_self",
                children:
...
`,
              e.jsx(n, {
                href: "#multiselect-nextjs-routing-implementation",
                target: "_self",
                children: "MultiSelect NextJS routing implementation",
              }),
              `
`,
            ],
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          " renders a non-hierarchical list of items to select from.",
        ],
      }),
      `
`,
...
`,
      e.jsxs(t.p, {
        children: [
          "The ",
          e.jsx(t.code, { children: "MultiSelect" }),
          " component is composed using the DS ",
          e.jsx(t.code, { children: "Accordion" }),
          " and ",
          e.jsx(t.code, { children: "Checkbox" }),
          `
          ...
          e.jsxs(t.li, {
            children: [
              ...
              e.jsx(t.a, {
                ...
                rel: "nofollow",
                children: "U.S. Web Design System (USWDS)",
              }),
              `
guidelines:`,
              `
...
`,
                  e.jsxs(t.li, {
                    children: [
                      "Use the ",
                      e.jsx(t.code, { children: "button" }),
                      " HTML element for screenreaders and keyboards.",
                    ],
                  }),
                  `
`,
                  e.jsxs(t.li, {
                    children: [
                      "Use the ",
                      e.jsx(t.code, { children: "aria-expanded" }),
...
`,
                  e.jsxs(t.li, {
                    children: [
                      "Use the ",
                      e.jsx(t.code, { children: "aria-controls" }),
                      " attribute to associate the control with the panel.",
                    ],
                  }),
                  `
`,
...
`,
          e.jsxs(t.li, {
            children: [
              "The open and close icons are decorative (",
              e.jsx(t.code, { children: "aria-hidden" }),
              " is ",
              e.jsx(t.code, { children: "true" }),
              ").",
            ],
...
`,
          e.jsxs(t.li, {
            children: [
              ...
              " utilizes the ",
              e.jsx(t.code, { children: "Accordion" }),
              `, the same functionality applies when
...
`,
      e.jsxs(t.p, {
        children: [
          "The Checkbox component renders ",
          e.jsx(t.code, { children: "<label>" }),
          " and ",
          e.jsx(t.code, { children: '<input type="checkbox" />' }),
          `
elements that are associated with each other; the label has a `,
          e.jsx(t.code, { children: "for" }),
          ` attribute with
the value of the `,
          e.jsx(t.code, { children: "input" }),
          "'s ",
          e.jsx(t.code, { children: "id" }),
          ` element. If there is helper or invalid text, the
`,
          e.jsx(t.code, { children: "<input>" }),
          " element will have a ",
          e.jsx(t.code, { children: "aria-describedby" }),
...
`,
          e.jsx(t.li, {
            children: e.jsx(t.a, {
              href: "../?path=/docs/components-overlays-switchers-accordion--docs#accessibility",
              children: "Reservoir Accordion Component",
            }),
          }),
          `
`,
          e.jsx(t.li, {
            children: e.jsx(t.a, {
              ...
              children: "Reservoir Checkbox Component",
            }),
          }),
          `
`,
          e.jsx(t.li, {
            children: e.jsx(t.a, {
              href: "https://dequeuniversity.com/rules/axe/4.4/nested-interactive",
              rel: "nofollow",
              children:
                "Deque University - Nested interactive controls are not announced by screen readers",
            }),
          }),
          `
`,
...
`,
      e.jsxs(t.p, {
        children: [
          "The options rendered in the ",
          e.jsx(t.code, { children: "MultiSelect" }),
          ` component are passed into the
component's `,
          e.jsx(t.code, { children: "items" }),
          ` prop. The expected data structure is an array of objects,
with each item having an `,
          e.jsx(t.code, { children: "id" }),
          " and a ",
          e.jsx(t.code, { children: "name" }),
          `. You also have the option to include
a second level of child items. Both parent and child items can optionally use
the `,
          e.jsx(t.code, { children: "isDisabled" }),
          " flag and include the ",
          e.jsx(t.code, { children: "itemCount" }),
          ` prop to render their associated
...
`,
      e.jsxs(t.p, {
        children: [
          "The ",
          e.jsx(t.code, { children: "defaultItemsVisible" }),
          ` prop can be used to set the number of list items that
will be visible when the list is first opened. The default value is `,
          e.jsx(t.code, { children: "5" }),
          ".",
        ],
      }),
      `
`,
      e.jsx(t.p, {
        children: `When there are nested list items, only the parent items will be considered when
      ...
      e.jsx(c, {
        content: e.jsxs(e.Fragment, {
          children: [
            ...
            " This prop can only be used with",
            " ",
            e.jsx(t.code, { children: 'listOverflow="expand"' }),
            ".",
          ],
        }),
        type: "informative",
...
`,
      e.jsx(t.p, {
        children: `The MultiSelect component allows for an optional set of child checkboxes to be passed, providing a hierarchical structure.
...
`,
          e.jsxs(t.li, {
            children: [
              "If all of the children checkboxes are checked, the parent's ",
              e.jsx(t.code, { children: "isChecked" }),
...
`,
          e.jsxs(t.li, {
            children: [
              "If only some of the child checkboxes are checked, the parent checkbox will have an ",
              e.jsx(t.code, { children: "isIndeterminate" }),
              " state.",
            ],
          }),
          `
...
`,
      e.jsxs(t.p, {
        children: [
          `Each checkbox — whether standalone, parent, or child — can be set in
a disabled state by using `,
          e.jsx(t.code, { children: "isDisabled" }),
          `. This provides flexibility in managing
the interaction and state of checkboxes within the `,
          e.jsx(t.code, { children: "MultiSelect" }),
          ` component,
...
`,
      e.jsx(t.p, {
        children: e.jsx(t.strong, { children: "Standalone Checkbox" }),
      }),
      `
`,
      e.jsxs(t.p, {
        children: [
          e.jsx(t.code, { children: "isDisabled" }),
          ` can be set directly for a standalone checkbox. When disabled, a
...
`,
      e.jsx(t.p, {
        children: e.jsx(t.strong, { children: "Parent Checkbox" }),
      }),
      `
`,
      e.jsxs(t.p, {
        children: [
          e.jsx(t.code, { children: "isDisabled" }),
          " cannot be set directly for a parent checkbox.",
        ],
      }),
      `
`,
...
`,
          e.jsx(t.li, {
            children: `If only some of the child checkboxes under a parent checkbox are disabled, the
parent checkbox will be enabled.`,
          }),
          `
`,
          e.jsx(t.li, {
            children: `If all of the child checkboxes under a parent checkbox are disabled, the
...
`,
      e.jsx(t.p, {
        children: `When disabled, a parent checkbox will not be clickable and its state will not
change.`,
      }),
      `
`,
      e.jsx(t.p, {
        children: e.jsx(t.strong, { children: "Child Checkboxes" }),
      }),
      `
`,
      e.jsxs(t.p, {
...
`,
      e.jsx(t.h3, {
        id: "disabled-parent-checkbox",
        children: "Disabled Parent Checkbox",
      }),
      `
`,
      e.jsx(s, { of: b }),
...
`,
      e.jsxs(t.p, {
        children: [
          "When ",
          e.jsx(t.code, { children: "isSearchable" }),
          " is set to ",
          e.jsx(t.code, { children: "true" }),
          `, a text input field will be enabled within
...
`,
      e.jsx(c, {
        content: e.jsxs(e.Fragment, {
          children: [
            e.jsx(t.strong, { children: "RECOMMENDATION:" }),
            " When the number of list items is 20 or greater, enable the search functionality and use scroll for the overflow.",
          ],
        }),
        type: "recommendation",
      }),
...
with each option in a `,
          e.jsx(t.code, { children: "MultiSelect" }),
          ` component. The item counts can be rendered
by passing the `,
          e.jsx(t.code, { children: "itemCount" }),
      ...
      e.jsx(c, {
        content: e.jsxs(e.Fragment, {
          children: [
            ...
            " When the ",
            e.jsx(t.code, { children: "itemCount" }),
            " data property is set as 0, the ",
            e.jsx(t.code, { children: "isDisabled" }),
            " data property should be used to disable the option.",
          ],
        }),
        type: "recommendation",
      }),
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          " is ",
          e.jsx(t.code, { children: "true" }),
          `, the list will render as a block element and displace
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          " is ",
          e.jsx(t.code, { children: "false" }),
          ` (default configuration), the list element will
`,
          e.jsx(t.em, { children: "float" }),
          ` above other UI elements and not impact their placement nor the overall
...
`,
      e.jsxs(t.p, {
        children: [
          "The width of the ",
          e.jsx(t.code, { children: "MultiSelect" }),
          ` component can be configured to handle the width in
two ways: `,
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          " is set to ",
          e.jsx(t.code, { children: "fitContent" }),
          `, the button and list elements will expand
...
`,
          e.jsx(t.li, {
            children: "The button element has a minimum width of 175px",
          }),
          `
`,
          e.jsx(t.li, {
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          " is set to ",
          e.jsx(t.code, { children: "full" }),
          `, the button and list elements will expand to fill
...
`,
      e.jsx(c, {
        content: e.jsxs(e.Fragment, {
          children: [
            e.jsx(t.strong, { children: "IMPORTANT:" }),
            " For a mobile viewport, the component will always render with ",
            e.jsx(t.code, { children: "width" }),
            " set to ",
            e.jsx(t.code, { children: "full" }),
            ".",
...
`,
      e.jsxs(t.p, {
        children: [
          "When ",
          e.jsx(t.code, { children: "isDefaultOpen" }),
          " is set to ",
          e.jsx(t.code, { children: "true" }),
          `, the component is displayed in the open
state by default.`,
        ],
      }),
      `
...
`,
      e.jsxs(t.p, {
        children: [
          "When using the ",
          e.jsx(t.code, { children: "MultiSelect" }),
          ` component in a group, it is recommended to use the
`,
          e.jsx(t.code, { children: "useMultiSelect" }),
          " hook to manage the state of all the ",
          e.jsx(t.code, { children: "MultiSelect" }),
          " components.",
        ],
      }),
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          e.jsx(t.code, { children: "useMultiSelect" }),
          " hook provides an ",
          e.jsx(t.code, { children: "onClear" }),
          ` function that should be used to
clear all the selected checkboxes in individual `,
          e.jsx(t.code, { children: "MultiSelect" }),
          ` components. This
function should be passed to the `,
          e.jsx(t.code, { children: "onClear" }),
          ` prop and is invoked through the
"clear" button in the `,
          e.jsx(t.code, { children: "MultiSelect" }),
          " component.",
        ],
...
`,
      e.jsxs(t.p, {
        children: [
          "The ",
          e.jsx(t.code, { children: "useMultiSelect" }),
          " hook also provides an ",
          e.jsx(t.code, { children: "onClearAll" }),
          ` function that can be
used to clear all the selected checkboxes across all `,
          e.jsx(t.code, { children: "MultiSelect" }),
          ` components.
The `,
          e.jsx(t.code, { children: "MultiSelect" }),
          " component does ",
          e.jsx(t.em, { children: "NOT" }),
          " have an ",
          e.jsx(t.code, { children: "onClearAll" }),
          ` prop. Instead, the
`,
          e.jsx(t.code, { children: "onClearAll" }),
          ` function should be invoked in a separate button or action.
Alternatively, use the `,
          e.jsx(t.code, { children: "MultiSelectGroup" }),
          " or ",
          e.jsx(t.code, { children: "FilterBar" }),
          ` (name TBD) components
in future releases.`,
        ],
      }),
...
`,
      e.jsx(t.h2, {
        id: "controlling-state-using-selecteditems-and-onchange-props",
        children: "Controlling State Using selectedItems and onChange Props",
      }),
      `
`,
      e.jsxs(t.p, {
        children: [
          "The ",
          e.jsx(t.code, { children: "MultiSelect" }),
          ` component does not store its state internally. It expects a
`,
          e.jsx(t.code, { children: "selectedItems" }),
          ` prop whose value follows a certain data structure that is
"normalized." This is used for calculating the selected item count. The value is
an object with a key of the `,
          e.jsx(t.code, { children: "MultiSelect" }),
          " component's ",
          e.jsx(t.code, { children: "id" }),
          ` value set to an
object with an "items" key. The "items" value is an array of the selected items.
Below is an exaple of the expected state shape of `,
          e.jsx(t.code, { children: "selectedItems" }),
          ":",
        ],
      }),
...
`,
      e.jsx(t.h2, {
        id: "multiselect-nextjs-routing-implementation",
        children: "MultiSelect NextJS routing implementation",
      }),
      `
`,
      e.jsxs(t.p, {
        children: [
          "This is helpful for when several ",
          e.jsx(t.code, { children: "MultiSelect" }),
          ` components are rendered inside a
`,
          e.jsx(t.code, { children: "FilterBar" }),
          " component. The ",
          e.jsx(t.code, { children: "MultiSelect" }),
...
`,
      e.jsx(t.p, {
        children: `It's also helpful if a consuming app is pushing state into the browser's url.
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          e.jsx(t.code, { children: "handleChange" }),
...
`,
      e.jsxs(t.p, {
        children: [
          e.jsx(t.code, { children: "useMultiSelect" }),
          ` is an optional hook provided by the component, for
...
the selectedItems. That includes the functions `,
...
`,
          ...
          ` for handling any changes to the selection of
items and the current state of the selection: `,
          e.jsx(t.code, { children: "selectedItems" }),
          ".",
        ],
      }),
...
`,
      e.jsxs(t.p, {
        children: [
          "Find the full documentation under ",
          e.jsx(t.a, {
...
`,
      ...
      `
`,
      e.jsx(x, { changelogData: C }),
    ],
  });
}
function F(l = {}) {
  const { wrapper: t } = { ...a(), ...l.components };
  return t ? e.jsx(t, { ...l, children: e.jsx(r, { ...l }) }) : r(l);
}
export { F as default };
