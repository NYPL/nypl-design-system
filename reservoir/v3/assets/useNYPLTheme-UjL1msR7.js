import{u as r,j as e,M as i,S as s}from"./iframe-D93LbwGv.js";function o(t){const n={code:"code",em:"em",h1:"h1",h2:"h2",li:"li",ol:"ol",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Hooks/useNYPLTheme"}),`
`,e.jsx(n.h1,{id:"usenypltheme",children:"useNYPLTheme"}),`
`,e.jsxs(n.table,{children:[e.jsx(n.thead,{children:e.jsxs(n.tr,{children:[e.jsx(n.th,{children:"Hook Version"}),e.jsx(n.th,{children:"DS Version"})]})}),e.jsxs(n.tbody,{children:[e.jsxs(n.tr,{children:[e.jsx(n.td,{children:"Added"}),e.jsx(n.td,{children:e.jsx(n.code,{children:"0.25.2"})})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:"Latest"}),e.jsx(n.td,{children:e.jsx(n.code,{children:"0.25.2"})})]})]})]}),`
`,e.jsxs(n.p,{children:["This custom hook is based on Chakra UI's ",e.jsx(n.code,{children:"useTheme"}),` hook. If your application
does not use CSS or SCSS files and you want to write CSS-in-JS styles in your
React components, the `,e.jsx(n.code,{children:"useNYPLTheme"}),` hook will provide you with NYPL-specific
style values.`]}),`
`,e.jsx(n.h2,{id:"usage",children:"Usage"}),`
`,e.jsxs(n.p,{children:["This hook depends on the ",e.jsx(n.code,{children:"DSProvider"}),` component and if the function is used
outside of this wrapper component, then the theme object will be empty. After
importing and rendering the `,e.jsx(n.code,{children:"DSProvider"}),` wrapper component, your children
...
`,language:"jsx"}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"theme"}),` variable will be a JS object with design token style values.
...
`,language:"jsx"})]})}function l(t={}){const{wrapper:n}={...r(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}export{l as default};
