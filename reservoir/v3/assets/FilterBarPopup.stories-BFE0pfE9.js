...
const Y = {
    ...
    argTypes: {
      ...
      totalResults: { control: !1 },
    },
  },
  b = {
    args: { id: "filterbar-popup-id", heading: "FilterBarPopup" },
    render: (r) => e.jsx(Z, { ...r }),
    parameters: {
      design: {
        type: "figma",
  ...
  Z = (r) => {
    const {
        onChange: m,
        onMixedStateChange: l,
        selectedItems: a,
        onClear: x,
        onClearAll: d,
      } = v(),
      n = [a],
      c = ({ isBlockElement: s, multiSelectWidth: h }) =>
        y &&
        y.map((o) =>
          e.jsx(
            I,
            {
              ...
              selectedItems: a,
              isBlockElement: s,
              onChange: (u) => m(u.target.id, o.id),
              onMixedStateChange: (u) => l(u.target.id, o.id, o.items),
              onClear: () => x(o.id),
              width: h,
            },
            o.id
  ...
  $ = () => {
    const {
      ...
      x = ({ isBlockElement: n, multiSelectWidth: c }) =>
        y &&
        y.map((t) =>
          e.jsx(
            I,
            {
              ...
              selectedItems: l,
              isBlockElement: n,
              onChange: (s) => r(s.target.id, t.id),
              onMixedStateChange: (s) => m(s.target.id, t.id, t.items),
              onClear: () => a(t.id),
              width: c,
            },
            t.id
    ...
    return e.jsxs(X, {
      align: "left",
      children: [
        e.jsx(k, { children: "Custom H3 Heading" }),
        e.jsx(g, {
          heading: e.jsx(P, { level: "h3", children: "Custom H3 Heading" }),
          renderChildren: d,
        }),
        e.jsx(k, { children: "Custom H5 Heading" }),
        e.jsx(g, {
          heading: e.jsx(P, { level: "h5", children: "Custom H5 Heading" }),
          renderChildren: d,
        }),
        e.jsx(k, { children: "Default heading" }),
        e.jsx(g, { renderChildren: d }),
      ],
    });
  },
  ee = (r) => {
    ...
    const u = () => {
      ...
      L = ({ isBlockElement: f, multiSelectWidth: M }) =>
        B &&
        B.map((i) =>
          e.jsx(
            I,
            {
              ...
              selectedItems: a,
              isBlockElement: f,
              onChange: (T) => m(T.target.id, i.id),
              onMixedStateChange: (T) => l(T.target.id, i.id, i.items),
              onClear: () => x(i.id),
              width: M,
            },
            i.id
...
b.parameters = {
  ...
  parameters: {
    ...
    jest: ["FilterBarPopup.test.tsx"]
      ...
      ...((E = (A = b.parameters) == null ? void 0 : A.docs) == null
        ? void 0
        : E.source),
    },
    description: {
      ...
      ...((R = (G = b.parameters) == null ? void 0 : G.docs) == null
        ? void 0
        : R.description),
    },
  },
...
C.parameters = {
  ...
  render: () => <FilterBarPopupHeadingStory />
      ...
      ...((_ = (V = C.parameters) == null ? void 0 : V.docs) == null
        ? void 0
        : _.source),
    },
  },
...
j.parameters = {
  ...j.parameters,
  docs: {
    ...((N = j.parameters) == null ? void 0 : N.docs),
    source: {
      originalSource: `{
  render: () => <FilterBarChildrenStory />
}`,
      ...((q = (O = j.parameters) == null ? void 0 : O.docs) == null
        ? void 0
        : q.source),
    },
  },
...
F.parameters = {
  ...
  render: () => <FilterBarTotalResultsStory />
      ...
      ...((D = (z = F.parameters) == null ? void 0 : z.docs) == null
        ? void 0
        : D.source),
    },
  },
...
const re = [
  ...
  ne = Object.freeze(
    Object.defineProperty(
      {
        __proto__: null,
        FilterBarPopupHeading: C,
        MultipleChildren: j,
        TotalResultsExample: F,
        WithControls: b,
...
export { ne as F, j as M, F as T, b as W, C as a };
