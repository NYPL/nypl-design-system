...
import { F as s, W as r } from "./FeedbackBox.stories-CTFzhH6J.js";
const x = [
  {
    date: "2025-05-22",
    version: "3.6.2",
            ...
            children: [
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, {
                    children: e.jsx(n.code, { children: "1.3.0" }),
                  }),
                ],
              }),
              e.jsxs(n.tr, {
...
`,
              e.jsx(o, {
                href: "#feedbackbox-screens",
                target: "_self",
                children: "FeedbackBox Screens",
              }),
              `
`,
            ],
...
`,
              e.jsx(o, {
                href: "#programmatically-open",
                target: "_self",
                children: "Programmatically Open",
              }),
              `
`,
            ],
...
`,
      e.jsx(n.p, {
        children: `An NYPL privacy policy link will render within every screen of the FeedbackBox
...
`,
          e.jsxs(n.li, {
            children: [
              "For the purposes of Storybook, only one (1) ",
              e.jsx(n.code, { children: "FeedbackBox" }),
              ` component
example is rendered on the bottom right of this page. The `,
              e.jsx(n.code, { children: "FeedbackBox" }),
              ` example
...
`,
          e.jsxs(n.li, {
            children: [
              "The background color and color mode can be updated in the ",
              e.jsx(n.code, { children: "FeedbackBox" }),
              `
"With Controls" tab in Storybook. To get a better idea of how the `,
              e.jsx(n.code, { children: "FeedbackBox" }),
              `
...
`,
              e.jsx(n.code, { children: "ui.white" }),
              ", ",
              e.jsx(n.code, { children: "ui.bg.default" }),
              ", ",
              e.jsx(n.code, { children: "dark.ui.bg.default" }),
              ", and ",
              e.jsx(n.code, { children: "dark.ui.bg.page" }),
              ".",
            ],
          }),
          `
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "FeedbackBox" }),
          ` component is a complex component built from various Reservoir
DS and Chakra components. The two main components are the DS `,
          e.jsx(n.code, { children: "Button" }),
          ` component
used to open Chakra's `,
          e.jsx(n.code, { children: "Drawer" }),
          " component.",
        ],
      }),
      `
...
"Escape" key, or by clicking outside of the dialog. When the `,
          e.jsx(n.code, { children: "FeedbackBox" }),
          `
...
`,
      e.jsxs(n.p, {
        children: [
          "The markup of the ",
          e.jsx(n.code, { children: "FeedbackBox" }),
          ` structurally matches the modal dialog pattern
that is implemented by Chakra's `,
          e.jsx(n.code, { children: "Modal" }),
          " and ",
          e.jsx(n.code, { children: "Drawer" }),
          ` components. The container
has `,
          e.jsx(n.code, { children: "role=”dialog”" }),
          ", ",
          e.jsx(n.code, { children: "aria-modal=”true”" }),
          ", ",
          e.jsx(n.code, { children: "tabindex={0}" }),
          ", ",
          e.jsx(n.code, { children: "aria-labelledby" }),
          ` that
references the title within the dialog, and `,
          e.jsx(n.code, { children: "aria-describedby" }),
          ` that references a
...
`,
      e.jsxs(n.p, {
        children: [
          "Within the ",
          e.jsx(n.code, { children: "FeedbackBox" }),
          ` component, the radio input field is created from the DS
`,
          e.jsx(n.code, { children: "RadioGroup" }),
          " and ",
          e.jsx(n.code, { children: "Radio" }),
          ` components, and input fields are created from the DS
`,
          e.jsx(n.code, { children: "TextInput" }),
          ` component. Each of these components has their own accessibility
...
`,
      e.jsxs(n.p, {
        children: [
          "Whereas the ",
          e.jsx(n.code, { children: "FeedbackBox" }),
          `'s primary button element is placed within the DOM
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://v1.chakra-ui.com/docs/components/overlay/modal#accessibility",
              rel: "nofollow",
              children: "Chakra Modal Accessibility",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://v1.chakra-ui.com/docs/components/overlay/drawer#accessibility",
              rel: "nofollow",
              children: "Chakra Drawer Accessibility",
            }),
          }),
          `
`,
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              children: "DS Radio Accessibility",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              children: "DS RadioGroup Accessibility",
            }),
          }),
          `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "notificationText" }),
          ` prop can be used to display important or relevant
information above the form's description text. The text or JSX element passed
will be rendered in a Reservoir `,
...
`,
          e.jsx(n.code, { children: "FeedbackBox" }),
          " component. There is a 500 character limit for this textarea field.",
        ],
      }),
      `
`,
...
application. If there is an error, the `,
          e.jsx(n.code, { children: "isInvalidComment" }),
          ` prop can be used to
...
will be selected by default. Use the `,
          e.jsx(n.code, { children: "showCategoryField" }),
          ` prop to toggle the
...
email field. Use the `,
          e.jsx(n.code, { children: "showEmailField" }),
          ` prop to toggle the visibility of this
field.`,
        ],
      }),
      `
...
application. If there is an error, the `,
          e.jsx(n.code, { children: "isInvalidEmail" }),
          ` prop can be used to
toggle the invalid state.`,
        ],
      }),
...
`,
          e.jsx(n.code, { children: "FeedbackBox" }),
          ` component that there is an error, the "confirmation" screen will
...
`,
      e.jsxs(n.p, {
        children: [
          "This is the initial screen that will render based on the default ",
          e.jsx(n.code, { children: "view" }),
          ` prop
value of `,
          e.jsx(n.code, { children: '"form"' }),
          `. The "form" screen will render an optional notification,
...
complete. The other option is to pass the `,
          e.jsx(n.code, { children: "view" }),
          " prop a value of ",
...
is always the same, an email-specific message when `,
          e.jsx(n.code, { children: "showEmailField" }),
          ` is set to
`,
          e.jsx(n.code, { children: "true" }),
          ", an additional confirmation message set through the ",
          e.jsx(n.code, { children: "confirmationText" }),
          `
...
successful API request. Setting the `,
          e.jsx(n.code, { children: "view" }),
          " prop through a ",
          e.jsx(n.code, { children: "useState" }),
          ` value is
only one way to update and pass the "confirmation" value to the `,
          e.jsx(n.code, { children: "FeedbackBox" }),
          `
component. Using the `,
          e.jsx(n.code, { children: "fetch" }),
          " API is one possible approach.",
        ],
      }),
      `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          'The only way to render the "error" screen is by passing the ',
          e.jsx(n.code, { children: "view" }),
          ` prop a value
of `,
          e.jsx(n.code, { children: '"error"' }),
          ". This ",
          e.jsx(n.strong, { children: "should" }),
          ` be used if there is an error with the form
...
`,
      e.jsx(n.p, {
        children: `The "error" screen will render an error icon, an error message, the privacy
...
API request. Setting the `,
          e.jsx(n.code, { children: "view" }),
          " prop through a ",
          e.jsx(n.code, { children: "useState" }),
          ` value is only one way
to update and pass the "error" value to the `,
          e.jsx(n.code, { children: "FeedbackBox" }),
          ` component. Using the
`,
          e.jsx(n.code, { children: "fetch" }),
...
can use. The object will always contain the `,
          e.jsx(n.code, { children: "comment" }),
          ` field. If the "category"
field is visible through the `,
          e.jsx(n.code, { children: "showCategoryField" }),
          ` prop, then the object will also
contain the `,
          e.jsx(n.code, { children: "category" }),
          ` field. If the "email" field is visible through the
`,
          e.jsx(n.code, { children: "showEmailField" }),
          " prop, then the object will also contain the ",
...
`,
          ...
          " component's ",
          e.jsx(n.code, { children: "onSubmit" }),
          ` prop. The form data will be returned through
the function's argument as an object, called `,
...
`,
      e.jsx(n.h3, {
        id: "hidden-field-values",
        children: "Hidden Field Values",
      }),
      `
`,
      e.jsxs(n.p, {
...
the form data from the `,
          e.jsx(n.code, { children: "FeedbackBox" }),
          " component, the ",
          e.jsx(n.code, { children: "hiddenFields" }),
          ` prop can be
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "FeedbackBox" }),
          ` component can be opened programmatically if needed, but this
requires an extra step when importing and implementing the component. Instead
of importing the `,
          e.jsx(n.code, { children: "FeedbackBox" }),
          " component directly, use the ",
          e.jsx(n.code, { children: "useFeedbackBox" }),
          ` hook
to get the `,
          e.jsx(n.code, { children: "FeedbackBox" }),
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "FeedbackBox" }),
          ` component is the same as the one imported directly, but now
the `,
...
example below that uses a custom `,
          e.jsx(n.code, { children: "Button" }),
          ` to open the Modal. The existing button
...
`,
      ...
      `
`,
      e.jsx(m, { changelogData: x }),
    ],
  });
}
function j(i = {}) {
  const { wrapper: n } = { ...d(), ...i.components };
  return n ? e.jsx(n, { ...i, children: e.jsx(a, { ...i }) }) : a(i);
}
export { j as default };
