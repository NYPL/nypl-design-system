import { a4 as a, j as e, V as j, r as V, o as v } from "./iframe-D93LbwGv.js";
import { a as B } from "./storybookUtils-BmTl87w5.js";
const F = {
    ...
    argTypes: {
      ...
      isDismissible: B(),
      onClick: { control: !1 },
      tagSetData: { control: !1 },
      type: { control: !1, table: { defaultValue: { summary: "filter" } } },
    },
  },
  t = {
    args: {
      ...
      tagSetData: [
        {
          label: e.jsx("a", {
            href: "../?path=/story/components-basic-elements-card--with-controls",
            children: "Card",
          }),
        },
        {
          ...
          label: e.jsx("a", {
            href: "../?path=/story/components-page-layout-structuredcontent--controls",
        ...
        },
        {
          ...
          label: e.jsx("a", {
            href: "../?path=/story/components-feedback-progressindicator--with-controls",
        ...
        },
        {
          ...
          label: e.jsx("a", {
            href: "../?path=/docs/hooks-usenyplbreakpoints--docs",
            children: "useNYPLBreakpoints React hook",
          }),
        },
      ],
      type: "explore",
    ...
    argTypes: {
      isDismissible: { table: { disable: !0 } },
      onClick: { table: { disable: !0 } },
    },
    parameters: {
      design: {
        type: "figma",
  ...
  c = [
    { iconName: "utilityAccountFilled", id: "abby-road", label: "Abbey Road" },
  ...
  R = () => {
    const [n, i] = V.useState(c),
      D = (s) => {
        if (
          (console.log(`Clicked from the onClick props: ${s.label}`),
          s.id === "clear-filters")
        ) {
          i([]);
          return;
        }
        i((w) => w.filter((T) => T.id !== s.id));
      };
    return n.length === 0
      ? e.jsx(v, {
          id: "reset-tags",
  ...
  r = {
    render: (n) =>
      e.jsx(a, { id: "tagSet-id-filter", tagSetData: c, type: "filter" }),
  },
  l = {
    args: {
      className: void 0,
      id: void 0,
      isDismissible: void 0,
      onClick: void 0,
      tagSetData: void 0,
      type: void 0,
    },
        ...
        children: [
          e.jsx(a, {
            tagSetData: [
              {
                label: e.jsx("a", {
                  href: "../?path=/story/components-basic-elements-card--card-with-controls",
                  children: "Card",
                }),
              },
              {
                label: e.jsx("a", {
                  href: "../?path=/docs/components-page-layout-structuredcontent--structured-content-with-controls",
                  children: "StructuredContent",
                }),
              },
              {
                label: e.jsx("a", {
                  href: "../?path=/docs/components-feedback-progressindicator--progress-indicator-with-controls",
                  children: "ProgressIndicator",
                }),
              },
              {
                label: e.jsx("a", {
                  href: "../?path=/docs/hooks-usenyplbreakpoints--page",
                  children: "useNYPLBreakpoints React hook",
                }),
              },
            ],
          ...
          e.jsx(a, {
            isDismissible: !0,
            onClick: (n) => console.log(`Clicked from the onClick props: ${n}`),
            tagSetData: [
              { id: "red", label: "Red" },
              { id: "orange", label: "Orange" },
              { id: "yellow", label: "Yellow" },
...
t.parameters = {
  ...
  parameters: {
    ...
    description: {
      ...
      ...((h = (b = t.parameters) == null ? void 0 : b.docs) == null
        ? void 0
        : h.description),
    },
  },
...
o.parameters = {
  ...
  render: _args => <FilterVariantStory />
      ...
      ...((f = (u = o.parameters) == null ? void 0 : u.docs) == null
        ? void 0
        : f.source),
    },
  },
...
r.parameters = {
  ...
  render: _args => <TagSet id="tagSet-id-filter" tagSetData={defaultTagSetData} type="filter" />
      ...
      ...((S = (k = r.parameters) == null ? void 0 : k.docs) == null
        ? void 0
        : S.source),
    },
  },
...
l.parameters = {
  ...
  render: () => <VStack align="stretch" gap="l">
      ...
      ...((C = (x = l.parameters) == null ? void 0 : x.docs) == null
        ? void 0
        : C.source),
    },
  },
    ...
    Object.defineProperty(
      {
        ...
        ExploreVariant: t,
        FilterVariant: r,
        FilterVariantDismiss: o,
        FormattingExamples: l,
...
export { t as E, o as F, L as T, r as a, l as b };
