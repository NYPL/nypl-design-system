...
import {
  ...
  b as y,
  c as b,
} from "./DatePicker.stories-CyJhaAr3.js";
const D = [
  {
    date: "2024-09-19",
    version: "3.3.2",
            ...
            children: [
              e.jsxs(t.tr, {
                children: [
                  ...
                  e.jsx(t.td, {
                    children: e.jsx(t.code, { children: "0.24.0" }),
                  }),
                ],
              }),
              e.jsxs(t.tr, {
                children: [
                  ...
                  e.jsx(t.td, {
                    children: e.jsx(t.code, { children: "3.3.2" }),
                  }),
                ],
              }),
            ],
...
`,
              e.jsx(n, {
                href: "#date-inputs-and-output",
                target: "_self",
                children: "Date Inputs and Output",
              }),
              `
`,
            ],
...
`,
              e.jsx(n, {
                href: "#getting-date-input-values",
                target: "_self",
                children: "Getting Date Input Values",
              }),
              `
`,
            ],
...
`,
      e.jsx(t.p, {
        children: `This is fully customizable to allow selectable full dates, only the month, or
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          e.jsx(t.code, { children: "react-datepicker" }),
          ` npm package.
This package exports a component that is used internally to display the popup
calendar, manage its data, and associate the `,
          e.jsx(t.code, { children: "<label>" }),
          ` element with its corresponding
`,
...
`,
      e.jsx(t.p, {
        children: `This component is accessible through keyboard navigation. When keyboard users tab to
...
`,
      e.jsxs(t.p, {
        children: [
          "The Reservoir ",
          e.jsx(t.code, { children: "DatePicker" }),
          " handles the grouping of the two ",
          e.jsx(t.code, { children: "<input>" }),
          ` elements in
the "date range" mode by wrapping the elements in a `,
          e.jsx(t.code, { children: "<fieldset>" }),
          ` element with
its own `,
          e.jsx(t.code, { children: "<legend>" }),
          ` label for the group. Note that this is in addition to the two
labels that each `,
          e.jsx(t.code, { children: "<input>" }),
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          `
attribute. If a `,
          e.jsx(t.code, { children: "helperTextFrom" }),
          " or ",
          e.jsx(t.code, { children: "helperTextTo" }),
          ` is passed in addition to a general
`,
          e.jsx(t.code, { children: "helperText" }),
          " for the entire ",
          e.jsx(t.code, { children: "DatePicker" }),
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          ` that tells screen reader users what
the element is and how to access its calendar. In the "date range" mode, when `,
...
`,
          e.jsx(t.li, {
            children: e.jsx(t.a, {
              href: "https://github.com/Hacker0x01/react-datepicker#accessibility",
              rel: "nofollow",
              children: "react-datepicker Accessibility",
            }),
          }),
          `
`,
          e.jsx(t.li, {
            children: e.jsx(t.a, {
              href: "https://whatsock.com/Templates/Datepickers/Basic,%20Auto%20Open/index.htm",
              rel: "nofollow",
              children: "Apex 4x Technical Style Guide: Aria Date Picker",
            }),
          }),
          `
`,
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          e.jsx(t.code, { children: "isDateRange" }),
          " prop to ",
...
will share the props and styling. Note that for date range types, a `,
          e.jsx(t.code, { children: "fieldset" }),
          `
is used as the parent wrapper and the `,
          e.jsx(t.code, { children: "labelText" }),
          " is used for the ",
          e.jsx(t.code, { children: "legend" }),
          `
...
`,
      e.jsx(t.p, {
        children: `Note: In the following example, the minimum date is "1/1/2022" and the max date
...
`,
      e.jsxs(t.p, {
        children: [
          "By default, the ",
          e.jsx(t.code, { children: "DatePicker" }),
          ` will display the input date value in the full
format that contains the year, month, and day such as "2021-01-30". Although
this is the default, it can be explicitly set through the `,
          e.jsx(t.code, { children: "dateType" }),
          ` prop with
value of `,
...
the month and the year when `,
          e.jsx(t.code, { children: "dateType" }),
          " is set to ",
          e.jsx(t.code, { children: '"month"' }),
          `. Note
...
`,
      e.jsxs(t.p, {
        children: [
          "It's possible to select dates by only the year when ",
          e.jsx(t.code, { children: "dateType" }),
          ` is set to
`,
          e.jsx(t.code, { children: '"year"' }),
          `. Note that only 12 values will appear in the popup calendar; the four
...
`,
      e.jsx(t.h2, {
        id: "date-inputs-and-output",
        children: "Date Inputs and Output",
      }),
      `
`,
      e.jsx(t.h3, {
        id: "initial-date-values",
        children: "Initial Date Values",
      }),
      `
`,
      e.jsxs(t.p, {
        children: [
          "The initial date values can be set through ",
          e.jsx(t.code, { children: "initialDate" }),
          ` for the "From" input
field and `,
          e.jsx(t.code, { children: "initialDateTo" }),
          ` for the "To" input field. In the following examples,
`,
          e.jsx(t.code, { children: "initialDate" }),
          " is ",
          e.jsx(t.code, { children: '"12/1/21"' }),
          " and ",
          e.jsx(t.code, { children: "initialDateTo" }),
          " is ",
          e.jsx(t.code, { children: '"12/10/21"' }),
          `. The
`,
          e.jsx(t.code, { children: "initialDate" }),
          " and ",
          e.jsx(t.code, { children: "initialDateTo" }),
          " values are used in the JS ",
          e.jsx(t.code, { children: "Date" }),
          ` function so
...
`,
      e.jsxs(t.p, {
        children: [
          "The display date format can be updated through the ",
          e.jsx(t.code, { children: "dateFormat" }),
          ` prop. The
default is set to `,
          e.jsx(t.code, { children: '"yyyy-MM-dd"' }),
          ` based on the NYPL styleguide. This should be
written in `,
          e.jsx(t.a, {
...
`,
      e.jsx(t.h3, {
        id: "max-and-min-date-values",
        children: "Max and Min Date Values",
      }),
      `
`,
      e.jsxs(t.p, {
        children: [
          "The maximum and minimum date values can be set through the ",
          e.jsx(t.code, { children: "maxDate" }),
          ` and
`,
          e.jsx(t.code, { children: "minDate" }),
          ` props, respectively. In this example, go back to January through
...
`,
      e.jsx(t.h2, {
        id: "getting-date-input-values",
        children: "Getting Date Input Values",
      }),
      `
`,
      e.jsx(t.h3, {
        id: "controlled-component-using-onchange-prop",
        children: "Controlled Component Using onChange prop",
      }),
      `
`,
      e.jsxs(t.p, {
...
`,
          ...
          ` prop function. This will be called every time the date is updated in
either the start date input field or the end date input field. The returned
data is an object with `,
          e.jsx(t.code, { children: "startDate" }),
          " and ",
          e.jsx(t.code, { children: "endDate" }),
          " keys and ",
          e.jsx(t.code, { children: "Date" }),
          " object values.",
        ],
...
`,
      e.jsx(t.h3, {
        ...
        children: "Uncontrolled Component Using refs",
      }),
      `
`,
      e.jsxs(t.p, {
        children: [
          ...
          e.jsx(t.code, { children: "ref" }),
          ` props
to the DS DatePicker component to get values from the DOM. In this scenario, you
need to also pass in a `,
          e.jsx(t.code, { children: "nameFrom" }),
          " prop so that the ",
          e.jsx(t.code, { children: "ref" }),
          ` values knows what DOM
element to get the value from. If you are using a date range, you need to pass
additional `,
          e.jsx(t.code, { children: "nameTo" }),
          " and ",
          e.jsx(t.code, { children: "refTo" }),
          ` props or else only the start date value will be
obtained.`,
        ],
      }),
      `
`,
      e.jsxs(t.p, {
        children: [
          ...
          e.jsx(t.code, { children: "register" }),
          " React ",
          e.jsx(t.code, { children: "ref" }),
          ` from the
`,
          e.jsx(t.code, { children: "react-hook-form" }),
          " package.",
        ],
      }),
      `
...
`,
      ...
      `
`,
      e.jsx(u, { changelogData: D }),
    ],
  });
}
function k(s = {}) {
  const { wrapper: t } = { ...l(), ...s.components };
  return t ? e.jsx(t, { ...s, children: e.jsx(d, { ...s }) }) : d(s);
}
export { k as default };
