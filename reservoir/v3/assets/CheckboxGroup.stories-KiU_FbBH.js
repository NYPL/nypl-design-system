...
const { expect: r, userEvent: T, within: Q } = __STORYBOOK_MODULE_TEST__,
  Z = {
    ...
    argTypes: {
      ...
      isFullWidth: { table: { defaultValue: { summary: "true" } } },
      isInvalid: { table: { defaultValue: { summary: "false" } } },
      isRequired: { table: { defaultValue: { summary: "false" } } },
      key: { table: { disable: !0 } },
      layout: { table: { defaultValue: { summary: "column" } }, options: N },
      name: { control: !1 },
      onChange: { control: !1 },
      ref: { table: { disable: !0 } },
  ...
  n = {
    ...
    render: (l) =>
      e.jsxs(t, {
        ...l,
        children: [
          e.jsx(a, { id: "checkbox-2", value: "2", labelText: "Checkbox 2" }),
          e.jsx(a, { id: "checkbox-3", value: "3", labelText: "Checkbox 3" }),
          e.jsx(a, { id: "checkbox-4", value: "4", labelText: "Checkbox 4" }),
          e.jsx(a, { id: "checkbox-5", value: "5", labelText: "Checkbox 5" }),
        ],
      }),
    play: async ({ canvasElement: l }) => {
      const c = Q(l);
      r(c.getByText("Standard Checkbox Group")).toBeInTheDocument(),
        r(c.getByText(/This is the helper text/)).toBeInTheDocument();
      const x = c.getByLabelText("Checkbox 2"),
        s = c.getByLabelText("Checkbox 4"),
        o = c.getByLabelText("Checkbox 5");
      r(x).not.toBeChecked(),
        r(s).not.toBeChecked(),
        await T.click(x),
        await T.click(s),
  ...
  return e.jsxs(t, {
    ...
    children: [
      e.jsx(a, {
        isChecked: x,
        isIndeterminate: s,
        onChange: (o) => c([o.target.checked, o.target.checked]),
        labelText: "Parent Checkbox",
        id: "parent-checkbox",
      }),
      e.jsx(a, {
        isChecked: l[0],
        onChange: (o) => c([o.target.checked, l[1]]),
        labelText: "Child Checkbox 1",
        id: "child-checkbox-1",
      }),
      e.jsx(a, {
        isChecked: l[1],
        onChange: (o) => c([l[0], o.target.checked]),
...
const k = { render: () => e.jsx($, {}) };
function ee() {
  const [l, c] = z.useState([]),
    x = () => {
      c(["art", "science", "math"]);
    },
    s = () => {
    ...
    o = () => {
      c(["physics", "science", "chemistry"]);
    },
    K = (j) => {
      c(j), console.log("Selected values:", j);
    };
  return e.jsxs(X, {
    align: "stretch",
    spacing: "m",
    children: [
      e.jsx("span", { children: "Set values to:" }),
      e.jsxs(Y, {
        children: [
          e.jsx(v, {
            id: "btn1",
            onClick: x,
            children: '"art", "science", "math"',
          }),
          e.jsx(v, {
            id: "btn2",
            onClick: s,
            children: '"math", "music", "magic"',
          }),
          e.jsx(v, {
            id: "btn3",
            onClick: o,
            children: '"physics", "science", "chemistry"',
          }),
        ],
      }),
      e.jsxs(t, {
        ...
        value: l,
        children: [
          e.jsx(a, { id: "art", labelText: "Art", value: "art" }),
          e.jsx(a, {
            id: "chemistry",
            labelText: "Chemistry",
            value: "chemistry",
          }),
          e.jsx(a, { id: "english", labelText: "English", value: "english" }),
          e.jsx(a, { id: "magic", labelText: "Magic", value: "magic" }),
          e.jsx(a, { id: "math", labelText: "Math", value: "math" }),
          e.jsx(a, { id: "music", labelText: "Music", value: "music" }),
          e.jsx(a, { id: "physics", labelText: "Physics", value: "physics" }),
          e.jsx(a, { id: "science", labelText: "Science", value: "science" }),
        ],
      }),
    ],
  });
}
const p = { render: () => e.jsx(ee, {}) };
var g, f, y;
n.parameters = {
  ...n.parameters,
  docs: {
...
i.parameters = {
  ...
  render: () => <VStack align="left" spacing="l">
      ...
      ...((E = (G = i.parameters) == null ? void 0 : G.docs) == null
        ? void 0
        : E.source),
    },
  },
...
h.parameters = {
  ...
  render: () => <CheckboxGroup id="errored" invalidText="Error message for the full group." isInvalid labelText="Errored Checkbox Group" name="errored-example">
      ...
      ...((I = (B = h.parameters) == null ? void 0 : B.docs) == null
        ? void 0
        : I.source),
    },
  },
...
b.parameters = {
  ...
  render: () => <CheckboxGroup id="required" isRequired labelText="Required Checkbox Group" name="required-example" helperText="The reason for being required.">
      ...
      ...((F = (q = b.parameters) == null ? void 0 : q.docs) == null
        ? void 0
        : F.source),
    },
  },
...
u.parameters = {
  ...u.parameters,
  docs: {
    ...((_ = u.parameters) == null ? void 0 : _.docs),
    source: {
      originalSource: `{
  render: () => <CheckboxGroup id="full-width" isFullWidth labelText="Checkbox Group" name="checkbox-example">
      ...
      ...((A = (M = u.parameters) == null ? void 0 : M.docs) == null
        ? void 0
        : A.source),
    },
  },
...
k.parameters = {
  ...k.parameters,
  docs: {
    ...((W = k.parameters) == null ? void 0 : W.docs),
    source: {
      originalSource: `{
  render: () => <IndeterminateCheckboxExample />
}`,
      ...((P = (O = k.parameters) == null ? void 0 : O.docs) == null
        ? void 0
        : P.source),
    },
  },
...
const ae = [
    ...
    "Required",
    "Disabled",
    "LabelsUsingJSXElements",
    "IndeterminateExample",
    "ProgrammaticallyUpdateValues",
  ],
  le = Object.freeze(
    Object.defineProperty(
      {
        ...
        Disabled: d,
        Errored: h,
        IndeterminateExample: k,
        LabelsUsingJSXElements: u,
        Layout: i,
        ProgrammaticallyUpdateValues: p,
        Required: b,
        WithControls: n,
