...
import { T as d, W as o, R as x, D as j } from "./Text.stories-DzDhRk55.js";
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          ` element and can be used to render
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "Text" }),
          " component renders paragraph ",
          e.jsx(n.code, { children: "p" }),
          ` HTML elements which are inherently
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          e.jsx(n.code, { children: "subtitle1" }),
          `,
`,
          e.jsx(n.code, { children: "subtitle2" }),
          ", ",
          e.jsx(n.code, { children: "overline1" }),
          " and ",
          e.jsx(n.code, { children: "overline2" }),
...
`,
          e.jsx(n.a, {
            href: "../?path=/docs/style-guide-typography--docs#text-display-sizes",
