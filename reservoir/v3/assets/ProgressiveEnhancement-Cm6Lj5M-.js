...
const h =
  "" + new URL("progressive-enhancement-D6OmyPF-.png", import.meta.url).href;
function l(i) {
  const n = {
    a: "a",
    code: "code",
  ...
  return e.jsxs(e.Fragment, {
    children: [
      e.jsx(o, { title: "Accessibility Guide/Progressive Enhancement" }),
      `
`,
      e.jsx(n.h1, {
...
`,
              e.jsx(r, {
                href: "#nypl-and-ds-problem",
                target: "_self",
                children: "NYPL and DS Problem",
              }),
              `
`,
            ],
...
`,
              e.jsx(r, {
                href: "#html-button-issue",
                target: "_self",
                children: "HTML Button Issue",
              }),
              `
`,
            ],
...
`,
      e.jsx(n.p, {
        children: `Progressive enhancement is a frontend development strategy and mindset that
...
`,
      e.jsx(n.p, {
        children: `A key benefit of progressive enhancement is that it prioritizes a fast and
...
`,
      e.jsx(n.p, {
        children: `On the development side, this inclusive design philosophy focuses on knowing and
...
`,
      e.jsx(n.h2, {
        id: "nypl-and-ds-problem",
        children: "NYPL and DS Problem",
      }),
      `
`,
      e.jsx(n.p, {
        children: `When JavaScript is turned off in the browser, certain NYPL user interfaces and
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          "s can only work without JavaScript in the following contexts.",
        ],
      }),
      `
`,
...
`,
          e.jsxs(n.li, {
            children: [
              ...
              ` element, if it has an attribute of type="submit",
...
`,
          e.jsxs(n.li, {
            children: [
              "When used inside a ",
              e.jsx(n.code, { children: "<form>" }),
              ` element, if it has an attribute of type="reset",
...
`,
      e.jsxs(n.p, {
        children: [
          "However, there are several DS components that use the ",
          e.jsx(n.code, { children: "Button" }),
          ` component (and
therefore the `,
          e.jsx(n.code, { children: "<button>" }),
          ` HTML element) outside of a form to open, close, or
...
`,
      e.jsx(n.p, {
        children: `As of v3.6.1, the DS contains 25 fully functional components, and 34 components
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.code, { children: "FeaturedContent" }),
          }),
          `
`,
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.code, { children: "HelperErrorText" }),
          }),
          `
`,
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.code, { children: "HorizontalRule" }),
          }),
          `
`,
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.code, { children: "SkipNavigation" }),
          }),
          `
`,
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.code, { children: "StructuredContent" }),
          }),
          `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          "The following (16) use the HTML ",
          e.jsx(n.code, { children: "<button>" }),
          ` element and are not fully functional
without JavaScript:`,
        ],
      }),
      `
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.code, { children: "AlphabetFilter" }),
          }),
          `
`,
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.code, { children: "MultiSelectGroup" }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.code, { children: "NewsletterSignup" }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.code, { children: "Notification" }),
          }),
          `
`,
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.code, { children: "CheckboxGroup" }),
          }),
          `
`,
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.code, { children: "FilterBarInline" }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.code, { children: "FilterBarPopup" }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.code, { children: "ProgressIndicator" }),
          }),
          `
`,
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.code, { children: "SkeletonLoader" }),
          }),
          `
`,
...
`,
      e.jsx(n.p, {
        children: "The following (1) depend on external libraries:",
      }),
      `
`,
      e.jsxs(n.ul, {
...
`,
      e.jsxs(n.p, {
        children: [
          "Based on the ",
          e.jsx(n.a, {
            href: "https://github.com/NYPL/engineering-general/blob/main/standards/javscript.md",
            rel: "nofollow",
            children: "Engineering General JavaScript standard",
          }),
          `,
...
`,
      e.jsx(n.p, {
        children: `Various new pages and features being built for NYPL have JavaScript-heavy
...
`,
      e.jsx(n.h2, {
        id: "noscript-fallback-example",
        children: "noscript Fallback Example",
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          "We recommend placing the following ",
          e.jsx(n.code, { children: "noscript" }),
          ` snippet at the top of the
`,
          e.jsx(n.code, { children: "<body>" }),
          " tag in your HTML for the global message.",
        ],
      }),
      `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          "If you are using the Pages Router, you can add the ",
          e.jsx(n.code, { children: "noscript" }),
          ` tag in the
`,
          e.jsx(n.code, { children: "_document.js" }),
          " file.",
        ],
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          "If you are using the App Router, you can add the ",
          e.jsx(n.code, { children: "noscript" }),
          ` tag in the
`,
          e.jsx(n.code, { children: "layout.js" }),
          " file.",
        ],
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          ...
          e.jsx(n.code, { children: "noscript" }),
          ` tag is rendered on the server side for
      ...
      e.jsx(a, {
        content: e.jsxs(e.Fragment, {
          children: [
            ...
            " The above example needs to be modified to work appropriately in Next.js. See the",
            " ",
            e.jsx(n.a, {
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "MDN Progressive Enhancement",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://piccalil.li/blog/its-about-time-i-tried-to-explain-what-progressive-enhancement-actually-is/",
              rel: "nofollow",
              children:
