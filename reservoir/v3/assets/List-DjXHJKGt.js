            ...
            children: [
              e.jsxs(s.tr, {
                children: [
                  ...
                  e.jsx(s.td, {
                    children: e.jsx(s.code, { children: "0.7.0" }),
                  }),
                ],
              }),
              e.jsxs(s.tr, {
                children: [
                  ...
                  e.jsx(s.td, {
                    children: e.jsx(s.code, { children: "3.6.0" }),
                  }),
                ],
              }),
            ],
...
`,
              e.jsx(t, {
                href: "#lists-with-data-props",
                target: "_self",
                children: "Lists with Data Props",
              }),
              `
`,
            ],
...
`,
      e.jsxs(s.p, {
        children: [
          "Internally, the ",
          e.jsx(s.code, { children: "List" }),
          ` component implements native HTML markup for unordered,
ordered, and description lists. This includes `,
          e.jsx(s.code, { children: "ul" }),
          ", ",
          e.jsx(s.code, { children: "ol" }),
          ", and ",
          e.jsx(s.code, { children: "dl" }),
          ` elements.
When data is passed into the `,
          e.jsx(s.code, { children: "listItems" }),
          ` data prop, the appropriate children
HTML elements are used. This includes `,
          e.jsx(s.code, { children: "li" }),
          ` for unorder and ordered lists, and
`,
          e.jsx(s.code, { children: "dt" }),
          " and ",
          e.jsx(s.code, { children: "dd" }),
          " elements for description lists.",
        ],
      }),
      `
`,
      e.jsxs(s.p, {
        children: [
          "The description type for the ",
          e.jsx(s.code, { children: "List" }),
          " component is wrapped in a ",
          e.jsx(s.code, { children: "section" }),
          ` element
with an `,
          e.jsx(s.code, { children: "h2" }),
          " header. Keep that in mind when ordering headings on the page.",
        ],
      }),
      `
`,
...
`,
          e.jsx(s.li, {
            children: e.jsx(s.a, {
              href: "https://www.w3.org/WAI/tutorials/page-structure/content/",
              rel: "nofollow",
              children: "W3C WAI Content Structure",
            }),
          }),
          `
`,
          e.jsx(s.li, {
            children: e.jsx(s.a, {
              ...
              rel: "nofollow",
              children:
                "Deque University Appropriate Semantic Markup for Lists",
            }),
          }),
          `
`,
...
`,
      e.jsx(s.p, {
        children: e.jsx(s.em, {
          children: `Note: This element is officially called the "Description List" element in HTML5.
...
`,
          e.jsx(s.li, {
            children: e.jsx(s.a, {
              href: "https://www.w3.org/WAI/WCAG21/Techniques/html/H40.html",
              rel: "nofollow",
              children: "W3C Using description lists",
            }),
          }),
          `
`,
          e.jsx(s.li, {
            children: e.jsx(s.a, {
              ...
              rel: "nofollow",
              children: "MDN dl: The Description List element",
            }),
          }),
          `
`,
...
`,
      e.jsxs(s.p, {
        children: [
          ...
          e.jsx(s.code, { children: '"dl"' }),
          " to the ",
          e.jsx(s.code, { children: "type" }),
          ` prop. The optional
`,
          e.jsx(s.code, { children: "title" }),
          ` prop will now render above the description list element. This type of
list renders `,
          e.jsx(s.code, { children: "dt" }),
          " and ",
          e.jsx(s.code, { children: "dd" }),
...
`,
      e.jsxs(s.p, {
        children: [
          "By default, the ",
          e.jsx(s.code, { children: '"dl"' }),
          ` description list will render row dividers between each
`,
          e.jsx(s.code, { children: "dt" }),
          "/",
          e.jsx(s.code, { children: "dd" }),
          " pair. To remove the row dividers, pass ",
          e.jsx(s.code, { children: "false" }),
          ` to the
`,
          e.jsx(s.code, { children: "showRowDividers" }),
          " prop.",
        ],
      }),
      `
...
`,
      e.jsx(s.h3, {
        id: "description-list-with-custom-headings",
        children: "Description List with Custom Headings",
      }),
      `
`,
      e.jsxs(s.p, {
        children: [
          "The optional ",
          e.jsx(s.code, { children: "title" }),
          " prop will render the description list's heading as an ",
          e.jsx(s.code, { children: "h2" }),
          `
element by default when the `,
          e.jsx(s.code, { children: "title" }),
          ` value is a string. It's possible that the
`,
          e.jsx(s.code, { children: "h2" }),
          ` element will not fit in an app's heading hierarchy. If this is the case,
`,
          e.jsx(s.code, { children: "title" }),
          " can also take a ",
          e.jsx(s.code, { children: "JSX.Element" }),
          " type value.",
        ],
      }),
      `
...
`,
      e.jsx(s.h3, {
        id: "description-list-of-links",
        children: "Description List of Links",
      }),
      `
`,
      e.jsxs(s.p, {
        children: [
          "An example with HTML elements inside of the ",
          e.jsx(s.code, { children: "dd" }),
          " elements.",
        ],
      }),
...
`,
      e.jsxs(s.p, {
        children: [
          ...
          "/",
          e.jsx(s.code, { children: "dd" }),
          " elements cannot be passed as children to the ",
          e.jsx(s.code, { children: "List" }),
          ` element,
an array with data can be passed into the `,
          e.jsx(s.code, { children: "listItems" }),
          ` prop. Note: either
children elements or the `,
          e.jsx(s.code, { children: "listItems" }),
          " prop should be passed but not both.",
        ],
      }),
      `
`,
      e.jsx(s.h3, {
        id: "unordered-and-ordered",
        children: "Unordered and Ordered",
      }),
      `
`,
      e.jsxs(s.p, {
...
stored as an array of strings, then that data array can be passed into `,
          e.jsx(s.code, { children: "listItems" }),
          ".",
        ],
      }),
...
an array of objects, then that data array can be passed into `,
          e.jsx(s.code, { children: "listItems" }),
          `. The
object must have two keys, `,
          e.jsx(s.code, { children: "term" }),
          " and ",
...
`,
      ...
      `
`,
      e.jsx(x, { changelogData: w }),
    ],
  });
}
function v(i = {}) {
  const { wrapper: s } = { ...h(), ...i.components };
  return s ? e.jsx(s, { ...i, children: e.jsx(l, { ...i }) }) : l(i);
}
export { v as default };
