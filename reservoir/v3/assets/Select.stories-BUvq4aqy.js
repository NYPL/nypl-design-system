...
import { a } from "./storybookUtils-BmTl87w5.js";
const { expect: h, userEvent: v, within: N } = __STORYBOOK_MODULE_TEST__,
  J = {
    ...
    argTypes: {
      ...
      showHelperInvalidText: a("true"),
      showLabel: a("true"),
      showRequiredLabel: a("true"),
      value: { control: !1 },
    },
  },
  i = {
    ...
    render: (o) =>
      e.jsxs(l, {
        ...o,
        children: [
          e.jsx("option", { value: "red", children: "Red" }),
          e.jsx("option", { value: "green", children: "Green" }),
          e.jsx("option", { value: "blue", children: "Blue" }),
          e.jsx("option", { value: "black", children: "Black" }),
          e.jsx("option", { value: "white", children: "White" }),
        ],
      }),
    parameters: {
      design: {
    ...
    play: async ({ canvasElement: o }) => {
      const t = N(o),
        n = t.getByRole("combobox");
      await v.selectOptions(n, "green"),
        h(t.getByText("Green").selected).toBeTruthy(),
        await v.selectOptions(n, "black"),
        h(t.getByText("Black").selected).toBeTruthy(),
        h(t.getByText("Green").selected).toBeFalsy();
    },
  },
  r = {
    render: () =>
  ...
  u = {
    render: () =>
      e.jsxs(l, {
        ...
        name: "country",
        children: [
          e.jsx("option", { value: "algeria", children: "Algeria" }),
          e.jsx("option", { value: "argentina", children: "Argentina" }),
          e.jsx("option", { value: "australia", children: "Australia" }),
          e.jsx("option", { value: "brazil", children: "Brazil" }),
          e.jsx("option", { value: "canada", children: "Canada" }),
          e.jsx("option", { value: "china", children: "China" }),
        ],
      }),
  };
function K() {
  const [o, t] = _.useState(),
    n = (x) => {
      console.log("Controlled value:", x.target.value), t(x.target.value);
    };
  return e.jsxs(l, {
    helperText: "This is the helper text.",
    id: "example-1",
...
const p = { render: () => e.jsx(K, {}) };
function Y() {
  const o = _.createRef(),
    t = () => {
      const n = o.current.value;
      console.log("Using uncontrolled ref:", n);
    };
  return e.jsx(P, {
    id: "form",
    children: e.jsxs(U, {
      children: [
        ...
        e.jsx(z, { id: "submit", onClick: t, children: "Submit" }),
      ],
    }),
  });
}
const d = { render: () => e.jsx(Y, {}) };
var b, m, T, j, f;
i.parameters = {
  ...i.parameters,
  docs: {
  ...
  play: async ({
    ...
    expect((screen.getByText("Green") as HTMLOptionElement).selected).toBeFalsy();
      ...
      ...((T = (m = i.parameters) == null ? void 0 : m.docs) == null
        ? void 0
        : T.source),
    },
    description: {
      ...
      ...((f = (j = i.parameters) == null ? void 0 : j.docs) == null
        ? void 0
        : f.description),
    },
  },
...
r.parameters = {
  ...
  render: () => <VStack align="stretch" spacing={8}>
      ...
      ...((B = (g = r.parameters) == null ? void 0 : g.docs) == null
        ? void 0
        : B.source),
    },
  },
...
s.parameters = {
  ...
  render: () => <Select helperText="This is the helper text." id="errored" invalidText="This is the error text :(" isInvalid labelText="What is your favorite color?" name="color">
      ...
      ...((w = (k = s.parameters) == null ? void 0 : k.docs) == null
        ? void 0
        : w.source),
    },
  },
...
c.parameters = {
  ...
  render: () => <Select helperText="This is the helper text." id="disabled" invalidText="This is the error text :(" isDisabled labelText="What is your favorite color?" name="color">
      ...
      ...((G = (R = c.parameters) == null ? void 0 : R.docs) == null
        ? void 0
        : G.source),
    },
  },
...
u.parameters = {
  ...
  render: () => <Select autoComplete="country-name" id="autocomplete" labelText="Select a country" name="country">
      ...
      ...((D = (C = u.parameters) == null ? void 0 : C.docs) == null
        ? void 0
        : D.source),
    },
  },
...
p.parameters = {
  ...
  render: () => <SelectControlledExample />
      ...
      ...((V = (L = p.parameters) == null ? void 0 : L.docs) == null
        ? void 0
        : V.source),
    },
  },
...
d.parameters = {
  ...
  render: () => <SelectUncontrolledExample />
      ...
      ...((O = (I = d.parameters) == null ? void 0 : I.docs) == null
        ? void 0
        : O.source),
    },
  },
    ...
    Object.defineProperty(
      {
        ...
        Errored: s,
        GetInputValue: p,
        GetUncontrolledInputValue: d,
        LabellingVariations: r,
        WithControls: i,
        __namedExportsOrder: Q,
        default: J,
      },
      Symbol.toStringTag,
      { value: "Module" }
...
export { u as A, c as D, s as E, p as G, r as L, $ as S, i as W, d as a };
