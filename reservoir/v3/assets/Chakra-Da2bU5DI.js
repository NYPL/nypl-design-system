...
`,
      e.jsx(n.p, {
        children: `The Reservoir Design System (DS) project was influenced by other design systems but
...
`,
      e.jsx(n.p, {
        children: `Chakra UI is an open source component library that is opinionated and uses design
...
`,
      e.jsx(n.p, {
        children: `Chakra follows WAI-ARIA and WCAG 2.1 standards and guidelines which aligns with
...
`,
          e.jsx(n.em, { children: "if necessary" }),
          `, and accessibility standards in place, developers at NYPL using
...
`,
      e.jsxs(n.p, {
        children: [
          "We recommend to read Chakra's own ",
          e.jsx(n.a, {
...
our `,
          e.jsx(n.a, {
            href: "https://github.com/NYPL/nypl-design-system/blob/development/CHAKRA_MIGRATION_GUIDE.md",
            rel: "nofollow",
            children: "Chakra Migration Guide",
          }),
          ".",
        ],
      }),
...
`,
      e.jsx(n.p, {
        children: `In order to use DS components in a consuming application, there is a necessary
...
will render styles properly. Internally, the `,
          e.jsx(n.code, { children: "DSProvider" }),
          ` is built on top of
Chakra's `,
          e.jsx(n.code, { children: "ChakraProvider" }),
...
Chakra have a `,
          ...
          " component so we will use Chakra's ",
          e.jsx(n.code, { children: "Button" }),
          ` component to
compose the DS `,
          e.jsx(n.code, { children: "Button" }),
          " component. However, the DS has a ",
          e.jsx(n.code, { children: "Hero" }),
          ` component that
is not already built by Chakra. In this case, the DS `,
          e.jsx(n.code, { children: "Hero" }),
          ` component will
internally use `,
          e.jsx(n.code, { children: "Chakra" }),
          " components such as ",
...
`,
      e.jsx(n.h3, {
        id: "components-composed-with-chakra",
        children: "Components Composed with Chakra",
      }),
      `
`,
      e.jsx(n.p, {
        children: `While we can directly use Chakra components that align with DS components, we
...
available. For example, whereas `,
          e.jsx(n.code, { children: "m" }),
          " (",
          e.jsx(n.code, { children: "margin" }),
          "), ",
          e.jsx(n.code, { children: "me" }),
          " (",
...
`,
      e.jsxs(n.p, {
        children: [
          "Components built from Chakra rename the component with the ",
          e.jsx(n.code, { children: "Chakra" }),
          " name prefix.",
        ],
      }),
...
`,
      e.jsxs(n.p, {
        children: [
          "In this example, the ",
          e.jsx(n.code, { children: "ChakraTabs" }),
...
`,
      e.jsx(n.p, {
        children: `We are writing CSS style object rules into Javascript objects that work with
...
as `,
          e.jsx(n.code, { children: ".button-outline" }),
          " to a Javascript object (more on this in the ",
          e.jsx(s, {
            href: "#anatomy-of-a-component-styling-object",
            target: "_self",
            children: `Anatomy of a
...
`,
      e.jsx(n.h3, {
        id: "components-re-exported-from-chakra",
        children: "Components re-exported from Chakra",
      }),
      `
`,
      e.jsxs(n.p, {
...
in the `,
          e.jsx(n.code, { children: "/src/index.ts" }),
          " file. Note that not ",
          e.jsx(n.em, { children: "all" }),
          ` Chakra components are re-exported
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          ", ",
          e.jsx(n.code, { children: "HStack" }),
          ", ",
          e.jsx(n.code, { children: "Square" }),
          ", ",
          e.jsx(n.code, { children: "Stack" }),
          ", ",
          e.jsx(n.code, { children: "VStack" }),
        ],
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          ...
          `: These components are harder to have snapshot tests for because, internally,
...
`,
      e.jsxs(n.p, {
        children: [
          e.jsx(n.strong, { children: "Update" }),
          `: Newer Chakra UI versions have mostly fixed this issue. Still, since
...
`,
      e.jsxs(n.p, {
        children: [
          "The NYPL DS' theme file can be found at ",
          e.jsx(n.code, { children: "src/theme/index.ts" }),
          `. This creates a new
theme that extends Chakra's theme and is set in the `,
          e.jsx(n.code, { children: "DSProvider" }),
          ` component. Note
that the example below is the general structure of the `,
          e.jsx(n.code, { children: "theme" }),
          ` object but the DS
`,
          e.jsx(n.code, { children: "theme" }),
          ` object has values already set so it may look different. You would generally
only work and add new object values in the `,
          e.jsx(n.code, { children: "components" }),
          ` obejct key for new
...
`,
      e.jsxs(n.p, {
        children: [
          e.jsx(n.em, { children: "Note" }),
          `: There are some SCSS files used to style third party plugins and to
...
`,
      e.jsx(n.h3, {
        id: "anatomy-of-a-component-styling-object",
        children: "Anatomy of a Component Styling Object",
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          "For in-depth information, read Chakra's ",
          e.jsx(n.a, {
            href: "https://chakra-ui.com/docs/theming/component-style",
            rel: "nofollow",
            children: "Component Style documentation",
          }),
          ".",
        ],
      }),
...
`,
      e.jsxs(n.p, {
        children: [
          "Component theme files can be found in the ",
          e.jsx(n.code, { children: "src/theme/components/" }),
          ` directory.
...
the `,
          e.jsx(n.code, { children: "variants" }),
        ...
        children: [
          e.jsx(n.thead, {
            children: e.jsxs(n.tr, {
              children: [
                e.jsx(n.th, { children: "Key Name" }),
                e.jsx(n.th, { children: "EM/PX value" }),
              ],
            }),
          }),
          e.jsxs(n.tbody, {
            children: [
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, { children: "sm" }),
                  e.jsx(n.td, { children: "20em/320px" }),
                ],
              }),
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, { children: "md" }),
                  e.jsx(n.td, { children: "38em/600px" }),
                ],
              }),
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, { children: "lg" }),
                  e.jsx(n.td, { children: "60em/960px" }),
                ],
              }),
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, { children: "xl" }),
                  e.jsx(n.td, { children: "80em/1280px" }),
                ],
              }),
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, { children: "2xl" }),
                  e.jsx(n.td, { children: "96em/1536px" }),
                ],
              }),
            ],
          }),
...
effect at defined breakpoint values. Note that the Chakra `,
          e.jsx(n.code, { children: '"base"' }),
          ` key value is
the same as `,
...
`,
          e.jsx(n.code, { children: "button.ts" }),
...
`,
      e.jsxs(n.p, {
        children: [
          "All available colors can be found in ",
          e.jsx(n.code, { children: "src/theme/foundations/colors.ts" }),
          `. Chakra
autogenerates the `,
          e.jsx(n.code, { children: "colors" }),
      ...
      e.jsxs(n.table, {
        children: [
          e.jsx(n.thead, {
            children: e.jsxs(n.tr, {
              children: [
                e.jsx(n.th, { children: "Theme object value" }),
                e.jsx(n.th, { children: "CSS variable" }),
              ],
            }),
          }),
          e.jsxs(n.tbody, {
            children: [
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, {
                    children: e.jsx(n.code, { children: "colors.ui.focus" }),
                  }),
                  e.jsx(n.td, {
              ...
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, {
                    children: e.jsx(n.code, {
                      children: "colors.ui.link.primary",
                    }),
                  }),
                  e.jsx(n.td, {
                    children: e.jsx(n.code, {
              ...
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, {
                    children: e.jsx(n.code, {
                      children: "colors.ui.link.secondary",
                    }),
                  }),
                  e.jsx(n.td, {
                    children: e.jsx(n.code, {
              ...
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, {
                    children: e.jsx(n.code, {
                      children: 'colors.section["whats-on"].primary',
                    }),
                  }),
                  e.jsx(n.td, {
                    children: e.jsx(n.code, {
              ...
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, {
                    children: e.jsx(n.code, {
                      children: 'colors.section["whats-on"].secondary',
                    }),
                  }),
                  e.jsx(n.td, {
                    children: e.jsx(n.code, {
...
`,
          e.jsx(n.code, { children: "red.400" }),
          ", ",
          e.jsx(n.code, { children: "blue.600" }),
...
`,
      e.jsxs(n.p, {
        children: [
          "All the spacing values can be found in the ",
          e.jsx(n.code, { children: "src/theme/foundations/spacing.ts" }),
          `
      ...
      e.jsxs(n.table, {
        children: [
          e.jsx(n.thead, {
            children: e.jsxs(n.tr, {
              children: [
                e.jsx(n.th, { children: "NYPL name Value" }),
                e.jsx(n.th, { children: "Chakra Value" }),
                e.jsx(n.th, { children: "DS Variable" }),
              ],
            }),
          }),
          e.jsxs(n.tbody, {
            children: [
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, { children: "xxs" }),
                  e.jsx(n.td, { children: "1" }),
                  e.jsx(n.td, { children: "--nypl-space-xxs" }),
                ],
              }),
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, { children: "xs" }),
                  e.jsx(n.td, { children: "2" }),
                  e.jsx(n.td, { children: "--nypl-space-xs" }),
                ],
              }),
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, { children: "s" }),
                  e.jsx(n.td, { children: "4" }),
                  e.jsx(n.td, { children: "--nypl-space-s" }),
                ],
              }),
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, { children: "m" }),
                  e.jsx(n.td, { children: "6" }),
                  e.jsx(n.td, { children: "--nypl-space-m" }),
                ],
              }),
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, { children: "l" }),
                  e.jsx(n.td, { children: "8" }),
                  e.jsx(n.td, { children: "--nypl-space-l" }),
                ],
              }),
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, { children: "xl" }),
                  e.jsx(n.td, { children: "12" }),
                  e.jsx(n.td, { children: "--nypl-space-xl" }),
                ],
              }),
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, { children: "xxl" }),
                  e.jsx(n.td, { children: "16" }),
                  e.jsx(n.td, { children: "--nypl-space-xxl" }),
                ],
              }),
              e.jsxs(n.tr, {
                children: [
                  e.jsx(n.td, { children: "xxxl" }),
                  e.jsx(n.td, { children: "24" }),
                  e.jsx(n.td, { children: "--nypl-space-xxxl" }),
                ],
              }),
            ],
          }),
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          e.jsx(n.code, { children: "button" }),
          "s have a ",
          e.jsx(n.code, { children: "padding: 8px 16px" }),
          " value:",
        ],
      }),
      `
...
`,
      e.jsxs(n.p, {
        children: [
          "All typography values can be found in the ",
          e.jsx(n.code, { children: "src/theme/foundations/typography.ts" }),
          `
...
`,
      e.jsx(n.p, {
        children: `NYPL Reservoir components are built around the Chakra UI library. While Reservoir
...
`,
      e.jsx(l, {
        isBold: !0,
        children:
          "While this is available to use, it is not recommended. If you see a need to override styles, please reach out to the NYPL Reservoir team for assistance.",
      }),
      `
`,
      e.jsxs(n.p, {
...
UI `,
          e.jsx(n.a, {
            href: "https://chakra-ui.com/docs/styled-system/features/style-props",
            rel: "nofollow",
            children: "Style Props page",
          }),
          ".",
        ],
      }),
...
CSS-in-JS styles in your React components, the `,
          e.jsx(n.code, { children: "useNYPLTheme" }),
          ` hook will provide
you with NYPL-specific style values. This hook depends on the `,
          e.jsx(n.code, { children: "DSProvider" }),
          `
...
`,
      e.jsxs(n.p, {
        children: [
          "After importing and rendering the ",
          e.jsx(n.code, { children: "DSProvider" }),
...
`,
      e.jsx(n.p, {
        children: e.jsx(n.em, {
          children: "Note: more patterns will be added.",
        }),
      }),
      `
`,
...
tested in the `,
          e.jsx(n.code, { children: "@chakra-ui/react" }),
...
function h(o = {}) {
  const { wrapper: n } = { ...i(), ...o.components };
