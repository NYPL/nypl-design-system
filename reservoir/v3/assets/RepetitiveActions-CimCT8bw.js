import { u as a, j as e, M as r, L as t, S as s } from "./iframe-D93LbwGv.js";
function l(i) {
  const n = {
    a: "a",
    code: "code",
  ...
  return e.jsxs(e.Fragment, {
    children: [
      e.jsx(r, { title: "Accessibility Guide/Repetitive Actions" }),
      `
`,
...
`,
              e.jsx(t, {
                href: "#unique-button-labels-and-link-text",
                target: "_self",
                children: "Unique Button Labels and Link Text",
              }),
              `
`,
            ],
...
`,
      e.jsx(n.p, {
        children: `To navigate a website, screen reader users often tab through buttons and links
...
`,
      e.jsx(n.h2, {
        id: "unique-button-labels-and-link-text",
        children: "Unique Button Labels and Link Text",
      }),
      `
`,
      e.jsx(n.p, {
        children: `Button labels and link text should generally be unique on any given page,
primarily to aid navigation for screen reader users.`,
      }),
      `
`,
      e.jsx(n.p, {
        children: `In cases where the visible text cannot be changed, additional context can be
...
`,
          e.jsx(n.li, {
            children: `adding additional text within the button or link and hiding it off-screen so
...
`,
          e.jsx(n.li, {
            children: "using aria-label to override the visible text",
          }),
          `
`,
          e.jsx(n.li, {
            children: `using aria-labelledby to override the visible text by referencing both the
...
`,
      e.jsx(n.p, {
        children: 'For example, a link that is visibly titled "Read more" can:',
      }),
      `
`,
      e.jsxs(n.ul, {
...
`,
          e.jsxs(n.li, {
            children: [
              "include ",
              e.jsx(n.code, {
                children: '<span class="sr-only">about jobs</span>',
              }),
              ` after the visible text
within the link where `,
              e.jsx(n.code, { children: "sr-only" }),
              ` is a custom class with styles to position the
`,
              e.jsx(n.code, { children: "<span>" }),
              " element off-screen",
            ],
          }),
          `
`,
          e.jsxs(n.li, {
            children: [
              ...
              " attribute with complete descriptive text",
            ],
          }),
          `
`,
          e.jsxs(n.li, {
            children: [
              ...
              ` attribute with references to multiple element IDs,
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://www.scottohara.me/blog/2017/04/14/inclusively-hidden.html",
              rel: "nofollow",
              children: "Scott O'Hara Blog: Inclusively Hidden",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://www.washington.edu/accessibility/checklist/links-buttons/",
              rel: "nofollow",
              children: "University of Washington: Links and Buttons",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://www.washington.edu/accessibility/websites/links-buttons/",
              rel: "nofollow",
              children:
                "University of Washington: Links and Buttons on Websites",
            }),
          }),
          `
`,
