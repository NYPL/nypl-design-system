import { u as a, j as e, M as o, L as s, S as r } from "./iframe-D93LbwGv.js";
function l(i) {
  const n = {
    a: "a",
    code: "code",
  ...
  return e.jsxs(e.Fragment, {
    children: [
      e.jsx(o, { title: "Style Guide/Breakpoints" }),
      `
`,
...
`,
      e.jsx(n.p, {
        children: `The Reservoir Design System (DS) adheres to four global breakpoints for
...
`,
      e.jsx(n.p, {
        children: "The following CSS variables are available through the DS.",
      }),
      `
`,
      e.jsx(r, {
...
`,
      e.jsxs(n.p, {
        children: [
          "If you are using SCSS and imported the DS ",
          e.jsx(n.code, { children: "/dist/resources.scss" }),
          ` file, then you
can use the following SCSS variables in your media queries or SCSS `,
          e.jsx(n.code, { children: "breakpoint" }),
          `
function (if used).`,
        ],
      }),
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://www.figma.com/file/qShodlfNCJHb8n03IFyApM/Master?node-id=17983%3A60146",
              rel: "nofollow",
              children:
