import { al as t, j as e, a6 as H, m as S, L as b } from "./iframe-D93LbwGv.js";
const C = {
    title: "Components/Content Display/HelperErrorText",
    component: t,
    argTypes: {
      ariaAtomic: { control: !1, table: { defaultValue: { summary: "true" } } },
      ariaLive: { table: { defaultValue: { summary: "polite" } } },
      children: { table: { disable: !0 } },
      className: { control: !1 },
      id: { control: !1 },
      isInvalid: { table: { defaultValue: { summary: "false" } } },
      isRenderedText: { table: { defaultValue: { summary: "false" } } },
    },
  },
  r = {
    args: {
    ...
    render: (a) =>
      e.jsx(t, {
        ...a,
        text: a.isInvalid ? "This is the error text :(" : a.text,
      }),
  },
  s = {
  ...
  n = {
    args: { ariaAtomic: !0, ariaLive: "polite" },
    name: "ARIA Controls",
    render: (a) =>
      e.jsx(t, {
        ...a,
      ...
      e.jsxs(e.Fragment, {
        children: [
          e.jsx(t, {
            text: e.jsxs(e.Fragment, {
              children: [
                ...
                " ",
                e.jsx("a", { href: "https://nypl.org", children: "a link" }),
                ".",
              ],
            }),
          }),
          e.jsx(t, {
            text: e.jsxs(S, {
              children: [
                "This second example uses Reservoir Design System (DS) components, such as the ",
                e.jsx(b, { href: "#", children: "`Link`" }),
                " component, and the `Text` component.",
              ],
            }),
          }),
        ],
  ...
  i = {
    name: "Invalid State",
    render: () =>
      e.jsx(t, { isInvalid: !0, text: "This is the error text :(" }),
  };
var l, p, d, c, m;
r.parameters = {
  ...r.parameters,
  ...
  render: args => <HelperErrorText {...args} text={args.isInvalid ? "This is the error text :(" : args.text} />
      ...
      ...((d = (p = r.parameters) == null ? void 0 : p.docs) == null
        ? void 0
        : d.source),
    },
    description: {
...
n.parameters = {
  ...
  render: args => <HelperErrorText {...args} text="Live updates to the helper and error text can be read to screen readers with the appropriate aria-atomic and aria-live props." />
      ...
      ...((f = (v = n.parameters) == null ? void 0 : v.docs) == null
        ? void 0
        : f.source),
    },
  },
...
o.parameters = {
  ...
  render: () => <>
      ...
      ...((y = (I = o.parameters) == null ? void 0 : I.docs) == null
        ? void 0
        : y.source),
    },
  },
...
i.parameters = {
  ...
  render: () => <HelperErrorText isInvalid text="This is the error text :(" />
      ...
      ...((j = (L = i.parameters) == null ? void 0 : L.docs) == null
        ? void 0
        : j.source),
    },
  },
...
export { n as A, k as H, i as I, s as T, r as W, o as a };
