import { u as o, j as e, M as s, L as l } from "./iframe-D93LbwGv.js";
function r(i) {
  const n = {
    a: "a",
    code: "code",
  ...
  return e.jsxs(e.Fragment, {
    children: [
      e.jsx(s, { title: "Style Guide/Forms" }),
      `
`,
...
`,
              e.jsx(l, {
                href: "#input-labelling",
                target: "_self",
                children: "Input Labelling",
              }),
              `
`,
            ],
...
`,
      e.jsxs(n.p, {
        children: [
          "Use the ",
          e.jsx(n.a, {
            href: "../?path=/story/components-form-elements-form--with-controls",
            children: "Form",
          }),
          `
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          ` component offers two child-components to assist with layout:
`,
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "FormField" }),
          ` component is used as a parent for all input components from
...
`,
          e.jsx(n.code, { children: "Form" }),
          ` is it is necessary to wrap each individual form input component within
a `,
          e.jsx(n.code, { children: "FormField" }),
          " component to ensure proper spacing and responsiveness.",
        ],
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "FormRow" }),
          " component is used as a parent of multiple ",
          e.jsx(n.code, { children: "FormField" }),
          ` components
...
`,
      e.jsx(n.p, {
        children: `The recommended layout and spacing within individual form input components is
...
`,
      e.jsx(n.p, {
        children: `The list of form input fields available in the Reservoir Design System (DS)
...
`,
          e.jsx(n.li, {
            children: "TextInput (text, tel, url, number, password, textarea)",
          }),
          `
`,
...
`,
      e.jsx(n.p, {
        children: `Most form components in the DS will have the option to show a
label, basic helper text and error text.`,
      }),
      `
`,
      e.jsx(n.p, {
        children: `For accessibility compliance, a text value for the label is always required. If
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          ", ",
          e.jsx(n.code, { children: "FileUploader" }),
          `,
`,
          ...
          " and ",
          e.jsx(n.code, { children: "TextInput" }),
          ` will show the label at the top
of the rendered component. While `,
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://www.figma.com/file/qShodlfNCJHb8n03IFyApM/?node-id=10734%3A2768",
              rel: "nofollow",
              children: "General Forms Page",
            }),
          }),
          `
`,
...
function d(i = {}) {
  const { wrapper: n } = { ...o(), ...i.components };
