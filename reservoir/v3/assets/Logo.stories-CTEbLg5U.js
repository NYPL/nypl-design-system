import { ap as I, bj as t, j as l, Z as R, H as _ } from "./iframe-D93LbwGv.js";
...
const V = [
  ...
  E = ["default", "xxsmall", "xsmall", "small", "medium", "large"],
  J = {
    ...
    argTypes: {
      ...
      decorative: G(),
      id: { control: !1 },
      name: { control: { type: "select" }, options: V },
      size: {
        control: { type: "select" },
        options: E,
  ...
  o = {
    ...
    render: (e) =>
      l.jsx("div", {
        style:
          e.name.indexOf("White") !== -1 || e.name.indexOf("Negative") !== -1
            ? {
  ...
  g = (e, T = {}) => {
    const a = { textAlign: "center" },
      { size: d = "large", displayValue: F, sizeBasedOn: q = "width" } = T;
    let h = e;
    return (
      (e.indexOf("White") !== -1 || e.indexOf("Negative") !== -1) &&
        ((a.backgroundColor = "var(--nypl-colors-ui-gray-xx-dark)"),
        (a.color = "var(--nypl-colors-ui-white)"),
        (a.paddingBottom = "var(--nypl-space-l)"),
        (a.paddingTop = "var(--nypl-space-l)")),
      d !== "large" && (h += `-${d}`),
      l.jsxs(
        "div",
        {
          style: a,
          children: [
            l.jsx(_, { level: "h4", size: "heading6", children: F }),
            l.jsx(t, { name: e, size: d, sizeBasedOn: q }),
          ],
        },
        h
      )
...
for (const e in p) A.push(g(p[e], { displayValue: p[e] }));
for (const e in s)
  N.push(g("nyplFullBlack", { displayValue: s[e].display, size: s[e].size }));
for (const e in s)
  H.push(
    g("nyplFullBlack", {
      displayValue: s[e].display,
      size: s[e].size,
      sizeBasedOn: "height",
    })
  );
const m = (e) => l.jsx(R, { columns: 1, children: e }),
  r = { render: () => m(N) },
  i = { render: () => m(H) },
  n = { render: () => m(A) },
  c = {
      ...
      l.jsx(t, {
        ...
        children: l.jsx("svg", {
          ...
          children: l.jsxs("g", {
            ...
            clipRule: "evenodd",
            children: [
              l.jsx("path", { fill: "#fff", d: "M0 0h192.756v192.756H0V0z" }),
              l.jsx("path", {
...
o.parameters = {
  ...
  render: args => <div style={args.name.indexOf("White") !== -1 || args.name.indexOf("Negative") !== -1 ? {
    backgroundColor: "var(--nypl-colors-ui-gray-xx-dark)",
    display: "inline-block",
    padding: "var(--nypl-space-l)",
    width: "100%"
  ...
  parameters: {
    ...
    jest: ["Logo.test.tsx"]
      ...
      ...((v = (y = o.parameters) == null ? void 0 : y.docs) == null
        ? void 0
        : v.source),
    },
    description: {
      ...
      ...((f = (x = o.parameters) == null ? void 0 : x.docs) == null
        ? void 0
        : f.description),
    },
  },
...
r.parameters = {
  ...
  render: () => allLogosGrid(sizes)
      ...
      ...((C = (k = r.parameters) == null ? void 0 : k.docs) == null
        ? void 0
        : C.source),
    },
  },
...
i.parameters = {
  ...
  render: () => allLogosGrid(sizesBasedOnHeight)
      ...
      ...((W = (b = i.parameters) == null ? void 0 : b.docs) == null
        ? void 0
        : W.source),
    },
  },
...
n.parameters = {
  ...
  render: () => allLogosGrid(logos)
      ...
      ...((j = (S = n.parameters) == null ? void 0 : S.docs) == null
        ? void 0
        : j.source),
    },
  },
...
c.parameters = {
  ...
  render: args => <Logo {...args}>
      ...
      ...((O = (M = c.parameters) == null ? void 0 : M.docs) == null
        ? void 0
        : O.source),
    },
  },
...
export { n as A, c as C, D as L, r as S, o as W, i as a };
