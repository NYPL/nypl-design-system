import { u as o, j as e, M as d, S as i } from "./iframe-D93LbwGv.js";
function t(n) {
  const s = {
    a: "a",
    code: "code",
  ...
  return e.jsxs(e.Fragment, {
    children: [
      e.jsx(d, { title: "Hooks/useWindowSize" }),
      `
`,
...
`,
      e.jsxs(s.p, {
        children: [
          ...
          e.jsx(s.a, {
            href: "https://usehooks-typescript.com/react-hook/use-window-size",
            rel: "nofollow",
            children: "Typescript hooks",
          }),
          `.
...
`,
      e.jsxs(s.p, {
        children: [
          ...
          e.jsxs(s.a, {
            href: "https://github.com/NYPL/nypl-design-system/blob/development/src/components/Tabs/Tabs.tsx",
            rel: "nofollow",
            children: [e.jsx(s.code, { children: "Tabs" }), " component"],
          }),
          ".",
        ],
      }),
...
function r(n = {}) {
  const { wrapper: s } = { ...o(), ...n.components };
