...
function d(t) {
  ...
  return e.jsxs(e.Fragment, {
    children: [
      e.jsx(c, { title: "Style Guide/Buttons" }),
      `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          "Use the ",
          e.jsx(n.a, {
            href: "../?path=/story/components-form-elements-button--with-controls",
            children: "Button",
          }),
          `
...
`,
          e.jsx(n.li, {
            children: `Buttons used for Back to Top actions have a Secondary button style with an
...
`,
          e.jsxs(n.li, {
            children: [
              "When buttons are used in a group, they should be wrapped in a ",
...
the `,
              ...
              " button is on the right and the ",
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          " components are displayed in a group, use the ",
          e.jsx(n.code, { children: "ButtonGroup" }),
          `
component to handle the spacing and layout. The `,
          e.jsx(n.code, { children: "ButtonGroup" }),
          ` component will use
`,
          e.jsx(n.code, { children: "--nypl-space-xs" }),
          " (0.5rem) for spacing in horizontal group layouts.",
        ],
      }),
      `
`,
...
`,
          e.jsx(n.code, { children: "--nypl-space-l" }),
          ` (2rem) for spacing between all other UI elements. This spacing
...
`,
      e.jsx(r, {
        ...
        children: e.jsxs(l, {
          mb: "16px",
          children: [
            e.jsx(i, { id: "basic", children: "Button Text" }),
            e.jsxs(i, {
              id: "btn-search",
              children: [
                e.jsx(o, { name: "search", size: "small", align: "left" }),
                "Button Text",
              ],
            }),
            e.jsx(i, {
              id: "only-icon",
              children: e.jsx(o, { name: "close", size: "medium" }),
            }),
            e.jsx(i, {
              buttonType: "callout",
              id: "donate",
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "buttonType" }),
          ` prop should be used to render various forms of the button
component.`,
        ],
      }),
      `
      ...
      e.jsx(r, {
        ...
        children: e.jsxs(l, {
          ...
          children: [
            ...
            e.jsx(i, { buttonType: "text", id: "text", children: "Text" }),
            e.jsx(i, {
              buttonType: "callout",
              id: "callout",
              children: "Callout",
            ...
            e.jsx(i, { buttonType: "pill", id: "pill", children: "Pill" }),
            e.jsx(i, {
              buttonType: "link",
              id: "link",
...
`,
          e.jsx(n.li, {
            children: "used for actions that move the user forward",
          }),
          `
`,
...
`,
          e.jsx(n.li, {
            children: "Visual Treatment: plain text only without an underline",
          }),
          `
`,
        ],
...
`,
          e.jsx(n.li, {
            children: "used for call to actions such as donation buttons",
          }),
          `
`,
          e.jsx(n.li, {
            children: "Visual Treatment: rectangular, NYPL red background",
          }),
          `
`,
        ],
...
`,
          e.jsx(n.li, {
            children: "used in cases where there is no brand color",
          }),
          `
`,
          e.jsx(n.li, {
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          ` variant has been deprecated for accessibility reasons. From a visual
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          ` prop should be used to render various sizes of the button component:
`,
          e.jsx(n.code, { children: '"small"' }),
          ", ",
          e.jsx(n.code, { children: '"medium"' }),
          " (default) and ",
          e.jsx(n.code, { children: '"large"' }),
          ".",
        ],
      }),
      `
...
`,
          e.jsx(n.li, {
            children: `This size can be used when space is limited or when the action is of lesser
significance.`,
          }),
          `
`,
          e.jsxs(n.li, {
            children: [
              ...
              " Even though the ",
              e.jsx(n.code, { children: '"small"' }),
              ` size is available, it is recommended
to use the `,
              e.jsx(n.code, { children: '"medium"' }),
              " or ",
              e.jsx(n.code, { children: '"large"' }),
...
`,
          e.jsx(n.li, {
            children: `This button size should be used unless there is a very compelling reason to
...
`,
          e.jsxs(n.li, {
            children: [
              ...
              " Use the ",
              e.jsx(n.code, { children: '"large"' }),
              " size sparingly. Layouts should generally have only one ",
              e.jsx(n.code, { children: '"large"' }),
              " button.",
            ],
          }),
...
`,
          e.jsxs(n.li, {
            children: [
              'The "Back to Top" button must be set as ',
              e.jsx(n.code, { children: '"secondary"' }),
              ` and must include an up
arrow icon.`,
            ],
          }),
          `
`,
          e.jsxs(n.li, {
            children: [
              "Previous and Next buttons should be set as ",
              e.jsx(n.code, { children: '"secondary"' }),
              ` and be wrapped in a
`,
              e.jsx(n.code, { children: "ButtonGroup" }),
...
`,
          e.jsxs(n.li, {
            children: [
              "Only use the ",
              e.jsx(n.code, { children: '"noBrand"' }),
              " style where there is no brand color. ",
              e.jsx(n.em, {
        ...
        children: e.jsxs(l, {
          children: [
            e.jsx(i, {
              ...
              id: "callout2",
              mb: "16px",
              children: "Donate to this library",
            }),
            e.jsxs(i, {
              buttonType: "secondary",
              id: "secondary2",
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://www.figma.com/file/qShodlfNCJHb8n03IFyApM/Master?node-id=11477%3A2298",
              rel: "nofollow",
              children:
