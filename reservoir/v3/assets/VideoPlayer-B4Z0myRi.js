...
import {
  ...
  E as m,
  H as j,
} from "./VideoPlayer.stories-BQfw39n_.js";
            ...
            children: [
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, {
                    children: e.jsx(n.code, { children: "0.23.2" }),
                  }),
                ],
              }),
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, {
                    children: e.jsx(n.code, { children: "3.6.4" }),
                  }),
                ],
              }),
            ],
...
`,
              e.jsx(i, {
                href: "#extracting-video-ids",
                target: "_self",
                children: "Extracting Video IDs",
              }),
              `
`,
            ],
...
`,
              e.jsx(i, {
                href: "#example-embed-code-snippets",
                target: "_self",
                children: "Example Embed Code Snippets",
              }),
              `
`,
            ],
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          " component is used to embed a ",
          e.jsx(n.code, { children: "Vimeo" }),
          " or ",
          e.jsx(n.code, { children: "YouTube" }),
          ` video player
on a page. The component requires the `,
          e.jsx(n.code, { children: "embedCode" }),
          " prop or both the ",
          e.jsx(n.code, { children: "videoType" }),
          `
and `,
          e.jsx(n.code, { children: "videoId" }),
          ` props. The component will not function properly if you try to set
all of them.`,
        ],
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          "You can extract the videoId from the video's URL. ",
          e.jsx(n.strong, { children: "IMPORTANT:" }),
          ` Do not try to
enter the full video URL as the `,
          e.jsx(n.code, { children: "videoId" }),
          " value.",
        ],
      }),
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          ` prop is used to control the sizing of the space allotted for
the video rendering. Ultimately, the `,
          e.jsx(n.code, { children: "aspectRatio" }),
          ` prop should be set to match
the aspect ratio of the video that is being rendered. The default aspect ratio
is `,
          e.jsx(n.code, { children: "16:9" }),
          ".",
        ],
      }),
      `
...
`,
      e.jsxs(n.p, {
        children: [
          e.jsx(n.strong, { children: "Example Vimeo IDs:" }),
          " ",
          e.jsx(n.code, { children: "474719268" }),
          ", ",
          e.jsx(n.code, { children: "491405018" }),
          ", ",
          e.jsx(n.code, { children: "493795778" }),
          " (square)",
          e.jsx("br", {}),
          `
`,
          e.jsx(n.strong, { children: "Example YouTube IDs:" }),
          " ",
          e.jsx(n.code, { children: "PfqgDG1qrKg" }),
          ", ",
          e.jsx(n.code, { children: "roi5V8ppi7Y" }),
          ", ",
          e.jsx(n.code, { children: "nm-dD2tx6bk" }),
        ],
      }),
      `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          ` element with either a Vimeo or
YouTube video. `,
          e.jsx(n.code, { children: "iframe" }),
          "s can be accessible if a ",
          e.jsx(n.code, { children: "title" }),
          ` attribute is provided.
When passing in a video type and a video `,
          e.jsx(n.code, { children: "id" }),
          `, make sure to pass a title.
Otherwise, the title must already be provided in the embed code value that is
passed to the `,
          e.jsx(n.code, { children: "embedCode" }),
          ` prop. A default one is provided but a custom one is
recommended.`,
        ],
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          "Not all the Vimeo or YouTube videos passed to the ",
          e.jsx(n.code, { children: "VideoPlayer" }),
          ` component will
...
`,
          e.jsx(n.li, {
            children: `Never use autoplay on videos; a user must click the play button to start the
video.`,
          }),
          `
`,
          e.jsx(n.li, {
            children: `Always show all the video player's controls for the user to interact with the
video.`,
          }),
          `
`,
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "W3C Making Audio and Video Media Accessible",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://webaim.org/techniques/frames/",
              rel: "nofollow",
              children: "WebAIM Creating Accessible Frames and Iframes",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "MDN iframe: The Inline Frame element",
            }),
          }),
          `
`,
...
`,
      e.jsx(n.h2, {
        id: "example-embed-code-snippets",
        children: "Example Embed Code Snippets",
      }),
      `
`,
      e.jsx(n.p, {
        children: `The examples below are shown with precise HTML formatting. However, often the
...
`,
      e.jsxs(n.p, {
        children: [
          "If the necessary props are not passed to the ",
          e.jsx(n.code, { children: "VideoPlayer" }),
          ` component, the
...
`,
      e.jsxs(n.p, {
        children: [
          "It's possible to include HTML in the ",
          e.jsx(n.code, { children: "helperText" }),
          " prop.",
        ],
      }),
      `
