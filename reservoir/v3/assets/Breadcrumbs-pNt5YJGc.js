...
import {
  ...
  C as j,
  a as m,
} from "./Breadcrumbs.stories-DoM5vSpf.js";
const b = [
  {
    date: "2025-01-30",
    version: "3.5.3",
            ...
            children: [
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, {
                    children: e.jsx(n.code, { children: "0.0.3" }),
                  }),
                ],
              }),
              e.jsxs(n.tr, {
...
`,
              e.jsx(s, {
                href: "#custom-link-and-link-props",
                target: "_self",
                children: "Custom Link and Link Props",
              }),
              `
`,
            ],
...
`,
      e.jsxs(n.p, {
        children: [
          "Only one ",
          e.jsx(n.code, { children: "Breadcrumbs" }),
          ` component should be rendered on a page. This is because
only one HTML `,
          e.jsx(n.code, { children: "<nav>" }),
          " element with an ",
          e.jsx(n.code, { children: "aria-label" }),
          ` attribute value of
"Breadcrumbs" should be rendered on a page. The DS `,
          e.jsx(n.code, { children: "Breadcrumbs" }),
          ` component
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          ` list element. The current page link is
denoted by an `,
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://www.w3.org/TR/wai-aria-practices/examples/breadcrumb/index.html",
              rel: "nofollow",
              children: "W3 Breadcrumbs Practice",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://chakra-ui.com/docs/components/navigation/breadcrumb",
              rel: "nofollow",
              children: "Chakra UI Breadcrumb",
            }),
          }),
          `
`,
...
breadcrumb page title is over 40 characters, the `,
          e.jsx(n.code, { children: "Breadcrumb" }),
          ` component will
truncate the title and an ellipsis will be added to the end of the truncated
text. The full title will be shown in a `,
          e.jsx(n.code, { children: "Tooltip" }),
          ` component when hovering over
...
`,
      e.jsx(n.h2, {
        id: "custom-link-component-and-link-props",
        children: "Custom Link Component and Link Props",
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "customLinkComponent" }),
          ` prop allows apps with internal routers (Next.js, for example) to pass their custom link component
into the `,
          e.jsx(n.code, { children: "Breadcrumbs" }),
          " component. This allows the ",
          e.jsx(n.code, { children: "Breadcrumbs" }),
          " links to use client-side routing, so users can navigate between pages without reloading the full page.",
        ],
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          "Additionally, the ",
          e.jsx(n.code, { children: "linkProps" }),
          " prop on ",
          e.jsx(n.code, { children: "breadcrumbsData" }),
          " allows any of the framework's ",
          e.jsx(n.a, {
...
`,
      e.jsxs(n.p, {
        children: [
          "Note: assigning a value for ",
          e.jsx(n.code, { children: "href" }),
          " in ",
          e.jsx(n.code, { children: "linkProps" }),
          " will override the ",
          e.jsx(n.code, { children: "url" }),
          " prop, so we recommend against this.",
        ],
      }),
      `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "Breadcrumbs" }),
          ` component background color can be set to a value of the
`,
          e.jsx(n.code, { children: "breadcrumbsType" }),
          " type. If the ",
          e.jsx(n.code, { children: "breadcrumbsType" }),
          ` prop is omitted, the default
background color is `,
          e.jsx(n.code, { children: '"whatsOn"' }),
          " (",
          e.jsx(n.code, { children: "ui.black" }),
          ").",
        ],
      }),
      `
...
`,
      ...
      `
`,
      e.jsx(x, { changelogData: b }),
    ],
  });
}
function y(r = {}) {
  const { wrapper: n } = { ...c(), ...r.components };
