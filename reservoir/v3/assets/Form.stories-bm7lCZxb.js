...
const L = {
      ...
      e.jsxs(c, {
        ...
        children: [
            ...
            children: [
              ...
              e.jsx(i, {
                children: e.jsxs(x, {
                  ...
                  showLabel: !0,
                  children: [
                    e.jsx("option", { children: "Option 1" }),
                    e.jsx("option", { children: "Option 2" }),
                    e.jsx("option", { children: "Option 3" }),
                    e.jsx("option", { children: "Option 4" }),
                    e.jsx("option", { children: "Option 5" }),
                  ],
                }),
              }),
            ],
          ...
          e.jsx(l, {
            children: e.jsx(i, {
              children: e.jsx(k, {
                children: e.jsx(M, { id: "submit", children: "Submit" }),
              }),
            }),
          }),
        ],
  ...
  P = (t) => {
    ...
    return e.jsxs(
      ...
      {
        children: [
          e.jsx(C, { level: "h3", size: "heading6", children: S }),
          e.jsx(c, {
            gap: t,
            id: `form-spacing-${t}`,
            children: e.jsxs(l, {
              children: [
                e.jsx(i, {
                  children: e.jsxs(x, {
                    helperText: "The select field helper text.",
                    id: `select-spacing-${t}-1`,
                    labelText: "Select Field",
                    name: `select-spacing-${t}-1`,
                    showLabel: !0,
                    children: [
                      e.jsx("option", { children: "Option 1" }),
                      e.jsx("option", { children: "Option 2" }),
                ...
                e.jsx(i, {
                  children: e.jsxs(x, {
                    helperText: "The select field helper text.",
                    id: `select-spacing-${t}-2`,
                    labelText: "Select Field",
                    name: `select-spacing-${t}-2`,
                    showLabel: !0,
                    children: [
                      e.jsx("option", { children: "Option 1" }),
                      e.jsx("option", { children: "Option 2" }),
                ...
                e.jsx(i, {
                  children: e.jsxs(x, {
                    helperText: "The select field helper text.",
                    id: `select-spacing-${t}-3`,
                    labelText: "Select Field",
                    name: `select-spacing-${t}-3`,
                    showLabel: !0,
                    children: [
                      e.jsx("option", { children: "Option 1" }),
                      e.jsx("option", { children: "Option 2" }),
  ...
  y = [],
  h = R;
for (const t in h) y.push(P(h[t]));
const q = (t) => e.jsx("ul", { style: { listStyle: "none" }, children: t }),
  s = { render: () => q(y) };
var m, u, F, T, j;
o.parameters = {
  ...o.parameters,
  ...
  render: args => <Form {...args} id="form-id">
    ...
    description: {
      ...
      ...((j = (T = o.parameters) == null ? void 0 : T.docs) == null
        ? void 0
        : j.description),
    },
  },
...
s.parameters = {
  ...
  render: () => getForms(sizes)
      ...
      ...((f = (g = s.parameters) == null ? void 0 : g.docs) == null
        ? void 0
        : f.source),
    },
  },
};
const I = ["WithControls", "FormSpacing"],
  D = Object.freeze(
