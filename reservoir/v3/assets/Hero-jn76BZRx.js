            ...
            children: [
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, {
                    children: e.jsx(n.code, { children: "0.2.0" }),
                  }),
                ],
              }),
              e.jsxs(n.tr, {
                children: [
                  ...
                  e.jsx(n.td, {
                    children: e.jsx(n.code, { children: "3.4.1" }),
                  }),
                ],
              }),
            ],
...
`,
              e.jsx(r, {
                href: "#active-variants",
                target: "_self",
                children: "Active Variants",
              }),
              `
`,
            ],
...
`,
              e.jsx(r, {
                href: "#fallback-campaign-image",
                target: "_self",
                children: "Fallback Campaign Image",
              }),
              `
`,
            ],
...
`,
              e.jsx(r, {
                href: "#deprecated-variants",
                target: "_self",
                children: "Deprecated Variants",
              }),
              `
`,
            ],
...
`,
              e.jsx(r, {
                href: "#color-variations-for-secondary-hero",
                target: "_self",
                children: "Color Variations for Secondary Hero",
              }),
              `
`,
            ],
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          ` component is used to display a full width banner at the top of a page.
The `,
          e.jsx(n.code, { children: "Hero" }),
          " will contain a required ",
          e.jsx(n.code, { children: "h1" }),
          ` page title and may also include optional
...
`,
      e.jsxs(n.p, {
        children: [
          "There are currently three main hero types: ",
...
`,
      e.jsxs(n.p, {
        children: [
          "Two hero types have been deprecated: ",
          e.jsx(n.code, { children: '"secondary"' }),
          " and ",
          e.jsx(n.code, { children: '"fiftyFifty"' }),
          `. The
...
`,
      e.jsxs(n.p, {
        children: [
          "Under the ",
          e.jsx(n.code, { children: '"secondary"' }),
          ` hero type, there are four additional subtypes:
`,
          e.jsx(n.code, { children: '"secondaryBooksAndMore"' }),
          ", ",
          e.jsx(n.code, { children: '"secondaryLocations"' }),
          ", ",
          e.jsx(n.code, { children: '"secondaryResearch"' }),
          `, and
`,
...
`,
      e.jsxs(n.p, {
        children: [
          "For the variations that use image ",
...
`,
      e.jsxs(n.p, {
        children: [
          "Note: the ",
          e.jsx(n.code, { children: "imageProps" }),
          " prop is not the same as the ",
          e.jsx(n.code, { children: "backgroundImageSrc" }),
          ` prop
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "Hero" }),
          ` component is commonly used as a banner below the page's header and
breadcrumbs and above the main content. This means that if the `,
          e.jsx(n.code, { children: "Hero" }),
          ` displays
a heading element, it should be the first on the page and an `,
          e.jsx(n.code, { children: "h1" }),
          ` element set
through `,
...
`,
      e.jsxs(n.p, {
        children: [
          "Each ",
          e.jsx(n.code, { children: "Hero" }),
          " variation can be rendered through the ",
          e.jsx(n.code, { children: "heroType" }),
          " prop.",
        ],
      }),
      `
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: '"primary"' }),
          " hero type can be used with the ",
          e.jsx(n.code, { children: "backgroundColor" }),
          ", ",
          e.jsx(n.code, { children: "backgroundImageSrc" }),
          `,
`,
          e.jsx(n.code, { children: "foregroundColor" }),
          ", ",
          e.jsx(n.code, { children: "heading" }),
          ", ",
          e.jsx(n.code, { children: "locationDetails" }),
          ", and ",
          e.jsx(n.code, { children: "subHeaderText" }),
          ` props. The
minimum props that should be used are `,
          e.jsx(n.code, { children: "backgroundImageSrc" }),
          " and ",
          e.jsx(n.code, { children: "heading" }),
          ".",
...
`,
          ...
          ", and ",
          e.jsx(n.code, { children: "subHeaderText" }),
          " props. The minimum prop to use is the ",
          e.jsx(n.code, { children: "heading" }),
          `
prop.`,
        ],
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          e.jsx(n.code, { children: '"campaign"' }),
          " hero type can be used with the ",
          e.jsx(n.code, { children: "backdropBackgroundColor" }),
          `,
`,
          e.jsx(n.code, { children: "backgroundColor" }),
          ", ",
...
`,
          ...
          ", and ",
          e.jsx(n.code, { children: "subHeaderText" }),
          ` props. The minimum props to use are
`,
          e.jsx(n.code, { children: "backgroundImageSrc" }),
          ", ",
          e.jsx(n.code, { children: "heading" }),
...
`,
      e.jsx(n.p, {
        children: `This variant has the special use case of having a background and foreground. We
...
`,
      e.jsx(n.h4, {
        id: "isdarkbackgroundimage",
        children: "isDarkBackgroundImage",
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "isDarkBackgroundImage" }),
          " prop can be used in the ",
          e.jsx(n.code, { children: '"campaign"' }),
          ` hero to toggle
...
`,
      e.jsx(n.h4, {
        ...
        children: "backdropBackgroundColor",
      }),
      `
`,
      e.jsxs(n.p, {
...
`,
      e.jsxs(n.p, {
        children: [
          "By default, the ",
          e.jsx(n.code, { children: "Hero" }),
          ` component renders a dark background color with light
...
`,
          ...
          e.jsx(n.code, { children: "foregroundColor" }),
          " and ",
          e.jsx(n.code, { children: "isDarkText" }),
          " props.",
        ],
      }),
      `
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "imageProps" }),
          " prop can be used to set a fallback for the ",
          e.jsx(n.strong, { children: "main" }),
          ` image in
the `,
          e.jsx(n.code, { children: '"campaign"' }),
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "Hero" }),
          " component does not use the ",
          e.jsx(n.code, { children: "Image" }),
          ` component, however, for the
background image. The background image is rendered through the CSS
`,
          e.jsx(n.code, { children: "background-image" }),
          ` property. This means that more work is needed to set a
...
`,
      e.jsx(n.p, {
        children: `The following example demonstrates how to set a fallback image for both the main
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          " variant of the ",
          e.jsx(n.code, { children: "Hero" }),
          ` component has been deprecated. This
...
`,
      e.jsxs(n.p, {
        children: [
          e.jsx(n.strong, { children: "NOTE:" }),
          " The layout offered in the ",
          e.jsx(n.code, { children: "fiftyFifty" }),
          ` variant has been replaced by
the `,
          e.jsx(n.a, {
            href: "../?path=/docs/components-basic-elements-featuredcontent--docs",
...
`,
      e.jsx(n.h2, {
        id: "color-variations-for-secondary-hero",
        children: "Color Variations for Secondary Hero",
      }),
      `
`,
