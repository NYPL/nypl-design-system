import { u as s, j as e, M as r, L as t, S as a } from "./iframe-D93LbwGv.js";
function i(o) {
  const n = {
    a: "a",
    code: "code",
  ...
  return e.jsxs(e.Fragment, {
    children: [
      e.jsx(r, { title: "Development Guide/Header" }),
      `
`,
...
`,
              e.jsx(t, {
                href: "#header-log-in-timeout",
                target: "_self",
                children: "Header Log In Timeout",
              }),
              `
`,
            ],
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          ` is the top most feature on NYPL sites. Even though this component
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://ds-header.nypl.org/header",
              rel: "nofollow",
              children: "NYPL Header Preview",
            }),
          }),
          `
`,
...
`,
          e.jsxs(n.li, {
            children: [
              "uses the DS' ",
              e.jsx(n.code, { children: "SkipNavigation" }),
              " component for webpage accessibility,",
            ],
          }),
          `
`,
...
`,
          e.jsxs(n.li, {
            children: [
              "a log in form for patrons to log into NYPL's ",
              e.jsx(n.a, {
                href: "https://nypl.na2.iiivega.com/",
                rel: "nofollow",
                children: "Catalog",
              }),
              `
...
`,
          e.jsxs(n.li, {
            children: [
              "a search form for patrons to search the Catalog and across ",
              e.jsx(n.a, {
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "Header" }),
          " should be embedded on an NYPL app through the following code snippet:",
        ],
      }),
      `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          "The placeholder styles and ",
          e.jsx(n.code, { children: "div" }),
          ` wrapper are additional elements that are used
to mitigate the "jumping" effect that occurs when the `,
          e.jsx(n.code, { children: "Header" }),
          ` is loaded on a
page. The `,
          e.jsx(n.code, { children: "Header" }),
          ` script is loaded asynchronously and this means that the
`,
          e.jsx(n.code, { children: "Header" }),
          ` will render after the rest of the page is rendered and it will push the
main content down. The fixed height of the placeholder `,
          e.jsx(n.code, { children: "div" }),
          ` prevents the main
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "Header" }),
          ` component contains multiple native HTML elements that work together
...
`,
          e.jsxs(n.li, {
            children: [
              ...
              ` HTML element - This landmark element renders NYPL alert
messages. Per accessibility guidelines, this element cannot be nested within
the `,
              e.jsx(n.code, { children: "<header>" }),
              ` element, so it is rendered above. More information can be found
in the `,
              e.jsx(n.a, {
                href: "../?path=/docs/components-feedback-notification--docs#accessibility",
                children: "Notification Accessibility",
              }),
              `
section.`,
            ],
...
`,
          e.jsxs(n.li, {
            children: [
              e.jsx(n.code, { children: "<header>" }),
              ` HTML element - This landmark element denotes the top content section
of the page. There should only be one main `,
              e.jsx(n.code, { children: "<header>" }),
              ` element on the page as a
child of the `,
...
`,
          e.jsxs(n.li, {
            children: [
              e.jsx(n.code, { children: "<nav>" }),
              " HTML elements - The ",
              e.jsx(n.code, { children: "Header" }),
              " component renders one (1) ",
              e.jsx(n.code, { children: "<nav>" }),
              ` element
in the mobile view and two (2) `,
              e.jsx(n.code, { children: "<nav>" }),
              " elements in the desktop view. Each ",
              e.jsx(n.code, { children: "<nav>" }),
              `
element appropriately contains its own `,
...
`,
          e.jsxs(n.li, {
            children: [
              ...
              " HTML element - The ",
              e.jsx(n.code, { children: "<form>" }),
              " element is used in the search feature.",
            ],
          }),
          `
`,
          e.jsxs(n.li, {
            children: [
              "Dropdowns buttons with focus-trap feature - The ",
              e.jsx(n.code, { children: "Header" }),
              " uses ",
              e.jsx(n.code, { children: "react-focus-lock" }),
              `
...
Note: This is how the original NYPL `,
              e.jsx(n.code, { children: "Header" }),
              ` was implemented and its Reservoir
counterpart replicates this behavior. However, this is not the
`,
              e.jsx(n.em, { children: "currently recommended" }),
              ` way to implement focus management in dropdowns.
According to the `,
              e.jsx(n.a, {
                href: "https://www.w3.org/wiki/MenuButton",
                rel: "nofollow",
                children: "W3C",
              }),
              `, up and down arrow
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://developer.mozilla.org/en-US/docs/Web/HTML/Element/header#page_header",
              rel: "nofollow",
              children: "MDN header",
            }),
          }),
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://www.w3.org/WAI/tutorials/page-structure/regions/#page-header",
              rel: "nofollow",
              children: "W3C Page Regions, Page header",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://www.w3.org/WAI/tutorials/page-structure/regions/#navigation",
              rel: "nofollow",
              children: "W3C Page Regions, Navigation",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "MDN nav: The Navigation Section element",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              href: "https://www.w3.org/WAI/tutorials/page-structure/labels/",
              rel: "nofollow",
              children: "W3C Labeling Regions",
            }),
          }),
          `
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "MDN form: The Form element",
            }),
          }),
          `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          "The ",
          e.jsx(n.code, { children: "Header" }),
          " component implements the DS ",
          e.jsx(n.code, { children: "SkipNavigation" }),
          ` component. More
information about the component can be found in the
`,
          e.jsx(n.a, {
            href: "../?path=/docs/components-navigation-skipnavigation--docs",
...
`,
          e.jsx(n.a, {
            href: "../?path=/docs/accessibility-guide-skip-navigation--docs",
            children: "accessibility guideline",
          }),
          ".",
        ],
      }),
...
`,
          e.jsx(n.a, {
            ...
            rel: "nofollow",
            children: "NYPL's accessibility resource",
          }),
          ".",
        ],
      }),
...
`,
      e.jsx(n.h3, {
        id: "templateappcontainer",
        children: "TemplateAppContainer",
      }),
      `
`,
      e.jsxs(n.p, {
        children: [
          "The DS ",
          e.jsx(n.a, {
            href: "../?path=/docs/components-page-layout-template--docs",
            children: e.jsx(n.code, { children: "TemplateAppContainer" }),
          }),
          `
component renders the same `,
          ...
          e.jsx(n.code, { children: "Header" }),
          ` component
renders. When using both the `,
          e.jsx(n.code, { children: "Header" }),
          " and the ",
          e.jsx(n.code, { children: "TemplateAppContainer" }),
          ` components,
set the `,
          e.jsx(n.code, { children: "renderSkipNavigation" }),
          " prop in the ",
          e.jsx(n.code, { children: "TemplateAppContainer" }),
          ` component to
`,
          e.jsx(n.code, { children: "false" }),
          ". This will prevent two ",
          e.jsx(n.code, { children: "SkipNavigation" }),
...
`,
      e.jsxs(n.p, {
        children: [
          "While the ",
          e.jsx(n.code, { children: "Header" }),
          ` doesn't perform authentication, it does determine whether a user is
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          e.jsx(n.code, { children: "Header" }),
          ` mounts. At that time, it looks for the
`,
          e.jsx(n.code, { children: "nyplIdentityPatron" }),
          " cookie. If it exists, an ",
          e.jsx(n.code, { children: "accessToken" }),
          ` is extracted from the cookie
and sent via fetch request to the `,
          e.jsx(n.code, { children: "patronApiUrl" }),
          `. If the request is successful, the
patron's name is returned. The name is then stored in a React Context variable called
`,
          e.jsx(n.code, { children: "HeaderContext" }),
          ", which is available to all children of the ",
          e.jsx(n.code, { children: "Header" }),
          `. The existence of the
patron's name in `,
          e.jsx(n.code, { children: "HeaderContext" }),
          " causes the ",
          e.jsx(n.code, { children: "HeaderLoginButton" }),
          " and ",
          e.jsx(n.code, { children: "HeaderLogin" }),
          ` to
...
`,
      e.jsxs(n.p, {
        children: [
          "There is the possibility that the call to the ",
          e.jsx(n.code, { children: "patronApiUrl" }),
          ` returns a response with a
`,
          e.jsx(n.code, { children: "statusCode" }),
          " of 401 and an ",
          e.jsx(n.code, { children: "expired" }),
          " key set to true. This means the ",
          e.jsx(n.code, { children: "accessToken" }),
          ` is
expired. If this is the case, the `,
          e.jsx(n.code, { children: "Header" }),
          " will attempt to refresh the ",
          e.jsx(n.code, { children: "accessToken" }),
          ` by
sending a fetch request to the `,
          e.jsx(n.code, { children: "tokenRefreshLink" }),
          ". If successful, the ",
          e.jsx(n.code, { children: "Header" }),
          ` will retry
the request to the `,
...
`,
      e.jsx(n.p, {
        children: `In the mobile view, the "log in" feature can be seen when the user SVG icon
...
`,
      e.jsx(n.p, {
        children: `When opened, the dropdown menu will contain two red buttons that will direct the
user to the Catalog or the Research Catalog login pages.`,
      }),
      `
`,
      e.jsx(n.p, {
        children: `When logged in, the dropdown menu will also display the patron's name and an
...
navigation of the `,
          e.jsx(n.code, { children: "Header" }),
          `. When opened, the dropdown menu will display two
...
`,
      e.jsx(n.p, {
        children: `When logged in, the dropdown button's text will turn from "Log In" to
...
`,
      e.jsxs(n.p, {
        children: [
          "There is a single search form in the ",
          e.jsx(n.code, { children: "Header" }),
...
`,
          e.jsx(n.a, {
            href: "https://nypl.na2.iiivega.com/search?query=cats&searchType=everything&pageSize=10",
            rel: "nofollow",
...
`,
          e.jsx(n.a, {
            href: "https://www.nypl.org/search/cats?searched_from=header_search&timestamp=1658412778392",
            rel: "nofollow",
            children: "NYPL.org search",
          }),
          `
...
`,
      e.jsx(n.p, {
        children: `In the mobile view, the patron needs to click on the search icon button for the
...
`,
      e.jsx(n.p, {
        children: `In the desktop view, the patron needs to click on the "Search" button with the
...
`,
      e.jsxs(n.p, {
        children: [
          "There are two main navigational lists in the ",
          e.jsx(n.code, { children: "Header" }),
          ` component. The (1) first
contains:`,
        ],
      }),
      `
...
`,
          e.jsx(n.li, {
            children: "a link to NYPL's email subscription service",
          }),
          `
`,
...
`,
      e.jsx(n.p, {
        children: `In the mobile view, the patron needs to click on the hamburger menu icon button
...
`,
      e.jsx(n.p, {
        children: `The location link, the log in dropdown button, and the search dropdown button,
...
while the second set of links (2) appears at the bottom of the `,
          e.jsx(n.code, { children: "Header" }),
          ".",
        ],
      }),
...
or the Research Catalog, or log out by using the log out link in the `,
          e.jsx(n.code, { children: "Header" }),
          `
component. Because of this, there is a mismatch where one or more service
`,
          e.jsx(n.em, { children: "thinks" }),
          " the patron is still logged in. In order to avoid confusion, the ",
          e.jsx(n.code, { children: "Header" }),
          `
...
current workaround for logging out a patron in the `,
          e.jsx(n.code, { children: "Header" }),
          " component.",
        ],
      }),
...
will start in the `,
          e.jsx(n.code, { children: "Header" }),
          ` component. Once this timer reaches 0, the Header will
insert an `,
          e.jsx(n.code, { children: "iframe" }),
          " HTML element into the ",
          e.jsx(n.code, { children: "body" }),
          ` HTML element of the webpage.
This `,
          e.jsx(n.code, { children: "iframe" }),
          "'s ",
          e.jsx(n.code, { children: "src" }),
          ` attribute is set to the necessary Encore Catalog logout
link. This `,
          e.jsx(n.code, { children: "iframe" }),
          " element has a style of ",
          e.jsx(n.code, { children: "display: none" }),
...
function h(o = {}) {
  ...
  return n ? e.jsx(n, { ...o, children: e.jsx(i, { ...o }) }) : i(o);
}
export { h as default };
