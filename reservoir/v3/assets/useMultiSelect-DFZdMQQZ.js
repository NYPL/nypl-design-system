import { u as l, j as e, M as o, S as s } from "./iframe-D93LbwGv.js";
function c(n) {
  const t = {
    a: "a",
    code: "code",
  ...
  return e.jsxs(e.Fragment, {
    children: [
      e.jsx(o, { title: "Hooks/useMultiSelect" }),
      `
`,
        ...
        children: [
          e.jsx(t.thead, {
            children: e.jsxs(t.tr, {
              children: [
                e.jsx(t.th, { children: "Hook Version" }),
            ...
            children: [
              ...
              e.jsxs(t.tr, {
                children: [
                  ...
                  e.jsx(t.td, {
                    children: e.jsx(t.code, { children: "3.0.0" }),
                  }),
                ],
              }),
            ],
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          ` provides all functions needed to handle the selectedItems. This
...
`,
      e.jsxs(t.p, {
        children: [
          ...
          ` used for handling
the selectedItems object and `,
          e.jsx(t.code, { children: "disabled" }),
          ` state of items are not included in the
selectedItems. The function `,
          e.jsx(t.code, { children: "onClear" }),
          ` can be used to clear the selectedItems of
a specific `,
          e.jsx(t.code, { children: "MultiSelect" }),
          ` component connected to the hook. The hook also provides
the `,
          e.jsx(t.code, { children: "selectedItems" }),
          ` object containing the currently checked/selected items and a
`,
          e.jsx(t.code, { children: "setSelectedItems" }),
          " function to set or manipulate the state of ",
          e.jsx(t.code, { children: "selectedItems" }),
          `.
If using `,
          e.jsx(t.code, { children: "setSelectedItems" }),
          `, check that the correct data structure is passed
into `,
          e.jsx(t.code, { children: "setSelectedItems" }),
          ".",
        ],
...
`,
      e.jsxs(t.p, {
        children: [
          "For a full implementation example with a ",
          e.jsx(t.code, { children: "MultiSelect" }),
          ` component, view the
`,
          e.jsx(t.a, {
            href: "https://github.com/NYPL/nypl-design-system/blob/development/src/components/MultiSelect/MultiSelect.tsx",
            rel: "nofollow",
...
`,
      e.jsx(t.h2, {
        id: "usemultiselect-hook-implementation-in-a-multiselect",
        children: "useMultiSelect Hook implementation in a MultiSelect",
      }),
      `
`,
      e.jsxs(t.p, {
        children: [
          "The MultiSelect component can display nested items. When the ",
          e.jsx(t.code, { children: "useMultiSelect" }),
          `
...
`,
      e.jsx(t.p, {
        children: `The data structure to pass the setSelectedItems function in order to set a
inital state:`,
      }),
      `
`,
...
function i(n = {}) {
  const { wrapper: t } = { ...l(), ...n.components };
  return t ? e.jsx(t, { ...n, children: e.jsx(c, { ...n }) }) : c(n);
}
export { i as default };
