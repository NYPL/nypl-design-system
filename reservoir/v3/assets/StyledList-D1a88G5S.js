...
import {
  ...
  F as m,
  D as f,
} from "./StyledList.stories-BZJxXc_o.js";
const y = [
    {
      date: "2024-07-25",
      version: "3.2.0",
    ...
    e.jsxs(e.Fragment, {
      children: [
        ...
        e.jsxs("i", {
          children: [
            '"...and for the ',
            e.jsx("b", { children: "City of New York" }),
            '"',
          ],
        }),
      ],
...
`,
              e.jsx(i, {
                href: "#styledlist-children",
                target: "_self",
                children: "StyledList Children",
              }),
              `
`,
            ],
...
`,
      e.jsxs(n.p, {
        children: [
          "Internally, the ",
          e.jsx(n.code, { children: "StyledList" }),
          ` component implements native HTML markup for
unordered lists. When data is passed into the `,
          e.jsx(n.code, { children: "listItems" }),
          ` data prop, the
appropriate children `,
          e.jsx(n.code, { children: "li" }),
          " HTML elements are used.",
        ],
      }),
      `
`,
...
`,
          e.jsx(n.li, {
            children: e.jsx(n.a, {
              ...
              rel: "nofollow",
              children: "W3C WAI Content Structure Lists",
            }),
          }),
          `
`,
...
`,
      e.jsxs(n.p, {
        children: [
          "The font size can be changed through the ",
          e.jsx(n.code, { children: "textSize" }),
          ` prop. The values are a
limited selection from the `,
...
`,
      e.jsxs(n.p, {
        children: [
          ...
          ", ",
          e.jsx(n.code, { children: '"body1"' }),
          ", ",
          e.jsx(n.code, { children: '"body2"' }),
          ", ",
...
`,
      e.jsxs(n.p, {
        children: [
          e.jsx(n.code, { children: '"tag"' }),
          ", ",
          e.jsx(n.code, { children: '"mini"' }),
          ".",
        ],
      }),
      `
...
`,
      e.jsxs(n.p, {
        children: [
          "Pass in ",
          e.jsx(n.code, { children: "<li>" }),
          " children elements as you normally would for the ",
...
`,
      e.jsxs(n.p, {
        children: [
          "Data in the ",
          e.jsx(n.code, { children: "listItems" }),
          ` prop array can be JSX Elements or strings. The
`,
          e.jsx(n.code, { children: "StyledList" }),
          " component will render the data as ",
          e.jsx(n.code, { children: "li" }),
          ` elements, so there is no
need to add them in the `,
          e.jsx(n.code, { children: "listItems" }),
          " array. ",
          e.jsxs(n.em, {
            children: [
              "If ",
              e.jsx(n.code, { children: "li" }),
              ` elements wrap the data in the
`,
              e.jsx(n.code, { children: "listItems" }),
              " array, they will be rendered as nested ",
              e.jsx(n.code, { children: "li" }),
              ` elements and incorrectly
...
`,
      ...
      `
`,
      e.jsx(p, { changelogData: y }),
    ],
  });
}
function T(s = {}) {
  const { wrapper: n } = { ...h(), ...s.components };
  return n ? e.jsx(n, { ...s, children: e.jsx(c, { ...s }) }) : c(s);
}
export { T as default, b as listItems };
