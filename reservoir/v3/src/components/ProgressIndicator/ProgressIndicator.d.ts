...
export declare const progressIndicatorTypesArray: readonly [
  "circular",
  "linear"
];
export declare const progressIndicatorLabelPlacementsArray: readonly [
  "bottom",
  "right",
  "top",
  "left"
 ...
 */
export declare const ProgressIndicator: ChakraComponent<
