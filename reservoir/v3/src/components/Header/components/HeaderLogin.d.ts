 ...
 */
declare const HeaderLogin: import("@chakra-ui/system/dist/system.types").ChakraComponent<({ catalogRef, isMobile }: HeaderLoginProps) => import('../../../../node_modules/react/jsx-runtime').JSX.Element, {}>;
