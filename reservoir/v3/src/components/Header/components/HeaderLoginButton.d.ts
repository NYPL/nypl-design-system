 ...
 */
declare const HeaderLoginButton: import("@chakra-ui/system/dist/system.types").ChakraComponent<({ isMobile }: HeaderLoginButtonProps) => import('../../../../node_modules/react/jsx-runtime').JSX.Element, {}>;
