 ...
 */
declare const HeaderSearchForm: import("@chakra-ui/system/dist/system.types").ChakraComponent<
  ({
    isMobile,
  }: HeaderSearchFormProps) => import("../../../../node_modules/react/jsx-runtime").JSX.Element,
  {}
>;
