 ...
 * (as expected).
 */
declare const MultiSelectItemsCountButton: import('../../../node_modules/react').ForwardRefExoticComponent<MultiSelectItemsCountButtonProps & import('../../../node_modules/react').RefAttributes<HTMLButtonElement>>;
