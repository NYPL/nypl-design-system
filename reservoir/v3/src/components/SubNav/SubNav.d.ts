...
export declare const SubNavButton: React.FC<
  React.PropsWithChildren<SubNavButtonProps>
>;
export declare const SubNavLink: React.FC<
  React.PropsWithChildren<SubNavLinkProps>
>;
/**
 ...
 */
export declare const SubNav: ChakraComponent<
